...
rule APT_BLUENOROFF
{
    ...
    strings:
        $domain0 = "02usweb\.us" ascii wide nocase
        $domain1 = "05usweb\.us" ascii wide nocase
        $domain2 = "06ukweb\.uk" ascii wide nocase
        $domain3 = "06usweb\.us" ascii wide nocase
        $domain4 = "07usweb\.site" ascii wide nocase
        $domain5 = "163qiye\.top" ascii wide nocase
        $domain6 = "1driv\.org" ascii wide nocase
        $domain7 = "1drv\.email" ascii wide nocase
        $domain8 = "1drvmail\.work" ascii wide nocase
        $domain9 = "256ventures\.us" ascii wide nocase
        $domain10 = "31ventures\.info" ascii wide nocase
        $domain11 = "32\.ww-live\.online" ascii wide nocase
        $domain12 = "3f\.teams-meet\.xyz" ascii wide nocase
        $domain13 = "5q\.ms-meets\.online" ascii wide nocase
        $domain14 = "a\.mylkc\.cloudns\.ch" ascii wide nocase
        $domain15 = "abf-cap\.co" ascii wide nocase
        $domain16 = "abf-cap\.com" ascii wide nocase
        $domain17 = "abiesvc\.com" ascii wide nocase
        $domain18 = "abiesvc\.info" ascii wide nocase
        $domain19 = "abiesvc\.jp\.net" ascii wide nocase
        $domain20 = "account-googlemeet\.com" ascii wide nocase
        $domain21 = "adiclas-nft\.quest" ascii wide nocase
        $domain22 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain23 = "aidpartners\.org" ascii wide nocase
        $domain24 = "ajayplamingo\.com" ascii wide nocase
        $domain25 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain26 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain27 = "altair-vc\.co\.uk" ascii wide nocase
        $domain28 = "altair-vc\.com" ascii wide nocase
        $domain29 = "altair\.linkpc\.net" ascii wide nocase
        $domain30 = "amazonaws1\.info" ascii wide nocase
        $domain31 = "amzonnews\.club" ascii wide nocase
        $domain32 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain33 = "angelbridge\.capital" ascii wide nocase
        $domain34 = "angelbridge\.jp" ascii wide nocase
        $domain35 = "ankanimatoka\.com" ascii wide nocase
        $domain36 = "annaelsa\.xyz" ascii wide nocase
        $domain37 = "anobaka\.info" ascii wide nocase
        $domain38 = "anobaka\.jp" ascii wide nocase
        $domain39 = "antcapital\.us" ascii wide nocase
        $domain40 = "api\.betterfun\.space" ascii wide nocase
        $domain41 = "api\.clearit\.sbs" ascii wide nocase
        $domain42 = "api\.flashstore\.sbs" ascii wide nocase
        $domain43 = "api\.zerodev\.pro" ascii wide nocase
        $domain44 = "api\.zoom-sdk\.com" ascii wide nocase
        $domain45 = "apizoom\.myfanshu\.com" ascii wide nocase
        $domain46 = "app-wechat\.xyz" ascii wide nocase
        $domain47 = "app\.baiduweb\.pro" ascii wide nocase
        $domain48 = "app\.developcore\.org" ascii wide nocase
        $domain49 = "app\.republicrypto\.vc" ascii wide nocase
        ...
        $ip62 = "45.61.140.26" ascii wide
        $ip63 = "66.181.166.15" ascii wide
