...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain9 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain10 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain11 = "24\.rvtoolis\.info" ascii wide nocase
        $domain12 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain13 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain14 = "2b\.rvtoolsit\.com" ascii wide nocase
        $domain15 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain16 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain17 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain18 = "3p\.workbenche\.com" ascii wide nocase
        $domain19 = "40\.workbencse\.com" ascii wide nocase
        $domain20 = "45perhour\.org" ascii wide nocase
        $domain21 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain22 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain23 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain24 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain25 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain26 = "7stories\.sbs" ascii wide nocase
        $domain27 = "91movs\.com" ascii wide nocase
        $domain28 = "9xstream\.live" ascii wide nocase
        $domain29 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain30 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain31 = "abstractest-hydroski\.site" ascii wide nocase
        $domain32 = "academytradeai\.com" ascii wide nocase
        $domain33 = "acquasicuras\.com" ascii wide nocase
        $domain34 = "actbluecs\.com" ascii wide nocase
        $domain35 = "actblues\.net" ascii wide nocase
        $domain36 = "adionetjrei\.shop" ascii wide nocase
        $domain37 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain38 = "adrilex\.digital" ascii wide nocase
        $domain39 = "aexnp\.com" ascii wide nocase
        $domain40 = "afd-esign\.info" ascii wide nocase
        $domain41 = "afeherbopenuk\.com" ascii wide nocase
        $domain42 = "agora-mesmo\.com" ascii wide nocase
        $domain43 = "agronomywork\.info" ascii wide nocase
        $domain44 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain45 = "aialgocamp\.com" ascii wide nocase
        $domain46 = "aialgocore\.com" ascii wide nocase
        $domain47 = "aialgodrive\.com" ascii wide nocase
        $domain48 = "aialgoflow\.com" ascii wide nocase
        $domain49 = "aialgofusion\.com" ascii wide nocase
