...
rule APT_UNC6691_1
{
    ...
    strings:
        ...
        $domain3 = "0243jcssa\.online" ascii wide nocase
        $domain4 = "027hao\.cn" ascii wide nocase
        $domain5 = "0291\.top" ascii wide nocase
        $domain6 = "0505\.wwxblue\.workers\.dev" ascii wide nocase
        $domain7 = "0rdershop\.com" ascii wide nocase
        $domain8 = "1-nycyh\.workers\.dev" ascii wide nocase
        $domain9 = "1\.a13518075286\.workers\.dev" ascii wide nocase
        $domain10 = "11\.jponliine\.com" ascii wide nocase
        $domain11 = "125540947\.workers\.dev" ascii wide nocase
        $domain12 = "1289238bgyu8bgy8o\.pages\.dev" ascii wide nocase
        $domain13 = "1328054280\.workers\.dev" ascii wide nocase
        $domain14 = "13802880308\.workers\.dev" ascii wide nocase
        $domain15 = "13p13\.tyhls\.cn" ascii wide nocase
        $domain16 = "14\.harajukup\.com" ascii wide nocase
        $domain17 = "15999756862\.workers\.dev" ascii wide nocase
        $domain18 = "16388\.pages\.dev" ascii wide nocase
        $domain19 = "18agj\.com" ascii wide nocase
        $domain20 = "1a\.zencartjp\.com" ascii wide nocase
        $domain21 = "1b21533f51\.workers\.dev" ascii wide nocase
        $domain22 = "1bxvv83nskca6a14\.cfd" ascii wide nocase
        $domain23 = "1d8x3\.com" ascii wide nocase
        $domain24 = "1f\.okinasumo\.com" ascii wide nocase
        $domain25 = "1f6z8\.com" ascii wide nocase
        $domain26 = "1f8z5\.com" ascii wide nocase
        $domain27 = "1j1j\.tyhls\.cn" ascii wide nocase
        $domain28 = "1k\.kyusmalli\.com" ascii wide nocase
        $domain29 = "1k\.zenjpmart\.com" ascii wide nocase
        $domain30 = "1k1k\.tyhls\.cn" ascii wide nocase
        $domain31 = "1k4m8\.com" ascii wide nocase
        $domain32 = "1m9z3\.com" ascii wide nocase
        $domain33 = "1mgtpu86\.niponshop\.com" ascii wide nocase
        $domain34 = "1n3p9\.com" ascii wide nocase
        $domain35 = "1n5f8\.com" ascii wide nocase
        $domain36 = "1natsuhina\.workers\.dev" ascii wide nocase
        $domain37 = "1p2k9\.com" ascii wide nocase
        $domain38 = "1p4k9\.com" ascii wide nocase
        $domain39 = "1q\.zenshopjp\.com" ascii wide nocase
        $domain40 = "1r8v2\.com" ascii wide nocase
        $domain41 = "1t7n3\.com" ascii wide nocase
        $domain42 = "1u8\.bnb5\.vip" ascii wide nocase
        $domain43 = "1x5r6\.com" ascii wide nocase
        $domain44 = "1x9p2\.com" ascii wide nocase
        $domain45 = "1z1z\.tyhls\.cn" ascii wide nocase
        $domain46 = "2023\.youorder\.shop" ascii wide nocase
        $domain47 = "20240307-488\.pages\.dev" ascii wide nocase
        $domain48 = "20240309-3ug\.pages\.dev" ascii wide nocase
        $domain49 = "20240410\.tdbvqepmg\.workers\.dev" ascii wide nocase
