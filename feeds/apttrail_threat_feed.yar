...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain14 = "afsder\.com" ascii wide nocase
        $domain15 = "agegamepay\.com" ascii wide nocase
        $domain16 = "ageofwuxia\.com" ascii wide nocase
        $domain17 = "ageofwuxia\.info" ascii wide nocase
        $domain18 = "ageofwuxia\.net" ascii wide nocase
        $domain19 = "ageofwuxia\.org" ascii wide nocase
        $domain20 = "akacur\.tk" ascii wide nocase
        $domain21 = "akamaixed\.net" ascii wide nocase
        $domain22 = "alibaba\.zzux\.com" ascii wide nocase
        $domain23 = "aliyun\.com\.co" ascii wide nocase
        $domain24 = "alpha-els\.com" ascii wide nocase
        $domain25 = "alxc\.tbtianyan\.com" ascii wide nocase
        $domain26 = "amazonlivenews\.com" ascii wide nocase
        $domain27 = "andropwn\.xyz" ascii wide nocase
        $domain28 = "aone\.ddns\.net" ascii wide nocase
        $domain29 = "ap\.philancourts\.com" ascii wide nocase
        $domain30 = "api\.emazemedia\.com" ascii wide nocase
        $domain31 = "api\.googleauthenticatoronline\.com" ascii wide nocase
        $domain32 = "api\.sourcedata\.kuwannba\.com" ascii wide nocase
        $domain33 = "app\.kaspersky-scan\.com" ascii wide nocase
        $domain34 = "app\.microsoftstaticapi\.com" ascii wide nocase
        $domain35 = "arestc\.net" ascii wide nocase
        $domain36 = "asdasw21\.icu" ascii wide nocase
        $domain37 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain38 = "assistcustody\.xyz" ascii wide nocase
        $domain39 = "astudycarsceu\.net" ascii wide nocase
        $domain40 = "asushotfix\.com" ascii wide nocase
        $domain41 = "atomiclampco\.com" ascii wide nocase
        $domain42 = "auth\.microsoftsservice\.com" ascii wide nocase
        $domain43 = "az\.performed12\.com" ascii wide nocase
        $domain44 = "back\.rooter\.tk" ascii wide nocase
        $domain45 = "backdoor\.apt\.photo" ascii wide nocase
        $domain46 = "bingsearches\.com" ascii wide nocase
        $domain47 = "bobs8\.oss-cn-hongkong\.aliyuncs\.com" ascii wide nocase
        $domain48 = "bold-hamilton\.207-246-119-197\.plesk\.page" ascii wide nocase
        $domain49 = "boopainc\.com" ascii wide nocase
...
rule APT_LOTUSBLOSSOM
{
    ...
    strings:
        ...
        $domain34 = "scristioned\.dyndns-web\.com" ascii wide nocase
        $domain35 = "seachers\.net" ascii wide nocase
        $domain36 = "self-dns\.it\.com" ascii wide nocase
        $domain37 = "serchers\.net" ascii wide nocase
        $domain38 = "shotacon\.dyndns\.info" ascii wide nocase
        $domain39 = "skycloudcenter\.com" ascii wide nocase
        $domain40 = "tgecc\.org" ascii wide nocase
        $domain41 = "tintuchoahau\.com" ascii wide nocase
        $domain42 = "ubkv1t\.ec0\.com" ascii wide nocase
        $domain43 = "usa-moon\.net" ascii wide nocase
        $domain44 = "verolalia\.dyndns\.org" ascii wide nocase
        $domain45 = "vienclp\.com" ascii wide nocase
        $domain46 = "w\.7sytdjc\.wroi\.cxy\.com" ascii wide nocase
        $domain47 = "wiresguard\.com" ascii wide nocase
        $domain48 = "wsi\.dyndns\.org" ascii wide nocase
        $domain49 = "www3\.bkav2010\.net" ascii wide nocase
