...
rule APT_FORUMTROLL
{
    ...
    strings:
        ...
        $domain24 = "mil-by\.info" ascii wide nocase
        $domain25 = "moscow\.corptravel\.org" ascii wide nocase
        $domain26 = "ms-appdata-fonts\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain27 = "ms-appdata-main\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain28 = "ms-appdata-query\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain29 = "mstn-ru\.com" ascii wide nocase
        $domain30 = "passport\.yandeks\.info" ascii wide nocase
        $domain31 = "peerflix\.net" ascii wide nocase
        $domain32 = "perf-service-clients2\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain33 = "primakovreadings\.info" ascii wide nocase
        $domain34 = "primakovreadings2025\.info" ascii wide nocase
        $domain35 = "rabotnik\.today" ascii wide nocase
        $domain36 = "rdp-api-front\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain37 = "rdp-query-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain38 = "rdp-statistics-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain39 = "srv480138\.hstgr\.cloud" ascii wide nocase
        $domain40 = "srv484118\.hstgr\.cloud" ascii wide nocase
        $domain41 = "status-portal-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain42 = "svobody\.org" ascii wide nocase
        $domain43 = "ulitsa\.svobody\.org" ascii wide nocase
        $domain44 = "yandeks\.info" ascii wide nocase
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain13 = "247l\.net" ascii wide nocase
        $domain14 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain15 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain16 = "360scanner\.store" ascii wide nocase
        $domain17 = "360share\.pro" ascii wide nocase
        $domain18 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain19 = "4caddie\.com" ascii wide nocase
        ...
        $domain28 = "8cap\.inashtech\.com" ascii wide nocase
        $domain29 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain30 = "a\.videotalks\.site" ascii wide nocase
        $domain31 = "aa2akhtech\.in" ascii wide nocase
        $domain32 = "aarnaitsolution\.in" ascii wide nocase
        ...
        $domain39 = "abiyz\.com" ascii wide nocase
        $domain40 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain41 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain42 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain43 = "acom\.capital" ascii wide nocase
        $domain44 = "acoustickoala\.com" ascii wide nocase
        $domain45 = "acroadovw\.com" ascii wide nocase
        $domain46 = "activity-179384736\.site" ascii wide nocase
        $domain47 = "activity-permission\.online" ascii wide nocase
        $domain48 = "additional\.work\.gd" ascii wide nocase
        $domain49 = "additionalpublic\.work\.gd" ascii wide nocase
...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain21 = "24170-40494\.bacloud\.info" ascii wide nocase
        $domain22 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain23 = "2let\.org" ascii wide nocase
        $domain24 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain25 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain26 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain27 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain28 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain29 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain30 = "63inc\.com" ascii wide nocase
        $domain31 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain32 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain33 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain34 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain35 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain36 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain37 = "81-cn\.ddns\.net" ascii wide nocase
        $domain38 = "81-cn\.info" ascii wide nocase
        $domain39 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain40 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain41 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain42 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain43 = "a\.bc\.1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain44 = "a\.bc\.1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain45 = "a\.bc\.1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain46 = "a\.bc\.64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain47 = "a\.fetchdrive\.info" ascii wide nocase
        $domain48 = "a5936441-e402-41e3-b02b-75af112074b5\.org-co\.net" ascii wide nocase
        $domain49 = "a6dff163-e0b9-49c9-87e4-357f761f3c3b\.us-east-1\.cloud\.genez\.io" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain23 = "keystore-explorer\.com" ascii wide nocase
        $domain24 = "mstore\.framfarmers\.co\.uk" ascii wide nocase
        $domain25 = "pofelal314\.workers\.dev" ascii wide nocase
        $domain26 = "rv-tools\.eu" ascii wide nocase
        $domain27 = "rvtoo1s\.com" ascii wide nocase
        $domain28 = "rvtooles\.com" ascii wide nocase
        $domain29 = "rvtoolis\.com" ascii wide nocase
        $domain30 = "rvtoolit\.com" ascii wide nocase
        $domain31 = "rvtoolsac\.com" ascii wide nocase
        $domain32 = "rvtoolsacad\.com" ascii wide nocase
        $domain33 = "rvtoolspro\.com" ascii wide nocase
        $domain34 = "rvtoolspro\.info" ascii wide nocase
        $domain35 = "rvtoolspro\.online" ascii wide nocase
        $domain36 = "rvtoolsus\.com" ascii wide nocase
        $domain37 = "rvtoolsusa\.com" ascii wide nocase
        $domain38 = "server-cd2\.bipewi2747\.workers\.dev" ascii wide nocase
        $domain39 = "server-cdn\.jawigaw383\.workers\.dev" ascii wide nocase
        $domain40 = "server-cdn\.lafise2419\.workers\.dev" ascii wide nocase
        $domain41 = "server-cdn\.lecoc56350\.workers\.dev" ascii wide nocase
        $domain42 = "server-cdn\.sidoke9822\.workers\.dev" ascii wide nocase
        $domain43 = "server-cdn\.virej10913\.workers\.dev" ascii wide nocase
        $domain44 = "server-cdn\.xohahey822\.workers\.dev" ascii wide nocase
        $domain45 = "server-web-cdn\.detocim498\.workers\.dev" ascii wide nocase
        $domain46 = "server-web-cdn\.dones86497\.workers\.dev" ascii wide nocase
        $domain47 = "server-web-cdn\.kagoli5215\.workers\.dev" ascii wide nocase
        $domain48 = "server-web-cdn\.mevame4224\.workers\.dev" ascii wide nocase
        $domain49 = "server-web-cdn\.nefixeg373\.workers\.dev" ascii wide nocase
