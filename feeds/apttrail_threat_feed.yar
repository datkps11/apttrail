...
rule APT_UNC6691_1
{
    ...
    strings:
        ...
        $domain1 = "0rdershop\.com" ascii wide nocase
        $domain2 = "11\.jponliine\.com" ascii wide nocase
        $domain3 = "14\.harajukup\.com" ascii wide nocase
        $domain4 = "1a\.zencartjp\.com" ascii wide nocase
        $domain5 = "1f\.okinasumo\.com" ascii wide nocase
        $domain6 = "1f6z8\.com" ascii wide nocase
        $domain7 = "1k\.kyusmalli\.com" ascii wide nocase
        $domain8 = "1k\.zenjpmart\.com" ascii wide nocase
        $domain9 = "1m9z3\.com" ascii wide nocase
        $domain10 = "1mgtpu86\.niponshop\.com" ascii wide nocase
        $domain11 = "1n3p9\.com" ascii wide nocase
        $domain12 = "1p2k9\.com" ascii wide nocase
        $domain13 = "1p4k9\.com" ascii wide nocase
        $domain14 = "1q\.zenshopjp\.com" ascii wide nocase
        $domain15 = "1r8v2\.com" ascii wide nocase
        $domain16 = "1x9p2\.com" ascii wide nocase
        $domain17 = "2023\.youorder\.shop" ascii wide nocase
        $domain18 = "2c8b3f19-0325-4acc-a3dd-31a918e4dbf5\.random\.yourorders\.shop" ascii wide nocase
        $domain19 = "2d8n1\.com" ascii wide nocase
        $domain20 = "2f7r4\.com" ascii wide nocase
        $domain21 = "2g9p7\.com" ascii wide nocase
        $domain22 = "2k5v3\.com" ascii wide nocase
        $domain23 = "2k9x5\.com" ascii wide nocase
        $domain24 = "2n3v6\.com" ascii wide nocase
        $domain25 = "2n8b6\.com" ascii wide nocase
        $domain26 = "2w6p1\.com" ascii wide nocase
        $domain27 = "2x1p9\.com" ascii wide nocase
        $domain28 = "3c8f1\.com" ascii wide nocase
        $domain29 = "3d2p5\.com" ascii wide nocase
        $domain30 = "3m1x8\.com" ascii wide nocase
        $domain31 = "3memk1pz\.niponshop\.com" ascii wide nocase
        $domain32 = "3n7r6\.com" ascii wide nocase
        $domain33 = "3p5g8\.com" ascii wide nocase
        $domain34 = "3q\.fujifindjp\.com" ascii wide nocase
        $domain35 = "3t4b8\.com" ascii wide nocase
        $domain36 = "3u2t71\.niponshop\.com" ascii wide nocase
        $domain37 = "3z2f7\.com" ascii wide nocase
        $domain38 = "41\.animebuyjp\.com" ascii wide nocase
        $domain39 = "44\.kireiishop\.com" ascii wide nocase
        $domain40 = "4b8x2\.com" ascii wide nocase
        $domain41 = "4f8c1\.com" ascii wide nocase
        $domain42 = "4f9m7\.com" ascii wide nocase
        $domain43 = "4g5k2\.com" ascii wide nocase
        $domain44 = "4hejvbg\.niponshop\.com" ascii wide nocase
        $domain45 = "4k1d8\.com" ascii wide nocase
        $domain46 = "4kt185\.niponshop\.com" ascii wide nocase
        $domain47 = "4n1v3\.com" ascii wide nocase
        $domain48 = "4q7v3\.com" ascii wide nocase
        $domain49 = "4t9w2\.com" ascii wide nocase
