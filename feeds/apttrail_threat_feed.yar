...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain26 = "0992\.app" ascii wide nocase
        $domain27 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain28 = "099ae\.qcechaw\.cc" ascii wide nocase
        $domain29 = "0am15\.com" ascii wide nocase
        $domain30 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain31 = "0b461\.xdjuvoau\.xyz" ascii wide nocase
        $domain32 = "0b6c80a39c\.top" ascii wide nocase
        $domain33 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain34 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain35 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain36 = "0bb7\.dmjdwvpy\.com" ascii wide nocase
        $domain37 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain38 = "0cncoxi\.com" ascii wide nocase
        $domain39 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain40 = "0dc48\.xjhvsgg\.xyz" ascii wide nocase
        $domain41 = "0de\.ofvtspr\.xyz" ascii wide nocase
        $domain42 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain43 = "0e8\.kqyxwyb\.xyz" ascii wide nocase
        $domain44 = "0fx7qmdggegytul\.xyz" ascii wide nocase
        $domain45 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain46 = "0jijrwbzxzzxz04\.xyz" ascii wide nocase
        $domain47 = "0opus\.com" ascii wide nocase
        $domain48 = "0r97p\.com" ascii wide nocase
        $domain49 = "1\.votetexas\.xyz" ascii wide nocase
