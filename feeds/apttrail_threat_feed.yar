...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain32 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain33 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain34 = "0sv8\.qiz172u9i01\.dns\.army" ascii wide nocase
        $domain35 = "0t3ofn4r21\.dns\.navy" ascii wide nocase
        $domain36 = "0twjc657tu\.v6\.navy" ascii wide nocase
        $domain37 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain38 = "0x0\.care" ascii wide nocase
        $domain39 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain40 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain41 = "100000recipe\.com" ascii wide nocase
        $domain42 = "100nservercc\.cfd" ascii wide nocase
        $domain43 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain44 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain45 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain46 = "10nservercc\.cfd" ascii wide nocase
        $domain47 = "10onlinen\.cfd" ascii wide nocase
        $domain48 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain49 = "11nservercc\.cfd" ascii wide nocase
