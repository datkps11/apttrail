...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain9 = "0278\.fxexebji\.org" ascii wide nocase
        $domain10 = "028mfsb\.com" ascii wide nocase
        $domain11 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain12 = "03f6aef6fd\.top" ascii wide nocase
        $domain13 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain14 = "047\.auyciwmw\.com" ascii wide nocase
        $domain15 = "04f327f914\.top" ascii wide nocase
        $domain16 = "054\.esqifis\.com" ascii wide nocase
        $domain17 = "063\.heppmpuz\.org" ascii wide nocase
        $domain18 = "0661\.vdrywdi\.xyz" ascii wide nocase
        $domain19 = "06bf0\.crfbbarx\.com" ascii wide nocase
        $domain20 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain21 = "070052\.sod777\.com" ascii wide nocase
        $domain22 = "07c0\.ybbshhn\.com" ascii wide nocase
        $domain23 = "07f61\.ncjqeyid\.com" ascii wide nocase
        $domain24 = "0847\.zcfniju\.cc" ascii wide nocase
        $domain25 = "09688\.xkbaamgc\.cc" ascii wide nocase
        $domain26 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain27 = "099ae\.qcechaw\.cc" ascii wide nocase
        $domain28 = "0am15\.com" ascii wide nocase
        $domain29 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain30 = "0b461\.xdjuvoau\.xyz" ascii wide nocase
        $domain31 = "0b6c80a39c\.top" ascii wide nocase
        $domain32 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain33 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain34 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain35 = "0bb7\.dmjdwvpy\.com" ascii wide nocase
        $domain36 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain37 = "0cncoxi\.com" ascii wide nocase
        $domain38 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain39 = "0dc48\.xjhvsgg\.xyz" ascii wide nocase
        $domain40 = "0de\.ofvtspr\.xyz" ascii wide nocase
        $domain41 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain42 = "0e8\.kqyxwyb\.xyz" ascii wide nocase
        $domain43 = "0fx7qmdggegytul\.xyz" ascii wide nocase
        $domain44 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain45 = "0jijrwbzxzzxz04\.xyz" ascii wide nocase
        $domain46 = "0opus\.com" ascii wide nocase
        $domain47 = "0r97p\.com" ascii wide nocase
        $domain48 = "1\.votetexas\.xyz" ascii wide nocase
        $domain49 = "100000000115d9\.sod777\.com" ascii wide nocase
