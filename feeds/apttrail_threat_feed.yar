...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain10 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.voranstaks\.shop" ascii wide nocase
        $domain11 = "05nservercc\.cfd" ascii wide nocase
        $domain12 = "05onlinen\.cfd" ascii wide nocase
        $domain13 = "06nservercc\.cfd" ascii wide nocase
        $domain14 = "06onlinen\.cfd" ascii wide nocase
        $domain15 = "07nservercc\.cfd" ascii wide nocase
        $domain16 = "07onlinen\.cfd" ascii wide nocase
        $domain17 = "08nservercc\.cfd" ascii wide nocase
        $domain18 = "08onlinen\.cfd" ascii wide nocase
        $domain19 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain20 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain21 = "09nservercc\.cfd" ascii wide nocase
        $domain22 = "09onlinen\.cfd" ascii wide nocase
        $domain23 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain24 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain25 = "0x0\.care" ascii wide nocase
        $domain26 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain27 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain28 = "100000recipe\.com" ascii wide nocase
        $domain29 = "100nservercc\.cfd" ascii wide nocase
        $domain30 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain31 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain32 = "10nservercc\.cfd" ascii wide nocase
        $domain33 = "10onlinen\.cfd" ascii wide nocase
        $domain34 = "11nservercc\.cfd" ascii wide nocase
        $domain35 = "11onlinen\.cfd" ascii wide nocase
        $domain36 = "12-ko-official\.com" ascii wide nocase
        $domain37 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain38 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain39 = "12nservercc\.cfd" ascii wide nocase
        $domain40 = "12onlinen\.cfd" ascii wide nocase
        $domain41 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain42 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain43 = "13nservercc\.cfd" ascii wide nocase
        $domain44 = "13onlinen\.cfd" ascii wide nocase
        $domain45 = "13udm\.v6\.navy" ascii wide nocase
        $domain46 = "149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain47 = "149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain48 = "14nservercc\.cfd" ascii wide nocase
        $domain49 = "14onlinen\.cfd" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain2 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain3 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain4 = "alert-router-b3a\.workers\.dev" ascii wide nocase
        $domain5 = "angryipa\.com" ascii wide nocase
        $domain6 = "angryipac\.com" ascii wide nocase
        $domain7 = "angryipac\.net" ascii wide nocase
        $domain8 = "angryipsc\.com" ascii wide nocase
        $domain9 = "api-gateway-a3f\.workers\.dev" ascii wide nocase
        $domain10 = "api\.rvtoolacs\.online" ascii wide nocase
        $domain11 = "app-cdn-software-gza4gebuf3cqd8h6\.z03\.azurefd\.net" ascii wide nocase
        $domain12 = "app-cdn\.celixi6266\.workers\.dev" ascii wide nocase
        $domain13 = "app\.pofelal314\.workers\.dev" ascii wide nocase
        $domain14 = "app\.sync-engine-d8b\.workers\.dev" ascii wide nocase
        $domain15 = "bapiyat727\.workers\.dev" ascii wide nocase
        $domain16 = "beekeeperstudio-db\.com" ascii wide nocase
        $domain17 = "beekeeperstudio\.cc" ascii wide nocase
        $domain18 = "beekeeperstudio\.co" ascii wide nocase
        $domain19 = "beekeeperstudio\.pro" ascii wide nocase
        $domain20 = "beekeeperstudio\.softwarep2p\.com" ascii wide nocase
        $domain21 = "beekeeperstudio\.space" ascii wide nocase
        $domain22 = "beekeeperstudio\.tech" ascii wide nocase
        $domain23 = "calm-haze-cdae\.test-runner-4b7\.workers\.dev" ascii wide nocase
        $domain24 = "cdn-ae\.azureedge\.net" ascii wide nocase
        $domain25 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain26 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain27 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain28 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain29 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain30 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain31 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain32 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain33 = "computerservicesource\.com" ascii wide nocase
        $domain34 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain35 = "daniel-foster\.workers\.dev" ascii wide nocase
        $domain36 = "dark-bar-d282\.nina-alvarez\.workers\.dev" ascii wide nocase
        $domain37 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain38 = "data-pipeline-9e4\.workers\.dev" ascii wide nocase
        $domain39 = "database-lists\.com" ascii wide nocase
        $domain40 = "db-proxy-9b2\.daniel-foster\.workers\.dev" ascii wide nocase
        $domain41 = "dbeaver-database\.app" ascii wide nocase
        $domain42 = "dbeaver-database\.cc" ascii wide nocase
        $domain43 = "dbeaver-database\.cloud" ascii wide nocase
        $domain44 = "dbeaver-database\.co" ascii wide nocase
        $domain45 = "dbeaver-database\.com" ascii wide nocase
        $domain46 = "dbeaver-database\.org" ascii wide nocase
        $domain47 = "dbeaver-database\.pro" ascii wide nocase
        $domain48 = "dbeaver-database\.tech" ascii wide nocase
        $domain49 = "dbeaver-database\.us" ascii wide nocase
