...
rule APT_PATCHWORK
{
    ...
    strings:
        ...
        $domain35 = "asftbngh\.top" ascii wide nocase
        $domain36 = "asiandefnetwork\.com" ascii wide nocase
        $domain37 = "asustufupdates\.com" ascii wide nocase
        $domain38 = "atus\.toproid\.xyz" ascii wide nocase
        $domain39 = "aurorafoss\.xyz" ascii wide nocase
        $domain40 = "auth\.fyicompsol\.xyz" ascii wide nocase
        $domain41 = "avangrid\.info" ascii wide nocase
        $domain42 = "avtofrom\.us" ascii wide nocase
        $domain43 = "azureinternalupdates\.com" ascii wide nocase
        $domain44 = "b3autybab3s\.com" ascii wide nocase
        $domain45 = "baidunetdisk\.info" ascii wide nocase
        $domain46 = "bayanat\.co\.nf" ascii wide nocase
        $domain47 = "beautifullimages\.co\.nf" ascii wide nocase
        $domain48 = "beijingtv\.org" ascii wide nocase
        $domain49 = "bhutanembassynepal\.com" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        $domain0 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain1 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain2 = "angryipa\.com" ascii wide nocase
        $domain3 = "angryipac\.com" ascii wide nocase
        $domain4 = "angryipac\.net" ascii wide nocase
        $domain5 = "angryipsc\.com" ascii wide nocase
        $domain6 = "api\.rvtoolacs\.online" ascii wide nocase
        $domain7 = "app-cdn-software-gza4gebuf3cqd8h6\.z03\.azurefd\.net" ascii wide nocase
        $domain8 = "app-cdn\.celixi6266\.workers\.dev" ascii wide nocase
        $domain9 = "app\.pofelal314\.workers\.dev" ascii wide nocase
        $domain10 = "bapiyat727\.workers\.dev" ascii wide nocase
        $domain11 = "beekeeperstudio-db\.com" ascii wide nocase
        $domain12 = "beekeeperstudio\.cc" ascii wide nocase
        $domain13 = "beekeeperstudio\.co" ascii wide nocase
        $domain14 = "beekeeperstudio\.pro" ascii wide nocase
        $domain15 = "beekeeperstudio\.softwarep2p\.com" ascii wide nocase
        $domain16 = "beekeeperstudio\.space" ascii wide nocase
        $domain17 = "beekeeperstudio\.tech" ascii wide nocase
        $domain18 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain19 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain20 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain21 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain22 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain23 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain24 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain25 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain26 = "computerservicesource\.com" ascii wide nocase
        $domain27 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain28 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain29 = "database-lists\.com" ascii wide nocase
        $domain30 = "dbeaver-database\.app" ascii wide nocase
        $domain31 = "dbeaver-database\.cc" ascii wide nocase
        $domain32 = "dbeaver-database\.cloud" ascii wide nocase
        $domain33 = "dbeaver-database\.co" ascii wide nocase
        $domain34 = "dbeaver-database\.com" ascii wide nocase
        $domain35 = "dbeaver-database\.org" ascii wide nocase
        $domain36 = "dbeaver-database\.pro" ascii wide nocase
        $domain37 = "dbeaver-database\.tech" ascii wide nocase
        $domain38 = "dbeaver-database\.us" ascii wide nocase
        $domain39 = "dbeaver\.softwarep2p\.com" ascii wide nocase
        $domain40 = "dbforges\.com" ascii wide nocase
        $domain41 = "deguercuernavaca\.mx" ascii wide nocase
        $domain42 = "dev\.rvtoolacs\.online" ascii wide nocase
        $domain43 = "devartc\.com" ascii wide nocase
        $domain44 = "devartes\.com" ascii wide nocase
        $domain45 = "devartos\.com" ascii wide nocase
        $domain46 = "devartq\.com" ascii wide nocase
        $domain47 = "devartsi\.com" ascii wide nocase
        $domain48 = "devolutions-rdm\.com" ascii wide nocase
        $domain49 = "devolutions\.space" ascii wide nocase
