...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain33 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain34 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain35 = "10nservercc\.cfd" ascii wide nocase
        $domain36 = "10onlinen\.cfd" ascii wide nocase
        $domain37 = "11nservercc\.cfd" ascii wide nocase
        $domain38 = "11onlinen\.cfd" ascii wide nocase
        $domain39 = "12-ko-official\.com" ascii wide nocase
        $domain40 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain41 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain42 = "12nservercc\.cfd" ascii wide nocase
        $domain43 = "12onlinen\.cfd" ascii wide nocase
        $domain44 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain45 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain46 = "13nservercc\.cfd" ascii wide nocase
        $domain47 = "13onlinen\.cfd" ascii wide nocase
        $domain48 = "13udm\.v6\.navy" ascii wide nocase
        $domain49 = "149amdoc-hometax\.mydns\.bz" ascii wide nocase
...
rule APT_UNC5174
{
    ...
    strings:
        ...
        $domain10 = "l1\.topayapp\.org" ascii wide nocase
        $domain11 = "lin\.c1oudf1are\.com" ascii wide nocase
        $domain12 = "lin\.huionepay\.me" ascii wide nocase
        $domain13 = "lin\.telegrams\.icu" ascii wide nocase
        $domain14 = "mcafeecdn\.xyz" ascii wide nocase
        $domain15 = "mtls\.sex666vr\.com" ascii wide nocase
        $domain16 = "samsungcdn\.com" ascii wide nocase
        $domain17 = "start\.bootstrapcdn\.fun" ascii wide nocase
        $domain18 = "telegrams\.icu" ascii wide nocase
        $domain19 = "topayapp\.org" ascii wide nocase
        $domain20 = "virustotal\.xyz" ascii wide nocase
        $domain21 = "vs\.gooogleasia\.com" ascii wide nocase
        $domain22 = "w1\.topayapp\.org" ascii wide nocase
