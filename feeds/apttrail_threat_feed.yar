...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain6 = "129react\.pages\.dev" ascii wide nocase
        $domain7 = "15248636\.site" ascii wide nocase
        $domain8 = "1688dsj\.com" ascii wide nocase
        $domain9 = "172-86-114-141\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain10 = "172-86-114-170\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain11 = "1drvmicrosoft\.com" ascii wide nocase
        $domain12 = "247l\.net" ascii wide nocase
        $domain13 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain14 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain15 = "360scanner\.store" ascii wide nocase
        $domain16 = "360share\.pro" ascii wide nocase
        $domain17 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain18 = "4caddie\.com" ascii wide nocase
        $domain19 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain20 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain21 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain22 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain23 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain24 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain25 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain26 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain27 = "8cap\.inashtech\.com" ascii wide nocase
        $domain28 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain29 = "a\.videotalks\.site" ascii wide nocase
        $domain30 = "aa2akhtech\.in" ascii wide nocase
        $domain31 = "aarnaitsolution\.in" ascii wide nocase
        ...
        $domain38 = "abiyz\.com" ascii wide nocase
        ...
        $domain42 = "acom\.capital" ascii wide nocase
        $domain43 = "acoustickoala\.com" ascii wide nocase
        $domain44 = "acroadovw\.com" ascii wide nocase
        $domain45 = "activity-179384736\.site" ascii wide nocase
        $domain46 = "activity-permission\.online" ascii wide nocase
        $domain47 = "additional\.work\.gd" ascii wide nocase
        $domain48 = "additionalpublic\.work\.gd" ascii wide nocase
        $domain49 = "addrcheck\.corecheckmailsrv\.com" ascii wide nocase
