...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $ip52 = "103.76.228.204" ascii wide
        $ip53 = "104.168.145.83" ascii wide
        $ip54 = "104.194.152.22" ascii wide
        ...
        $ip59 = "107.148.71.88" ascii wide
        $ip60 = "107.189.16.65" ascii wide
        $ip61 = "109.248.151.179" ascii wide
        $ip62 = "115.193.38.156" ascii wide
        $ip63 = "115.195.112.167" ascii wide
        $ip64 = "115.197.193.142" ascii wide
        $ip65 = "116.202.99.218" ascii wide
        $ip66 = "118.194.248.246" ascii wide
        $ip67 = "121.183.134.113" ascii wide
        $ip68 = "121.183.134.113" ascii wide
        $ip69 = "121.183.134.113" ascii wide
        $ip70 = "121.66.72.110" ascii wide
        $ip71 = "123.58.200.110" ascii wide
        $ip72 = "125.118.95.227" ascii wide
        $ip73 = "125.136.67.99" ascii wide
        $ip74 = "138.197.235.123" ascii wide
        $ip75 = "138.68.112.220" ascii wide
        $ip76 = "139.208.63.224" ascii wide
        $ip77 = "141.164.41.17" ascii wide
        $ip78 = "152.32.138.120" ascii wide
        $ip79 = "152.89.247.57" ascii wide
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain9 = "1688dsj\.com" ascii wide nocase
        $domain10 = "17\.docsend\.store" ascii wide nocase
        $domain11 = "172-86-114-141\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain12 = "172-86-114-170\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain13 = "172-86-89-213\.cprapid\.com" ascii wide nocase
        $domain14 = "1drvmicrosoft\.com" ascii wide nocase
        $domain15 = "1winfans\.com" ascii wide nocase
        $domain16 = "247l\.net" ascii wide nocase
        $domain17 = "260120\.vercel\.app" ascii wide nocase
        $domain18 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain19 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain20 = "3\.143\.24\.91\.sslip\.io" ascii wide nocase
        $domain21 = "360scanner\.store" ascii wide nocase
        $domain22 = "360share\.pro" ascii wide nocase
        $domain23 = "3la6ol\.net" ascii wide nocase
        $domain24 = "49rjaf1fgrlzl1t82dpxmiqmyeedl4kku5y3hjvanjleyhpo3pjmbn23q0\.pages\.dev" ascii wide nocase
        $domain25 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain26 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain27 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain28 = "5l\.securemypc\.xyz" ascii wide nocase
        $domain29 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain30 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain31 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain32 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain33 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain34 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain35 = "91\.90\.121\.87\.sslip\.io" ascii wide nocase
        $domain36 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain37 = "a\.videotalks\.site" ascii wide nocase
        $domain38 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain39 = "abc\.meeting-central\.online" ascii wide nocase
        $domain40 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain41 = "abc\.preconnection\.online" ascii wide nocase
        $domain42 = "abc\.roomconnect\.online" ascii wide nocase
        $domain43 = "abilityscan360\.com" ascii wide nocase
        $domain44 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain45 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain46 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain47 = "acoustickoala\.com" ascii wide nocase
        $domain48 = "acroadovw\.com" ascii wide nocase
        $domain49 = "activity-179384736\.site" ascii wide nocase
...
rule APT_PAPERWEREWOLF
{
    ...
    strings:
        $domain0 = "arrotech\.org" ascii wide nocase
        $domain1 = "awalitalk\.com" ascii wide nocase
        $domain2 = "certcalc\.online" ascii wide nocase
        $domain3 = "easytrns\.com" ascii wide nocase
        $domain4 = "fast-eda\.my" ascii wide nocase
        $domain5 = "fastchessplay\.com" ascii wide nocase
        $domain6 = "fungaros\.com" ascii wide nocase
        $domain7 = "hakyru\.com" ascii wide nocase
        $domain8 = "jantyroza\.com" ascii wide nocase
        $domain9 = "ntpadjust\.online" ascii wide nocase
        $domain10 = "ntpbayhai\.online" ascii wide nocase
        $domain11 = "ntpcalc\.online" ascii wide nocase
        $domain12 = "ntpchck\.online" ascii wide nocase
        $domain13 = "ntpcheck\.online" ascii wide nocase
        $domain14 = "ntpcorrect\.online" ascii wide nocase
        $domain15 = "ntpedge\.online" ascii wide nocase
        $domain16 = "ntpfetch\.online" ascii wide nocase
        $domain17 = "ntpfix\.online" ascii wide nocase
        $domain18 = "ntpget\.online" ascii wide nocase
        $domain19 = "ntphaiba\.online" ascii wide nocase
        $domain20 = "ntphaimot\.online" ascii wide nocase
        $domain21 = "ntphaisau\.online" ascii wide nocase
        $domain22 = "ntpinform\.online" ascii wide nocase
        $domain23 = "ntpluck\.online" ascii wide nocase
        $domain24 = "ntpmatch\.online" ascii wide nocase
        $domain25 = "ntpmuoitam\.online" ascii wide nocase
        $domain26 = "ntpnet\.online" ascii wide nocase
        $domain27 = "ntpquirks\.online" ascii wide nocase
        $domain28 = "ntpsetup\.online" ascii wide nocase
        $domain29 = "ntpsum\.online" ascii wide nocase
        $domain30 = "ntpsync\.online" ascii wide nocase
        $domain31 = "ntptake\.online" ascii wide nocase
        $domain32 = "ntptop\.online" ascii wide nocase
        $domain33 = "ntptrack\.online" ascii wide nocase
        $domain34 = "ntpverify\.online" ascii wide nocase
        $domain35 = "ntpzone\.online" ascii wide nocase
        $domain36 = "packetflow\.online" ascii wide nocase
        $domain37 = "packethost\.online" ascii wide nocase
        $domain38 = "packetlabs\.online" ascii wide nocase
        $domain39 = "packetread\.online" ascii wide nocase
        $domain40 = "packetsign\.online" ascii wide nocase
        $domain41 = "packettake\.online" ascii wide nocase
        $domain42 = "packetuser\.online" ascii wide nocase
        $domain43 = "packetxhub\.online" ascii wide nocase
        $domain44 = "ruzede\.com" ascii wide nocase
        $domain45 = "sslchck\.online" ascii wide nocase
        $domain46 = "sslcom\.online" ascii wide nocase
        $domain47 = "sslfix\.online" ascii wide nocase
        $domain48 = "sslhttp\.online" ascii wide nocase
        $domain49 = "sslntp\.online" ascii wide nocase
...
rule APT_SANDWORM
{
    ...
    strings:
        ...
        $domain14 = "adobeprotectcheck\.com" ascii wide nocase
        $domain15 = "ads\.ew\.com\.cn" ascii wide nocase
        $domain16 = "ads\.tolinkhub\.com" ascii wide nocase
        $domain17 = "aiads\.best" ascii wide nocase
        $domain18 = "akamaizes\.com" ascii wide nocase
        $domain19 = "all-invite\.org" ascii wide nocase
        $domain20 = "allserve\.xyz" ascii wide nocase
        $domain21 = "annualgieconferenceinmunich2024\.com" ascii wide nocase
        $domain22 = "antimailspam\.com" ascii wide nocase
        $domain23 = "api-to-now\.allserve\.xyz" ascii wide nocase
        $domain24 = "api\.beesapp\.top" ascii wide nocase
        $domain25 = "api\.budandan\.com" ascii wide nocase
        $domain26 = "api\.chaboshi\.cc" ascii wide nocase
        $domain27 = "api\.click2mine\.top" ascii wide nocase
        $domain28 = "api\.degendogs\.top" ascii wide nocase
        $domain29 = "api\.fastrig\.top" ascii wide nocase
        $domain30 = "api\.globalsimc\.com" ascii wide nocase
        $domain31 = "api\.gmc-doge\.top" ascii wide nocase
        $domain32 = "api\.jackpotsure\.win" ascii wide nocase
        $domain33 = "api\.luckytonspin\.top" ascii wide nocase
        $domain34 = "api\.omgton\.xyz" ascii wide nocase
        $domain35 = "api\.plantton\.top" ascii wide nocase
        $domain36 = "api\.powerdigger\.top" ascii wide nocase
        $domain37 = "api\.powerton\.top" ascii wide nocase
        $domain38 = "api\.surewinsgjackpot\.com" ascii wide nocase
        $domain39 = "api\.tonblastrun\.top" ascii wide nocase
        $domain40 = "api\.tonchainer\.top" ascii wide nocase
        $domain41 = "api\.toncore\.top" ascii wide nocase
        $domain42 = "api\.tondaily\.top" ascii wide nocase
        $domain43 = "api\.tondrillx\.top" ascii wide nocase
        $domain44 = "api\.tonengine\.top" ascii wide nocase
        $domain45 = "api\.tonfarmers\.top" ascii wide nocase
        $domain46 = "api\.tonforgex\.top" ascii wide nocase
        $domain47 = "api\.tonhive\.top" ascii wide nocase
        $domain48 = "api\.tonmineplus\.top" ascii wide nocase
        $domain49 = "api\.tonow\.top" ascii wide nocase
...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain28 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain29 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain30 = "435fdgfd-fgh675gh56jh-65jhg65ghjytu65\.netlify\.app" ascii wide nocase
        $domain31 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain32 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain33 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain34 = "63inc\.com" ascii wide nocase
        $domain35 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain36 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain37 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain38 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain39 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain40 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain41 = "81-cn\.ddns\.net" ascii wide nocase
        $domain42 = "81-cn\.info" ascii wide nocase
        $domain43 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain44 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain45 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain46 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain47 = "9af72fg4jg75hg8jg94kg94k9fk390gk4170674tr69bf1f766cdec1d11\.pages\.dev" ascii wide nocase
        $domain48 = "9af72fg4jg75hg8jg9dfghhfgdh5666k41706769d32bf1f766cdec1d1\.pages\.dev" ascii wide nocase
        $domain49 = "9af72fg4jg75hg8jg9dfghhfgdh5666k41706769d32bf1f766cdec1d11\.pages\.dev" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain48 = "agora-mesmo\.com" ascii wide nocase
        $domain49 = "agronomywork\.info" ascii wide nocase
