...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain5 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain6 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain7 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain8 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain9 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain10 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain11 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain12 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain13 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain14 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain15 = "ec2-app\.lewoha7320\.workers\.dev" ascii wide nocase
        $domain16 = "ec2-server-noisy-band-0fe8\.focapaj280\.workers\.dev" ascii wide nocase
        $domain17 = "ec2-server\.bayaj19162\.workers\.dev" ascii wide nocase
        $domain18 = "ec2-server\.gegodec527\.workers\.dev" ascii wide nocase
        $domain19 = "ec2-server\.milago3967\.workers\.dev" ascii wide nocase
        $domain20 = "etherial\.groover\.workers\.dev" ascii wide nocase
        $domain21 = "floral-paper-8eb1\.pihara4672\.workers\.dev" ascii wide nocase
        $domain22 = "groover\.workers\.dev" ascii wide nocase
        $domain23 = "harnetsecuriity\.com" ascii wide nocase
        $domain24 = "harnetsecurity\.com" ascii wide nocase
        $domain25 = "hornetseculty\.com" ascii wide nocase
        $domain26 = "horpetsecurity\.com" ascii wide nocase
        $domain27 = "keystore-explorer\.com" ascii wide nocase
        $domain28 = "mstore\.framfarmers\.co\.uk" ascii wide nocase
        $domain29 = "pofelal314\.workers\.dev" ascii wide nocase
        $domain30 = "rustore\.rvtouls\.com" ascii wide nocase
        $domain31 = "rv-tools\.eu" ascii wide nocase
        $domain32 = "rv-tools\.info" ascii wide nocase
        $domain33 = "rvtoo1s\.com" ascii wide nocase
        $domain34 = "rvtoolaca\.com" ascii wide nocase
        $domain35 = "rvtoolaca\.online" ascii wide nocase
        $domain36 = "rvtoolacs\.com" ascii wide nocase
        $domain37 = "rvtoolas\.com" ascii wide nocase
        $domain38 = "rvtoolc\.info" ascii wide nocase
        $domain39 = "rvtooles\.com" ascii wide nocase
        $domain40 = "rvtooles\.info" ascii wide nocase
        $domain41 = "rvtooli\.info" ascii wide nocase
        $domain42 = "rvtoolis\.com" ascii wide nocase
        $domain43 = "rvtoolit\.com" ascii wide nocase
        $domain44 = "rvtoolsac\.com" ascii wide nocase
        $domain45 = "rvtoolsacad\.com" ascii wide nocase
        $domain46 = "rvtoolsacs\.com" ascii wide nocase
        $domain47 = "rvtoolsax\.com" ascii wide nocase
        $domain48 = "rvtoolsed\.com" ascii wide nocase
        $domain49 = "rvtoolses\.com" ascii wide nocase
