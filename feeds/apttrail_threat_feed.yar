...
rule APT_SANDWORM
{
    ...
    strings:
        ...
        $domain35 = "dontgivedamn\.com" ascii wide nocase
        $domain36 = "dontgivefuck\.com" ascii wide nocase
        $domain37 = "drive\.google\.com\.filepreview\.auth\.userarea\.click" ascii wide nocase
        $domain38 = "dvjbn4sg4p1ck\.cloudfront\.net" ascii wide nocase
        $domain39 = "esetpremium\.com" ascii wide nocase
        $domain40 = "ett\.ddns\.net" ascii wide nocase
        $domain41 = "ett\.hopto\.org" ascii wide nocase
        $domain42 = "fbapp\.info" ascii wide nocase
        $domain43 = "fbapp\.link" ascii wide nocase
        $domain44 = "fbapp\.top" ascii wide nocase
        $domain45 = "filepreview\.auth\.userarea\.click" ascii wide nocase
        $domain46 = "gieannualconferenceinmunich\.com" ascii wide nocase
        $domain47 = "globdomain\.ru" ascii wide nocase
        $domain48 = "google-account-settings\.spdup\.art" ascii wide nocase
        $domain49 = "hackzona\.tk" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain5 = "0278\.fxexebji\.org" ascii wide nocase
        $domain6 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain7 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain8 = "047\.auyciwmw\.com" ascii wide nocase
        $domain9 = "063\.heppmpuz\.org" ascii wide nocase
        $domain10 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain11 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain12 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain13 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain14 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain15 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain16 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain17 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain18 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain19 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain20 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain21 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain22 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain23 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain24 = "158\.ozhignq\.com" ascii wide nocase
        $domain25 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain26 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain27 = "168\.yktajeyp\.com" ascii wide nocase
        $domain28 = "17cx1\.com" ascii wide nocase
        $domain29 = "17cx11\.com" ascii wide nocase
        $domain30 = "17cx2\.com" ascii wide nocase
        $domain31 = "17cx3\.com" ascii wide nocase
        $domain32 = "17cx4\.com" ascii wide nocase
        $domain33 = "17cx5\.com" ascii wide nocase
        $domain34 = "17cx7\.com" ascii wide nocase
        $domain35 = "17cx8\.com" ascii wide nocase
        $domain36 = "17cx9\.com" ascii wide nocase
        $domain37 = "17cxa\.com" ascii wide nocase
        $domain38 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain39 = "17lu\.life" ascii wide nocase
        $domain40 = "17lulu\.club" ascii wide nocase
        $domain41 = "17lulu\.live" ascii wide nocase
        $domain42 = "17lulu\.ltd" ascii wide nocase
        $domain43 = "17lulu\.online" ascii wide nocase
        $domain44 = "17lulu\.site" ascii wide nocase
        $domain45 = "17lulu\.store" ascii wide nocase
        $domain46 = "17lutv\.life" ascii wide nocase
        $domain47 = "17lutv\.live" ascii wide nocase
        $domain48 = "17lutv\.online" ascii wide nocase
        $domain49 = "17lutv\.shop" ascii wide nocase
