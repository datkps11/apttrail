...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain43 = "a5936441-e402-41e3-b02b-75af112074b5\.org-co\.net" ascii wide nocase
        $domain44 = "a6dff163-e0b9-49c9-87e4-357f761f3c3b\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain45 = "aa173\.bank-ok\.com" ascii wide nocase
        $domain46 = "aapletv\.org" ascii wide nocase
        $domain47 = "abc\.bol-north\.com" ascii wide nocase
        $domain48 = "academy\.lesporc\.live" ascii wide nocase
        $domain49 = "acc\.pk-govt\.net" ascii wide nocase
