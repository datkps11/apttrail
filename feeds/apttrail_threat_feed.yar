...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $ip71 = "104.194.133.88" ascii wide
        $ip72 = "104.194.133.88" ascii wide
        $ip73 = "104.217.163.61" ascii wide
        $ip74 = "104.232.71.7" ascii wide
        $ip75 = "107.172.197.175" ascii wide
        $ip76 = "107.175.172.129" ascii wide
        $ip77 = "107.189.16.122" ascii wide
        $ip78 = "107.189.16.122" ascii wide
        $ip79 = "107.189.16.176" ascii wide
