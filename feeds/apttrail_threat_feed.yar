...
rule APT_UNC6691_1
{
    ...
    strings:
        ...
        $domain4 = "0291\.top" ascii wide nocase
        $domain5 = "0505\.wwxblue\.workers\.dev" ascii wide nocase
        $domain6 = "0rdershop\.com" ascii wide nocase
        $domain7 = "1-nycyh\.workers\.dev" ascii wide nocase
        $domain8 = "1\.a13518075286\.workers\.dev" ascii wide nocase
        $domain9 = "11\.jponliine\.com" ascii wide nocase
        $domain10 = "125540947\.workers\.dev" ascii wide nocase
        $domain11 = "1289238bgyu8bgy8o\.pages\.dev" ascii wide nocase
        $domain12 = "13802880308\.workers\.dev" ascii wide nocase
        $domain13 = "14\.harajukup\.com" ascii wide nocase
        $domain14 = "15999756862\.workers\.dev" ascii wide nocase
        $domain15 = "16388\.pages\.dev" ascii wide nocase
        $domain16 = "18agj\.com" ascii wide nocase
        $domain17 = "1a\.zencartjp\.com" ascii wide nocase
        $domain18 = "1b21533f51\.workers\.dev" ascii wide nocase
        $domain19 = "1bxvv83nskca6a14\.cfd" ascii wide nocase
        $domain20 = "1d8x3\.com" ascii wide nocase
        $domain21 = "1f\.okinasumo\.com" ascii wide nocase
        $domain22 = "1f6z8\.com" ascii wide nocase
        $domain23 = "1f8z5\.com" ascii wide nocase
        $domain24 = "1k\.kyusmalli\.com" ascii wide nocase
        $domain25 = "1k\.zenjpmart\.com" ascii wide nocase
        $domain26 = "1k4m8\.com" ascii wide nocase
        $domain27 = "1m9z3\.com" ascii wide nocase
        $domain28 = "1mgtpu86\.niponshop\.com" ascii wide nocase
        $domain29 = "1n3p9\.com" ascii wide nocase
        $domain30 = "1n5f8\.com" ascii wide nocase
        $domain31 = "1natsuhina\.workers\.dev" ascii wide nocase
        $domain32 = "1p2k9\.com" ascii wide nocase
        $domain33 = "1p4k9\.com" ascii wide nocase
        $domain34 = "1q\.zenshopjp\.com" ascii wide nocase
        $domain35 = "1r8v2\.com" ascii wide nocase
        $domain36 = "1t7n3\.com" ascii wide nocase
        $domain37 = "1u8\.bnb5\.vip" ascii wide nocase
        $domain38 = "1x5r6\.com" ascii wide nocase
        $domain39 = "1x9p2\.com" ascii wide nocase
        $domain40 = "2023\.youorder\.shop" ascii wide nocase
        $domain41 = "20240309-3ug\.pages\.dev" ascii wide nocase
        $domain42 = "20240410\.tdbvqepmg\.workers\.dev" ascii wide nocase
        $domain43 = "2204\.miltonq6xtbse\.workers\.dev" ascii wide nocase
        $domain44 = "251422406\.workers\.dev" ascii wide nocase
        $domain45 = "2c8b3f19-0325-4acc-a3dd-31a918e4dbf5\.random\.yourorders\.shop" ascii wide nocase
        $domain46 = "2d8n1\.com" ascii wide nocase
        $domain47 = "2f7r4\.com" ascii wide nocase
        $domain48 = "2g8c4\.com" ascii wide nocase
        $domain49 = "2g9p7\.com" ascii wide nocase
