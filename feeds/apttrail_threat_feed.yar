...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain13 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain14 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain15 = "3p\.workbenche\.com" ascii wide nocase
        $domain16 = "40\.workbencse\.com" ascii wide nocase
        $domain17 = "45perhour\.org" ascii wide nocase
        $domain18 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain19 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain20 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain21 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain22 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain23 = "7stories\.sbs" ascii wide nocase
        $domain24 = "91movs\.com" ascii wide nocase
        $domain25 = "9xstream\.live" ascii wide nocase
        $domain26 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain27 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain28 = "abstractest-hydroski\.site" ascii wide nocase
        $domain29 = "academytradeai\.com" ascii wide nocase
        $domain30 = "acquasicuras\.com" ascii wide nocase
        $domain31 = "actbluecs\.com" ascii wide nocase
        $domain32 = "actblues\.net" ascii wide nocase
        $domain33 = "adionetjrei\.shop" ascii wide nocase
        $domain34 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain35 = "adrilex\.digital" ascii wide nocase
        $domain36 = "aexnp\.com" ascii wide nocase
        $domain37 = "afeherbopenuk\.com" ascii wide nocase
        $domain38 = "agora-mesmo\.com" ascii wide nocase
        $domain39 = "agronomywork\.info" ascii wide nocase
        $domain40 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain41 = "aialgocamp\.com" ascii wide nocase
        $domain42 = "aialgocore\.com" ascii wide nocase
        $domain43 = "aialgodrive\.com" ascii wide nocase
        $domain44 = "aialgoflow\.com" ascii wide nocase
        $domain45 = "aialgofusion\.com" ascii wide nocase
        $domain46 = "aialgohash\.com" ascii wide nocase
        $domain47 = "aialgorithmforge\.com" ascii wide nocase
        $domain48 = "aialgorithmicforge\.com" ascii wide nocase
        $domain49 = "aialgorithmicpath\.com" ascii wide nocase
