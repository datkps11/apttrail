...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain10 = "172-86-114-141\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain11 = "172-86-114-170\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain12 = "1drvmicrosoft\.com" ascii wide nocase
        $domain13 = "1winfans\.com" ascii wide nocase
        $domain14 = "247l\.net" ascii wide nocase
        $domain15 = "260120\.vercel\.app" ascii wide nocase
        $domain16 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain17 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain18 = "360scanner\.store" ascii wide nocase
        $domain19 = "360share\.pro" ascii wide nocase
        $domain20 = "3la6ol\.net" ascii wide nocase
        $domain21 = "49rjaf1fgrlzl1t82dpxmiqmyeedl4kku5y3hjvanjleyhpo3pjmbn23q0\.pages\.dev" ascii wide nocase
        $domain22 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain23 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain24 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain25 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain26 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain27 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain28 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain29 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain30 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain31 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain32 = "a\.videotalks\.site" ascii wide nocase
        $domain33 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain34 = "abc\.meeting-central\.online" ascii wide nocase
        $domain35 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain36 = "abc\.preconnection\.online" ascii wide nocase
        $domain37 = "abc\.roomconnect\.online" ascii wide nocase
        $domain38 = "abilityscan360\.com" ascii wide nocase
        $domain39 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain40 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain41 = "accounts\.ceinbase\.com" ascii wide nocase
