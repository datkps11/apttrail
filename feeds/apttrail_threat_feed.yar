...
rule APT_CHARMINGKITTEN
{
    ...
    strings:
        ...
        $domain13 = "3dauth\.live" ascii wide nocase
        $domain14 = "3dconfirrnation\.com" ascii wide nocase
        $domain15 = "8ghefkwdvbfdsg3asdf1\.com" ascii wide nocase
        $domain16 = "academy-update\.com" ascii wide nocase
        $domain17 = "accesscheckout\.online" ascii wide nocase
        $domain18 = "accessverification\.online" ascii wide nocase
        $domain19 = "acconut-mail\.com" ascii wide nocase
        $domain20 = "acconut-signin\.com" ascii wide nocase
        $domain21 = "acconut-verify\.com" ascii wide nocase
        $domain22 = "account-customerservice\.com" ascii wide nocase
        $domain23 = "account-drive\.com" ascii wide nocase
        $domain24 = "account-dropbox\.net" ascii wide nocase
        $domain25 = "account-google\.co" ascii wide nocase
        $domain26 = "account-log-user-verify-mail\.com" ascii wide nocase
        $domain27 = "account-login\.net" ascii wide nocase
        $domain28 = "account-logins\.com" ascii wide nocase
        $domain29 = "account-permission-mail-user\.com" ascii wide nocase
        $domain30 = "account-profile-users\.info" ascii wide nocase
        $domain31 = "account-servicemanagement\.info" ascii wide nocase
        $domain32 = "account-servicerecovery\.com" ascii wide nocase
        $domain33 = "account-servieemanagement\.info" ascii wide nocase
        $domain34 = "account-signin-myaccount-users\.ga" ascii wide nocase
        $domain35 = "account-signin\.com" ascii wide nocase
        $domain36 = "account-siqnin\.com" ascii wide nocase
        $domain37 = "account-support-user\.com" ascii wide nocase
        $domain38 = "account-user-permission-account\.com" ascii wide nocase
        $domain39 = "account-user-verify-mail\.com" ascii wide nocase
        $domain40 = "account-user\.com" ascii wide nocase
        $domain41 = "account-users-mail\.com" ascii wide nocase
        $domain42 = "account-verifiy\.net" ascii wide nocase
        $domain43 = "accountroyal\.com" ascii wide nocase
        $domain44 = "accounts-apple\.com" ascii wide nocase
        $domain45 = "accounts-drive\.com" ascii wide nocase
        $domain46 = "accounts-googelmail\.com" ascii wide nocase
        $domain47 = "accounts-googelmails\.com" ascii wide nocase
        $domain48 = "accounts-logins\.net" ascii wide nocase
        $domain49 = "accounts-mails\.com" ascii wide nocase
