...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain1 = "17cx1\.com" ascii wide nocase
        $domain2 = "17cx11\.com" ascii wide nocase
        $domain3 = "17cx2\.com" ascii wide nocase
        $domain4 = "17cx3\.com" ascii wide nocase
        $domain5 = "17cx4\.com" ascii wide nocase
        $domain6 = "17cx5\.com" ascii wide nocase
        $domain7 = "17cx7\.com" ascii wide nocase
        $domain8 = "17cx8\.com" ascii wide nocase
        $domain9 = "17cx9\.com" ascii wide nocase
        $domain10 = "17cxa\.com" ascii wide nocase
        $domain11 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain12 = "18cnask0a147yxj\.xyz" ascii wide nocase
        $domain13 = "1d42ghd36as85azx54\.com" ascii wide nocase
        $domain14 = "1lpaavvmir4v9dzsb4jte0o\.icu" ascii wide nocase
        $domain15 = "1vfw4raxub65c3d\.xyz" ascii wide nocase
        $domain16 = "26a\.online" ascii wide nocase
        $domain17 = "28w6a049zm106wi\.xyz" ascii wide nocase
        $domain18 = "2g6wtt4i1ze81qt\.xyz" ascii wide nocase
        $domain19 = "2gx51m4kethqidh\.xyz" ascii wide nocase
        $domain20 = "2qiy9d567qj5drz\.xyz" ascii wide nocase
        $domain21 = "2s3b3rknfqtwwpo\.xyz" ascii wide nocase
        $domain22 = "2z5y01z53ri8xg2\.xyz" ascii wide nocase
        $domain23 = "3dfigura\.com" ascii wide nocase
        $domain24 = "3dh24gfk25er62ted13\.com" ascii wide nocase
        $domain25 = "3ej7wtf93vnv8pbpq06dwwco\.cc" ascii wide nocase
        $domain26 = "3v5w1km5gv\.xyz" ascii wide nocase
        $domain27 = "4a95f\.sod777\.com" ascii wide nocase
        $domain28 = "4fh0tu51hafgn9t\.xyz" ascii wide nocase
        $domain29 = "4kgame\.us" ascii wide nocase
        $domain30 = "4u\.game" ascii wide nocase
        $domain31 = "4yifrepplzrrgf1\.cfd" ascii wide nocase
        $domain32 = "51crdh\.com" ascii wide nocase
        $domain33 = "51fl\.club" ascii wide nocase
        $domain34 = "51fl\.shop" ascii wide nocase
        $domain35 = "51fuli1\.com" ascii wide nocase
        $domain36 = "54mx1\.com" ascii wide nocase
        $domain37 = "54mx2\.com" ascii wide nocase
        $domain38 = "54mx3\.com" ascii wide nocase
        $domain39 = "5813hmmm3smt0rf3g\.lol" ascii wide nocase
        $domain40 = "590\.sod777\.com" ascii wide nocase
        $domain41 = "5chnx0w1finu45l\.xyz" ascii wide nocase
        $domain42 = "65sse\.668ddf\.cc" ascii wide nocase
        $domain43 = "668ddf\.cc" ascii wide nocase
        $domain44 = "697hiw91h3ksgk11wsl8k\.org" ascii wide nocase
        $domain45 = "6cxrf02iacu9s87\.xyz" ascii wide nocase
        $domain46 = "6lghtrr13tslzo7bpm\.com" ascii wide nocase
        $domain47 = "6zvjeulzaw5c0mv\.xyz" ascii wide nocase
        $domain48 = "70ln176jj4v6v4n\.xyz" ascii wide nocase
        $domain49 = "777bingos\.xyz" ascii wide nocase
