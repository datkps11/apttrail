...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain22 = "24170-40494\.bacloud\.info" ascii wide nocase
        $domain23 = "2672ewr5403894534fgdgfd5907e44fdfgdfg67088gdfgfd90e2cbd8b6\.pages\.dev" ascii wide nocase
        $domain24 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain25 = "2let\.org" ascii wide nocase
        $domain26 = "2r\.nrtcpk-net\.com" ascii wide nocase
        $domain27 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain28 = "3g\.maildownloadfiles\.com" ascii wide nocase
        $domain29 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain30 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain31 = "435fdgfd-fgh675gh56jh-65jhg65ghjytu65\.netlify\.app" ascii wide nocase
        $domain32 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain33 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain34 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain35 = "63inc\.com" ascii wide nocase
        $domain36 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain37 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain38 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain39 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain40 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain41 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain42 = "81-cn\.ddns\.net" ascii wide nocase
        $domain43 = "81-cn\.info" ascii wide nocase
        $domain44 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain45 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain46 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain47 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain48 = "9af72fg4jg75hg8jg94kg94k9fk390gk4170674tr69bf1f766cdec1d11\.pages\.dev" ascii wide nocase
        $domain49 = "9af72fg4jg75hg8jg9dfghhfgdh5666k41706769d32bf1f766cdec1d1\.pages\.dev" ascii wide nocase
...
rule APT_UNC6691_1
{
    ...
    strings:
        ...
        $domain2 = "0291\.top" ascii wide nocase
        $domain3 = "0505\.wwxblue\.workers\.dev" ascii wide nocase
        $domain4 = "0rdershop\.com" ascii wide nocase
        $domain5 = "1-nycyh\.workers\.dev" ascii wide nocase
        $domain6 = "1\.a13518075286\.workers\.dev" ascii wide nocase
        $domain7 = "11\.jponliine\.com" ascii wide nocase
        $domain8 = "125540947\.workers\.dev" ascii wide nocase
        $domain9 = "14\.harajukup\.com" ascii wide nocase
        $domain10 = "15999756862\.workers\.dev" ascii wide nocase
        $domain11 = "1a\.zencartjp\.com" ascii wide nocase
        $domain12 = "1b21533f51\.workers\.dev" ascii wide nocase
        $domain13 = "1f\.okinasumo\.com" ascii wide nocase
        $domain14 = "1f6z8\.com" ascii wide nocase
        $domain15 = "1k\.kyusmalli\.com" ascii wide nocase
        $domain16 = "1k\.zenjpmart\.com" ascii wide nocase
        $domain17 = "1k4m8\.com" ascii wide nocase
        $domain18 = "1m9z3\.com" ascii wide nocase
        $domain19 = "1mgtpu86\.niponshop\.com" ascii wide nocase
        $domain20 = "1n3p9\.com" ascii wide nocase
        $domain21 = "1n5f8\.com" ascii wide nocase
        $domain22 = "1natsuhina\.workers\.dev" ascii wide nocase
        $domain23 = "1p2k9\.com" ascii wide nocase
        $domain24 = "1p4k9\.com" ascii wide nocase
        $domain25 = "1q\.zenshopjp\.com" ascii wide nocase
        $domain26 = "1r8v2\.com" ascii wide nocase
        $domain27 = "1t7n3\.com" ascii wide nocase
        $domain28 = "1x9p2\.com" ascii wide nocase
        $domain29 = "2023\.youorder\.shop" ascii wide nocase
        $domain30 = "20240410\.tdbvqepmg\.workers\.dev" ascii wide nocase
        $domain31 = "2204\.miltonq6xtbse\.workers\.dev" ascii wide nocase
        $domain32 = "251422406\.workers\.dev" ascii wide nocase
        $domain33 = "2c8b3f19-0325-4acc-a3dd-31a918e4dbf5\.random\.yourorders\.shop" ascii wide nocase
        $domain34 = "2d8n1\.com" ascii wide nocase
        $domain35 = "2f7r4\.com" ascii wide nocase
        $domain36 = "2g8c4\.com" ascii wide nocase
        $domain37 = "2g9p7\.com" ascii wide nocase
        $domain38 = "2k5v3\.com" ascii wide nocase
        $domain39 = "2k9x5\.com" ascii wide nocase
        $domain40 = "2n3v6\.com" ascii wide nocase
        $domain41 = "2n8b6\.com" ascii wide nocase
        $domain42 = "2p7r9\.com" ascii wide nocase
        $domain43 = "2w6p1\.com" ascii wide nocase
        $domain44 = "2x1p9\.com" ascii wide nocase
        $domain45 = "2z4r9\.com" ascii wide nocase
        $domain46 = "3268194287\.workers\.dev" ascii wide nocase
        $domain47 = "3315212323\.workers\.dev" ascii wide nocase
        $domain48 = "3c8f1\.com" ascii wide nocase
        $domain49 = "3d2p5\.com" ascii wide nocase
