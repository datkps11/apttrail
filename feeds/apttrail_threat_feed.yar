...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain8 = "108901\.xyz" ascii wide nocase
        $domain9 = "115437\.xyz" ascii wide nocase
        $domain10 = "118652\.xyz" ascii wide nocase
        $domain11 = "119012\.xyz" ascii wide nocase
        $domain12 = "120974\.xyz" ascii wide nocase
        $domain13 = "126841\.xyz" ascii wide nocase
        $domain14 = "1274672\.xyz" ascii wide nocase
        $domain15 = "1279578\.xyz" ascii wide nocase
        $domain16 = "132690\.xyz" ascii wide nocase
        $domain17 = "1368497\.xyz" ascii wide nocase
        $domain18 = "143456\.xyz" ascii wide nocase
        $domain19 = "1459738\.xyz" ascii wide nocase
        $domain20 = "1485390\.xyz" ascii wide nocase
        $domain21 = "1549038\.xyz" ascii wide nocase
        $domain22 = "158739\.xyz" ascii wide nocase
        $domain23 = "158901\.xyz" ascii wide nocase
        $domain24 = "159352\.xyz" ascii wide nocase
        $domain25 = "1597382\.xyz" ascii wide nocase
        $domain26 = "159740\.xyz" ascii wide nocase
        $domain27 = "166504\.xyz" ascii wide nocase
        $domain28 = "168901\.xyz" ascii wide nocase
        $domain29 = "169327\.xyz" ascii wide nocase
        $domain30 = "173456\.xyz" ascii wide nocase
        $domain31 = "174567\.xyz" ascii wide nocase
        $domain32 = "1748906\.xyz" ascii wide nocase
        $domain33 = "175493\.xyz" ascii wide nocase
        $domain34 = "175678\.xyz" ascii wide nocase
        $domain35 = "1759248\.xyz" ascii wide nocase
        $domain36 = "178026\.xyz" ascii wide nocase
        $domain37 = "180746\.xyz" ascii wide nocase
        $domain38 = "18372046\.xyz" ascii wide nocase
        $domain39 = "1894627\.xyz" ascii wide nocase
        $domain40 = "19360482\.xyz" ascii wide nocase
        $domain41 = "19372048\.xyz" ascii wide nocase
        $domain42 = "1946308\.xyz" ascii wide nocase
        $domain43 = "1953087\.xyz" ascii wide nocase
        $domain44 = "1982604\.xyz" ascii wide nocase
        $domain45 = "204681\.xyz" ascii wide nocase
        $domain46 = "204759\.xyz" ascii wide nocase
        $domain47 = "204904\.xyz" ascii wide nocase
        $domain48 = "206904\.xyz" ascii wide nocase
        $domain49 = "206918\.xyz" ascii wide nocase
