...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $ip63 = "115.197.193.142" ascii wide
        $ip64 = "116.202.99.218" ascii wide
        $ip65 = "118.194.248.246" ascii wide
        $ip66 = "121.183.134.113" ascii wide
        $ip67 = "121.183.134.113" ascii wide
        $ip68 = "121.183.134.113" ascii wide
        $ip69 = "121.66.72.110" ascii wide
        $ip70 = "123.58.200.110" ascii wide
        $ip71 = "125.118.95.227" ascii wide
        $ip72 = "125.136.67.99" ascii wide
        $ip73 = "138.197.235.123" ascii wide
        $ip74 = "138.68.112.220" ascii wide
        $ip75 = "139.208.63.224" ascii wide
        $ip76 = "141.164.41.17" ascii wide
        $ip77 = "152.89.247.57" ascii wide
        $ip78 = "156.224.22.247" ascii wide
        $ip79 = "158.247.238.155" ascii wide
...
rule APT_LIBRARIANGHOULS
{
    ...
    strings:
        ...
        $domain2 = "accouts-verification\.ru" ascii wide nocase
        $domain3 = "acountservices\.nl" ascii wide nocase
        $domain4 = "acountservices\.online" ascii wide nocase
        $domain5 = "aemiliuszathe\.nl" ascii wide nocase
        $domain6 = "aeternus\.be" ascii wide nocase
        $domain7 = "alcor-as\.com" ascii wide nocase
        $domain8 = "allroundvideomedia\.nl" ascii wide nocase
        $domain9 = "almaz-aero\.site" ascii wide nocase
        $domain10 = "amorapersoneel\.nl" ascii wide nocase
        $domain11 = "anyhostings\.ru" ascii wide nocase
        $domain12 = "anyinfos\.ru" ascii wide nocase
        $domain13 = "aoffices\.ru" ascii wide nocase
        $domain14 = "autodegroenehoek\.nl" ascii wide nocase
        $domain15 = "autoopkoperbenny\.be" ascii wide nocase
        $domain16 = "autotificate\.com" ascii wide nocase
        $domain17 = "barbershopwbd\.nl" ascii wide nocase
        $domain18 = "batwoman-fashion\.nl" ascii wide nocase
        $domain19 = "beeldspraakfotografie\.nl" ascii wide nocase
        $domain20 = "berkelgame\.com" ascii wide nocase
        $domain21 = "bharatsingh-logistics\.nl" ascii wide nocase
        $domain22 = "biesbeauty\.nl" ascii wide nocase
        $domain23 = "blijlekkernij\.nl" ascii wide nocase
        $domain24 = "bloomakay\.be" ascii wide nocase
        $domain25 = "bmapps\.org" ascii wide nocase
        $domain26 = "boefjes\.nl" ascii wide nocase
        $domain27 = "boelit-pvlog\.be" ascii wide nocase
        $domain28 = "bouwwerkennoten\.be" ascii wide nocase
        $domain29 = "broodjesboutique\.nl" ascii wide nocase
        $domain30 = "cafestationskoffiehuis\.nl" ascii wide nocase
        $domain31 = "camperbilly\.nl" ascii wide nocase
        $domain32 = "camperreiseuropa\.nl" ascii wide nocase
        $domain33 = "careforhealing\.com" ascii wide nocase
        $domain34 = "center-mail\.ru" ascii wide nocase
        $domain35 = "choosingchange\.nl" ascii wide nocase
        $domain36 = "cirkelvoordeelshop\.nl" ascii wide nocase
        $domain37 = "claud-mail\.ru" ascii wide nocase
        $domain38 = "climatexperts\.be" ascii wide nocase
        $domain39 = "codevalley\.nl" ascii wide nocase
        $domain40 = "dagboekvaneenoverlever\.nl" ascii wide nocase
        $domain41 = "dakzaken\.nl" ascii wide nocase
        $domain42 = "daniel-stunnenberg\.nl" ascii wide nocase
        $domain43 = "danonnapinuccia\.nl" ascii wide nocase
        $domain44 = "datagiants\.be" ascii wide nocase
        $domain45 = "daydrinkingdisco\.com" ascii wide nocase
        $domain46 = "deauthorization\.online" ascii wide nocase
        $domain47 = "deboswachteramsterdam\.nl" ascii wide nocase
        $domain48 = "dedienstenpraktijk\.nl" ascii wide nocase
        $domain49 = "dennisbaptist\.com" ascii wide nocase
...
rule APT_MUSTANGPANDA
{
    ...
    strings:
        ...
        $domain22 = "b\.document-viewer\.xyz" ascii wide nocase
        $domain23 = "b83928922\.questincc\.com" ascii wide nocase
        $domain24 = "b8pjmgd6\.com" ascii wide nocase
        $domain25 = "babyafrosapparel\.com" ascii wide nocase
        $domain26 = "back\.vlvlvlvl\.site" ascii wide nocase
        $domain27 = "backups\.muathye\.com" ascii wide nocase
        $domain28 = "bcller\.com" ascii wide nocase
        $domain29 = "blogdirve\.com" ascii wide nocase
        $domain30 = "bonuscave\.com" ascii wide nocase
        $domain31 = "buyonebuy\.top" ascii wide nocase
        $domain32 = "c7p949983\.silveradeearyray\.com" ascii wide nocase
        $domain33 = "cabsecnow\.com" ascii wide nocase
        $domain34 = "calendargbmechanical\.cam" ascii wide nocase
        $domain35 = "calendarthomastecs\.cam" ascii wide nocase
        $domain36 = "calendercongress\.cam" ascii wide nocase
        $domain37 = "calendercongress\.com" ascii wide nocase
        $domain38 = "careerhuawei\.net" ascii wide nocase
        $domain39 = "cdn\.update\.huaweiyuncdn\.com" ascii wide nocase
        $domain40 = "cdn1\.update\.huaweiyuncdn\.com" ascii wide nocase
        $domain41 = "cdn7s65\.z13\.web\.core\.windows\.net" ascii wide nocase
        $domain42 = "concreteinportland\.com" ascii wide nocase
        $domain43 = "conflictaslesson\.com" ascii wide nocase
        $domain44 = "connectmvasalu\.cam" ascii wide nocase
        $domain45 = "constructionferryfences\.cam" ascii wide nocase
        $domain46 = "coolboxpc\.com" ascii wide nocase
        $domain47 = "csp\.document-invoiceviewer\.online" ascii wide nocase
        $domain48 = "csp\.document-viewer\.xyz" ascii wide nocase
        $domain49 = "csp\.documentpdfviewer\.xyz" ascii wide nocase
