...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain9 = "17067699af72f31706fgjkf5kg9j4990gk950\.netlify\.app" ascii wide nocase
        $domain10 = "1c1157fa\.caa\.update\.customs-lk\.org" ascii wide nocase
        $domain11 = "1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain12 = "1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain13 = "1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain14 = "203-124351878443\.hopto\.org" ascii wide nocase
        $domain15 = "24170-40494\.bacloud\.info" ascii wide nocase
        $domain16 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain17 = "2let\.org" ascii wide nocase
        $domain18 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain19 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain20 = "63inc\.com" ascii wide nocase
        $domain21 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain22 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain23 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain24 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain25 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain26 = "81-cn\.ddns\.net" ascii wide nocase
        $domain27 = "81-cn\.info" ascii wide nocase
        $domain28 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain29 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain30 = "a\.bc\.1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain31 = "a\.bc\.1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain32 = "a\.bc\.1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain33 = "a\.bc\.64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain34 = "a5936441-e402-41e3-b02b-75af112074b5\.org-co\.net" ascii wide nocase
        $domain35 = "a6dff163-e0b9-49c9-87e4-357f761f3c3b\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain36 = "aa173\.bank-ok\.com" ascii wide nocase
        $domain37 = "abc\.bol-north\.com" ascii wide nocase
        $domain38 = "academy\.lesporc\.live" ascii wide nocase
        $domain39 = "acc\.pk-govt\.net" ascii wide nocase
        $domain40 = "acenent\.site" ascii wide nocase
        $domain41 = "acfinang\.shop" ascii wide nocase
        $domain42 = "acrobat\.paknavy-pk\.org" ascii wide nocase
        $domain43 = "active\.roteh\.site" ascii wide nocase
        $domain44 = "adobe\.pdf-downlod\.com" ascii wide nocase
        $domain45 = "adobeglobal\.com" ascii wide nocase
        $domain46 = "advancedhealth\.medicallab\.site" ascii wide nocase
        $domain47 = "advisary\.army-govbd\.info" ascii wide nocase
        $domain48 = "advisories-sgcustoms\.d0cumentview\.info" ascii wide nocase
        $domain49 = "advisory-cabinetgpk\.servehttp\.com" ascii wide nocase
...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain41 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
        $domain42 = "accounts\.mgovcloud\.de" ascii wide nocase
        $domain43 = "accounts\.mgovcloud\.in\.cloudshare\.digital" ascii wide nocase
        $domain44 = "accounts\.mgovcloud\.in\.departmentofdefence\.live" ascii wide nocase
        $domain45 = "accounts\.mgovcloud\.in\.indiagov\.support" ascii wide nocase
        $domain46 = "accounts\.mgovcloud\.in\.storagecloud\.download" ascii wide nocase
        $domain47 = "accounts\.mgovcloud\.in\.virtualeoffice\.cloud" ascii wide nocase
        $domain48 = "accountsinfo\.site" ascii wide nocase
        $domain49 = "accountsmgovcloud\.in\.campindia\.xyz" ascii wide nocase
