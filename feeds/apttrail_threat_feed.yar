...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "app-cdn-software-gza4gebuf3cqd8h6\.z03\.azurefd\.net" ascii wide nocase
        $domain2 = "app-cdn\.celixi6266\.workers\.dev" ascii wide nocase
        $domain3 = "app\.pofelal314\.workers\.dev" ascii wide nocase
        $domain4 = "bapiyat727\.workers\.dev" ascii wide nocase
        $domain5 = "beekeeperstudio-db\.com" ascii wide nocase
        $domain6 = "beekeeperstudio\.cc" ascii wide nocase
        $domain7 = "beekeeperstudio\.co" ascii wide nocase
        $domain8 = "beekeeperstudio\.pro" ascii wide nocase
        $domain9 = "beekeeperstudio\.softwarep2p\.com" ascii wide nocase
        $domain10 = "beekeeperstudio\.space" ascii wide nocase
        $domain11 = "beekeeperstudio\.tech" ascii wide nocase
        $domain12 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain13 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain14 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain15 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain16 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain17 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain18 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain19 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain20 = "computerservicesource\.com" ascii wide nocase
        $domain21 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain22 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain23 = "database-lists\.com" ascii wide nocase
        $domain24 = "dbeaver-database\.app" ascii wide nocase
        $domain25 = "dbeaver-database\.cc" ascii wide nocase
        $domain26 = "dbeaver-database\.cloud" ascii wide nocase
        $domain27 = "dbeaver-database\.co" ascii wide nocase
        $domain28 = "dbeaver-database\.com" ascii wide nocase
        $domain29 = "dbeaver-database\.org" ascii wide nocase
        $domain30 = "dbeaver-database\.pro" ascii wide nocase
