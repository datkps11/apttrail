...
rule APT_COLDRIVER
{
    ...
    strings:
        ...
        $domain28 = "bigdatabroadway\.com" ascii wide nocase
        $domain29 = "bittechllc\.net" ascii wide nocase
        $domain30 = "blintepeeste\.org" ascii wide nocase
        $domain31 = "blueskynetwork-drive\.com" ascii wide nocase
        $domain32 = "blueskynetwork-shared\.com" ascii wide nocase
        $domain33 = "botguard-checker\.com" ascii wide nocase
        $domain34 = "botguard-web\.com" ascii wide nocase
        $domain35 = "cache-dns-forwarding\.com" ascii wide nocase
        $domain36 = "cache-dns-preview\.com" ascii wide nocase
        $domain37 = "cache-dns\.com" ascii wide nocase
        $domain38 = "cache-docs\.com" ascii wide nocase
        $domain39 = "cache-pdf\.com" ascii wide nocase
        $domain40 = "cache-pdf\.online" ascii wide nocase
        $domain41 = "cache-services\.live" ascii wide nocase
        $domain42 = "captchanom\.top" ascii wide nocase
        $domain43 = "centeritdefcity\.com" ascii wide nocase
        $domain44 = "challenge-identifier\.com" ascii wide nocase
        $domain45 = "challenge-share\.com" ascii wide nocase
        $domain46 = "changepassword-ukr\.net" ascii wide nocase
        $domain47 = "checker-bot\.com" ascii wide nocase
        $domain48 = "checkscreenit\.com" ascii wide nocase
        $domain49 = "cija-docs\.com" ascii wide nocase
