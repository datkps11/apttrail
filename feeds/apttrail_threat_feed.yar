...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain4 = "2co\.shop" ascii wide nocase
        $domain5 = "2ndline\.cfd" ascii wide nocase
        $domain6 = "34667\.fun" ascii wide nocase
        $domain7 = "37-221-64-202\.cprapid\.com" ascii wide nocase
        $domain8 = "37-221-64-252\.cprapid\.com" ascii wide nocase
        $domain9 = "376zbaqsnigt\.com" ascii wide nocase
        $domain10 = "3a4p8gq8bojwn\.xyz" ascii wide nocase
        $domain11 = "414\.camdvr\.org" ascii wide nocase
        $domain12 = "415\.mywire\.org" ascii wide nocase
        $domain13 = "419\.theworkpc\.com" ascii wide nocase
        $domain14 = "43-228-125-28\.cprapid\.com" ascii wide nocase
        $domain15 = "5-135-125-106\.cinfuserver\.com" ascii wide nocase
        $domain16 = "56184\.fun" ascii wide nocase
        $domain17 = "5gsewa\.cyou" ascii wide nocase
        $domain18 = "5zbm0\.cfd" ascii wide nocase
        $domain19 = "66xq2\.top" ascii wide nocase
        $domain20 = "6jxbmkpe\.torontobotdns\.com" ascii wide nocase
        $domain21 = "76767\.icu" ascii wide nocase
        $domain22 = "78990\.fun" ascii wide nocase
        $domain23 = "7thcpcupdates\.info" ascii wide nocase
        $domain24 = "873013\.xyz" ascii wide nocase
        $domain25 = "88c\.34667\.fun" ascii wide nocase
        $domain26 = "89204\.fun" ascii wide nocase
        $domain27 = "8fold\.space" ascii wide nocase
        $domain28 = "8ln62\.cfd" ascii wide nocase
        $domain29 = "8thpaycomission\.cloud" ascii wide nocase
        $domain30 = "8tqxpf27\.torontobotdns\.com" ascii wide nocase
        $domain31 = "903\.78990\.fun" ascii wide nocase
        $domain32 = "9123\.89204\.fun" ascii wide nocase
        $domain33 = "9882aa1216\.autos" ascii wide nocase
        $domain34 = "999game\.website" ascii wide nocase
        $domain35 = "9gi02\.cfd" ascii wide nocase
        $domain36 = "9ydygorig3l7z\.xyz" ascii wide nocase
        $domain37 = "a\.erforias\.cam" ascii wide nocase
        $domain38 = "aa\.76767\.icu" ascii wide nocase
        $domain39 = "aadharpor\.xyz" ascii wide nocase
        $domain40 = "aadharsewa\.site" ascii wide nocase
        $domain41 = "aadperson\.xyz" ascii wide nocase
        $domain42 = "aaloochaat\.com" ascii wide nocase
        $domain43 = "aboutcase\.nl" ascii wide nocase
        $domain44 = "ac\.76767\.icu" ascii wide nocase
        $domain45 = "accinfo\.live" ascii wide nocase
        $domain46 = "account-recovery\.com" ascii wide nocase
        $domain47 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain48 = "accountmail\.in" ascii wide nocase
        $domain49 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "12\.workbencn\.com" ascii wide nocase
        $domain2 = "178\.159\.43\.206\.sslip\.io" ascii wide nocase
        $domain3 = "1r\.rvtoolsed\.com" ascii wide nocase
        $domain4 = "1s\.rvtoolsai\.com" ascii wide nocase
        $domain5 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain6 = "1v\.rvtootsad\.com" ascii wide nocase
        $domain7 = "1yeralti\.com" ascii wide nocase
        $domain8 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain9 = "20\.rvtoolse\.info" ascii wide nocase
        $domain10 = "20\.rvtoolsme\.com" ascii wide nocase
        $domain11 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain12 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain13 = "24\.rvtoolis\.info" ascii wide nocase
        $domain14 = "24\.rvtoolsgo\.com" ascii wide nocase
        $domain15 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain16 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain17 = "2b\.rvtoolsit\.com" ascii wide nocase
        $domain18 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain19 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain20 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain21 = "3p\.workbenche\.com" ascii wide nocase
        $domain22 = "40\.workbencse\.com" ascii wide nocase
        $domain23 = "45perhour\.org" ascii wide nocase
        $domain24 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain25 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain26 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain27 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain28 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain29 = "5n\.rvtoolsrun\.com" ascii wide nocase
        $domain30 = "7stories\.sbs" ascii wide nocase
        $domain31 = "91movs\.com" ascii wide nocase
        $domain32 = "9xstream\.live" ascii wide nocase
        $domain33 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain34 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain35 = "abstractest-hydroski\.site" ascii wide nocase
        $domain36 = "academytradeai\.com" ascii wide nocase
        $domain37 = "acquasicuras\.com" ascii wide nocase
        $domain38 = "actbluecs\.com" ascii wide nocase
        $domain39 = "actblues\.net" ascii wide nocase
        $domain40 = "adionetjrei\.shop" ascii wide nocase
        $domain41 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain42 = "adrilex\.digital" ascii wide nocase
        $domain43 = "aexnp\.com" ascii wide nocase
        $domain44 = "afd-esign\.info" ascii wide nocase
        $domain45 = "afeherbopenuk\.com" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain20 = "06bf0\.crfbbarx\.com" ascii wide nocase
        $domain21 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain22 = "070052\.sod777\.com" ascii wide nocase
        $domain23 = "07c0\.ybbshhn\.com" ascii wide nocase
        $domain24 = "07f61\.ncjqeyid\.com" ascii wide nocase
        $domain25 = "0847\.zcfniju\.cc" ascii wide nocase
        $domain26 = "09688\.xkbaamgc\.cc" ascii wide nocase
        $domain27 = "0992\.app" ascii wide nocase
        $domain28 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain29 = "099ae\.qcechaw\.cc" ascii wide nocase
        $domain30 = "0am15\.com" ascii wide nocase
        $domain31 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain32 = "0b461\.xdjuvoau\.xyz" ascii wide nocase
        $domain33 = "0b6c80a39c\.top" ascii wide nocase
        $domain34 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain35 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain36 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain37 = "0bb7\.dmjdwvpy\.com" ascii wide nocase
        $domain38 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain39 = "0cncoxi\.com" ascii wide nocase
        $domain40 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain41 = "0dc48\.xjhvsgg\.xyz" ascii wide nocase
        $domain42 = "0de\.ofvtspr\.xyz" ascii wide nocase
        $domain43 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain44 = "0e8\.kqyxwyb\.xyz" ascii wide nocase
        $domain45 = "0fx7qmdggegytul\.xyz" ascii wide nocase
        $domain46 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain47 = "0jijrwbzxzzxz04\.xyz" ascii wide nocase
        $domain48 = "0opus\.com" ascii wide nocase
        $domain49 = "0r97p\.com" ascii wide nocase
