...
rule APT_WIRTE
{
    ...
    strings:
        ...
        $domain2 = "cdn\.techpointinfo\.com" ascii wide nocase
        $domain3 = "check\.office365-update\.com" ascii wide nocase
        $domain4 = "dentalaccord\.com" ascii wide nocase
        $domain5 = "dentalmatrix\.net" ascii wide nocase
        $domain6 = "doctoressolis\.com" ascii wide nocase
        $domain7 = "download\.share2file\.pro" ascii wide nocase
        $domain8 = "easybackupcloud\.com" ascii wide nocase
        $domain9 = "economymentor\.com" ascii wide nocase
        $domain10 = "economystocking\.com" ascii wide nocase
        $domain11 = "eg\.foxlove\.life" ascii wide nocase
        $domain12 = "egyptican\.com" ascii wide nocase
        $domain13 = "egyptskytours\.com" ascii wide nocase
        $domain14 = "egypttourism-online\.com" ascii wide nocase
        $domain15 = "ellemedic\.com" ascii wide nocase
        $domain16 = "est-clinic\.com" ascii wide nocase
        $domain17 = "finance-analyst\.com" ascii wide nocase
        $domain18 = "financecovers\.com" ascii wide nocase
        $domain19 = "financeinfoguide\.com" ascii wide nocase
        $domain20 = "firstohiobank\.com" ascii wide nocase
        $domain21 = "fox\.foxlove\.life" ascii wide nocase
        $domain22 = "foxlove\.life" ascii wide nocase
        $domain23 = "healthcarb\.com" ascii wide nocase
        $domain24 = "healthoptionstoday\.com" ascii wide nocase
        $domain25 = "healthscratches\.com" ascii wide nocase
        $domain26 = "imagine-world\.com" ascii wide nocase
        $domain27 = "jo\.foxlove\.life" ascii wide nocase
        $domain28 = "jordanrefugees\.com" ascii wide nocase
        $domain29 = "jordansons\.com" ascii wide nocase
        $domain30 = "king-pharmacy\.com" ascii wide nocase
        $domain31 = "kneeexercises\.net" ascii wide nocase
        $domain32 = "master-dental\.com" ascii wide nocase
        $domain33 = "micorsoft\.store" ascii wide nocase
        $domain34 = "microsoftliveforums\.com" ascii wide nocase
        $domain35 = "microsoftteams365\.com" ascii wide nocase
        $domain36 = "microsoftwindowshelp\.com" ascii wide nocase
        $domain37 = "neweconomysolution\.com" ascii wide nocase
        $domain38 = "niftybuysellchart\.com" ascii wide nocase
        $domain39 = "nutrition-information\.org" ascii wide nocase
        $domain40 = "office-update\.services" ascii wide nocase
        $domain41 = "office365-update\.co" ascii wide nocase
        $domain42 = "office365-update\.com" ascii wide nocase
        $domain43 = "omegaeyehospital\.com" ascii wide nocase
        $domain44 = "pocket-property\.com" ascii wide nocase
        $domain45 = "printspoolerupdates\.com" ascii wide nocase
        $domain46 = "qrdorks\.com" ascii wide nocase
        $domain47 = "saudiarabianow\.org" ascii wide nocase
        $domain48 = "saudiday\.org" ascii wide nocase
        $domain49 = "share2file\.pro" ascii wide nocase
