...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain8 = "91newai\.com" ascii wide nocase
        $domain9 = "a\.linuxupdate\.info" ascii wide nocase
        $domain10 = "accounts\.longmusic\.com" ascii wide nocase
        $domain11 = "ad\.scgawj\.com" ascii wide nocase
        $domain12 = "admin\.netbill\.pk" ascii wide nocase
        $domain13 = "adobe-cdn\.org" ascii wide nocase
        $domain14 = "aejava\.ddns\.net" ascii wide nocase
        $domain15 = "aejva\.ddns\.net" ascii wide nocase
        $domain16 = "afdentry\.workstation\.eu\.org" ascii wide nocase
        $domain17 = "afsder\.com" ascii wide nocase
        $domain18 = "agegamepay\.com" ascii wide nocase
        $domain19 = "ageofwuxia\.com" ascii wide nocase
        $domain20 = "ageofwuxia\.info" ascii wide nocase
        $domain21 = "ageofwuxia\.net" ascii wide nocase
        $domain22 = "ageofwuxia\.org" ascii wide nocase
        $domain23 = "akacur\.tk" ascii wide nocase
        $domain24 = "akamaixed\.net" ascii wide nocase
        $domain25 = "alibaba\.zzux\.com" ascii wide nocase
        $domain26 = "aliyun\.com\.co" ascii wide nocase
        $domain27 = "alpha-els\.com" ascii wide nocase
        $domain28 = "alxc\.tbtianyan\.com" ascii wide nocase
        $domain29 = "amazonlivenews\.com" ascii wide nocase
        $domain30 = "ampolice\.org" ascii wide nocase
        $domain31 = "andropwn\.xyz" ascii wide nocase
        $domain32 = "aone\.ddns\.net" ascii wide nocase
        $domain33 = "ap\.philancourts\.com" ascii wide nocase
        $domain34 = "api\.emazemedia\.com" ascii wide nocase
        $domain35 = "api\.googleauthenticatoronline\.com" ascii wide nocase
        $domain36 = "api\.sourcedata\.kuwannba\.com" ascii wide nocase
        $domain37 = "app\.kaspersky-scan\.com" ascii wide nocase
        $domain38 = "app\.microsoftstaticapi\.com" ascii wide nocase
        $domain39 = "app30\.hema129\.com" ascii wide nocase
        $domain40 = "app40\.hema129\.com" ascii wide nocase
        $domain41 = "arestc\.net" ascii wide nocase
        $domain42 = "asdasw21\.icu" ascii wide nocase
        $domain43 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain44 = "assistcustody\.xyz" ascii wide nocase
        $domain45 = "astudycarsceu\.net" ascii wide nocase
        $domain46 = "asushotfix\.com" ascii wide nocase
        $domain47 = "atomiclampco\.com" ascii wide nocase
        $domain48 = "auth\.microsoftsservice\.com" ascii wide nocase
        $domain49 = "az\.performed12\.com" ascii wide nocase
