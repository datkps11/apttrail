...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain39 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain40 = "abc\.meeting-central\.online" ascii wide nocase
        $domain41 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain42 = "abc\.preconnection\.online" ascii wide nocase
        $domain43 = "abc\.roomconnect\.online" ascii wide nocase
        $domain44 = "abilityscan360\.com" ascii wide nocase
        $domain45 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain46 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain47 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain48 = "acoustickoala\.com" ascii wide nocase
        $domain49 = "acroadovw\.com" ascii wide nocase
