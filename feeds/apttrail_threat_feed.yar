...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain38 = "acquasicuras\.com" ascii wide nocase
        $domain39 = "actbluecs\.com" ascii wide nocase
        $domain40 = "actblues\.net" ascii wide nocase
        $domain41 = "adionetjrei\.shop" ascii wide nocase
        $domain42 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain43 = "adrilex\.digital" ascii wide nocase
        $domain44 = "aexnp\.com" ascii wide nocase
        $domain45 = "afd-esign\.info" ascii wide nocase
        $domain46 = "afeherbopenuk\.com" ascii wide nocase
        $domain47 = "agora-mesmo\.com" ascii wide nocase
        $domain48 = "agronomywork\.info" ascii wide nocase
        $domain49 = "aiadvancedreasoning\.com" ascii wide nocase
