...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain10 = "agrosuccessventure\.com" ascii wide nocase
        $domain11 = "airpaz\.egnyte\.com" ascii wide nocase
        $domain12 = "airpazflys\.egnyte\.com" ascii wide nocase
        $domain13 = "aitradingchatgpt\.com" ascii wide nocase
        $domain14 = "alibabacloud\.dynamic-dns\.net" ascii wide nocase
        $domain15 = "alibabacloud\.wikaba\.com" ascii wide nocase
        $domain16 = "alibabacloud\.zzux\.com" ascii wide nocase
        $domain17 = "alkan\.egnyte\.com" ascii wide nocase
        $domain18 = "altrixo\.com" ascii wide nocase
        $domain19 = "amazo0n\.serveftp\.com" ascii wide nocase
        $domain20 = "ampacindustries\.com" ascii wide nocase
        $domain21 = "ankara24saatacikcicekci\.com" ascii wide nocase
        $domain22 = "apikeyallervice\.business" ascii wide nocase
        $domain23 = "apikeyallervice\.com" ascii wide nocase
        $domain24 = "approvallr\.club" ascii wide nocase
        $domain25 = "appsharecloud\.com" ascii wide nocase
        $domain26 = "archivora\.club" ascii wide nocase
        $domain27 = "archivora\.sbs" ascii wide nocase
        $domain28 = "arenareport\.report" ascii wide nocase
        $domain29 = "assignmenthelptoday\.com" ascii wide nocase
        $domain30 = "asure-onlinee\.com" ascii wide nocase
        $domain31 = "aurasync2\.com" ascii wide nocase
        $domain32 = "authntica\.qpon" ascii wide nocase
        $domain33 = "banaftxdhj\.com" ascii wide nocase
        $domain34 = "bankwirey\.qpon" ascii wide nocase
        $domain35 = "bevestig\.in" ascii wide nocase
        $domain36 = "bgpweb\.com" ascii wide nocase
        $domain37 = "billwise\.qpon" ascii wide nocase
        $domain38 = "binden\.in" ascii wide nocase
        $domain39 = "bing-google-soft\.com" ascii wide nocase
        $domain40 = "blazingketo\.com" ascii wide nocase
        $domain41 = "cairoairport\.egnyte\.com" ascii wide nocase
        $domain42 = "calendra\.cloud" ascii wide nocase
        $domain43 = "calendra\.sbs" ascii wide nocase
        $domain44 = "cardguard\.qpon" ascii wide nocase
        $domain45 = "cashflowr\.qpon" ascii wide nocase
        $domain46 = "catalogerx\.cloud" ascii wide nocase
        $domain47 = "cdn\.bgpweb\.com" ascii wide nocase
        $domain48 = "checkmatey\.qpon" ascii wide nocase
        $domain49 = "ciscoupdate2019\.gotdns\.ch" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain3 = "1yeralti\.com" ascii wide nocase
        $domain4 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain5 = "20\.rvtoolse\.info" ascii wide nocase
        $domain6 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain7 = "24\.rvtoolis\.info" ascii wide nocase
        $domain8 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain9 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain10 = "3p\.workbenche\.com" ascii wide nocase
        $domain11 = "45perhour\.org" ascii wide nocase
        $domain12 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain13 = "7stories\.sbs" ascii wide nocase
        $domain14 = "91movs\.com" ascii wide nocase
        $domain15 = "9xstream\.live" ascii wide nocase
        $domain16 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain17 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain18 = "abstractest-hydroski\.site" ascii wide nocase
        $domain19 = "academytradeai\.com" ascii wide nocase
        $domain20 = "acquasicuras\.com" ascii wide nocase
        $domain21 = "actbluecs\.com" ascii wide nocase
        $domain22 = "actblues\.net" ascii wide nocase
        $domain23 = "adionetjrei\.shop" ascii wide nocase
        $domain24 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain25 = "adrilex\.digital" ascii wide nocase
        $domain26 = "aexnp\.com" ascii wide nocase
        $domain27 = "afeherbopenuk\.com" ascii wide nocase
        $domain28 = "agronomywork\.info" ascii wide nocase
        $domain29 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain30 = "aialgocamp\.com" ascii wide nocase
        $domain31 = "aialgocore\.com" ascii wide nocase
        $domain32 = "aialgodrive\.com" ascii wide nocase
        $domain33 = "aialgoflow\.com" ascii wide nocase
        $domain34 = "aialgofusion\.com" ascii wide nocase
        $domain35 = "aialgohash\.com" ascii wide nocase
        $domain36 = "aialgorithmforge\.com" ascii wide nocase
        $domain37 = "aialgorithmicforge\.com" ascii wide nocase
        $domain38 = "aialgorithmicpath\.com" ascii wide nocase
        $domain39 = "aialgosense\.com" ascii wide nocase
        $domain40 = "aialgosphere\.com" ascii wide nocase
        $domain41 = "aianalyticengine\.com" ascii wide nocase
        $domain42 = "aianalyticmesh\.com" ascii wide nocase
        $domain43 = "aiautomationframework\.com" ascii wide nocase
        $domain44 = "aiautonomycore\.com" ascii wide nocase
        $domain45 = "aibigdatamap\.com" ascii wide nocase
        $domain46 = "aibotscale\.com" ascii wide nocase
        $domain47 = "aibrainatelier\.com" ascii wide nocase
        $domain48 = "aibrainframe\.com" ascii wide nocase
        $domain49 = "aibrainlogicc\.com" ascii wide nocase
