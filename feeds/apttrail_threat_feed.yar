...
rule APT_CLOUDATLAS
{
    ...
    strings:
        ...
        $domain10 = "billet-ru\.net" ascii wide nocase
        $domain11 = "blackberry-support\.herokuapp\.com" ascii wide nocase
        $domain12 = "brexitimpact\.com" ascii wide nocase
        $domain13 = "checklicensekey\.com" ascii wide nocase
        $domain14 = "cityru-travel\.org" ascii wide nocase
        $domain15 = "cloud\.archive-downloader\.com" ascii wide nocase
        $domain16 = "cloud\.digitalstorage\.workers\.dev" ascii wide nocase
        $domain17 = "comparelicense\.com" ascii wide nocase
        $domain18 = "content-protect\.net" ascii wide nocase
        $domain19 = "control-issue\.net" ascii wide nocase
        $domain20 = "cortanaupdater\.info" ascii wide nocase
        $domain21 = "curly-waterfall-360d\.fetrikekke531\.workers\.dev" ascii wide nocase
        $domain22 = "dc-microsoft\.workers\.dev" ascii wide nocase
        $domain23 = "desktoppreview\.com" ascii wide nocase
        $domain24 = "digitalstorage\.workers\.dev" ascii wide nocase
        $domain25 = "doc-fid\.com" ascii wide nocase
        $domain26 = "documents\.publicserver\.workers\.dev" ascii wide nocase
        $domain27 = "driver-key\.com" ascii wide nocase
        $domain28 = "driver-updated\.com" ascii wide nocase
        $domain29 = "driversolution\.net" ascii wide nocase
        $domain30 = "e-aks\.uz" ascii wide nocase
        $domain31 = "e-government-pk\.com" ascii wide nocase
        $domain32 = "e-govoffice\.com" ascii wide nocase
        $domain33 = "ecolines\.es" ascii wide nocase
        $domain34 = "eu\.microsoft-365\.workers\.dev" ascii wide nocase
        $domain35 = "eurasia-research\.org" ascii wide nocase
        $domain36 = "exactsynchtime\.ru" ascii wide nocase
        $domain37 = "falling-haze-1812\.jerkufetra754\.workers\.dev" ascii wide nocase
        $domain38 = "falling-haze-1813\.jerkufetra754\.workers\.dev" ascii wide nocase
        $domain39 = "fatobara\.com" ascii wide nocase
        $domain40 = "fetrikekke531\.workers\.dev" ascii wide nocase
        $domain41 = "flashsupport\.org" ascii wide nocase
        $domain42 = "fmsru\.ru" ascii wide nocase
        $domain43 = "get-news-online\.com" ascii wide nocase
        $domain44 = "gettemplate\.org" ascii wide nocase
        $domain45 = "gimnazija\.org" ascii wide nocase
        $domain46 = "gmocloudhosting\.com" ascii wide nocase
        $domain47 = "gosportal\.net" ascii wide nocase
        $domain48 = "haarmannsi\.cz" ascii wide nocase
        $domain49 = "host-tools\.net" ascii wide nocase
