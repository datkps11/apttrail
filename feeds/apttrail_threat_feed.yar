...
rule APT_CHARMINGKITTEN
{
    ...
    strings:
        ...
        $domain13 = "30min-smartsight-hr\.com" ascii wide nocase
        $domain14 = "3dauth\.live" ascii wide nocase
        $domain15 = "3dconfirrnation\.com" ascii wide nocase
        $domain16 = "8ghefkwdvbfdsg3asdf1\.com" ascii wide nocase
        $domain17 = "academy-update\.com" ascii wide nocase
        $domain18 = "accesscheckout\.online" ascii wide nocase
        $domain19 = "accessverification\.online" ascii wide nocase
        $domain20 = "acconut-mail\.com" ascii wide nocase
        $domain21 = "acconut-signin\.com" ascii wide nocase
        $domain22 = "acconut-verify\.com" ascii wide nocase
        $domain23 = "account-customerservice\.com" ascii wide nocase
        $domain24 = "account-drive\.com" ascii wide nocase
        $domain25 = "account-dropbox\.net" ascii wide nocase
        $domain26 = "account-google\.co" ascii wide nocase
        $domain27 = "account-log-user-verify-mail\.com" ascii wide nocase
        $domain28 = "account-login\.net" ascii wide nocase
        $domain29 = "account-logins\.com" ascii wide nocase
        $domain30 = "account-permission-mail-user\.com" ascii wide nocase
        $domain31 = "account-profile-users\.info" ascii wide nocase
        $domain32 = "account-servicemanagement\.info" ascii wide nocase
        $domain33 = "account-servicerecovery\.com" ascii wide nocase
        $domain34 = "account-servieemanagement\.info" ascii wide nocase
        $domain35 = "account-signin-myaccount-users\.ga" ascii wide nocase
        $domain36 = "account-signin\.com" ascii wide nocase
        $domain37 = "account-siqnin\.com" ascii wide nocase
        $domain38 = "account-support-user\.com" ascii wide nocase
        $domain39 = "account-user-permission-account\.com" ascii wide nocase
        $domain40 = "account-user-verify-mail\.com" ascii wide nocase
        $domain41 = "account-user\.com" ascii wide nocase
        $domain42 = "account-users-mail\.com" ascii wide nocase
        $domain43 = "account-verifiy\.net" ascii wide nocase
        $domain44 = "accountroyal\.com" ascii wide nocase
        $domain45 = "accounts-apple\.com" ascii wide nocase
        $domain46 = "accounts-drive\.com" ascii wide nocase
        $domain47 = "accounts-googelmail\.com" ascii wide nocase
        $domain48 = "accounts-googelmails\.com" ascii wide nocase
        $domain49 = "accounts-logins\.net" ascii wide nocase
