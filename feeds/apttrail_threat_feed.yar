...
rule APT_TURLA
{
    ...
    strings:
        ...
        $domain27 = "carleasingguru\.com" ascii wide nocase
        $domain28 = "cars-online\.zapto\.org" ascii wide nocase
        $domain29 = "cdn\.datacenterate\.com" ascii wide nocase
        $domain30 = "celestyna\.tk" ascii wide nocase
        $domain31 = "ceremon\.2waky\.com" ascii wide nocase
        $domain32 = "cheapflights\.etowns\.net" ascii wide nocase
        $domain33 = "chinafood\.chickenkiller\.com" ascii wide nocase
        $domain34 = "chjeepcarlease\.com" ascii wide nocase
        $domain35 = "climbent\.mooo\.com" ascii wide nocase
        $domain36 = "codewizard\.ml" ascii wide nocase
        $domain37 = "coldriver\.strangled\.net" ascii wide nocase
        $domain38 = "communityeu\.xp3\.biz" ascii wide nocase
        $domain39 = "connectotels\.net" ascii wide nocase
        $domain40 = "crusider\.tk" ascii wide nocase
        $domain41 = "cyberazov\.com" ascii wide nocase
        $domain42 = "cyberazov\.tk" ascii wide nocase
        $domain43 = "d3hdbjtb1686tn\.cloudfront\.net" ascii wide nocase
        $domain44 = "da\.anythinktech\.com" ascii wide nocase
        $domain45 = "datacenterate\.com" ascii wide nocase
        $domain46 = "davilta\.tk" ascii wide nocase
        $domain47 = "dellservice\.publicvm\.com" ascii wide nocase
        $domain48 = "deme\.ml" ascii wide nocase
        $domain49 = "developarea\.mooo\.com" ascii wide nocase
