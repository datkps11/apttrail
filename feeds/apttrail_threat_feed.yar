...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain2 = "01nservercc\.cfd" ascii wide nocase
        $domain3 = "01onlinen\.cfd" ascii wide nocase
        $domain4 = "02nservercc\.cfd" ascii wide nocase
        $domain5 = "02onlinen\.cfd" ascii wide nocase
        $domain6 = "03nservercc\.cfd" ascii wide nocase
        $domain7 = "03onlinen\.cfd" ascii wide nocase
        $domain8 = "04nservercc\.cfd" ascii wide nocase
        $domain9 = "04onlinen\.cfd" ascii wide nocase
        $domain10 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.onlinenhiscomservice\.store" ascii wide nocase
        $domain11 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.voranstaks\.shop" ascii wide nocase
        $domain12 = "05c0\.nkfumxgqxd\.v6\.rocks" ascii wide nocase
        $domain13 = "05nservercc\.cfd" ascii wide nocase
        $domain14 = "05onlinen\.cfd" ascii wide nocase
        $domain15 = "06nservercc\.cfd" ascii wide nocase
        $domain16 = "06onlinen\.cfd" ascii wide nocase
        $domain17 = "0751u9n4lg\.v6\.rocks" ascii wide nocase
        $domain18 = "07nservercc\.cfd" ascii wide nocase
        $domain19 = "07onlinen\.cfd" ascii wide nocase
        $domain20 = "08nservercc\.cfd" ascii wide nocase
        $domain21 = "08onlinen\.cfd" ascii wide nocase
        $domain22 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain23 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain24 = "09nservercc\.cfd" ascii wide nocase
        $domain25 = "09onlinen\.cfd" ascii wide nocase
        $domain26 = "0c50zrvnoi\.v6\.rocks" ascii wide nocase
        $domain27 = "0g25r94p96\.v6\.army" ascii wide nocase
        $domain28 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain29 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain30 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain31 = "0x0\.care" ascii wide nocase
        $domain32 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain33 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain34 = "100000recipe\.com" ascii wide nocase
        $domain35 = "100nservercc\.cfd" ascii wide nocase
        $domain36 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain37 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain38 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain39 = "10nservercc\.cfd" ascii wide nocase
        $domain40 = "10onlinen\.cfd" ascii wide nocase
        $domain41 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain42 = "11nservercc\.cfd" ascii wide nocase
        $domain43 = "11onlinen\.cfd" ascii wide nocase
        $domain44 = "12-ko-official\.com" ascii wide nocase
        $domain45 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain46 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain47 = "12e9w4hp1f\.v6\.army" ascii wide nocase
        $domain48 = "12nservercc\.cfd" ascii wide nocase
        $domain49 = "12onlinen\.cfd" ascii wide nocase
