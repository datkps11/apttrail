...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain25 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain26 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain27 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain28 = "435fdgfd-fgh675gh56jh-65jhg65ghjytu65\.netlify\.app" ascii wide nocase
        $domain29 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain30 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain31 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain32 = "63inc\.com" ascii wide nocase
        $domain33 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain34 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain35 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain36 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain37 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain38 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain39 = "81-cn\.ddns\.net" ascii wide nocase
        $domain40 = "81-cn\.info" ascii wide nocase
        $domain41 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain42 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain43 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain44 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain45 = "9af72fg4jg75hg8jg94kg94k9fk390gk4170674tr69bf1f766cdec1d11\.pages\.dev" ascii wide nocase
        $domain46 = "a\.bc\.1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain47 = "a\.bc\.1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain48 = "a\.bc\.1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain49 = "a\.bc\.64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
...
rule APT_UNC1151
{
    ...
    strings:
        ...
        $domain34 = "all-ukraine\.top" ascii wide nocase
        $domain35 = "alls-gos\.top" ascii wide nocase
        $domain36 = "americandeliriumsociety\.shop" ascii wide nocase
        $domain37 = "ams-gos\.top" ascii wide nocase
        $domain38 = "ao-opros\.top" ascii wide nocase
        $domain39 = "api\.passport-yandex\.ru" ascii wide nocase
        $domain40 = "aplikacje\.ron-mil\.space" ascii wide nocase
        $domain41 = "authorization-inbox\.site" ascii wide nocase
        $domain42 = "awa-opros\.top" ascii wide nocase
        $domain43 = "aws-opros\.top" ascii wide nocase
        $domain44 = "backstagemerch\.shop" ascii wide nocase
        $domain45 = "beez-gos\.top" ascii wide nocase
        $domain46 = "bel-oprosov\.top" ascii wide nocase
        $domain47 = "belaru-opros\.top" ascii wide nocase
        $domain48 = "bell-gos\.club" ascii wide nocase
        $domain49 = "besh-opros\.top" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "45perhour\.org" ascii wide nocase
        $domain2 = "7stories\.sbs" ascii wide nocase
        $domain3 = "91movs\.com" ascii wide nocase
        $domain4 = "9xstream\.live" ascii wide nocase
        $domain5 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain6 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain7 = "abstractest-hydroski\.site" ascii wide nocase
        $domain8 = "academytradeai\.com" ascii wide nocase
        $domain9 = "acquasicuras\.com" ascii wide nocase
        $domain10 = "actbluecs\.com" ascii wide nocase
        $domain11 = "actblues\.net" ascii wide nocase
        $domain12 = "adionetjrei\.shop" ascii wide nocase
        $domain13 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain14 = "adrilex\.digital" ascii wide nocase
        $domain15 = "aexnp\.com" ascii wide nocase
        $domain16 = "afeherbopenuk\.com" ascii wide nocase
        $domain17 = "agronomywork\.info" ascii wide nocase
        $domain18 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain19 = "aialgocamp\.com" ascii wide nocase
        $domain20 = "aialgocore\.com" ascii wide nocase
        $domain21 = "aialgodrive\.com" ascii wide nocase
        $domain22 = "aialgoflow\.com" ascii wide nocase
        $domain23 = "aialgofusion\.com" ascii wide nocase
        $domain24 = "aialgohash\.com" ascii wide nocase
        $domain25 = "aialgorithmforge\.com" ascii wide nocase
        $domain26 = "aialgorithmicforge\.com" ascii wide nocase
        $domain27 = "aialgorithmicpath\.com" ascii wide nocase
        $domain28 = "aialgosense\.com" ascii wide nocase
        $domain29 = "aialgosphere\.com" ascii wide nocase
        $domain30 = "aianalyticengine\.com" ascii wide nocase
        $domain31 = "aianalyticmesh\.com" ascii wide nocase
        $domain32 = "aiautomationframework\.com" ascii wide nocase
        $domain33 = "aiautonomycore\.com" ascii wide nocase
        $domain34 = "aibigdatamap\.com" ascii wide nocase
        $domain35 = "aibotscale\.com" ascii wide nocase
        $domain36 = "aibrainatelier\.com" ascii wide nocase
        $domain37 = "aibrainframe\.com" ascii wide nocase
        $domain38 = "aibrainlogicc\.com" ascii wide nocase
        $domain39 = "aibrainmatrixed\.com" ascii wide nocase
        $domain40 = "aibrainyard\.com" ascii wide nocase
        $domain41 = "aibuildersguild\.com" ascii wide nocase
        $domain42 = "aibuildnet\.com" ascii wide nocase
        $domain43 = "aibuildspark\.com" ascii wide nocase
        $domain44 = "aibytepad\.com" ascii wide nocase
        $domain45 = "aicalcengine\.com" ascii wide nocase
        $domain46 = "aichatbeam\.com" ascii wide nocase
        $domain47 = "aichatfuse\.com" ascii wide nocase
        $domain48 = "aichattask\.com" ascii wide nocase
        $domain49 = "aichippad\.com" ascii wide nocase
