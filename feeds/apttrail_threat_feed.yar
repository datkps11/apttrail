...
rule APT_CLOUDATLAS
{
    ...
    strings:
        ...
        $domain5 = "apkcrypter\.com" ascii wide nocase
        $domain6 = "archive-downloader\.com" ascii wide nocase
        $domain7 = "asia\.office365-cloud\.workers\.dev" ascii wide nocase
        $domain8 = "avito-service\.net" ascii wide nocase
        $domain9 = "azureblog\.info" ascii wide nocase
        $domain10 = "becloud\.website" ascii wide nocase
        $domain11 = "billet-ru\.net" ascii wide nocase
        $domain12 = "blackberry-support\.herokuapp\.com" ascii wide nocase
        $domain13 = "brexitimpact\.com" ascii wide nocase
        $domain14 = "checklicensekey\.com" ascii wide nocase
        $domain15 = "cityru-travel\.org" ascii wide nocase
        $domain16 = "cloud\.archive-downloader\.com" ascii wide nocase
        $domain17 = "cloud\.digitalstorage\.workers\.dev" ascii wide nocase
        $domain18 = "comparelicense\.com" ascii wide nocase
        $domain19 = "connectcosmo\.click" ascii wide nocase
        $domain20 = "connectcosmo\.online" ascii wide nocase
        $domain21 = "content-protect\.net" ascii wide nocase
        $domain22 = "control-issue\.net" ascii wide nocase
        $domain23 = "copilotgptawer\.cfd" ascii wide nocase
        $domain24 = "cortanaupdater\.info" ascii wide nocase
        $domain25 = "cosmo-service\.org" ascii wide nocase
        $domain26 = "curly-waterfall-360d\.fetrikekke531\.workers\.dev" ascii wide nocase
        $domain27 = "dc-microsoft\.workers\.dev" ascii wide nocase
        $domain28 = "desktoppreview\.com" ascii wide nocase
        $domain29 = "digitalstorage\.workers\.dev" ascii wide nocase
        $domain30 = "doc-fid\.com" ascii wide nocase
        $domain31 = "documents\.publicserver\.workers\.dev" ascii wide nocase
        $domain32 = "driver-key\.com" ascii wide nocase
        $domain33 = "driver-updated\.com" ascii wide nocase
        $domain34 = "driversolution\.net" ascii wide nocase
        $domain35 = "e-aks\.uz" ascii wide nocase
        $domain36 = "e-government-pk\.com" ascii wide nocase
        $domain37 = "e-govoffice\.com" ascii wide nocase
        $domain38 = "ecolines\.es" ascii wide nocase
        $domain39 = "eu\.microsoft-365\.workers\.dev" ascii wide nocase
        $domain40 = "eurasia-research\.org" ascii wide nocase
        $domain41 = "exactsynchtime\.ru" ascii wide nocase
        $domain42 = "falling-haze-1812\.jerkufetra754\.workers\.dev" ascii wide nocase
        $domain43 = "falling-haze-1813\.jerkufetra754\.workers\.dev" ascii wide nocase
        $domain44 = "fatobara\.com" ascii wide nocase
        $domain45 = "fetrikekke531\.workers\.dev" ascii wide nocase
        $domain46 = "flashsupport\.org" ascii wide nocase
        $domain47 = "fmsru\.ru" ascii wide nocase
        $domain48 = "get-news-online\.com" ascii wide nocase
        $domain49 = "gettemplate\.org" ascii wide nocase
...
rule APT_Q27
{
    ...
    strings:
        ...
        $domain10 = "links3s\.s3\.ap-east-1\.amazonaws\.com" ascii wide nocase
        $domain11 = "nsjdhmdjs\.com" ascii wide nocase
        $domain12 = "potatouu\.com" ascii wide nocase
        $domain13 = "s3work08\.s3\.ap-east-1\.amazonaws\.com" ascii wide nocase
        $domain14 = "t\.pic447\.com" ascii wide nocase
        $domain15 = "uu\.goldeyeuu\.io" ascii wide nocase
        $domain16 = "v\.pic447\.com" ascii wide nocase
