...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain30 = "andropwn\.xyz" ascii wide nocase
        $domain31 = "aone\.ddns\.net" ascii wide nocase
        $domain32 = "ap\.philancourts\.com" ascii wide nocase
        $domain33 = "api\.emazemedia\.com" ascii wide nocase
        $domain34 = "api\.googleauthenticatoronline\.com" ascii wide nocase
        $domain35 = "api\.sourcedata\.kuwannba\.com" ascii wide nocase
        $domain36 = "app\.kaspersky-scan\.com" ascii wide nocase
        $domain37 = "app\.microsoftstaticapi\.com" ascii wide nocase
        $domain38 = "app30\.hema129\.com" ascii wide nocase
        $domain39 = "app40\.hema129\.com" ascii wide nocase
        $domain40 = "arestc\.net" ascii wide nocase
        $domain41 = "asdasw21\.icu" ascii wide nocase
        $domain42 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain43 = "assistcustody\.xyz" ascii wide nocase
        $domain44 = "astudycarsceu\.net" ascii wide nocase
        $domain45 = "asushotfix\.com" ascii wide nocase
        $domain46 = "atomiclampco\.com" ascii wide nocase
        $domain47 = "auth\.microsoftsservice\.com" ascii wide nocase
        $domain48 = "az\.performed12\.com" ascii wide nocase
        $domain49 = "back\.rooter\.tk" ascii wide nocase
...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain29 = "10nservercc\.cfd" ascii wide nocase
        $domain30 = "10onlinen\.cfd" ascii wide nocase
        $domain31 = "11nservercc\.cfd" ascii wide nocase
        $domain32 = "11onlinen\.cfd" ascii wide nocase
        $domain33 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain34 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain35 = "12nservercc\.cfd" ascii wide nocase
        $domain36 = "12onlinen\.cfd" ascii wide nocase
        $domain37 = "13nservercc\.cfd" ascii wide nocase
        $domain38 = "13onlinen\.cfd" ascii wide nocase
        $domain39 = "14nservercc\.cfd" ascii wide nocase
        $domain40 = "14onlinen\.cfd" ascii wide nocase
        $domain41 = "15dhyfituhivoivjjgijrtjtgg\.cfd" ascii wide nocase
        $domain42 = "15fuerouhrgiurtituigjtug\.cfd" ascii wide nocase
        $domain43 = "15hjdgvfdjbvunghghod\.cfd" ascii wide nocase
        $domain44 = "15jhguerhguyogjopgoff\.cfd" ascii wide nocase
        $domain45 = "15nservercc\.cfd" ascii wide nocase
        $domain46 = "15onlinen\.cfd" ascii wide nocase
        $domain47 = "15ygfyerfgyufhsdgfyegf\.cfd" ascii wide nocase
        $domain48 = "15yufibeuiohuireiogjrgji\.cfd" ascii wide nocase
        $domain49 = "1636\.site" ascii wide nocase
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $ip54 = "103.65.230.100" ascii wide
        $ip55 = "104.168.136.24" ascii wide
        $ip56 = "104.168.151.34" ascii wide
        $ip57 = "104.168.157.45" ascii wide
        $ip58 = "104.168.157.45" ascii wide
        $ip59 = "104.168.165.165" ascii wide
        $ip60 = "104.168.165.165" ascii wide
        $ip61 = "104.168.165.173" ascii wide
        $ip62 = "104.168.165.173" ascii wide
        $ip63 = "104.168.165.203" ascii wide
        $ip64 = "104.168.165.203" ascii wide
        $ip65 = "104.168.172.20" ascii wide
        $ip66 = "104.168.203.159" ascii wide
        $ip67 = "104.168.203.159" ascii wide
        $ip68 = "104.194.133.88" ascii wide
        $ip69 = "104.194.133.88" ascii wide
        $ip70 = "104.217.163.61" ascii wide
        $ip71 = "104.232.71.7" ascii wide
        $ip72 = "107.172.197.175" ascii wide
        $ip73 = "107.175.172.129" ascii wide
        $ip74 = "107.189.16.122" ascii wide
        $ip75 = "107.189.16.122" ascii wide
        $ip76 = "107.189.16.176" ascii wide
        $ip77 = "107.189.16.176" ascii wide
        $ip78 = "107.189.20.152" ascii wide
        $ip79 = "107.189.20.152" ascii wide
...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain18 = "amazo0n\.serveftp\.com" ascii wide nocase
        $domain19 = "ampacindustries\.com" ascii wide nocase
        $domain20 = "ankara24saatacikcicekci\.com" ascii wide nocase
        $domain21 = "apikeyallervice\.business" ascii wide nocase
        $domain22 = "apikeyallervice\.com" ascii wide nocase
        $domain23 = "appsharecloud\.com" ascii wide nocase
        $domain24 = "assignmenthelptoday\.com" ascii wide nocase
        $domain25 = "asure-onlinee\.com" ascii wide nocase
        $domain26 = "aurasync2\.com" ascii wide nocase
        $domain27 = "bevestig\.in" ascii wide nocase
        $domain28 = "binden\.in" ascii wide nocase
        $domain29 = "bing-google-soft\.com" ascii wide nocase
        $domain30 = "cairoairport\.egnyte\.com" ascii wide nocase
        $domain31 = "ciscoupdate2019\.gotdns\.ch" ascii wide nocase
        $domain32 = "cloud-233f9\.firebaseapp\.com" ascii wide nocase
        $domain33 = "cloud-233f9\.web\.app" ascii wide nocase
        $domain34 = "cloud-ed980\.web\.app" ascii wide nocase
        $domain35 = "cms\.qa" ascii wide nocase
        $domain36 = "cnsmportal\.egnyte\.com" ascii wide nocase
        $domain37 = "d25btwd9wax8gu\.cloudfront\.net" ascii wide nocase
        $domain38 = "domainsoftcloud\.com" ascii wide nocase
        $domain39 = "downloadfile\.egnyte\.com" ascii wide nocase
        $domain40 = "enreji\.gov\.tr" ascii wide nocase
        $domain41 = "fbcsoft\.egnyte\.com" ascii wide nocase
        $domain42 = "fileuploadcloud\.egnyte\.com" ascii wide nocase
        $domain43 = "gcare\.egnyte\.com" ascii wide nocase
        $domain44 = "getgooogle\.hopto\.org" ascii wide nocase
        $domain45 = "ghostrider\.serveirc\.com" ascii wide nocase
        $domain46 = "gladiyator\.tk" ascii wide nocase
        $domain47 = "googl-165a0\.web\.app" ascii wide nocase
        $domain48 = "googl-6c11f\.web\.app" ascii wide nocase
        $domain49 = "google-softnet\.com" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain23 = "dbeaver-database\.app" ascii wide nocase
        $domain24 = "dbeaver-database\.cc" ascii wide nocase
        $domain25 = "dbeaver-database\.cloud" ascii wide nocase
        $domain26 = "dbeaver-database\.co" ascii wide nocase
        $domain27 = "dbeaver-database\.com" ascii wide nocase
        $domain28 = "dbeaver-database\.org" ascii wide nocase
        $domain29 = "dbeaver-database\.pro" ascii wide nocase
        $domain30 = "dbeaver-database\.tech" ascii wide nocase
        $domain31 = "dbeaver-database\.us" ascii wide nocase
        $domain32 = "dbeaver\.softwarep2p\.com" ascii wide nocase
        $domain33 = "download\.rvtools-dev\.com" ascii wide nocase
        $domain34 = "download\.rvtools-skillcamp\.com" ascii wide nocase
        $domain35 = "ec2-app\.lewoha7320\.workers\.dev" ascii wide nocase
        $domain36 = "ec2-server-noisy-band-0fe8\.focapaj280\.workers\.dev" ascii wide nocase
        $domain37 = "ec2-server\.bayaj19162\.workers\.dev" ascii wide nocase
        $domain38 = "ec2-server\.gegodec527\.workers\.dev" ascii wide nocase
        $domain39 = "ec2-server\.milago3967\.workers\.dev" ascii wide nocase
        $domain40 = "etherial\.groover\.workers\.dev" ascii wide nocase
        $domain41 = "floral-paper-8eb1\.pihara4672\.workers\.dev" ascii wide nocase
        $domain42 = "groover\.workers\.dev" ascii wide nocase
        $domain43 = "harnetsecuriity\.com" ascii wide nocase
        $domain44 = "harnetsecurity\.com" ascii wide nocase
        $domain45 = "heidisql-enterprise\.app" ascii wide nocase
        $domain46 = "heidisql-enterprise\.cc" ascii wide nocase
        $domain47 = "heidisql-enterprise\.cloud" ascii wide nocase
        $domain48 = "heidisql-enterprise\.co" ascii wide nocase
        $domain49 = "heidisql-enterprise\.com" ascii wide nocase
