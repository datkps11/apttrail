...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain2 = "00pr43\.picid1fdl6\.dynv6\.net" ascii wide nocase
        $domain3 = "01nservercc\.cfd" ascii wide nocase
        $domain4 = "01onlinen\.cfd" ascii wide nocase
        $domain5 = "022hucku25u\.dns\.navy" ascii wide nocase
        $domain6 = "02nservercc\.cfd" ascii wide nocase
        $domain7 = "02onlinen\.cfd" ascii wide nocase
        $domain8 = "03nservercc\.cfd" ascii wide nocase
        $domain9 = "03onlinen\.cfd" ascii wide nocase
        $domain10 = "04nservercc\.cfd" ascii wide nocase
        $domain11 = "04onlinen\.cfd" ascii wide nocase
        $domain12 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.onlinenhiscomservice\.store" ascii wide nocase
        $domain13 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.voranstaks\.shop" ascii wide nocase
        $domain14 = "05c0\.nkfumxgqxd\.v6\.rocks" ascii wide nocase
        $domain15 = "05nservercc\.cfd" ascii wide nocase
        $domain16 = "05onlinen\.cfd" ascii wide nocase
        $domain17 = "06nservercc\.cfd" ascii wide nocase
        $domain18 = "06onlinen\.cfd" ascii wide nocase
        $domain19 = "0751u9n4lg\.v6\.rocks" ascii wide nocase
        $domain20 = "07nservercc\.cfd" ascii wide nocase
        $domain21 = "07onlinen\.cfd" ascii wide nocase
        $domain22 = "086k3a\.93vf4b71cv\.dynv6\.net" ascii wide nocase
        $domain23 = "08nservercc\.cfd" ascii wide nocase
        $domain24 = "08onlinen\.cfd" ascii wide nocase
        $domain25 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain26 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain27 = "09nservercc\.cfd" ascii wide nocase
        $domain28 = "09onlinen\.cfd" ascii wide nocase
        $domain29 = "0a1fi7nsne\.dynv6\.net" ascii wide nocase
        $domain30 = "0c50zrvnoi\.v6\.rocks" ascii wide nocase
        $domain31 = "0g25r94p96\.v6\.army" ascii wide nocase
        $domain32 = "0grde8ebon\.dns\.army" ascii wide nocase
        $domain33 = "0jr87375qt\.v6\.navy" ascii wide nocase
        $domain34 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain35 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain36 = "0sv8\.qiz172u9i01\.dns\.army" ascii wide nocase
        $domain37 = "0t3ofn4r21\.dns\.navy" ascii wide nocase
        $domain38 = "0twjc657tu\.v6\.navy" ascii wide nocase
        $domain39 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain40 = "0x0\.care" ascii wide nocase
        $domain41 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain42 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain43 = "100000recipe\.com" ascii wide nocase
        $domain44 = "100nservercc\.cfd" ascii wide nocase
        $domain45 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain46 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain47 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain48 = "10nservercc\.cfd" ascii wide nocase
        $domain49 = "10onlinen\.cfd" ascii wide nocase
