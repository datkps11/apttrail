...
rule APT_LOTUSBLOSSOM
{
    ...
    strings:
        ...
        $domain4 = "api\.skycloudcenter\.com" ascii wide nocase
        $domain5 = "api\.wiresguard\.com" ascii wide nocase
        $domain6 = "asean-star\.com" ascii wide nocase
        $domain7 = "aseaneco\.org" ascii wide nocase
        $domain8 = "aseansec\.dynalias\.org" ascii wide nocase
        $domain9 = "babysoal\.com" ascii wide nocase
        $domain10 = "beckhammer\.xicp\.net" ascii wide nocase
        $domain11 = "boshman09\.com" ascii wide nocase
        $domain12 = "chris201\.net" ascii wide nocase
        $domain13 = "cpcl2006\.dyndns-free\.com" ascii wide nocase
        $domain14 = "cybertunnel\.dyndns\.info" ascii wide nocase
        $domain15 = "dtdf5vu\.nt7yq\.info" ascii wide nocase
        $domain16 = "harryleed\.dyndns\.org" ascii wide nocase
        $domain17 = "iascas\.net" ascii wide nocase
        $domain18 = "imonju\.com" ascii wide nocase
        $domain19 = "imonju\.net" ascii wide nocase
        $domain20 = "interhero\.net" ascii wide nocase
        $domain21 = "j\.4tc3ldw\.g9ml\.www0\.org" ascii wide nocase
        $domain22 = "jackyson\.dyndns\.info" ascii wide nocase
        $domain23 = "kid\.dyndns\.org" ascii wide nocase
        $domain24 = "kjd\.dyndns\.org" ascii wide nocase
        $domain25 = "l\.hovux\.eln9wj7\.7gpj\.org" ascii wide nocase
        $domain26 = "newinfo32\.eicp\.net" ascii wide nocase
        $domain27 = "newshappys\.dyndns-blog\.com" ascii wide nocase
        $domain28 = "petto\.mooo\.com" ascii wide nocase
        $domain29 = "phil-army\.gotdns\.org" ascii wide nocase
        $domain30 = "phil-gov\.gotdns\.org" ascii wide nocase
        $domain31 = "scristioned\.dyndns-web\.com" ascii wide nocase
        $domain32 = "seachers\.net" ascii wide nocase
        $domain33 = "serchers\.net" ascii wide nocase
        $domain34 = "shotacon\.dyndns\.info" ascii wide nocase
        $domain35 = "skycloudcenter\.com" ascii wide nocase
        $domain36 = "tgecc\.org" ascii wide nocase
        $domain37 = "tintuchoahau\.com" ascii wide nocase
        $domain38 = "ubkv1t\.ec0\.com" ascii wide nocase
        $domain39 = "usa-moon\.net" ascii wide nocase
        $domain40 = "verolalia\.dyndns\.org" ascii wide nocase
        $domain41 = "vienclp\.com" ascii wide nocase
        $domain42 = "w\.7sytdjc\.wroi\.cxy\.com" ascii wide nocase
        $domain43 = "wiresguard\.com" ascii wide nocase
        $domain44 = "wsi\.dyndns\.org" ascii wide nocase
        $domain45 = "www3\.bkav2010\.net" ascii wide nocase
        $ip46 = "124.222.137.114" ascii wide
        $ip47 = "59.110.7.32" ascii wide
        $ip48 = "59.110.7.32" ascii wide
        $ip49 = "95.179.213.0" ascii wide
        $ip50 = "95.179.213.0" ascii wide
...
rule APT_SKYCLOAK
{
    ...
    strings:
        ...
        $domain3 = "yuknkap4im65njr3tlprnpqwj4h7aal4hrn2tdieg75rpp6fx25hqbyd\.onion" ascii wide nocase
