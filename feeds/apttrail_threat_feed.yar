...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain20 = "49rjaf1fgrlzl1t82dpxmiqmyeedl4kku5y3hjvanjleyhpo3pjmbn23q0\.pages\.dev" ascii wide nocase
        $domain21 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain22 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain23 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain24 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain25 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain26 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain27 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain28 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain29 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain30 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain31 = "a\.videotalks\.site" ascii wide nocase
        $domain32 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain33 = "abc\.meeting-central\.online" ascii wide nocase
        $domain34 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain35 = "abc\.preconnection\.online" ascii wide nocase
        $domain36 = "abc\.roomconnect\.online" ascii wide nocase
        $domain37 = "abilityscan360\.com" ascii wide nocase
        ...
        $domain41 = "acoustickoala\.com" ascii wide nocase
        $domain42 = "acroadovw\.com" ascii wide nocase
        $domain43 = "activity-179384736\.site" ascii wide nocase
        $domain44 = "activity-permission\.online" ascii wide nocase
        $domain45 = "additional\.work\.gd" ascii wide nocase
...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain23 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain24 = "2let\.org" ascii wide nocase
        $domain25 = "2r\.nrtcpk-net\.com" ascii wide nocase
        $domain26 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain27 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain28 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain29 = "435fdgfd-fgh675gh56jh-65jhg65ghjytu65\.netlify\.app" ascii wide nocase
        $domain30 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain31 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain32 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain33 = "63inc\.com" ascii wide nocase
        $domain34 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain35 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain36 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain37 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain38 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain39 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain40 = "81-cn\.ddns\.net" ascii wide nocase
        $domain41 = "81-cn\.info" ascii wide nocase
        $domain42 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain43 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain44 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain45 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain46 = "9af72fg4jg75hg8jg94kg94k9fk390gk4170674tr69bf1f766cdec1d11\.pages\.dev" ascii wide nocase
        $domain47 = "a\.bc\.1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain48 = "a\.bc\.1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain49 = "a\.bc\.1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
