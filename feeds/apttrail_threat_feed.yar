...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain36 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain37 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain38 = "12nservercc\.cfd" ascii wide nocase
        $domain39 = "12onlinen\.cfd" ascii wide nocase
        $domain40 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain41 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain42 = "13nservercc\.cfd" ascii wide nocase
        $domain43 = "13onlinen\.cfd" ascii wide nocase
        $domain44 = "13udm\.v6\.navy" ascii wide nocase
        $domain45 = "149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain46 = "149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain47 = "14nservercc\.cfd" ascii wide nocase
        $domain48 = "14onlinen\.cfd" ascii wide nocase
        $domain49 = "152\.32\.139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
...
rule APT_KUN3
{
    ...
    strings:
        ...
        $domain5 = "addguard\.cn" ascii wide nocase
        $domain6 = "af-whatsapp\.com" ascii wide nocase
        $domain7 = "anzhihui\.net" ascii wide nocase
        $domain8 = "api\.hami888\.com" ascii wide nocase
        $domain9 = "app\.zyxhlh\.com" ascii wide nocase
        $domain10 = "apps-aisi\.com" ascii wide nocase
        $domain11 = "apps-helloworld\.com" ascii wide nocase
        $domain12 = "apps-huorong\.com" ascii wide nocase
        $domain13 = "apps-i4\.com" ascii wide nocase
        $domain14 = "apps-kakaocorp\.com" ascii wide nocase
        $domain15 = "apps-kakaotalk\.com" ascii wide nocase
        $domain16 = "apps-kuaiiian\.com" ascii wide nocase
        $domain17 = "apps-oray\.com" ascii wide nocase
        $domain18 = "apps-sougoupinyin\.com" ascii wide nocase
        $domain19 = "apps-tencent\.com" ascii wide nocase
        $domain20 = "apps-v2rayn\.com" ascii wide nocase
        $domain21 = "apps-winrar\.com" ascii wide nocase
        $domain22 = "apps-wps\.com" ascii wide nocase
        $domain23 = "apps-xiangrikui\.com" ascii wide nocase
        $domain24 = "appx-wps\.com" ascii wide nocase
        $domain25 = "aps-wps\.com" ascii wide nocase
        $domain26 = "awq-line\.com" ascii wide nocase
        $domain27 = "backlinkmate\.com" ascii wide nocase
        $domain28 = "baobeimiao\.com" ascii wide nocase
        $domain29 = "bbbbbd\.cn" ascii wide nocase
        $domain30 = "beijingjiawenkeji\.com" ascii wide nocase
        $domain31 = "beijingzhongmingsheng\.com" ascii wide nocase
        $domain32 = "biz-wps\.com" ascii wide nocase
        $domain33 = "bjjfyyfk\.com" ascii wide nocase
        $domain34 = "blackfale\.xyz" ascii wide nocase
        $domain35 = "bwsc668\.com" ascii wide nocase
        $domain36 = "cashotc\.com" ascii wide nocase
        $domain37 = "chachazaimai\.com" ascii wide nocase
        $domain38 = "chromiumx-360\.cn" ascii wide nocase
        $domain39 = "clash55\.com" ascii wide nocase
        $domain40 = "clash99\.com" ascii wide nocase
        $domain41 = "clashdown\.link" ascii wide nocase
        $domain42 = "clashdown\.today" ascii wide nocase
        $domain43 = "css-line\.com" ascii wide nocase
        $domain44 = "cym-line\.com" ascii wide nocase
        $domain45 = "cz\.czsiss\.icu" ascii wide nocase
        $domain46 = "czsiss\.icu" ascii wide nocase
        $domain47 = "d1-myvip-mirrors\.avadev\.cn" ascii wide nocase
        $domain48 = "dingze\.com\.cn" ascii wide nocase
        $domain49 = "dkalca11\.asia" ascii wide nocase
