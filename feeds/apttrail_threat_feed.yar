...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain9 = "ad\.scgawj\.com" ascii wide nocase
        $domain10 = "admin\.netbill\.pk" ascii wide nocase
        $domain11 = "adobe-cdn\.org" ascii wide nocase
        $domain12 = "aejava\.ddns\.net" ascii wide nocase
        $domain13 = "aejva\.ddns\.net" ascii wide nocase
        $domain14 = "afdentry\.workstation\.eu\.org" ascii wide nocase
        $domain15 = "afsder\.com" ascii wide nocase
        $domain16 = "agegamepay\.com" ascii wide nocase
        $domain17 = "ageofwuxia\.com" ascii wide nocase
        $domain18 = "ageofwuxia\.info" ascii wide nocase
        $domain19 = "ageofwuxia\.net" ascii wide nocase
        $domain20 = "ageofwuxia\.org" ascii wide nocase
        $domain21 = "akacur\.tk" ascii wide nocase
        $domain22 = "akamaixed\.net" ascii wide nocase
        $domain23 = "alibaba\.zzux\.com" ascii wide nocase
        $domain24 = "aliyun\.com\.co" ascii wide nocase
        $domain25 = "alpha-els\.com" ascii wide nocase
        $domain26 = "alxc\.tbtianyan\.com" ascii wide nocase
        $domain27 = "amazonlivenews\.com" ascii wide nocase
        $domain28 = "andropwn\.xyz" ascii wide nocase
        $domain29 = "aone\.ddns\.net" ascii wide nocase
        $domain30 = "ap\.philancourts\.com" ascii wide nocase
        $domain31 = "api\.emazemedia\.com" ascii wide nocase
        $domain32 = "api\.googleauthenticatoronline\.com" ascii wide nocase
        $domain33 = "api\.sourcedata\.kuwannba\.com" ascii wide nocase
        $domain34 = "app\.kaspersky-scan\.com" ascii wide nocase
        $domain35 = "app\.microsoftstaticapi\.com" ascii wide nocase
        $domain36 = "app30\.hema129\.com" ascii wide nocase
        $domain37 = "app40\.hema129\.com" ascii wide nocase
        $domain38 = "arestc\.net" ascii wide nocase
        $domain39 = "asdasw21\.icu" ascii wide nocase
        $domain40 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain41 = "assistcustody\.xyz" ascii wide nocase
        $domain42 = "astudycarsceu\.net" ascii wide nocase
        $domain43 = "asushotfix\.com" ascii wide nocase
        $domain44 = "atomiclampco\.com" ascii wide nocase
        $domain45 = "auth\.microsoftsservice\.com" ascii wide nocase
        $domain46 = "az\.performed12\.com" ascii wide nocase
        $domain47 = "back\.rooter\.tk" ascii wide nocase
        $domain48 = "backdoor\.apt\.photo" ascii wide nocase
        $domain49 = "bganmcza\.top" ascii wide nocase
