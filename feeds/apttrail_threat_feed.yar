...
rule APT_SANDWORM
{
    ...
    strings:
        ...
        $domain14 = "apidocs\.ataas\.cl" ascii wide nocase
        $domain15 = "aplusdesktop\.workers\.dev" ascii wide nocase
        $domain16 = "aplusmodgovua\.workers\.dev" ascii wide nocase
        $domain17 = "armylpus\.workers\.dev" ascii wide nocase
        $domain18 = "armyplus-desktop\.workers\.dev" ascii wide nocase
        $domain19 = "aut0mat\.info" ascii wide nocase
        $domain20 = "beta-0-110\.armyplus-desktop\.workers\.dev" ascii wide nocase
        $domain21 = "beta-0-2237\.desktopapluscom\.workers\.dev" ascii wide nocase
        $domain22 = "bka\.im" ascii wide nocase
        $domain23 = "cazino-game\.com" ascii wide nocase
        $domain24 = "cdnauthsoft\.com" ascii wide nocase
        $domain25 = "checksystem\.nl" ascii wide nocase
        $domain26 = "claud\.in" ascii wide nocase
        $domain27 = "cloud-sync\.org" ascii wide nocase
        $domain28 = "cloue\.link" ascii wide nocase
        $domain29 = "cxim\.asia" ascii wide nocase
        $domain30 = "darkett\.ddns\.net" ascii wide nocase
        $domain31 = "darksea\.ddns\.net" ascii wide nocase
        $domain32 = "ddumasz\.info" ascii wide nocase
        $domain33 = "deltaexchange\.net" ascii wide nocase
        $domain34 = "desktopaplus\.workers\.dev" ascii wide nocase
        $domain35 = "desktopapluscom\.workers\.dev" ascii wide nocase
        $domain36 = "documentreader\.net" ascii wide nocase
        $domain37 = "documents-reader\.com" ascii wide nocase
        $domain38 = "dontgivedamn\.com" ascii wide nocase
        $domain39 = "dontgivefuck\.com" ascii wide nocase
        $domain40 = "drive\.google\.com\.filepreview\.auth\.userarea\.click" ascii wide nocase
        $domain41 = "dvjbn4sg4p1ck\.cloudfront\.net" ascii wide nocase
        $domain42 = "esetpremium\.com" ascii wide nocase
        $domain43 = "ett\.ddns\.net" ascii wide nocase
        $domain44 = "ett\.hopto\.org" ascii wide nocase
        $domain45 = "fbapp\.info" ascii wide nocase
        $domain46 = "fbapp\.link" ascii wide nocase
        $domain47 = "fbapp\.top" ascii wide nocase
        $domain48 = "filepreview\.auth\.userarea\.click" ascii wide nocase
        $domain49 = "gieannualconferenceinmunich\.com" ascii wide nocase
