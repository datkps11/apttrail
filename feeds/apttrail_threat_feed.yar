...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain24 = "arenareport\.report" ascii wide nocase
        $domain25 = "assignmenthelptoday\.com" ascii wide nocase
        $domain26 = "asure-onlinee\.com" ascii wide nocase
        $domain27 = "aurasync2\.com" ascii wide nocase
        $domain28 = "bevestig\.in" ascii wide nocase
        $domain29 = "binden\.in" ascii wide nocase
        $domain30 = "bing-google-soft\.com" ascii wide nocase
        $domain31 = "blazingketo\.com" ascii wide nocase
        $domain32 = "cairoairport\.egnyte\.com" ascii wide nocase
        $domain33 = "ciscoupdate2019\.gotdns\.ch" ascii wide nocase
        $domain34 = "cloud-233f9\.firebaseapp\.com" ascii wide nocase
        $domain35 = "cloud-233f9\.web\.app" ascii wide nocase
        $domain36 = "cloud-ed980\.web\.app" ascii wide nocase
        $domain37 = "cms\.qa" ascii wide nocase
        $domain38 = "cnsmportal\.egnyte\.com" ascii wide nocase
        $domain39 = "d25btwd9wax8gu\.cloudfront\.net" ascii wide nocase
        $domain40 = "domainsoftcloud\.com" ascii wide nocase
        $domain41 = "downloadfile\.egnyte\.com" ascii wide nocase
        $domain42 = "enreji\.gov\.tr" ascii wide nocase
        $domain43 = "fbcsoft\.egnyte\.com" ascii wide nocase
        $domain44 = "fileuploadcloud\.egnyte\.com" ascii wide nocase
        $domain45 = "gcare\.egnyte\.com" ascii wide nocase
        $domain46 = "getgooogle\.hopto\.org" ascii wide nocase
        $domain47 = "ghostrider\.serveirc\.com" ascii wide nocase
        $domain48 = "gladiyator\.tk" ascii wide nocase
        $domain49 = "googl-165a0\.web\.app" ascii wide nocase
