...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain27 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain28 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain29 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain30 = "0x0\.care" ascii wide nocase
        $domain31 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain32 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain33 = "100000recipe\.com" ascii wide nocase
        $domain34 = "100nservercc\.cfd" ascii wide nocase
        $domain35 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain36 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain37 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain38 = "10nservercc\.cfd" ascii wide nocase
        $domain39 = "10onlinen\.cfd" ascii wide nocase
        $domain40 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain41 = "11nservercc\.cfd" ascii wide nocase
        $domain42 = "11onlinen\.cfd" ascii wide nocase
        $domain43 = "12-ko-official\.com" ascii wide nocase
        $domain44 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain45 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain46 = "12e9w4hp1f\.v6\.army" ascii wide nocase
        $domain47 = "12nservercc\.cfd" ascii wide nocase
        $domain48 = "12onlinen\.cfd" ascii wide nocase
        $domain49 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain2 = "1yeralti\.com" ascii wide nocase
        $domain3 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain4 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain5 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain6 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain7 = "3p\.workbenche\.com" ascii wide nocase
        $domain8 = "45perhour\.org" ascii wide nocase
        $domain9 = "7stories\.sbs" ascii wide nocase
        $domain10 = "91movs\.com" ascii wide nocase
        $domain11 = "9xstream\.live" ascii wide nocase
        $domain12 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain13 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain14 = "abstractest-hydroski\.site" ascii wide nocase
        $domain15 = "academytradeai\.com" ascii wide nocase
        $domain16 = "acquasicuras\.com" ascii wide nocase
        $domain17 = "actbluecs\.com" ascii wide nocase
        $domain18 = "actblues\.net" ascii wide nocase
        $domain19 = "adionetjrei\.shop" ascii wide nocase
        $domain20 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain21 = "adrilex\.digital" ascii wide nocase
        $domain22 = "aexnp\.com" ascii wide nocase
        $domain23 = "afeherbopenuk\.com" ascii wide nocase
        $domain24 = "agronomywork\.info" ascii wide nocase
        $domain25 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain26 = "aialgocamp\.com" ascii wide nocase
        $domain27 = "aialgocore\.com" ascii wide nocase
        $domain28 = "aialgodrive\.com" ascii wide nocase
        $domain29 = "aialgoflow\.com" ascii wide nocase
        $domain30 = "aialgofusion\.com" ascii wide nocase
        $domain31 = "aialgohash\.com" ascii wide nocase
        $domain32 = "aialgorithmforge\.com" ascii wide nocase
        $domain33 = "aialgorithmicforge\.com" ascii wide nocase
        $domain34 = "aialgorithmicpath\.com" ascii wide nocase
        $domain35 = "aialgosense\.com" ascii wide nocase
        $domain36 = "aialgosphere\.com" ascii wide nocase
        $domain37 = "aianalyticengine\.com" ascii wide nocase
        $domain38 = "aianalyticmesh\.com" ascii wide nocase
        $domain39 = "aiautomationframework\.com" ascii wide nocase
        $domain40 = "aiautonomycore\.com" ascii wide nocase
        $domain41 = "aibigdatamap\.com" ascii wide nocase
        $domain42 = "aibotscale\.com" ascii wide nocase
        $domain43 = "aibrainatelier\.com" ascii wide nocase
        $domain44 = "aibrainframe\.com" ascii wide nocase
        $domain45 = "aibrainlogicc\.com" ascii wide nocase
        $domain46 = "aibrainmatrixed\.com" ascii wide nocase
        $domain47 = "aibrainyard\.com" ascii wide nocase
        $domain48 = "aibuildersguild\.com" ascii wide nocase
        $domain49 = "aibuildnet\.com" ascii wide nocase
