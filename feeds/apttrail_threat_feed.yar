...
rule APT_CHARMINGKITTEN
{
    ...
    strings:
        ...
        $domain42 = "accounts-apple\.com" ascii wide nocase
        $domain43 = "accounts-drive\.com" ascii wide nocase
        $domain44 = "accounts-googelmail\.com" ascii wide nocase
        $domain45 = "accounts-googelmails\.com" ascii wide nocase
        $domain46 = "accounts-logins\.net" ascii wide nocase
        $domain47 = "accounts-mails\.com" ascii wide nocase
        $domain48 = "accounts-manager\.info" ascii wide nocase
        $domain49 = "accounts-service\.support" ascii wide nocase
...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain25 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain26 = "100000recipe\.com" ascii wide nocase
        $domain27 = "100nservercc\.cfd" ascii wide nocase
        $domain28 = "10nservercc\.cfd" ascii wide nocase
        $domain29 = "10onlinen\.cfd" ascii wide nocase
        $domain30 = "11nservercc\.cfd" ascii wide nocase
        $domain31 = "11onlinen\.cfd" ascii wide nocase
        $domain32 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain33 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain34 = "12nservercc\.cfd" ascii wide nocase
        $domain35 = "12onlinen\.cfd" ascii wide nocase
        $domain36 = "13nservercc\.cfd" ascii wide nocase
        $domain37 = "13onlinen\.cfd" ascii wide nocase
        $domain38 = "14nservercc\.cfd" ascii wide nocase
        $domain39 = "14onlinen\.cfd" ascii wide nocase
        $domain40 = "15dhyfituhivoivjjgijrtjtgg\.cfd" ascii wide nocase
        $domain41 = "15fuerouhrgiurtituigjtug\.cfd" ascii wide nocase
        $domain42 = "15hjdgvfdjbvunghghod\.cfd" ascii wide nocase
        $domain43 = "15jhguerhguyogjopgoff\.cfd" ascii wide nocase
        $domain44 = "15nservercc\.cfd" ascii wide nocase
        $domain45 = "15onlinen\.cfd" ascii wide nocase
        $domain46 = "15ygfyerfgyufhsdgfyegf\.cfd" ascii wide nocase
        $domain47 = "15yufibeuiohuireiogjrgji\.cfd" ascii wide nocase
        $domain48 = "1636\.site" ascii wide nocase
        $domain49 = "1661-0241-call\.site" ascii wide nocase
...
rule APT_PATCHWORK
{
    ...
    strings:
        ...
        $domain12 = "adskochbus\.org" ascii wide nocase
        $domain13 = "alfred\.ignorelist\.com" ascii wide nocase
        $domain14 = "alieanmote\.live" ascii wide nocase
        $domain15 = "altered\.twilightparadox\.com" ascii wide nocase
        $domain16 = "amelaits\.info" ascii wide nocase
        $domain17 = "anabel\.rootranger\.info" ascii wide nocase
        $domain18 = "anchorsoft\.org" ascii wide nocase
        $domain19 = "android-helper\.info" ascii wide nocase
        $domain20 = "anglerrscovey\.com" ascii wide nocase
        $domain21 = "annchenn\.com" ascii wide nocase
        $domain22 = "aonepiece\.org" ascii wide nocase
        $domain23 = "apcas\.bhutanembassynepal\.com" ascii wide nocase
        $domain24 = "api\.inboundhealthcare\.us" ascii wide nocase
        $domain25 = "api\.opensecurity-legacy\.com" ascii wide nocase
        $domain26 = "applepicker\.info" ascii wide nocase
        $domain27 = "appplace\.life" ascii wide nocase
        $domain28 = "apps-house\.com" ascii wide nocase
        $domain29 = "aquilei\.live" ascii wide nocase
        $domain30 = "aquileia\.live" ascii wide nocase
        $domain31 = "arabcomputersupportgroup\.com" ascii wide nocase
        $domain32 = "arkiverat\.info" ascii wide nocase
        $domain33 = "arpawebdom\.org" ascii wide nocase
        $domain34 = "asftbngh\.top" ascii wide nocase
        $domain35 = "asiandefnetwork\.com" ascii wide nocase
        $domain36 = "atus\.toproid\.xyz" ascii wide nocase
        $domain37 = "aurorafoss\.xyz" ascii wide nocase
        $domain38 = "auth\.fyicompsol\.xyz" ascii wide nocase
        $domain39 = "avangrid\.info" ascii wide nocase
        $domain40 = "avtofrom\.us" ascii wide nocase
        $domain41 = "b3autybab3s\.com" ascii wide nocase
        $domain42 = "baidunetdisk\.info" ascii wide nocase
        $domain43 = "bayanat\.co\.nf" ascii wide nocase
        $domain44 = "beautifullimages\.co\.nf" ascii wide nocase
        $domain45 = "beijingtv\.org" ascii wide nocase
        $domain46 = "bhutanembassynepal\.com" ascii wide nocase
        $domain47 = "biaonton\.insightglobel\.info" ascii wide nocase
        $domain48 = "bilibil\.info" ascii wide nocase
        $domain49 = "bin\.opensecurity-legacy\.com" ascii wide nocase
