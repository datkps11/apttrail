...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "app\.pofelal314\.workers\.dev" ascii wide nocase
        $domain2 = "bapiyat727\.workers\.dev" ascii wide nocase
        $domain3 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain4 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain5 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain6 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain7 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain8 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain9 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain10 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain11 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain12 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain13 = "ec2-app\.lewoha7320\.workers\.dev" ascii wide nocase
        $domain14 = "ec2-server-noisy-band-0fe8\.focapaj280\.workers\.dev" ascii wide nocase
        $domain15 = "ec2-server\.bayaj19162\.workers\.dev" ascii wide nocase
        $domain16 = "ec2-server\.gegodec527\.workers\.dev" ascii wide nocase
        $domain17 = "ec2-server\.milago3967\.workers\.dev" ascii wide nocase
        $domain18 = "floral-paper-8eb1\.pihara4672\.workers\.dev" ascii wide nocase
        $domain19 = "keystore-explorer\.com" ascii wide nocase
        $domain20 = "mstore\.framfarmers\.co\.uk" ascii wide nocase
        $domain21 = "pofelal314\.workers\.dev" ascii wide nocase
        $domain22 = "server-cd2\.bipewi2747\.workers\.dev" ascii wide nocase
        $domain23 = "server-cdn\.jawigaw383\.workers\.dev" ascii wide nocase
        $domain24 = "server-cdn\.lafise2419\.workers\.dev" ascii wide nocase
        $domain25 = "server-cdn\.lecoc56350\.workers\.dev" ascii wide nocase
        $domain26 = "server-cdn\.sidoke9822\.workers\.dev" ascii wide nocase
        $domain27 = "server-cdn\.virej10913\.workers\.dev" ascii wide nocase
        $domain28 = "server-cdn\.xohahey822\.workers\.dev" ascii wide nocase
        $domain29 = "server-web-cdn\.detocim498\.workers\.dev" ascii wide nocase
        $domain30 = "server-web-cdn\.dones86497\.workers\.dev" ascii wide nocase
        $domain31 = "server-web-cdn\.kagoli5215\.workers\.dev" ascii wide nocase
        $domain32 = "server-web-cdn\.mevame4224\.workers\.dev" ascii wide nocase
        $domain33 = "server-web-cdn\.nefixeg373\.workers\.dev" ascii wide nocase
        $domain34 = "server-web-cdn\.pixece7948\.workers\.dev" ascii wide nocase
        $domain35 = "server-web-cdn\.ravebo3233\.workers\.dev" ascii wide nocase
        $domain36 = "server-web-cdn\.rojotoc516\.workers\.dev" ascii wide nocase
        $domain37 = "server-web-cdn\.vosax32455\.workers\.dev" ascii wide nocase
        $domain38 = "server-web-cdn\.yevobod379\.workers\.dev" ascii wide nocase
        $domain39 = "server-web-cdn1\.gekod80409\.workers\.dev" ascii wide nocase
        $domain40 = "server-web\.sasex59966\.workers\.dev" ascii wide nocase
        $domain41 = "soft-base-01\.ginigiy117\.workers\.dev" ascii wide nocase
        $domain42 = "soft-dns\.sejilod748\.workers\.dev" ascii wide nocase
        $domain43 = "ssl\.bapiyat727\.workers\.dev" ascii wide nocase
        $domain44 = "web-app\.dasik14289\.workers\.dev" ascii wide nocase
        $domain45 = "web-app\.larij21770\.workers\.dev" ascii wide nocase
        $domain46 = "work-server-1\.picalob750\.workers\.dev" ascii wide nocase
