...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain37 = "aaloochaat\.com" ascii wide nocase
        $domain38 = "aboutcase\.nl" ascii wide nocase
        $domain39 = "ac\.76767\.icu" ascii wide nocase
        $domain40 = "accinfo\.live" ascii wide nocase
        $domain41 = "account-recovery\.com" ascii wide nocase
        $domain42 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain43 = "accountmail\.in" ascii wide nocase
        $domain44 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
        $domain45 = "accounts\.mgovcloud\.de" ascii wide nocase
        $domain46 = "accounts\.mgovcloud\.in\.cloudshare\.digital" ascii wide nocase
        $domain47 = "accounts\.mgovcloud\.in\.departmentofdefence\.live" ascii wide nocase
        $domain48 = "accounts\.mgovcloud\.in\.indiagov\.support" ascii wide nocase
        $domain49 = "accounts\.mgovcloud\.in\.storagecloud\.download" ascii wide nocase
