...
rule APT_BITTER
{
    ...
    strings:
        ...
        $domain31 = "autodefragapp\.com" ascii wide nocase
        $domain32 = "bakuackermannfashions\.com" ascii wide nocase
        $domain33 = "balkanclan\.com" ascii wide nocase
        $domain34 = "bartelemarks\.com" ascii wide nocase
        $domain35 = "benclickstudio\.com" ascii wide nocase
        $domain36 = "bensnewfashionstyles\.com" ascii wide nocase
        $domain37 = "bheragreens\.com" ascii wide nocase
        $domain38 = "bickrickneoservice\.com" ascii wide nocase
        $domain39 = "biocons\.pk" ascii wide nocase
        $domain40 = "blth32serv\.net" ascii wide nocase
        $domain41 = "blucollinsoutien\.com" ascii wide nocase
        $domain42 = "bluelotus\.mail-gdrive\.com" ascii wide nocase
        $domain43 = "bootcampquest\.com" ascii wide nocase
        ...
        $ip53 = "134.255.210.127" ascii wide
        $ip54 = "135.125.242.211" ascii wide
        $ip55 = "141.94.68.169" ascii wide
        $ip56 = "147.124.223.140" ascii wide
        $ip57 = "151.236.14.173" ascii wide
        $ip58 = "151.236.21.48" ascii wide
        $ip59 = "151.236.9.75" ascii wide
        $ip60 = "151.236.9.75" ascii wide
        $ip61 = "158.255.215.45" ascii wide
        $ip62 = "162.0.216.229" ascii wide
        $ip63 = "162.0.216.229" ascii wide
        $ip64 = "162.252.172.67" ascii wide
        $ip65 = "162.252.175.131" ascii wide
        $ip66 = "162.252.175.131" ascii wide
        $ip67 = "167.88.15.93" ascii wide
        $ip68 = "185.106.123.198" ascii wide
        $ip69 = "185.117.72.87" ascii wide
        $ip70 = "185.117.73.195" ascii wide
        $ip71 = "185.117.73.209" ascii wide
        $ip72 = "185.141.25.244" ascii wide
        $ip73 = "185.193.48.135" ascii wide
        $ip74 = "185.193.50.233" ascii wide
        $ip75 = "185.237.166.24" ascii wide
        $ip76 = "185.76.79.30" ascii wide
        $ip77 = "192.71.213.128" ascii wide
        $ip78 = "192.71.249.194" ascii wide
        $ip79 = "193.142.58.38" ascii wide
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain32 = "rvtoo1s\.com" ascii wide nocase
        $domain33 = "rvtoolaca\.com" ascii wide nocase
        $domain34 = "rvtoolaca\.online" ascii wide nocase
        $domain35 = "rvtoolacs\.com" ascii wide nocase
