...
rule APT_PATCHWORK
{
    ...
    strings:
        ...
        $domain42 = "b3autybab3s\.com" ascii wide nocase
        $domain43 = "baidunetdisk\.info" ascii wide nocase
        $domain44 = "bayanat\.co\.nf" ascii wide nocase
        $domain45 = "beautifullimages\.co\.nf" ascii wide nocase
        $domain46 = "beijingtv\.org" ascii wide nocase
        $domain47 = "bhutanembassynepal\.com" ascii wide nocase
        $domain48 = "biaonton\.insightglobel\.info" ascii wide nocase
        $domain49 = "bilibil\.info" ascii wide nocase
