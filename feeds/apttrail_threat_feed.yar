...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain2 = "163qiye\.top" ascii wide nocase
        $domain3 = "1driv\.org" ascii wide nocase
        $domain4 = "1drv\.email" ascii wide nocase
        $domain5 = "1drvmail\.work" ascii wide nocase
        $domain6 = "256ventures\.us" ascii wide nocase
        $domain7 = "31ventures\.info" ascii wide nocase
        $domain8 = "a\.mylkc\.cloudns\.ch" ascii wide nocase
        $domain9 = "abf-cap\.co" ascii wide nocase
        $domain10 = "abf-cap\.com" ascii wide nocase
        $domain11 = "abiesvc\.com" ascii wide nocase
        $domain12 = "abiesvc\.info" ascii wide nocase
        $domain13 = "abiesvc\.jp\.net" ascii wide nocase
        $domain14 = "adiclas-nft\.quest" ascii wide nocase
        $domain15 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain16 = "aidpartners\.org" ascii wide nocase
        $domain17 = "ajayplamingo\.com" ascii wide nocase
        $domain18 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain19 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain20 = "altair-vc\.co\.uk" ascii wide nocase
        $domain21 = "altair-vc\.com" ascii wide nocase
        $domain22 = "altair\.linkpc\.net" ascii wide nocase
        $domain23 = "amazonaws1\.info" ascii wide nocase
        $domain24 = "amzonnews\.club" ascii wide nocase
        $domain25 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain26 = "angelbridge\.capital" ascii wide nocase
        $domain27 = "angelbridge\.jp" ascii wide nocase
        $domain28 = "ankanimatoka\.com" ascii wide nocase
        $domain29 = "anobaka\.info" ascii wide nocase
        $domain30 = "anobaka\.jp" ascii wide nocase
        $domain31 = "antcapital\.us" ascii wide nocase
        $domain32 = "api\.betterfun\.space" ascii wide nocase
        $domain33 = "api\.clearit\.sbs" ascii wide nocase
        $domain34 = "api\.flashstore\.sbs" ascii wide nocase
        $domain35 = "api\.zerodev\.pro" ascii wide nocase
        $domain36 = "api\.zoom-sdk\.com" ascii wide nocase
        $domain37 = "apizoom\.myfanshu\.com" ascii wide nocase
        $domain38 = "app-wechat\.xyz" ascii wide nocase
        $domain39 = "app\.baiduweb\.pro" ascii wide nocase
        $domain40 = "app\.developcore\.org" ascii wide nocase
        $domain41 = "app\.republicrypto\.vc" ascii wide nocase
        $domain42 = "app\.thorwsap\.finance" ascii wide nocase
        $domain43 = "appleaccess\.pro" ascii wide nocase
        $domain44 = "appleupdate\.datauploader\.site" ascii wide nocase
        $domain45 = "arbordeck\.co\.in" ascii wide nocase
        $domain46 = "arborventures\.capital" ascii wide nocase
        $domain47 = "arkinvst\.com" ascii wide nocase
        $domain48 = "armzon\.onmypc\.org" ascii wide nocase
        $domain49 = "association\.linkpc\.net" ascii wide nocase
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain15 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain16 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain17 = "360scanner\.store" ascii wide nocase
        $domain18 = "360share\.pro" ascii wide nocase
        $domain19 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain20 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain21 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain22 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain23 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain24 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain25 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain26 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain27 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain28 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain29 = "a\.videotalks\.site" ascii wide nocase
        $domain30 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain31 = "abc\.meeting-central\.online" ascii wide nocase
        $domain32 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain33 = "abc\.preconnection\.online" ascii wide nocase
        $domain34 = "abc\.roomconnect\.online" ascii wide nocase
        $domain35 = "abilityscan360\.com" ascii wide nocase
        $domain36 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain37 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain38 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain39 = "acoustickoala\.com" ascii wide nocase
        $domain40 = "acroadovw\.com" ascii wide nocase
        $domain41 = "activity-179384736\.site" ascii wide nocase
        $domain42 = "activity-permission\.online" ascii wide nocase
        $domain43 = "additional\.work\.gd" ascii wide nocase
        $domain44 = "additionalpublic\.work\.gd" ascii wide nocase
        $domain45 = "addrcheck\.corecheckmailsrv\.com" ascii wide nocase
        $domain46 = "ade\.dropfile\.online" ascii wide nocase
        $domain47 = "admin-8jy8o7jbg\.vercel\.sh" ascii wide nocase
        $domain48 = "admin\.alwayswelcome\.online" ascii wide nocase
        $domain49 = "admin\.chrome-browser\.cloud" ascii wide nocase
        ...
        $ip60 = "104.168.151.34" ascii wide
        $ip61 = "104.168.157.45" ascii wide
        $ip62 = "104.168.157.45" ascii wide
        $ip63 = "104.168.165.165" ascii wide
        $ip64 = "104.168.165.165" ascii wide
        $ip65 = "104.168.165.173" ascii wide
        $ip66 = "104.168.165.173" ascii wide
        $ip67 = "104.168.165.203" ascii wide
        $ip68 = "104.168.165.203" ascii wide
        $ip69 = "104.168.172.20" ascii wide
        $ip70 = "104.168.203.159" ascii wide
        $ip71 = "104.168.203.159" ascii wide
        $ip72 = "104.192.42.117" ascii wide
        $ip73 = "104.194.133.88" ascii wide
        $ip74 = "104.194.133.88" ascii wide
        $ip75 = "104.217.163.61" ascii wide
        $ip76 = "104.232.71.7" ascii wide
        $ip77 = "107.172.197.175" ascii wide
        $ip78 = "107.175.172.129" ascii wide
        $ip79 = "107.189.16.122" ascii wide
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain2 = "01k\.cc" ascii wide nocase
        $domain3 = "022\.furzocpc\.cc" ascii wide nocase
        $domain4 = "0221f016\.6hv86gxz\.com" ascii wide nocase
        $domain5 = "025f\.cjmekxr\.xyz" ascii wide nocase
        $domain6 = "0278\.fxexebji\.org" ascii wide nocase
        $domain7 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain8 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain9 = "047\.auyciwmw\.com" ascii wide nocase
        $domain10 = "063\.heppmpuz\.org" ascii wide nocase
        $domain11 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain12 = "07f61\.ncjqeyid\.com" ascii wide nocase
        $domain13 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain14 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain15 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain16 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain17 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain18 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain19 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain20 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain21 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain22 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain23 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain24 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain25 = "12cc\.thqirrxu\.com" ascii wide nocase
        $domain26 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain27 = "158\.ozhignq\.com" ascii wide nocase
        $domain28 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain29 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain30 = "168\.yktajeyp\.com" ascii wide nocase
        $domain31 = "17cx1\.com" ascii wide nocase
        $domain32 = "17cx11\.com" ascii wide nocase
        $domain33 = "17cx2\.com" ascii wide nocase
        $domain34 = "17cx3\.com" ascii wide nocase
        $domain35 = "17cx4\.com" ascii wide nocase
        $domain36 = "17cx5\.com" ascii wide nocase
        $domain37 = "17cx7\.com" ascii wide nocase
        $domain38 = "17cx8\.com" ascii wide nocase
        $domain39 = "17cx9\.com" ascii wide nocase
        $domain40 = "17cxa\.com" ascii wide nocase
        $domain41 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain42 = "17lu\.life" ascii wide nocase
        $domain43 = "17lulu\.club" ascii wide nocase
        $domain44 = "17lulu\.live" ascii wide nocase
        $domain45 = "17lulu\.ltd" ascii wide nocase
        $domain46 = "17lulu\.online" ascii wide nocase
        $domain47 = "17lulu\.site" ascii wide nocase
        $domain48 = "17lulu\.store" ascii wide nocase
        $domain49 = "17lutv\.life" ascii wide nocase
