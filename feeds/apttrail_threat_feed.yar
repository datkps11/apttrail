...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain24 = "0x0\.care" ascii wide nocase
        $domain25 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain26 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain27 = "100000recipe\.com" ascii wide nocase
        $domain28 = "100nservercc\.cfd" ascii wide nocase
        $domain29 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain30 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain31 = "10nservercc\.cfd" ascii wide nocase
        $domain32 = "10onlinen\.cfd" ascii wide nocase
        $domain33 = "11nservercc\.cfd" ascii wide nocase
        $domain34 = "11onlinen\.cfd" ascii wide nocase
        $domain35 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain36 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain37 = "12nservercc\.cfd" ascii wide nocase
        $domain38 = "12onlinen\.cfd" ascii wide nocase
        $domain39 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain40 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain41 = "13nservercc\.cfd" ascii wide nocase
        $domain42 = "13onlinen\.cfd" ascii wide nocase
        $domain43 = "13udm\.v6\.navy" ascii wide nocase
        $domain44 = "149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain45 = "149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain46 = "14nservercc\.cfd" ascii wide nocase
        $domain47 = "14onlinen\.cfd" ascii wide nocase
        $domain48 = "152\.32\.139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain49 = "152\.32\.139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
...
rule APT_KUN3
{
    ...
    strings:
        ...
        $domain1 = "7s\.pc-kakaocorp\.com" ascii wide nocase
        $domain2 = "8-210-67-136\.cprapid\.com" ascii wide nocase
        $domain3 = "af-whatsapp\.com" ascii wide nocase
        $domain4 = "anzhihui\.net" ascii wide nocase
        $domain5 = "api\.hami888\.com" ascii wide nocase
        $domain6 = "app\.zyxhlh\.com" ascii wide nocase
        $domain7 = "apps-aisi\.com" ascii wide nocase
        $domain8 = "apps-helloworld\.com" ascii wide nocase
        $domain9 = "apps-huorong\.com" ascii wide nocase
        $domain10 = "apps-i4\.com" ascii wide nocase
        $domain11 = "apps-kakaocorp\.com" ascii wide nocase
        $domain12 = "apps-kakaotalk\.com" ascii wide nocase
        $domain13 = "apps-kuaiiian\.com" ascii wide nocase
        $domain14 = "apps-oray\.com" ascii wide nocase
        $domain15 = "apps-sougoupinyin\.com" ascii wide nocase
        $domain16 = "apps-tencent\.com" ascii wide nocase
        $domain17 = "apps-v2rayn\.com" ascii wide nocase
        $domain18 = "apps-winrar\.com" ascii wide nocase
        $domain19 = "apps-wps\.com" ascii wide nocase
        $domain20 = "apps-xiangrikui\.com" ascii wide nocase
        $domain21 = "appx-wps\.com" ascii wide nocase
        $domain22 = "aps-wps\.com" ascii wide nocase
        $domain23 = "awq-line\.com" ascii wide nocase
        $domain24 = "backlinkmate\.com" ascii wide nocase
        $domain25 = "baobeimiao\.com" ascii wide nocase
        $domain26 = "bbbbbd\.cn" ascii wide nocase
        $domain27 = "beijingjiawenkeji\.com" ascii wide nocase
        $domain28 = "beijingzhongmingsheng\.com" ascii wide nocase
        $domain29 = "biz-wps\.com" ascii wide nocase
        $domain30 = "bjjfyyfk\.com" ascii wide nocase
        $domain31 = "blackfale\.xyz" ascii wide nocase
        $domain32 = "bwsc668\.com" ascii wide nocase
        $domain33 = "cashotc\.com" ascii wide nocase
        $domain34 = "chachazaimai\.com" ascii wide nocase
        $domain35 = "clash55\.com" ascii wide nocase
        $domain36 = "clash99\.com" ascii wide nocase
        $domain37 = "clashdown\.link" ascii wide nocase
        $domain38 = "clashdown\.today" ascii wide nocase
        $domain39 = "css-line\.com" ascii wide nocase
        $domain40 = "cym-line\.com" ascii wide nocase
        $domain41 = "cz\.czsiss\.icu" ascii wide nocase
        $domain42 = "czsiss\.icu" ascii wide nocase
        $domain43 = "d1-myvip-mirrors\.avadev\.cn" ascii wide nocase
        $domain44 = "dingze\.com\.cn" ascii wide nocase
        $domain45 = "dkalca11\.asia" ascii wide nocase
        $domain46 = "down\.letsvpnc\.com" ascii wide nocase
        $domain47 = "download\.i96l6\.top" ascii wide nocase
        $domain48 = "drggn\.net" ascii wide nocase
        $domain49 = "dtm2\.com" ascii wide nocase
