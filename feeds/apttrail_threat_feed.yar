...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain2 = "1s\.rvtoolsai\.com" ascii wide nocase
        $domain3 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain4 = "1v\.rvtootsad\.com" ascii wide nocase
        $domain5 = "1yeralti\.com" ascii wide nocase
        $domain6 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain7 = "20\.rvtoolse\.info" ascii wide nocase
        $domain8 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain9 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain10 = "24\.rvtoolis\.info" ascii wide nocase
        $domain11 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain12 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain13 = "2b\.rvtoolsit\.com" ascii wide nocase
        $domain14 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain15 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain16 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain17 = "3p\.workbenche\.com" ascii wide nocase
        $domain18 = "40\.workbencse\.com" ascii wide nocase
        $domain19 = "45perhour\.org" ascii wide nocase
        $domain20 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain21 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain22 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain23 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain24 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain25 = "7stories\.sbs" ascii wide nocase
        $domain26 = "91movs\.com" ascii wide nocase
        $domain27 = "9xstream\.live" ascii wide nocase
        $domain28 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain29 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain30 = "abstractest-hydroski\.site" ascii wide nocase
        $domain31 = "academytradeai\.com" ascii wide nocase
        $domain32 = "acquasicuras\.com" ascii wide nocase
        $domain33 = "actbluecs\.com" ascii wide nocase
        $domain34 = "actblues\.net" ascii wide nocase
        $domain35 = "adionetjrei\.shop" ascii wide nocase
