...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain34 = "adiclas-nft\.quest" ascii wide nocase
        $domain35 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain36 = "aidpartners\.org" ascii wide nocase
        $domain37 = "ajayplamingo\.com" ascii wide nocase
        $domain38 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain39 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain40 = "altair-vc\.co\.uk" ascii wide nocase
        $domain41 = "altair-vc\.com" ascii wide nocase
        $domain42 = "altair\.linkpc\.net" ascii wide nocase
        $domain43 = "amazonaws1\.info" ascii wide nocase
        $domain44 = "amzonnews\.club" ascii wide nocase
        $domain45 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain46 = "angelbridge\.capital" ascii wide nocase
        $domain47 = "angelbridge\.jp" ascii wide nocase
        $domain48 = "ankanimatoka\.com" ascii wide nocase
        $domain49 = "annaelsa\.xyz" ascii wide nocase
...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain5 = "02nservercc\.cfd" ascii wide nocase
        $domain6 = "02onlinen\.cfd" ascii wide nocase
        $domain7 = "03nservercc\.cfd" ascii wide nocase
        $domain8 = "03onlinen\.cfd" ascii wide nocase
        $domain9 = "04nservercc\.cfd" ascii wide nocase
        $domain10 = "04onlinen\.cfd" ascii wide nocase
        $domain11 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.onlinenhiscomservice\.store" ascii wide nocase
        $domain12 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.voranstaks\.shop" ascii wide nocase
        $domain13 = "05c0\.nkfumxgqxd\.v6\.rocks" ascii wide nocase
        $domain14 = "05nservercc\.cfd" ascii wide nocase
        $domain15 = "05onlinen\.cfd" ascii wide nocase
        $domain16 = "06nservercc\.cfd" ascii wide nocase
        $domain17 = "06onlinen\.cfd" ascii wide nocase
        $domain18 = "0751u9n4lg\.v6\.rocks" ascii wide nocase
        $domain19 = "07nservercc\.cfd" ascii wide nocase
        $domain20 = "07onlinen\.cfd" ascii wide nocase
        $domain21 = "086k3a\.93vf4b71cv\.dynv6\.net" ascii wide nocase
        $domain22 = "08nservercc\.cfd" ascii wide nocase
        $domain23 = "08onlinen\.cfd" ascii wide nocase
        $domain24 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain25 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain26 = "09nservercc\.cfd" ascii wide nocase
        $domain27 = "09onlinen\.cfd" ascii wide nocase
        $domain28 = "0a1fi7nsne\.dynv6\.net" ascii wide nocase
        $domain29 = "0c50zrvnoi\.v6\.rocks" ascii wide nocase
        $domain30 = "0g25r94p96\.v6\.army" ascii wide nocase
        $domain31 = "0grde8ebon\.dns\.army" ascii wide nocase
        $domain32 = "0jr87375qt\.v6\.navy" ascii wide nocase
        $domain33 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain34 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain35 = "0sv8\.qiz172u9i01\.dns\.army" ascii wide nocase
        $domain36 = "0t3ofn4r21\.dns\.navy" ascii wide nocase
        $domain37 = "0twjc657tu\.v6\.navy" ascii wide nocase
        $domain38 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain39 = "0x0\.care" ascii wide nocase
        $domain40 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain41 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain42 = "100000recipe\.com" ascii wide nocase
        $domain43 = "100nservercc\.cfd" ascii wide nocase
        $domain44 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain45 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain46 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain47 = "10nservercc\.cfd" ascii wide nocase
        $domain48 = "10onlinen\.cfd" ascii wide nocase
        $domain49 = "112-216-240-98\.softether\.net" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain2 = "1r\.rvtoolsed\.com" ascii wide nocase
        $domain3 = "1s\.rvtoolsai\.com" ascii wide nocase
        $domain4 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain5 = "1v\.rvtootsad\.com" ascii wide nocase
        $domain6 = "1yeralti\.com" ascii wide nocase
        $domain7 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain8 = "20\.rvtoolse\.info" ascii wide nocase
        $domain9 = "20\.rvtoolsme\.com" ascii wide nocase
        $domain10 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain11 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain12 = "24\.rvtoolis\.info" ascii wide nocase
        $domain13 = "24\.rvtoolsgo\.com" ascii wide nocase
        $domain14 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain15 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain16 = "2b\.rvtoolsit\.com" ascii wide nocase
        $domain17 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain18 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain19 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain20 = "3p\.workbenche\.com" ascii wide nocase
        $domain21 = "40\.workbencse\.com" ascii wide nocase
        $domain22 = "45perhour\.org" ascii wide nocase
        $domain23 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain24 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain25 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain26 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain27 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain28 = "5n\.rvtoolsrun\.com" ascii wide nocase
        $domain29 = "7stories\.sbs" ascii wide nocase
        $domain30 = "91movs\.com" ascii wide nocase
        $domain31 = "9xstream\.live" ascii wide nocase
        $domain32 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain33 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain34 = "abstractest-hydroski\.site" ascii wide nocase
        $domain35 = "academytradeai\.com" ascii wide nocase
        $domain36 = "acquasicuras\.com" ascii wide nocase
        $domain37 = "actbluecs\.com" ascii wide nocase
        $domain38 = "actblues\.net" ascii wide nocase
        $domain39 = "adionetjrei\.shop" ascii wide nocase
        $domain40 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain41 = "adrilex\.digital" ascii wide nocase
        $domain42 = "aexnp\.com" ascii wide nocase
        $domain43 = "afd-esign\.info" ascii wide nocase
        $domain44 = "afeherbopenuk\.com" ascii wide nocase
        $domain45 = "agora-mesmo\.com" ascii wide nocase
        $domain46 = "agronomywork\.info" ascii wide nocase
        $domain47 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain48 = "aialgocamp\.com" ascii wide nocase
        $domain49 = "aialgocore\.com" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        $domain0 = "00da\.6hv86gxz\.com" ascii wide nocase
        $domain1 = "0159\.axmatx\.com" ascii wide nocase
        $domain2 = "01b26ddfd3\.top" ascii wide nocase
        $domain3 = "01k\.cc" ascii wide nocase
        $domain4 = "022\.furzocpc\.cc" ascii wide nocase
        $domain5 = "0221f016\.6hv86gxz\.com" ascii wide nocase
        $domain6 = "025f\.cjmekxr\.xyz" ascii wide nocase
        $domain7 = "0278\.fxexebji\.org" ascii wide nocase
        $domain8 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain9 = "03f6aef6fd\.top" ascii wide nocase
        $domain10 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain11 = "047\.auyciwmw\.com" ascii wide nocase
        $domain12 = "063\.heppmpuz\.org" ascii wide nocase
        $domain13 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain14 = "07f61\.ncjqeyid\.com" ascii wide nocase
        $domain15 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain16 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain17 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain18 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain19 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain20 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain21 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain22 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain23 = "0fx7qmdggegytul\.xyz" ascii wide nocase
        $domain24 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain25 = "0jijrwbzxzzxz04\.xyz" ascii wide nocase
        $domain26 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain27 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain28 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain29 = "12cc\.thqirrxu\.com" ascii wide nocase
        $domain30 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain31 = "158\.ozhignq\.com" ascii wide nocase
        $domain32 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain33 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain34 = "168\.yktajeyp\.com" ascii wide nocase
        $domain35 = "17cx1\.com" ascii wide nocase
        $domain36 = "17cx11\.com" ascii wide nocase
        $domain37 = "17cx2\.com" ascii wide nocase
        $domain38 = "17cx3\.com" ascii wide nocase
        $domain39 = "17cx4\.com" ascii wide nocase
        $domain40 = "17cx5\.com" ascii wide nocase
        $domain41 = "17cx7\.com" ascii wide nocase
        $domain42 = "17cx8\.com" ascii wide nocase
        $domain43 = "17cx9\.com" ascii wide nocase
        $domain44 = "17cxa\.com" ascii wide nocase
        $domain45 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain46 = "17lu\.life" ascii wide nocase
        $domain47 = "17lulu\.club" ascii wide nocase
        $domain48 = "17lulu\.live" ascii wide nocase
        $domain49 = "17lulu\.ltd" ascii wide nocase
