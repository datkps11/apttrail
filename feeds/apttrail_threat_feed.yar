...
rule APT_SIDEWINDER
{
    ...
    strings:
        ...
        $domain7 = "126-com\.live" ascii wide nocase
        $domain8 = "126mail-cn\.com" ascii wide nocase
        $domain9 = "163inc\.org" ascii wide nocase
        $domain10 = "168-gov\.info" ascii wide nocase
        $domain11 = "16bz5\.pmreco\.xyz" ascii wide nocase
        $domain12 = "17067699af72f31706fgjkf5kg9j4990gk950\.netlify\.app" ascii wide nocase
        $domain13 = "1846m\.pmreco\.xyz" ascii wide nocase
        $domain14 = "1c1157fa\.caa\.update\.customs-lk\.org" ascii wide nocase
        $domain15 = "1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain16 = "1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain17 = "1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain18 = "203-124351878443\.hopto\.org" ascii wide nocase
        $domain19 = "24170-40494\.bacloud\.info" ascii wide nocase
        $domain20 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain21 = "2let\.org" ascii wide nocase
        $domain22 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain23 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain24 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain25 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain26 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain27 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain28 = "63inc\.com" ascii wide nocase
        $domain29 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain30 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain31 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain32 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain33 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain34 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain35 = "81-cn\.ddns\.net" ascii wide nocase
        $domain36 = "81-cn\.info" ascii wide nocase
        $domain37 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain38 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain39 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain40 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain41 = "a\.bc\.1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain42 = "a\.bc\.1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain43 = "a\.bc\.1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain44 = "a\.bc\.64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain45 = "a\.fetchdrive\.info" ascii wide nocase
        $domain46 = "a5936441-e402-41e3-b02b-75af112074b5\.org-co\.net" ascii wide nocase
        $domain47 = "a6dff163-e0b9-49c9-87e4-357f761f3c3b\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain48 = "aa173\.bank-ok\.com" ascii wide nocase
        $domain49 = "aapletv\.org" ascii wide nocase
