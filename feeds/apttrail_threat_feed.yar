...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain24 = "appsharecloud\.com" ascii wide nocase
        $domain25 = "arenareport\.report" ascii wide nocase
        $domain26 = "assignmenthelptoday\.com" ascii wide nocase
        $domain27 = "asure-onlinee\.com" ascii wide nocase
        $domain28 = "aurasync2\.com" ascii wide nocase
        $domain29 = "bevestig\.in" ascii wide nocase
        $domain30 = "binden\.in" ascii wide nocase
