...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain20 = "4caddie\.com" ascii wide nocase
        ...
        $domain29 = "8cap\.inashtech\.com" ascii wide nocase
        $domain30 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain31 = "a\.videotalks\.site" ascii wide nocase
        $domain32 = "aa2akhtech\.in" ascii wide nocase
        $domain33 = "aarnaitsolution\.in" ascii wide nocase
        $domain34 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain35 = "abc\.meeting-central\.online" ascii wide nocase
        $domain36 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain37 = "abc\.preconnection\.online" ascii wide nocase
        $domain38 = "abc\.roomconnect\.online" ascii wide nocase
        $domain39 = "abilityscan360\.com" ascii wide nocase
        $domain40 = "abiyz\.com" ascii wide nocase
        $domain41 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain42 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain43 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain44 = "acom\.capital" ascii wide nocase
