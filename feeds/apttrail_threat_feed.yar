...
rule APT_BITTER
{
    ...
    strings:
        ...
        $domain22 = "apifilestore\.net" ascii wide nocase
        $domain23 = "app\.chabaka\.com" ascii wide nocase
        $domain24 = "app2\.appvlc\.com" ascii wide nocase
        $domain25 = "appbriar\.com" ascii wide nocase
        $domain26 = "appprotonvpn\.com" ascii wide nocase
        $domain27 = "appsupdate\.net" ascii wide nocase
        $domain28 = "archiverst\.com" ascii wide nocase
        $domain29 = "aroundtheworld123\.net" ascii wide nocase
        $domain30 = "autodefragapp\.com" ascii wide nocase
        $domain31 = "bakuackermannfashions\.com" ascii wide nocase
        $domain32 = "balkanclan\.com" ascii wide nocase
        $domain33 = "bartelemarks\.com" ascii wide nocase
        $domain34 = "benclickstudio\.com" ascii wide nocase
        $domain35 = "bensnewfashionstyles\.com" ascii wide nocase
        $domain36 = "bheragreens\.com" ascii wide nocase
        $domain37 = "bickrickneoservice\.com" ascii wide nocase
        $domain38 = "biocons\.pk" ascii wide nocase
