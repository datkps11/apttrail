...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain16 = "45perhour\.org" ascii wide nocase
        $domain17 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain18 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain19 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain20 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain21 = "7stories\.sbs" ascii wide nocase
        $domain22 = "91movs\.com" ascii wide nocase
        $domain23 = "9xstream\.live" ascii wide nocase
        $domain24 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain25 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain26 = "abstractest-hydroski\.site" ascii wide nocase
        $domain27 = "academytradeai\.com" ascii wide nocase
        $domain28 = "acquasicuras\.com" ascii wide nocase
        $domain29 = "actbluecs\.com" ascii wide nocase
        $domain30 = "actblues\.net" ascii wide nocase
        $domain31 = "adionetjrei\.shop" ascii wide nocase
        $domain32 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain33 = "adrilex\.digital" ascii wide nocase
        $domain34 = "aexnp\.com" ascii wide nocase
        $domain35 = "afeherbopenuk\.com" ascii wide nocase
        $domain36 = "agora-mesmo\.com" ascii wide nocase
        $domain37 = "agronomywork\.info" ascii wide nocase
        $domain38 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain39 = "aialgocamp\.com" ascii wide nocase
        $domain40 = "aialgocore\.com" ascii wide nocase
        $domain41 = "aialgodrive\.com" ascii wide nocase
        $domain42 = "aialgoflow\.com" ascii wide nocase
        $domain43 = "aialgofusion\.com" ascii wide nocase
        $domain44 = "aialgohash\.com" ascii wide nocase
        $domain45 = "aialgorithmforge\.com" ascii wide nocase
        $domain46 = "aialgorithmicforge\.com" ascii wide nocase
        $domain47 = "aialgorithmicpath\.com" ascii wide nocase
        $domain48 = "aialgosense\.com" ascii wide nocase
        $domain49 = "aialgosphere\.com" ascii wide nocase
