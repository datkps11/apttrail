...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain29 = "rv-tools\.eu" ascii wide nocase
        $domain30 = "rvtoo1s\.com" ascii wide nocase
        $domain31 = "rvtoolaca\.online" ascii wide nocase
        $domain32 = "rvtoolas\.com" ascii wide nocase
        $domain33 = "rvtooles\.com" ascii wide nocase
        $domain34 = "rvtoolis\.com" ascii wide nocase
        $domain35 = "rvtoolit\.com" ascii wide nocase
        $domain36 = "rvtoolsac\.com" ascii wide nocase
        $domain37 = "rvtoolsacad\.com" ascii wide nocase
        $domain38 = "rvtoolsacs\.com" ascii wide nocase
        $domain39 = "rvtoolsax\.com" ascii wide nocase
        $domain40 = "rvtoolsed\.com" ascii wide nocase
        $domain41 = "rvtoolshq\.com" ascii wide nocase
        $domain42 = "rvtoolsio\.com" ascii wide nocase
        $domain43 = "rvtoolsl\.com" ascii wide nocase
        $domain44 = "rvtoolsnow\.com" ascii wide nocase
        $domain45 = "rvtoolsnt\.com" ascii wide nocase
        $domain46 = "rvtoolso\.com" ascii wide nocase
        $domain47 = "rvtoolspro\.com" ascii wide nocase
        $domain48 = "rvtoolspro\.info" ascii wide nocase
        $domain49 = "rvtoolspro\.online" ascii wide nocase
