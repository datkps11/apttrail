...
rule APT_MUDDYWATER
{
    ...
    strings:
        $domain0 = "0359761\.xyz" ascii wide nocase
        $domain1 = "0419726\.xyz" ascii wide nocase
        $domain2 = "0518429\.xyz" ascii wide nocase
        $domain3 = "0682149\.xyz" ascii wide nocase
        $domain4 = "0746925\.xyz" ascii wide nocase
        $domain5 = "0946158\.xyz" ascii wide nocase
        $domain6 = "0947682\.xyz" ascii wide nocase
        $domain7 = "0973642\.xyz" ascii wide nocase
        $domain8 = "0973648\.xyz" ascii wide nocase
        $domain9 = "108901\.xyz" ascii wide nocase
        $domain10 = "115437\.xyz" ascii wide nocase
        $domain11 = "118652\.xyz" ascii wide nocase
        $domain12 = "119012\.xyz" ascii wide nocase
        $domain13 = "120974\.xyz" ascii wide nocase
        $domain14 = "126841\.xyz" ascii wide nocase
        $domain15 = "1274672\.xyz" ascii wide nocase
        $domain16 = "1279578\.xyz" ascii wide nocase
        $domain17 = "132690\.xyz" ascii wide nocase
        $domain18 = "1327589\.xyz" ascii wide nocase
        $domain19 = "1368497\.xyz" ascii wide nocase
        $domain20 = "143456\.xyz" ascii wide nocase
        $domain21 = "1459738\.xyz" ascii wide nocase
        $domain22 = "1485390\.xyz" ascii wide nocase
        $domain23 = "1549038\.xyz" ascii wide nocase
        $domain24 = "158739\.xyz" ascii wide nocase
        $domain25 = "158901\.xyz" ascii wide nocase
        $domain26 = "159352\.xyz" ascii wide nocase
        $domain27 = "1597382\.xyz" ascii wide nocase
        $domain28 = "159740\.xyz" ascii wide nocase
        $domain29 = "166504\.xyz" ascii wide nocase
        $domain30 = "168901\.xyz" ascii wide nocase
        $domain31 = "169327\.xyz" ascii wide nocase
        $domain32 = "172946\.xyz" ascii wide nocase
        $domain33 = "173456\.xyz" ascii wide nocase
        $domain34 = "174567\.xyz" ascii wide nocase
        $domain35 = "1748906\.xyz" ascii wide nocase
        $domain36 = "175130\.xyz" ascii wide nocase
        $domain37 = "175493\.xyz" ascii wide nocase
        $domain38 = "175678\.xyz" ascii wide nocase
        $domain39 = "1759248\.xyz" ascii wide nocase
        $domain40 = "178026\.xyz" ascii wide nocase
        $domain41 = "180746\.xyz" ascii wide nocase
        $domain42 = "182936\.xyz" ascii wide nocase
        $domain43 = "18372046\.xyz" ascii wide nocase
        $domain44 = "1837294\.xyz" ascii wide nocase
        $domain45 = "185240\.xyz" ascii wide nocase
        $domain46 = "1894627\.xyz" ascii wide nocase
        $domain47 = "19360482\.xyz" ascii wide nocase
        $domain48 = "19372048\.xyz" ascii wide nocase
        $domain49 = "1946308\.xyz" ascii wide nocase
