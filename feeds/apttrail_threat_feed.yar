...
rule APT_37
{
    ...
    strings:
        ...
        $domain2 = "1980food\.co\.kr" ascii wide nocase
        $domain3 = "1995ieudneu\.atwebpages\.com" ascii wide nocase
        $domain4 = "acddesigns\.com\.au" ascii wide nocase
        $domain5 = "acl-medias\.fr" ascii wide nocase
        $domain6 = "acount-pro\.club" ascii wide nocase
        $domain7 = "acount-pro\.live" ascii wide nocase
        $domain8 = "adamnews\.for\.ug" ascii wide nocase
        $domain9 = "admin\.mobonad\.com" ascii wide nocase
        $domain10 = "admin\.primgs\.lol" ascii wide nocase
        $domain11 = "ahnlab\.check\.pe\.hu" ascii wide nocase
        $domain12 = "ahooc\.com" ascii wide nocase
        $domain13 = "alireza\.traderfree\.online" ascii wide nocase
        $domain14 = "anlysis-info\.xyz" ascii wide nocase
        $domain15 = "annstyle\.ru" ascii wide nocase
        $domain16 = "api\.jquery\.services" ascii wide nocase
        $domain17 = "app-wallet\.com" ascii wide nocase
        $domain18 = "app\.cleanos\.online" ascii wide nocase
        $domain19 = "asia-studies\.net" ascii wide nocase
        $domain20 = "attachdown\.000webhostapp\.com" ascii wide nocase
        $domain21 = "attachdownload\.000webhostapp\.com" ascii wide nocase
        $domain22 = "attachdownload\.99on\.com" ascii wide nocase
        $domain23 = "atusay\.lat" ascii wide nocase
        $domain24 = "bajut\.pro" ascii wide nocase
        $domain25 = "bellissues\.live" ascii wide nocase
        $domain26 = "benefitinfo\.live" ascii wide nocase
        $domain27 = "benefitinfo\.pro" ascii wide nocase
        $domain28 = "benefiturl\.pro" ascii wide nocase
        $domain29 = "bian0151\.cafe24\.com" ascii wide nocase
        $domain30 = "bigfilemail\.net" ascii wide nocase
        $domain31 = "bignaver\.com" ascii wide nocase
        $domain32 = "bigwnet\.com" ascii wide nocase
        $domain33 = "bitwoll\.com" ascii wide nocase
        $domain34 = "blockochain\.info" ascii wide nocase
        $domain35 = "btcaes2\.duckdns\.org" ascii wide nocase
        $domain36 = "busyday\.atwebpages\.com" ascii wide nocase
        $domain37 = "buttyfly\.000webhostapp\.com" ascii wide nocase
        $domain38 = "careagency\.online" ascii wide nocase
        $domain39 = "carnegieinsider\.com" ascii wide nocase
        $domain40 = "cdns\.jquery\.services" ascii wide nocase
        $domain41 = "cerebrovascular\.net" ascii wide nocase
        $domain42 = "cexrout\.com" ascii wide nocase
        $domain43 = "change-pw\.com" ascii wide nocase
        $domain44 = "checkprofie\.com" ascii wide nocase
        $domain45 = "cheth\.lol" ascii wide nocase
        $domain46 = "christinadudley\.com" ascii wide nocase
        $domain47 = "cleanos\.online" ascii wide nocase
        $domain48 = "clonesec\.us" ascii wide nocase
        $domain49 = "cloudnaver\.com" ascii wide nocase
        $ip50 = "144.172.106.66" ascii wide
        $ip51 = "208.85.16.88" ascii wide
...
rule APT_BADMAGIC
{
    ...
    strings:
        ...
        $domain6 = "ivanovee\.ru" ascii wide nocase
        $domain7 = "kassperskylaw\.ru" ascii wide nocase
        $domain8 = "kb6ns\.ru" ascii wide nocase
        $domain9 = "licensecheckout\.net" ascii wide nocase
        $domain10 = "mail\.01yakutsk\.ru" ascii wide nocase
        $domain11 = "mail\.russexportlogistics\.ru" ascii wide nocase
        $domain12 = "passportyandex\.net" ascii wide nocase
        $domain13 = "russexportlogistics\.ru" ascii wide nocase
        $domain14 = "savebrowsing\.net" ascii wide nocase
        $domain15 = "securitysearch\.ddns\.net" ascii wide nocase
        $domain16 = "servicehost-update\.net" ascii wide nocase
        $domain17 = "softdownloaderonline\.net" ascii wide nocase
        $domain18 = "statusgeotrust\.com" ascii wide nocase
        $domain19 = "tapiservicemgr\.com" ascii wide nocase
        $domain20 = "uploaderonline\.com" ascii wide nocase
        $domain21 = "uploadingonline\.com" ascii wide nocase
        $domain22 = "versusmain\.com" ascii wide nocase
        $domain23 = "webservice-srv\.online" ascii wide nocase
        $domain24 = "webservice-srv1\.online" ascii wide nocase
        $domain25 = "winupdateronline\.com" ascii wide nocase
        $domain26 = "winuptodate\.com" ascii wide nocase
        $ip27 = "185.166.217.184" ascii wide
        $ip28 = "5.35.100.31" ascii wide
...
rule APT_BAHAMUT
{
    ...
    strings:
        ...
        $domain31 = "dev-demo\.click" ascii wide nocase
        $domain32 = "devicesupport-rnicrosoft\.com" ascii wide nocase
        $domain33 = "docreader\.icu" ascii wide nocase
        $domain34 = "doctor-reader\.icu" ascii wide nocase
        $domain35 = "domforworld\.com" ascii wide nocase
        $domain36 = "dservices\.space" ascii wide nocase
        $domain37 = "dsharedservices\.xyz" ascii wide nocase
        $domain38 = "electrobric\.com" ascii wide nocase
        $domain39 = "everification-session-load\.com" ascii wide nocase
        $domain40 = "fastfiterzone\.com" ascii wide nocase
        $domain41 = "fjasfjfas89e\.gkcx6ye4t4zafw8ju2xdr5na5\.de" ascii wide nocase
        $domain42 = "flux2key\.com" ascii wide nocase
        $domain43 = "freepunjab2020\.info" ascii wide nocase
        $domain44 = "freesexvideos\.ch" ascii wide nocase
        $domain45 = "frexinq\.com" ascii wide nocase
        $domain46 = "ft8hua063okwfdcu21pw\.de" ascii wide nocase
        $domain47 = "fvbyavgyea\.com" ascii wide nocase
        $domain48 = "gateway-yahoo\.com" ascii wide nocase
        $domain49 = "ghelp\.co" ascii wide nocase
...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain5 = "64\.176\.35\.214\.sslip\.io" ascii wide nocase
        $domain6 = "64\.176\.65\.49\.sslip\.io" ascii wide nocase
        $domain7 = "6ed123bf7c014f8597b97c1e88c9d7e1\.ddns\.gcloud\.gg" ascii wide nocase
        $domain8 = "7f4d5b4d9b3b4474a46824c3ae43d06a\.ddns\.gcloud\.gg" ascii wide nocase
        $domain9 = "91newai\.com" ascii wide nocase
        $domain10 = "a\.linuxupdate\.info" ascii wide nocase
        $domain11 = "accounts\.longmusic\.com" ascii wide nocase
        $domain12 = "ad\.scgawj\.com" ascii wide nocase
        $domain13 = "admin\.netbill\.pk" ascii wide nocase
        $domain14 = "adobe-cdn\.org" ascii wide nocase
        $domain15 = "aejava\.ddns\.net" ascii wide nocase
        $domain16 = "aejva\.ddns\.net" ascii wide nocase
        $domain17 = "afdentry\.workstation\.eu\.org" ascii wide nocase
        $domain18 = "afsder\.com" ascii wide nocase
        $domain19 = "agegamepay\.com" ascii wide nocase
        $domain20 = "ageofwuxia\.com" ascii wide nocase
        $domain21 = "ageofwuxia\.info" ascii wide nocase
        $domain22 = "ageofwuxia\.net" ascii wide nocase
        $domain23 = "ageofwuxia\.org" ascii wide nocase
        $domain24 = "akacur\.tk" ascii wide nocase
        $domain25 = "akamaixed\.net" ascii wide nocase
        $domain26 = "alibaba\.zzux\.com" ascii wide nocase
        $domain27 = "aliyun\.com\.co" ascii wide nocase
        $domain28 = "alpha-els\.com" ascii wide nocase
        $domain29 = "alxc\.tbtianyan\.com" ascii wide nocase
        $domain30 = "amazonlivenews\.com" ascii wide nocase
        $domain31 = "ampolice\.org" ascii wide nocase
        $domain32 = "andropwn\.xyz" ascii wide nocase
        $domain33 = "aone\.ddns\.net" ascii wide nocase
        $domain34 = "ap\.philancourts\.com" ascii wide nocase
        $domain35 = "api-v2\.cloud" ascii wide nocase
        $domain36 = "api\.emazemedia\.com" ascii wide nocase
        $domain37 = "api\.googleauthenticatoronline\.com" ascii wide nocase
        $domain38 = "api\.sourcedata\.kuwannba\.com" ascii wide nocase
        $domain39 = "app\.kaspersky-scan\.com" ascii wide nocase
        $domain40 = "app\.microsoftstaticapi\.com" ascii wide nocase
        $domain41 = "app30\.hema129\.com" ascii wide nocase
        $domain42 = "app40\.hema129\.com" ascii wide nocase
        $domain43 = "arestc\.net" ascii wide nocase
        $domain44 = "asdasw21\.icu" ascii wide nocase
        $domain45 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain46 = "assistcustody\.xyz" ascii wide nocase
        $domain47 = "astudycarsceu\.net" ascii wide nocase
        $domain48 = "asushotfix\.com" ascii wide nocase
        $domain49 = "atomiclampco\.com" ascii wide nocase
        $ip50 = "1.12.224.214" ascii wide
        $ip51 = "1.92.101.250" ascii wide
        $ip52 = "1.92.101.250" ascii wide
        $ip53 = "1.92.101.250" ascii wide
        $ip54 = "1.92.101.250" ascii wide
        $ip55 = "1.92.101.250" ascii wide
        $ip56 = "1.92.101.250" ascii wide
        $ip57 = "1.92.101.250" ascii wide
        $ip58 = "1.92.101.250" ascii wide
        $ip59 = "1.92.107.96" ascii wide
        $ip60 = "1.92.107.96" ascii wide
        $ip61 = "1.92.107.96" ascii wide
        $ip62 = "1.92.107.96" ascii wide
        $ip63 = "1.92.107.96" ascii wide
        $ip64 = "1.92.107.96" ascii wide
        $ip65 = "1.92.107.96" ascii wide
        $ip66 = "1.92.107.96" ascii wide
        $ip67 = "1.92.148.235" ascii wide
        $ip68 = "1.92.148.235" ascii wide
        $ip69 = "1.92.148.235" ascii wide
        $ip70 = "1.92.148.235" ascii wide
        $ip71 = "1.92.148.235" ascii wide
        $ip72 = "1.92.148.235" ascii wide
        $ip73 = "1.92.148.235" ascii wide
        $ip74 = "1.92.148.235" ascii wide
        $ip75 = "1.92.72.199" ascii wide
        $ip76 = "1.92.72.199" ascii wide
        $ip77 = "1.92.72.199" ascii wide
        $ip78 = "1.92.72.199" ascii wide
        $ip79 = "1.92.72.199" ascii wide
...
rule APT_BITTER
{
    ...
    strings:
        ...
        $domain1 = "365cloudz\.esanojinjasvc\.com" ascii wide nocase
        $domain2 = "55five\.lol" ascii wide nocase
        $domain3 = "888toto\.com" ascii wide nocase
        $domain4 = "8toto\.co" ascii wide nocase
        $domain5 = "918slot\.top" ascii wide nocase
        $domain6 = "99media\.com\.pk" ascii wide nocase
        $domain7 = "99togel\.org" ascii wide nocase
        $domain8 = "99toto\.shop" ascii wide nocase
        $domain9 = "a\.churchill91\.com" ascii wide nocase
        $domain10 = "aadresourcing\.com" ascii wide nocase
        $domain11 = "abelewebconnect\.com" ascii wide nocase
        $domain12 = "activemobistore\.ddns\.net" ascii wide nocase
        $domain13 = "adamsresearchshare\.com" ascii wide nocase
        $domain14 = "aday\.primeservices\.mobi" ascii wide nocase
        $domain15 = "aduhoki88\.com" ascii wide nocase
        $domain16 = "affinitycapitalgp\.com" ascii wide nocase
        $domain17 = "affinitycapitalgr\.com" ascii wide nocase
        $domain18 = "alfiehealtcareservice\.com" ascii wide nocase
        $domain19 = "alfiehealthcareservice\.com" ascii wide nocase
        $domain20 = "alkhaleejpk\.info" ascii wide nocase
        $domain21 = "alvesbarcelona\.com" ascii wide nocase
        $domain22 = "andbouncersclub\.com" ascii wide nocase
        $domain23 = "andrewswebstorage\.com" ascii wide nocase
        $domain24 = "apifilestore\.net" ascii wide nocase
        $domain25 = "app\.chabaka\.com" ascii wide nocase
        $domain26 = "app2\.appvlc\.com" ascii wide nocase
        $domain27 = "appbriar\.com" ascii wide nocase
        $domain28 = "appprotonvpn\.com" ascii wide nocase
        $domain29 = "appsupdate\.net" ascii wide nocase
        $domain30 = "archiverst\.com" ascii wide nocase
        $domain31 = "aroundtheworld123\.net" ascii wide nocase
        $domain32 = "ashersoftlib\.com" ascii wide nocase
        $domain33 = "autodefragapp\.com" ascii wide nocase
        $domain34 = "bakuackermannfashions\.com" ascii wide nocase
        $domain35 = "balkanclan\.com" ascii wide nocase
        $domain36 = "bartelemarks\.com" ascii wide nocase
        $domain37 = "benclickstudio\.com" ascii wide nocase
        $domain38 = "bensnewfashionstyles\.com" ascii wide nocase
        $domain39 = "bheragreens\.com" ascii wide nocase
        $domain40 = "bickrickneoservice\.com" ascii wide nocase
        $domain41 = "biocons\.pk" ascii wide nocase
        $domain42 = "blth32serv\.net" ascii wide nocase
        $domain43 = "blucollinsoutien\.com" ascii wide nocase
        $domain44 = "bluelotus\.mail-gdrive\.com" ascii wide nocase
        $domain45 = "bootcampquest\.com" ascii wide nocase
        $domain46 = "botanoolifeapp\.net" ascii wide nocase
        $domain47 = "box\.livevideosonlinepk\.com" ascii wide nocase
        $domain48 = "bravojacksonmentor\.com" ascii wide nocase
        $domain49 = "briarapppro\.org" ascii wide nocase
        $ip50 = "103.57.251.154" ascii wide
        $ip51 = "107.172.39.100" ascii wide
        $ip52 = "107.173.63.218" ascii wide
        $ip53 = "110.42.64.137" ascii wide
        $ip54 = "134.255.210.127" ascii wide
        $ip55 = "135.125.242.211" ascii wide
        $ip56 = "141.94.68.169" ascii wide
        ...
        $ip69 = "163.245.220.108" ascii wide
        $ip70 = "167.88.15.93" ascii wide
        $ip71 = "173.208.142.147" ascii wide
        $ip72 = "185.106.123.198" ascii wide
        $ip73 = "185.117.72.87" ascii wide
        $ip74 = "185.117.73.195" ascii wide
        $ip75 = "185.117.73.209" ascii wide
        $ip76 = "185.141.25.244" ascii wide
        $ip77 = "185.193.48.135" ascii wide
        $ip78 = "185.193.50.233" ascii wide
        $ip79 = "185.237.166.24" ascii wide
...
rule APT_BLACKTECH
{
    ...
    strings:
        ...
        $domain10 = "csp\.fortinetline\.com" ascii wide nocase
        $domain11 = "em\.totalpople\.info" ascii wide nocase
        $domain12 = "evergo\.dnset\.com" ascii wide nocase
        $domain13 = "fibtec\.jkub\.com" ascii wide nocase
        $domain14 = "fortinetline\.com" ascii wide nocase
        $domain15 = "gstrap\.jkub\.com" ascii wide nocase
        $domain16 = "harb\.bbsindex\.com" ascii wide nocase
        $domain17 = "herace\.https443\.org" ascii wide nocase
        $domain18 = "idonotknow\.lflinkup\.com" ascii wide nocase
        $domain19 = "idonotknow\.lflinkup\.net" ascii wide nocase
        $domain20 = "idonotknow\.serveusers\.com" ascii wide nocase
        $domain21 = "inkeslive\.com" ascii wide nocase
        $domain22 = "linuxhome\.jkub\.com" ascii wide nocase
        $domain23 = "macfee-update\.serveftp\.com" ascii wide nocase
        $domain24 = "microsoftonline\.com\.authorizeddns\.net" ascii wide nocase
        $domain25 = "microsoftvm\.net" ascii wide nocase
        $domain26 = "ns1001\.centosupdates\.com" ascii wide nocase
        $domain27 = "office\.panasocin\.com" ascii wide nocase
        $domain28 = "okinawas\.ssl443\.org" ascii wide nocase
        $domain29 = "org\.misecure\.com" ascii wide nocase
        $domain30 = "panasocin\.com" ascii wide nocase
        $domain31 = "portal\.fortinetline\.com" ascii wide nocase
        $domain32 = "portal\.microsoftvm\.net" ascii wide nocase
        $domain33 = "redhatstate\.hopto\.org" ascii wide nocase
        $domain34 = "rutentw\.com" ascii wide nocase
        $domain35 = "securitycenter\.kozow\.com" ascii wide nocase
        $domain36 = "systeminfo\.centosupdates\.com" ascii wide nocase
        $domain37 = "totalpople\.info" ascii wide nocase
        $domain38 = "update\.centosupdates\.com" ascii wide nocase
        $domain39 = "update\.panasocin\.com" ascii wide nocase
        $domain40 = "updates\.centosupdates\.com" ascii wide nocase
        $domain41 = "web2008\.rutentw\.com" ascii wide nocase
        $domain42 = "wg1\.inkeslive\.com" ascii wide nocase
        $domain43 = "woc\.yasonbin\.info" ascii wide nocase
        $domain44 = "yasonbin\.info" ascii wide nocase
        $ip45 = "122.116.205.124" ascii wide
        $ip46 = "172.104.109.217" ascii wide
        $ip47 = "212.115.54.194" ascii wide
        $ip48 = "223.200.120.73" ascii wide
        $ip49 = "61.216.119.56" ascii wide
...
rule APT_BLUENOROFF
{
    ...
    strings:
        $domain0 = "02euweb\.us" ascii wide nocase
        $domain1 = "02io\.us" ascii wide nocase
        $domain2 = "02room\.us" ascii wide nocase
        $domain3 = "02us\.sbs" ascii wide nocase
        $domain4 = "02usweb\.sbs" ascii wide nocase
        $domain5 = "02usweb\.us" ascii wide nocase
        $domain6 = "02web-zoom\.us" ascii wide nocase
        $domain7 = "02web\.sbs" ascii wide nocase
        $domain8 = "02web\.zoom\.02webus\.sbs" ascii wide nocase
        $domain9 = "02webus\.sbs" ascii wide nocase
        $domain10 = "02webus\.zoom\.02us\.sbs" ascii wide nocase
        $domain11 = "02webus\.zoom\.web02\.sbs" ascii wide nocase
        $domain12 = "02webzoom\.us" ascii wide nocase
        $domain13 = "03app\.live" ascii wide nocase
        $domain14 = "03app\.sbs" ascii wide nocase
        $domain15 = "04web\.sbs" ascii wide nocase
        $domain16 = "05ie\.live" ascii wide nocase
        $domain17 = "05in\.one" ascii wide nocase
        $domain18 = "05live\.biz" ascii wide nocase
        $domain19 = "05live\.co" ascii wide nocase
        $domain20 = "05live\.live" ascii wide nocase
        $domain21 = "05live\.sbs" ascii wide nocase
        $domain22 = "05live\.xyz" ascii wide nocase
        $domain23 = "05meet\.am\.in" ascii wide nocase
        $domain24 = "05meet\.click" ascii wide nocase
        $domain25 = "05meet\.co" ascii wide nocase
        $domain26 = "05meet\.live" ascii wide nocase
        $domain27 = "05meet\.sbs" ascii wide nocase
        $domain28 = "05meet\.us" ascii wide nocase
        $domain29 = "05meetus\.web05\.uk" ascii wide nocase
        $domain30 = "05uk\.us" ascii wide nocase
        $domain31 = "05ukweb\.uk" ascii wide nocase
        $domain32 = "05us\.live" ascii wide nocase
        $domain33 = "05us\.sbs" ascii wide nocase
        $domain34 = "05us\.zoom\.05webus\.sbs" ascii wide nocase
        $domain35 = "05us\.zoom\.web05\.sbs" ascii wide nocase
        $domain36 = "05usweb\.us" ascii wide nocase
        $domain37 = "05usweb\.zoom\.meet-05\.sbs" ascii wide nocase
        $domain38 = "05web\.us" ascii wide nocase
        $domain39 = "05webus\.meet\.05uk\.us" ascii wide nocase
        $domain40 = "05webus\.sbs" ascii wide nocase
        $domain41 = "06eu\.us" ascii wide nocase
        $domain42 = "06in\.us" ascii wide nocase
        $domain43 = "06ln\.live" ascii wide nocase
        $domain44 = "06on\.us" ascii wide nocase
        $domain45 = "06ukweb\.uk" ascii wide nocase
        $domain46 = "06us\.live" ascii wide nocase
        $domain47 = "06us\.sbs" ascii wide nocase
        $domain48 = "06us\.us" ascii wide nocase
        $domain49 = "06us\.zoom\.web06\.eu" ascii wide nocase
        $ip50 = "104.145.210.107" ascii wide
        $ip51 = "104.168.145.52" ascii wide
        $ip52 = "104.168.151.70" ascii wide
        $ip53 = "104.168.198.145" ascii wide
        $ip54 = "109.248.163.127" ascii wide
        $ip55 = "118.70.116.154" ascii wide
        $ip56 = "139.150.73.123" ascii wide
        $ip57 = "140.117.91.22" ascii wide
        $ip58 = "140.136.134.201" ascii wide
        $ip59 = "142.11.196.106" ascii wide
...
rule APT_CHARMINGKITTEN
{
    ...
    strings:
        ...
        $domain12 = "1stl\.ink" ascii wide nocase
        $domain13 = "30min-ergmeeting\.com" ascii wide nocase
        $domain14 = "30min-ergmeeting\.net" ascii wide nocase
        $domain15 = "30min-smartsight-hr\.com" ascii wide nocase
        $domain16 = "30min-smartsight\.com" ascii wide nocase
        $domain17 = "30min-ziprecruiter\.com" ascii wide nocase
        $domain18 = "30min-ziprecruiterhr\.com" ascii wide nocase
        $domain19 = "30minmeeting-quality\.com" ascii wide nocase
        $domain20 = "30minmeetinghr\.com" ascii wide nocase
        $domain21 = "30minziprecruiterhr\.net" ascii wide nocase
        $domain22 = "3dauth\.live" ascii wide nocase
        $domain23 = "3dconfirrnation\.com" ascii wide nocase
        $domain24 = "8475\.freelancedeveloper\.site" ascii wide nocase
        $domain25 = "8ghefkwdvbfdsg3asdf1\.com" ascii wide nocase
        $domain26 = "academy-update\.com" ascii wide nocase
        $domain27 = "accesscheckout\.online" ascii wide nocase
        $domain28 = "accessverification\.online" ascii wide nocase
        $domain29 = "acconut-mail\.com" ascii wide nocase
        $domain30 = "acconut-signin\.com" ascii wide nocase
        $domain31 = "acconut-verify\.com" ascii wide nocase
        $domain32 = "account-customerservice\.com" ascii wide nocase
        $domain33 = "account-drive\.com" ascii wide nocase
        $domain34 = "account-dropbox\.net" ascii wide nocase
        $domain35 = "account-google\.co" ascii wide nocase
        $domain36 = "account-log-user-verify-mail\.com" ascii wide nocase
        $domain37 = "account-login\.net" ascii wide nocase
        $domain38 = "account-logins\.com" ascii wide nocase
        $domain39 = "account-permission-mail-user\.com" ascii wide nocase
        $domain40 = "account-profile-users\.info" ascii wide nocase
        $domain41 = "account-servicemanagement\.info" ascii wide nocase
        $domain42 = "account-servicerecovery\.com" ascii wide nocase
        $domain43 = "account-servieemanagement\.info" ascii wide nocase
        $domain44 = "account-signin-myaccount-users\.ga" ascii wide nocase
        $domain45 = "account-signin\.com" ascii wide nocase
        $domain46 = "account-siqnin\.com" ascii wide nocase
        $domain47 = "account-support-user\.com" ascii wide nocase
        $domain48 = "account-user-permission-account\.com" ascii wide nocase
        $domain49 = "account-user-verify-mail\.com" ascii wide nocase
...
rule APT_CLOUDATLAS
{
    ...
    strings:
        ...
        $domain1 = "3i\.hilsabecks\.net" ascii wide nocase
        $domain2 = "56\.msgntfsys\.link" ascii wide nocase
        $domain3 = "7h\.ahmetgurses\.net" ascii wide nocase
        $domain4 = "advancestore\.workers\.dev" ascii wide nocase
        $domain5 = "agent-group\.org" ascii wide nocase
        $domain6 = "ahmetgurses\.net" ascii wide nocase
        $domain7 = "aitoall\.ru" ascii wide nocase
        $domain8 = "api-help\.com" ascii wide nocase
        $domain9 = "api\.office365online\.workers\.dev" ascii wide nocase
        $domain10 = "apkcrypter\.com" ascii wide nocase
        $domain11 = "archive-downloader\.com" ascii wide nocase
        $domain12 = "arendelle\.ru" ascii wide nocase
        $domain13 = "asia\.office365-cloud\.workers\.dev" ascii wide nocase
        $domain14 = "avito-service\.net" ascii wide nocase
        $domain15 = "azureblog\.info" ascii wide nocase
        $domain16 = "becloud\.website" ascii wide nocase
        $domain17 = "billet-ru\.net" ascii wide nocase
        $domain18 = "blackberry-support\.herokuapp\.com" ascii wide nocase
        $domain19 = "bot\.fortune-wheel\.ru" ascii wide nocase
        $domain20 = "brexitimpact\.com" ascii wide nocase
        $domain21 = "bryksina\.ru" ascii wide nocase
        $domain22 = "checklicensekey\.com" ascii wide nocase
        $domain23 = "cityru-travel\.org" ascii wide nocase
        $domain24 = "cloud\.archive-downloader\.com" ascii wide nocase
        $domain25 = "cloud\.digitalstorage\.workers\.dev" ascii wide nocase
        $domain26 = "comparelicense\.com" ascii wide nocase
        $domain27 = "connectcosmo\.click" ascii wide nocase
        $domain28 = "connectcosmo\.online" ascii wide nocase
        $domain29 = "content-protect\.net" ascii wide nocase
        $domain30 = "control-issue\.net" ascii wide nocase
        $domain31 = "copilotgptawer\.cfd" ascii wide nocase
        $domain32 = "cortanaupdater\.info" ascii wide nocase
        $domain33 = "cosmo-service\.org" ascii wide nocase
        $domain34 = "curly-waterfall-360d\.fetrikekke531\.workers\.dev" ascii wide nocase
        $domain35 = "dc-microsoft\.workers\.dev" ascii wide nocase
        $domain36 = "desktoppreview\.com" ascii wide nocase
        $domain37 = "dezinsekciya-top\.ru" ascii wide nocase
        $domain38 = "digitalstorage\.workers\.dev" ascii wide nocase
        $domain39 = "doc-fid\.com" ascii wide nocase
        $domain40 = "documents\.publicserver\.workers\.dev" ascii wide nocase
        $domain41 = "driver-key\.com" ascii wide nocase
        $domain42 = "driver-updated\.com" ascii wide nocase
        $domain43 = "driversolution\.net" ascii wide nocase
        $domain44 = "e-aks\.uz" ascii wide nocase
        $domain45 = "e-government-pk\.com" ascii wide nocase
        $domain46 = "e-govoffice\.com" ascii wide nocase
        $domain47 = "ecolines\.es" ascii wide nocase
        $domain48 = "elycleu\.click" ascii wide nocase
        $domain49 = "eu\.microsoft-365\.workers\.dev" ascii wide nocase
        $ip50 = "168.100.11.142" ascii wide
        $ip51 = "185.252.147.12" ascii wide
        $ip52 = "185.252.147.12" ascii wide
        $ip53 = "185.252.147.12" ascii wide
        $ip54 = "194.190.153.182" ascii wide
        $ip55 = "5.252.179.45" ascii wide
        $ip56 = "94.232.248.34" ascii wide
        $url57 = "/appalcanedentrecentlyconvergenting\.png" ascii wide nocase
        $url58 = "/soarnegroidmeanalkydapresowntipslushing\.png" ascii wide nocase
        $url59 = "/appalcanedentrecentlyconvergenting\.png" ascii wide nocase
...
rule APT_CODOSO
{
    ...
    strings:
        ...
        $domain34 = "premrera\.com" ascii wide nocase
        $domain35 = "prennera\.com" ascii wide nocase
        $domain36 = "savmpet\.com" ascii wide nocase
        $domain37 = "sfo02s01-in-f2\.cloudsend\.net" ascii wide nocase
        $domain38 = "sharepoint-vaeit\.com" ascii wide nocase
        $domain39 = "sinmoung\.com" ascii wide nocase
        $domain40 = "smi1egate\.com" ascii wide nocase
        $domain41 = "smtp\.outlookssl\.com" ascii wide nocase
        $domain42 = "ssl-vaeit\.com" ascii wide nocase
        $domain43 = "ssl-vait\.com" ascii wide nocase
        $domain44 = "supermanbox\.org" ascii wide nocase
        $domain45 = "svn1\.smi1egate\.com" ascii wide nocase
        $domain46 = "tk-in-f156\.2bunny\.com" ascii wide nocase
        $domain47 = "topsec2014\.com" ascii wide nocase
        $domain48 = "vipreclod\.com" ascii wide nocase
        $domain49 = "vpn\.premrera\.com" ascii wide nocase
...
rule APT_COLDRIVER
{
    meta:
        ...
        author = "APTtrail Automated Collection"
        apt_group = "COLDRIVER"
        aliases = "baitswitch, calisto, coldcopy"
    ...
    strings:
        ...
        $domain1 = "account\.officesecure\.online" ascii wide nocase
        $domain2 = "accounts-ukr\.com" ascii wide nocase
        $domain3 = "accounts\.hypertexttech\.com" ascii wide nocase
        $domain4 = "accounts\.kv-ukr\.net" ascii wide nocase
        $domain5 = "accounts\.ukr-mails\.net" ascii wide nocase
        $domain6 = "accounts\.ukr-reset\.email" ascii wide nocase
        $domain7 = "accsua\.com" ascii wide nocase
        $domain8 = "accsukr\.com" ascii wide nocase
        $domain9 = "advath\.officesecure\.online" ascii wide nocase
        $domain10 = "alightcruellane\.net" ascii wide nocase
        $domain11 = "allow-access\.com" ascii wide nocase
        $domain12 = "ankaramuhaseben\.com" ascii wide nocase
        $domain13 = "antibots-service\.com" ascii wide nocase
        $domain14 = "apicomcloud\.com" ascii wide nocase
        $domain15 = "app-sharcpoint\.com" ascii wide nocase
        $domain16 = "app-sharcpointe\.com" ascii wide nocase
        $domain17 = "app-sharcpolnt\.com" ascii wide nocase
        $domain18 = "app-sharcpolnte\.com" ascii wide nocase
        $domain19 = "applicationformsubmit\.me" ascii wide nocase
        $domain20 = "appsharcpointe\.com" ascii wide nocase
        $domain21 = "appsharcpointes\.com" ascii wide nocase
        $domain22 = "appssharcpointe\.com" ascii wide nocase
        $domain23 = "as-mvd\.ru" ascii wide nocase
        $domain24 = "attach-docs\.com" ascii wide nocase
        $domain25 = "attach-update\.com" ascii wide nocase
        $domain26 = "auth\.officesecure\.online" ascii wide nocase
        $domain27 = "authpoint\.usa\.officesecure\.online" ascii wide nocase
        $domain28 = "betmgm-support\.com" ascii wide nocase
        $domain29 = "betus-us\.info" ascii wide nocase
        $domain30 = "bigdatabroadway\.com" ascii wide nocase
        $domain31 = "bittechllc\.net" ascii wide nocase
        $domain32 = "blintepeeste\.org" ascii wide nocase
        $domain33 = "blueskynetwork-drive\.com" ascii wide nocase
        $domain34 = "blueskynetwork-shared\.com" ascii wide nocase
        $domain35 = "botguard-checker\.com" ascii wide nocase
        $domain36 = "botguard-web\.com" ascii wide nocase
        $domain37 = "cache-dns-forwarding\.com" ascii wide nocase
        $domain38 = "cache-dns-preview\.com" ascii wide nocase
        $domain39 = "cache-dns\.com" ascii wide nocase
        $domain40 = "cache-docs\.com" ascii wide nocase
        $domain41 = "cache-pdf\.com" ascii wide nocase
        $domain42 = "cache-pdf\.online" ascii wide nocase
        $domain43 = "cache-services\.live" ascii wide nocase
        $domain44 = "captchanom\.top" ascii wide nocase
        $domain45 = "centeritdefcity\.com" ascii wide nocase
        $domain46 = "challenge-identifier\.com" ascii wide nocase
        $domain47 = "challenge-share\.com" ascii wide nocase
        $domain48 = "changepassword-ukr\.net" ascii wide nocase
        $domain49 = "checker-bot\.com" ascii wide nocase
...
rule APT_DONOT
{
    meta:
        ...
        author = "APTtrail Automated Collection"
        apt_group = "DONOT"
        aliases = "GEOShell, apt-c-35, donot"
    ...
    strings:
        ...
        $domain14 = "alex-ikmz\.store" ascii wide nocase
        $domain15 = "alex-olpw\.store" ascii wide nocase
        $domain16 = "alex-ujmi\.com" ascii wide nocase
        $domain17 = "alex-ujmi\.store" ascii wide nocase
        $domain18 = "alex-yhnv\.store" ascii wide nocase
        $domain19 = "alter\.drivethrough\.top" ascii wide nocase
        $domain20 = "altzserberin\.info" ascii wide nocase
        $domain21 = "amazon-books-gifts\.com" ascii wide nocase
        $domain22 = "aoc\.sessions4life\.pw" ascii wide nocase
        $domain23 = "apifile\.xyz" ascii wide nocase
        $domain24 = "apkfreeware\.xyz" ascii wide nocase
        $domain25 = "apkv6\.endurecif\.top" ascii wide nocase
        $domain26 = "aplcompin\.site" ascii wide nocase
        $domain27 = "aplinvest\.site" ascii wide nocase
        $domain28 = "aplusgroup\.online" ascii wide nocase
        $domain29 = "app-palace\.live" ascii wide nocase
        $domain30 = "app-view-support\.club" ascii wide nocase
        $domain31 = "appie\.host" ascii wide nocase
        $domain32 = "appnsure\.com" ascii wide nocase
        $domain33 = "apps\.privatechat\.life" ascii wide nocase
        $domain34 = "appservices\.info" ascii wide nocase
        $domain35 = "appshare\.buzz" ascii wide nocase
        $domain36 = "appshares\.buzz" ascii wide nocase
        $domain37 = "appsharing\.buzz" ascii wide nocase
        $domain38 = "appsharinggo\.buzz" ascii wide nocase
        $domain39 = "appshazing\.buzz" ascii wide nocase
        $domain40 = "appsservicess\.buzz" ascii wide nocase
        $domain41 = "appsservicess\.info" ascii wide nocase
        $domain42 = "appsshares\.buzz" ascii wide nocase
        $domain43 = "appstringfy\.xyz" ascii wide nocase
        $domain44 = "appsupports\.info" ascii wide nocase
        $domain45 = "appview\.buzz" ascii wide nocase
        $domain46 = "appzserv\.info" ascii wide nocase
        $domain47 = "azure\.mglassservice\.com" ascii wide nocase
        $domain48 = "backup\.latestsyn\.xyz" ascii wide nocase
        $domain49 = "backuplogs\.xyz" ascii wide nocase
        ...
        $ip55 = "151.236.18.167" ascii wide
        $ip56 = "162.33.177.183" ascii wide
        $ip57 = "162.33.178.242" ascii wide
        $ip58 = "162.33.178.3" ascii wide
        $ip59 = "162.33.178.85" ascii wide
        $ip60 = "162.33.179.171" ascii wide
        $ip61 = "162.33.179.198" ascii wide
        $ip62 = "162.33.179.238" ascii wide
        $ip63 = "162.33.179.32" ascii wide
        $ip64 = "164.68.108.22" ascii wide
        $ip65 = "164.68.108.22" ascii wide
        $ip66 = "167.99.130.191" ascii wide
        $ip67 = "167.99.190.44" ascii wide
        $ip68 = "178.63.172.2" ascii wide
        $ip69 = "178.63.172.6" ascii wide
        $ip70 = "185.195.64.251" ascii wide
        $ip71 = "185.224.83.16" ascii wide
        $ip72 = "193.149.176.226" ascii wide
        $ip73 = "193.149.176.226" ascii wide
        $ip74 = "193.149.176.237" ascii wide
        $ip75 = "193.149.176.65" ascii wide
        $ip76 = "193.149.176.65" ascii wide
        $ip77 = "195.85.115.143" ascii wide
        $ip78 = "206.188.197.34" ascii wide
        $ip79 = "206.188.197.34" ascii wide
...
rule APT_DUKE
{
    ...
    strings:
        ...
        $domain18 = "antac\.org" ascii wide nocase
        $domain19 = "ap-northeast-1-aws\.s3-ua\.cloud" ascii wide nocase
        $domain20 = "ap-northeast-1-aws\.ukrainesec\.cloud" ascii wide nocase
        $domain21 = "aspeninstitute\.cloud" ascii wide nocase
        $domain22 = "asucloud\.us" ascii wide nocase
        $domain23 = "avis-google\.online" ascii wide nocase
        $domain24 = "aws-app\.online" ascii wide nocase
        $domain25 = "aws-atshop\.online" ascii wide nocase
        $domain26 = "aws-cert\.online" ascii wide nocase
        $domain27 = "aws-cloud\.online" ascii wide nocase
        $domain28 = "aws-cloud\.tech" ascii wide nocase
        $domain29 = "aws-data\.cloud" ascii wide nocase
        $domain30 = "aws-devops\.site" ascii wide nocase
        $domain31 = "aws-exam\.online" ascii wide nocase
        $domain32 = "aws-il\.cloud" ascii wide nocase
        $domain33 = "aws-join\.cloud" ascii wide nocase
        $domain34 = "aws-meet\.cloud" ascii wide nocase
        $domain35 = "aws-meetings\.cloud" ascii wide nocase
        $domain36 = "aws-ms\.cloud" ascii wide nocase
        $domain37 = "aws-my\.online" ascii wide nocase
        $domain38 = "aws-online\.cloud" ascii wide nocase
        $domain39 = "aws-platform\.cloud" ascii wide nocase
        $domain40 = "aws-s3\.cloud" ascii wide nocase
        $domain41 = "aws-sagyo\.site" ascii wide nocase
        $domain42 = "aws-sample\.online" ascii wide nocase
        $domain43 = "aws-secure\.cloud" ascii wide nocase
        $domain44 = "aws-talib\.online" ascii wide nocase
        $domain45 = "aws-ukraine\.cloud" ascii wide nocase
        $domain46 = "aws-yamada\.site" ascii wide nocase
        $domain47 = "awsmeet\.cloud" ascii wide nocase
        $domain48 = "awsmeetings\.online" ascii wide nocase
        $domain49 = "awsplatform\.online" ascii wide nocase
...
rule APT_EARTHESTRIES
{
    ...
    strings:
        $domain0 = "2261992\.s3\.amazonaws\.com" ascii wide nocase
        $domain1 = "acapros-app\.s3-us-west-2\.amazonaws\.com" ascii wide nocase
        $domain2 = "access\.trhammer\.com" ascii wide nocase
        $domain3 = "ahha-asset\.s3\.ap-northeast-2\.amazonaws\.com" ascii wide nocase
        $domain4 = "anynucleus\.com" ascii wide nocase
        $domain5 = "api\.farstream\.org" ascii wide nocase
        $domain6 = "api\.solveblemten\.com" ascii wide nocase
        $domain7 = "awsdns531\.com" ascii wide nocase
        $domain8 = "bbr-promo\.s3\.amazonaws\.com" ascii wide nocase
        $domain9 = "be-at-home\.s3\.ap-northeast-2\.amazonaws\.com" ascii wide nocase
        $domain10 = "beansdeals-static\.s3\.amazonaws\.com" ascii wide nocase
        $domain11 = "bigtimeassets\.s3\.amazonaws\.com" ascii wide nocase
        $domain12 = "billing\.clothworls\.com" ascii wide nocase
        $domain13 = "blog-app-system2\.s3\.amazonaws\.com" ascii wide nocase
        $domain14 = "breaknlinks\.s3\.amazonaws\.com" ascii wide nocase
        $domain15 = "c11r\.awsdns531\.com" ascii wide nocase
        $domain16 = "cas04\.awsdns531\.com" ascii wide nocase
        $domain17 = "cdn-6dd0035\.oxcdntech\.com" ascii wide nocase
        $domain18 = "cdn-7a3d\.vultr-dns\.com" ascii wide nocase
        $domain19 = "cdn181\.awsdns531\.com" ascii wide nocase
        $domain20 = "cdn728a66b0\.smartlinkcorp\.net" ascii wide nocase
        $domain21 = "check\.sysupdates\.org" ascii wide nocase
        $domain22 = "cloudlibraries\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain23 = "credits\.officesanalytics\.com" ascii wide nocase
        $domain24 = "dns2021\.net" ascii wide nocase
        $domain25 = "east\.smartpisang\.com" ascii wide nocase
        $domain26 = "esh\.hoovernamosong\.com" ascii wide nocase
        $domain27 = "farstream\.org" ascii wide nocase
        $domain28 = "globalnetzone\.bcdn\.net" ascii wide nocase
        $domain29 = "helpdesk\.stnekpro\.com" ascii wide nocase
        $domain30 = "imap\.dateupdata\.com" ascii wide nocase
        $domain31 = "infraredsen\.com" ascii wide nocase
        $domain32 = "jasmine\.lhousewares\.com" ascii wide nocase
        $domain33 = "jptomorrow\.com" ascii wide nocase
        $domain34 = "jttoday\.net" ascii wide nocase
        $domain35 = "keyplancorp\.com" ascii wide nocase
        $domain36 = "kia-almotores\.s3\.amazonaws\.com" ascii wide nocase
        $domain37 = "linkaircdn\.com" ascii wide nocase
        $domain38 = "llnw-dd\.awsdns531\.com" ascii wide nocase
        $domain39 = "lyncidc\.com" ascii wide nocase
        $domain40 = "materialplies\.com" ascii wide nocase
        $domain41 = "microware-help\.com" ascii wide nocase
        $domain42 = "mncdntech\.com" ascii wide nocase
        $domain43 = "ms101\.cloudshappen\.com" ascii wide nocase
        $domain44 = "music\.farstream\.org" ascii wide nocase
        $domain45 = "news\.colourtinctem\.com" ascii wide nocase
        $domain46 = "ntp\.sysupdates\.org" ascii wide nocase
        $domain47 = "nx2\.microware-help\.com" ascii wide nocase
        $domain48 = "officesanalytics\.com" ascii wide nocase
        $domain49 = "omnileadzdev\.s3\.amazonaws\.com" ascii wide nocase
...
rule APT_FEROCIOUSKITTEN
{
    ...
    strings:
        $domain0 = "accountes\.google\.comesignt\.website" ascii wide nocase
        $domain1 = "accounts\.google\.comisignin\.online" ascii wide nocase
        $domain2 = "aparat\.com-view\.space" ascii wide nocase
        $domain3 = "com-accounts\.website" ascii wide nocase
        $domain4 = "com-signin\.site" ascii wide nocase
        $domain5 = "com-view\.org" ascii wide nocase
        $domain6 = "com-view\.space" ascii wide nocase
        $domain7 = "come-signin\.quest" ascii wide nocase
        $domain8 = "comesignt\.website" ascii wide nocase
        $domain9 = "comi-site\.website" ascii wide nocase
        $domain10 = "comisignin\.online" ascii wide nocase
        $domain11 = "comuk\.space" ascii wide nocase
        $domain12 = "google\.comisignin\.online" ascii wide nocase
        $domain13 = "khabarfarsi\.com-view\.org" ascii wide nocase
        $domain14 = "microcaft\.xyz" ascii wide nocase
        $domain15 = "microsoft\.com-view\.space" ascii wide nocase
        $domain16 = "microsoft\.come-site\.website" ascii wide nocase
        $domain17 = "microsoft\.comi-site\.website" ascii wide nocase
        $domain18 = "microsoft\.comuk\.space" ascii wide nocase
        $domain19 = "microsoft\.microcaft\.xyz" ascii wide nocase
        $domain20 = "microsoft\.unupdate\.ml" ascii wide nocase
        $domain21 = "microsoft\.unupload\.xyz" ascii wide nocase
        $domain22 = "microsoft\.updatei\.com" ascii wide nocase
        $domain23 = "min\.come-site\.website" ascii wide nocase
        $domain24 = "min\.comi-site\.website" ascii wide nocase
        $domain25 = "ns1\.com-accounts\.website" ascii wide nocase
        $domain26 = "ns1\.com-signin\.site" ascii wide nocase
        $domain27 = "ns2\.com-accounts\.website" ascii wide nocase
        $domain28 = "ns2\.com-signin\.site" ascii wide nocase
        $domain29 = "unupdate\.ml" ascii wide nocase
        $domain30 = "unupload\.xyz" ascii wide nocase
        $domain31 = "updatei\.com" ascii wide nocase
...
rule APT_FORUMTROLL
{
    ...
    strings:
        ...
        $domain2 = "advertnow\.org" ascii wide nocase
        $domain3 = "adverty\.info" ascii wide nocase
        $domain4 = "browser-time-stats\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain5 = "bus-pod-tenant\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain6 = "clip-rdp-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain7 = "common-rdp-front\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain8 = "corptravel\.org" ascii wide nocase
        $domain9 = "cybers46\.team" ascii wide nocase
        $domain10 = "cybers4646\.my\.id" ascii wide nocase
        $domain11 = "e-library\.wiki" ascii wide nocase
        $domain12 = "elibrary\.wiki" ascii wide nocase
        $domain13 = "fast-telemetry-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain14 = "feedstream\.info" ascii wide nocase
        $domain15 = "front-static-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain16 = "futurebull\.live" ascii wide nocase
        $domain17 = "futurebull\.net" ascii wide nocase
        $domain18 = "globaloneai\.com" ascii wide nocase
        $domain19 = "infosecteam\.info" ascii wide nocase
        $domain20 = "kant300\.kantiana\.info" ascii wide nocase
        $domain21 = "kantiana\.info" ascii wide nocase
        $domain22 = "kpmedia\.city" ascii wide nocase
        $domain23 = "main-front-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain24 = "mediaoprosso\.ru" ascii wide nocase
        $domain25 = "mil-by\.info" ascii wide nocase
        $domain26 = "moscow\.corptravel\.org" ascii wide nocase
        $domain27 = "ms-appdata-fonts\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain28 = "ms-appdata-main\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain29 = "ms-appdata-query\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain30 = "mstn-ru\.com" ascii wide nocase
...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain1 = "00a7c185\.duckdns\.org" ascii wide nocase
        $domain2 = "00mknjbhy\.dynv6\.net" ascii wide nocase
        $domain3 = "00pr43\.picid1fdl6\.dynv6\.net" ascii wide nocase
        $domain4 = "01nservercc\.cfd" ascii wide nocase
        $domain5 = "01onlinen\.cfd" ascii wide nocase
        $domain6 = "022hucku25u\.dns\.navy" ascii wide nocase
        $domain7 = "02nservercc\.cfd" ascii wide nocase
        $domain8 = "02onlinen\.cfd" ascii wide nocase
        $domain9 = "03nservercc\.cfd" ascii wide nocase
        $domain10 = "03onlinen\.cfd" ascii wide nocase
        $domain11 = "04nservercc\.cfd" ascii wide nocase
        $domain12 = "04onlinen\.cfd" ascii wide nocase
        $domain13 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.onlinenhiscomservice\.store" ascii wide nocase
        $domain14 = "059879e5-b2e8-4f58-aa46-95f69d92aa34\.random\.voranstaks\.shop" ascii wide nocase
        $domain15 = "05c0\.nkfumxgqxd\.v6\.rocks" ascii wide nocase
        $domain16 = "05nservercc\.cfd" ascii wide nocase
        $domain17 = "05onlinen\.cfd" ascii wide nocase
        $domain18 = "06nservercc\.cfd" ascii wide nocase
        $domain19 = "06onlinen\.cfd" ascii wide nocase
        $domain20 = "0751u9n4lg\.v6\.rocks" ascii wide nocase
        $domain21 = "07nservercc\.cfd" ascii wide nocase
        $domain22 = "07onlinen\.cfd" ascii wide nocase
        $domain23 = "086k3a\.93vf4b71cv\.dynv6\.net" ascii wide nocase
        $domain24 = "08nservercc\.cfd" ascii wide nocase
        $domain25 = "08onlinen\.cfd" ascii wide nocase
        $domain26 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain27 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain28 = "09nservercc\.cfd" ascii wide nocase
        $domain29 = "09onlinen\.cfd" ascii wide nocase
        $domain30 = "0a1fi7nsne\.dynv6\.net" ascii wide nocase
        $domain31 = "0c50zrvnoi\.v6\.rocks" ascii wide nocase
        $domain32 = "0dj87hc\.v6\.rocks" ascii wide nocase
        $domain33 = "0g25r94p96\.v6\.army" ascii wide nocase
        $domain34 = "0grde8ebon\.dns\.army" ascii wide nocase
        $domain35 = "0jr87375qt\.v6\.navy" ascii wide nocase
        $domain36 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain37 = "0mvkf48r\.v6\.army" ascii wide nocase
        $domain38 = "0reudifh9384\.dynv6\.net" ascii wide nocase
        $domain39 = "0s2snxin4t\.v6\.navy" ascii wide nocase
        $domain40 = "0sv8\.qiz172u9i01\.dns\.army" ascii wide nocase
        $domain41 = "0t3ofn4r21\.dns\.navy" ascii wide nocase
        $domain42 = "0twjc657tu\.v6\.navy" ascii wide nocase
        $domain43 = "0vjdf88\.dynv6\.net" ascii wide nocase
        $domain44 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain45 = "0x0\.care" ascii wide nocase
        $domain46 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain47 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain48 = "100000recipe\.com" ascii wide nocase
        $domain49 = "100nservercc\.cfd" ascii wide nocase
        $ip50 = "101.36.114.235" ascii wide
        $ip51 = "103.20.235.113" ascii wide
        $ip52 = "103.212.120.253" ascii wide
        $ip53 = "103.76.228.204" ascii wide
        $ip54 = "104.168.145.83" ascii wide
        $ip55 = "104.194.152.22" ascii wide
        $ip56 = "104.194.152.251" ascii wide
        $ip57 = "104.194.152.251" ascii wide
        $ip58 = "104.36.229.179" ascii wide
        $ip59 = "104.36.229.179" ascii wide
        $ip60 = "107.148.71.88" ascii wide
        $ip61 = "107.189.16.65" ascii wide
        $ip62 = "109.248.151.179" ascii wide
        $ip63 = "115.193.38.156" ascii wide
        $ip64 = "115.195.112.167" ascii wide
        $ip65 = "115.197.193.142" ascii wide
        $ip66 = "116.202.99.218" ascii wide
        $ip67 = "118.194.248.246" ascii wide
        $ip68 = "121.183.134.113" ascii wide
...
rule APT_KUN3
{
    ...
    strings:
        ...
        $domain1 = "360-browser\.com" ascii wide nocase
        $domain2 = "360edge\.cn" ascii wide nocase
        $domain3 = "7s\.pc-kakaocorp\.com" ascii wide nocase
        $domain4 = "8-210-67-136\.cprapid\.com" ascii wide nocase
        $domain5 = "88886\.shop" ascii wide nocase
        $domain6 = "aaronbrender\.com" ascii wide nocase
        $domain7 = "aaronbrender\.net" ascii wide nocase
        $domain8 = "aaronbrender\.org" ascii wide nocase
        $domain9 = "addguard\.cn" ascii wide nocase
        $domain10 = "adzuki\.us" ascii wide nocase
        $domain11 = "af-whatsapp\.com" ascii wide nocase
        $domain12 = "agarpowder\.us" ascii wide nocase
        $domain13 = "andydeitrich\.com" ascii wide nocase
        $domain14 = "anzhihui\.net" ascii wide nocase
        $domain15 = "api\.hami888\.com" ascii wide nocase
        $domain16 = "app-kuake\.com\.cn" ascii wide nocase
        $domain17 = "app-quark\.com\.cn" ascii wide nocase
        $domain18 = "app\.zyxhlh\.com" ascii wide nocase
        $domain19 = "approved-medical\.com" ascii wide nocase
        $domain20 = "apps-aisi\.com" ascii wide nocase
        $domain21 = "apps-helloworld\.com" ascii wide nocase
        $domain22 = "apps-huorong\.com" ascii wide nocase
        $domain23 = "apps-i4\.com" ascii wide nocase
        $domain24 = "apps-kakaocorp\.com" ascii wide nocase
        $domain25 = "apps-kakaotalk\.com" ascii wide nocase
        $domain26 = "apps-kuaiiian\.com" ascii wide nocase
        $domain27 = "apps-oray\.com" ascii wide nocase
        $domain28 = "apps-quark\.com" ascii wide nocase
        $domain29 = "apps-sougoupinyin\.com" ascii wide nocase
        $domain30 = "apps-tencent\.com" ascii wide nocase
        $domain31 = "apps-v2rayn\.com" ascii wide nocase
        $domain32 = "apps-winrar\.com" ascii wide nocase
        $domain33 = "apps-wps\.com" ascii wide nocase
        $domain34 = "apps-xiangrikui\.com" ascii wide nocase
        $domain35 = "appx-wps\.com" ascii wide nocase
        $domain36 = "aps-wps\.com" ascii wide nocase
        ...
        $ip52 = "43.248.172.115" ascii wide
        $ip53 = "43.248.172.115" ascii wide
        $ip54 = "45.204.207.244" ascii wide
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain2 = "1-73g\.pages\.dev" ascii wide nocase
        $domain3 = "118274-zoomid\.com" ascii wide nocase
        $domain4 = "11stnft\.click" ascii wide nocase
        $domain5 = "1215\.vercel\.app" ascii wide nocase
        $domain6 = "123fisd\.naveicoipg\.online" ascii wide nocase
        $domain7 = "129react\.pages\.dev" ascii wide nocase
        $domain8 = "15248636\.site" ascii wide nocase
        $domain9 = "166-88-54-158\.nip\.io" ascii wide nocase
        $domain10 = "1688dsj\.com" ascii wide nocase
        $domain11 = "17\.docsend\.store" ascii wide nocase
        $domain12 = "172-86-114-141\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain13 = "172-86-114-170\.dal\.priv\.octovpn\.net" ascii wide nocase
        $domain14 = "172-86-89-213\.cprapid\.com" ascii wide nocase
        $domain15 = "1drvmicrosoft\.com" ascii wide nocase
        $domain16 = "1winfans\.com" ascii wide nocase
        $domain17 = "247l\.net" ascii wide nocase
        $domain18 = "260120\.vercel\.app" ascii wide nocase
        $domain19 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain20 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain21 = "3\.143\.24\.91\.sslip\.io" ascii wide nocase
        $domain22 = "360scanner\.store" ascii wide nocase
        $domain23 = "360share\.pro" ascii wide nocase
        $domain24 = "3la6ol\.net" ascii wide nocase
        $domain25 = "49rjaf1fgrlzl1t82dpxmiqmyeedl4kku5y3hjvanjleyhpo3pjmbn23q0\.pages\.dev" ascii wide nocase
        $domain26 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain27 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain28 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain29 = "5l\.securemypc\.xyz" ascii wide nocase
        $domain30 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain31 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain32 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain33 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain34 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain35 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain36 = "90\.ip-51-83-32\.eu" ascii wide nocase
        $domain37 = "91\.90\.121\.87\.sslip\.io" ascii wide nocase
        $domain38 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain39 = "a\.videotalks\.site" ascii wide nocase
        $domain40 = "aaronsfazzy\.slack\.com" ascii wide nocase
        $domain41 = "aaronzeeshan\.slack\.com" ascii wide nocase
        $domain42 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain43 = "abc\.meeting-central\.online" ascii wide nocase
        $domain44 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain45 = "abc\.preconnection\.online" ascii wide nocase
        $domain46 = "abc\.roomconnect\.online" ascii wide nocase
        $domain47 = "abilityscan360\.com" ascii wide nocase
        $domain48 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain49 = "access\.support\.general-meet\.site" ascii wide nocase
        $ip50 = "100.51.175.254" ascii wide
        $ip51 = "103.106.67.63" ascii wide
        $ip52 = "103.106.67.63" ascii wide
        $ip53 = "103.106.67.63" ascii wide
        $ip54 = "103.205.179.4" ascii wide
        $ip55 = "103.231.75.101" ascii wide
        $ip56 = "103.35.188.48" ascii wide
        $ip57 = "103.35.188.48" ascii wide
        $ip58 = "103.35.189.107" ascii wide
        $ip59 = "103.35.189.107" ascii wide
        $ip60 = "103.65.230.100" ascii wide
        $ip61 = "104.168.136.24" ascii wide
        $ip62 = "104.168.151.116" ascii wide
        $ip63 = "104.168.151.34" ascii wide
        $ip64 = "104.168.157.45" ascii wide
        $ip65 = "104.168.157.45" ascii wide
        $ip66 = "104.168.165.165" ascii wide
        $ip67 = "104.168.165.165" ascii wide
        $ip68 = "104.168.165.173" ascii wide
        $ip69 = "104.168.165.173" ascii wide
        $ip70 = "104.168.165.203" ascii wide
        $ip71 = "104.168.165.203" ascii wide
        $ip72 = "104.168.172.20" ascii wide
        $ip73 = "104.168.198.145" ascii wide
        $ip74 = "104.168.203.159" ascii wide
        $ip75 = "104.168.203.159" ascii wide
...
rule APT_LIBRARIANGHOULS
{
    ...
    strings:
        $domain0 = "4t-niagara\.com" ascii wide nocase
        $domain1 = "4tniagara\.com" ascii wide nocase
        $domain2 = "9mmenergy\.biz" ascii wide nocase
        $domain3 = "accouts-verification\.ru" ascii wide nocase
        $domain4 = "acountservices\.nl" ascii wide nocase
        $domain5 = "acountservices\.online" ascii wide nocase
        $domain6 = "aemiliuszathe\.nl" ascii wide nocase
        $domain7 = "aeternus\.be" ascii wide nocase
        $domain8 = "alcor-as\.com" ascii wide nocase
        $domain9 = "allroundvideomedia\.nl" ascii wide nocase
        $domain10 = "almaz-aero\.site" ascii wide nocase
        $domain11 = "amaryllisclinic\.nl" ascii wide nocase
        $domain12 = "amorapersoneel\.nl" ascii wide nocase
        $domain13 = "anyhostings\.ru" ascii wide nocase
        $domain14 = "anyinfos\.ru" ascii wide nocase
        $domain15 = "aoffices\.ru" ascii wide nocase
        $domain16 = "ardensonlineconsultancyfirm\.com" ascii wide nocase
        $domain17 = "artichi\.be" ascii wide nocase
        $domain18 = "artonlinemarketing\.nl" ascii wide nocase
        $domain19 = "autodegroenehoek\.nl" ascii wide nocase
        $domain20 = "autoopkoperbenny\.be" ascii wide nocase
        $domain21 = "autotificate\.com" ascii wide nocase
        $domain22 = "aviatronika\.online" ascii wide nocase
        $domain23 = "barbershopwbd\.nl" ascii wide nocase
        $domain24 = "batwoman-fashion\.nl" ascii wide nocase
        $domain25 = "beeldspraakfotografie\.nl" ascii wide nocase
        $domain26 = "berkelgame\.com" ascii wide nocase
        $domain27 = "bewustopvoedenenbegeleiden\.com" ascii wide nocase
        $domain28 = "bharatsingh-logistics\.nl" ascii wide nocase
        $domain29 = "biesbeauty\.nl" ascii wide nocase
        $domain30 = "bijbelseexpressie\.nl" ascii wide nocase
        $domain31 = "blijlekkernij\.nl" ascii wide nocase
        $domain32 = "bloomakay\.be" ascii wide nocase
        $domain33 = "bmapps\.org" ascii wide nocase
        $domain34 = "boefjes\.nl" ascii wide nocase
        $domain35 = "boelit-pvlog\.be" ascii wide nocase
        $domain36 = "bouwwerkennoten\.be" ascii wide nocase
        $domain37 = "broodjesboutique\.nl" ascii wide nocase
        $domain38 = "bulletpointband\.com" ascii wide nocase
        $domain39 = "cafestationskoffiehuis\.nl" ascii wide nocase
        $domain40 = "camperbilly\.nl" ascii wide nocase
        $domain41 = "camperreiseuropa\.nl" ascii wide nocase
        $domain42 = "careforhealing\.com" ascii wide nocase
        $domain43 = "cc-int\.online" ascii wide nocase
        $domain44 = "center-mail\.ru" ascii wide nocase
        $domain45 = "choosingchange\.nl" ascii wide nocase
        $domain46 = "cirkelvoordeelshop\.nl" ascii wide nocase
        $domain47 = "claud-mail\.ru" ascii wide nocase
        $domain48 = "climatexperts\.be" ascii wide nocase
        $domain49 = "codevalley\.nl" ascii wide nocase
        $ip50 = "92.63.173.61" ascii wide
...
rule APT_LOTUSBLOSSOM
{
    ...
    strings:
        ...
        $domain4 = "api\.cloudtrafficservice\.com" ascii wide nocase
        $domain5 = "api\.skycloudcenter\.com" ascii wide nocase
        $domain6 = "api\.wiresguard\.com" ascii wide nocase
        $domain7 = "asean-star\.com" ascii wide nocase
        $domain8 = "aseaneco\.org" ascii wide nocase
        $domain9 = "aseansec\.dynalias\.org" ascii wide nocase
        $domain10 = "babysoal\.com" ascii wide nocase
        $domain11 = "beckhammer\.xicp\.net" ascii wide nocase
        $domain12 = "boshman09\.com" ascii wide nocase
        $domain13 = "cdncheck\.it\.com" ascii wide nocase
        $domain14 = "chris201\.net" ascii wide nocase
        $domain15 = "cloudtrafficservice\.com" ascii wide nocase
        $domain16 = "cpcl2006\.dyndns-free\.com" ascii wide nocase
        $domain17 = "cybertunnel\.dyndns\.info" ascii wide nocase
        $domain18 = "dtdf5vu\.nt7yq\.info" ascii wide nocase
        $domain19 = "harryleed\.dyndns\.org" ascii wide nocase
        $domain20 = "iascas\.net" ascii wide nocase
        $domain21 = "imonju\.com" ascii wide nocase
        $domain22 = "imonju\.net" ascii wide nocase
        $domain23 = "interhero\.net" ascii wide nocase
        $domain24 = "j\.4tc3ldw\.g9ml\.www0\.org" ascii wide nocase
        $domain25 = "jackyson\.dyndns\.info" ascii wide nocase
        $domain26 = "kid\.dyndns\.org" ascii wide nocase
        $domain27 = "kjd\.dyndns\.org" ascii wide nocase
        $domain28 = "l\.hovux\.eln9wj7\.7gpj\.org" ascii wide nocase
        $domain29 = "newinfo32\.eicp\.net" ascii wide nocase
        $domain30 = "newshappys\.dyndns-blog\.com" ascii wide nocase
        $domain31 = "petto\.mooo\.com" ascii wide nocase
        $domain32 = "phil-army\.gotdns\.org" ascii wide nocase
        $domain33 = "phil-gov\.gotdns\.org" ascii wide nocase
        $domain34 = "safe-dns\.it\.com" ascii wide nocase
        $domain35 = "scristioned\.dyndns-web\.com" ascii wide nocase
        $domain36 = "seachers\.net" ascii wide nocase
        $domain37 = "self-dns\.it\.com" ascii wide nocase
        $domain38 = "serchers\.net" ascii wide nocase
        $domain39 = "shotacon\.dyndns\.info" ascii wide nocase
        $domain40 = "skycloudcenter\.com" ascii wide nocase
        $domain41 = "tgecc\.org" ascii wide nocase
        $domain42 = "tintuchoahau\.com" ascii wide nocase
        $domain43 = "ubkv1t\.ec0\.com" ascii wide nocase
        $domain44 = "usa-moon\.net" ascii wide nocase
        $domain45 = "verolalia\.dyndns\.org" ascii wide nocase
        $domain46 = "vienclp\.com" ascii wide nocase
        $domain47 = "w\.7sytdjc\.wroi\.cxy\.com" ascii wide nocase
        $domain48 = "wiresguard\.com" ascii wide nocase
        $domain49 = "wsi\.dyndns\.org" ascii wide nocase
        $ip50 = "124.222.137.114" ascii wide
        $ip51 = "59.110.7.32" ascii wide
        $ip52 = "59.110.7.32" ascii wide
        $ip53 = "95.179.213.0" ascii wide
        $ip54 = "95.179.213.0" ascii wide
...
rule APT_MUDDYWATER
{
    ...
    strings:
        $domain0 = "0179643\.xyz" ascii wide nocase
        $domain1 = "0195327\.xyz" ascii wide nocase
        $domain2 = "0296458\.xyz" ascii wide nocase
        $domain3 = "0359761\.xyz" ascii wide nocase
        $domain4 = "0416928\.xyz" ascii wide nocase
        $domain5 = "0419726\.xyz" ascii wide nocase
        $domain6 = "0427691\.xyz" ascii wide nocase
        $domain7 = "0437285\.xyz" ascii wide nocase
        $domain8 = "0495813\.xyz" ascii wide nocase
        $domain9 = "0518429\.xyz" ascii wide nocase
        $domain10 = "0584962\.xyz" ascii wide nocase
        $domain11 = "0618497\.xyz" ascii wide nocase
        $domain12 = "0679148\.xyz" ascii wide nocase
        $domain13 = "0682149\.xyz" ascii wide nocase
        $domain14 = "0713965\.xyz" ascii wide nocase
        $domain15 = "0746382\.xyz" ascii wide nocase
        $domain16 = "0746925\.xyz" ascii wide nocase
        $domain17 = "0853179\.xyz" ascii wide nocase
        $domain18 = "0857314\.xyz" ascii wide nocase
        $domain19 = "0865174\.xyz" ascii wide nocase
        $domain20 = "0946158\.xyz" ascii wide nocase
        $domain21 = "0947682\.xyz" ascii wide nocase
        $domain22 = "0973642\.xyz" ascii wide nocase
        $domain23 = "0973648\.xyz" ascii wide nocase
        $domain24 = "1059748\.xyz" ascii wide nocase
        $domain25 = "108901\.xyz" ascii wide nocase
        $domain26 = "115437\.xyz" ascii wide nocase
        $domain27 = "116240\.xyz" ascii wide nocase
        $domain28 = "118462\.xyz" ascii wide nocase
        $domain29 = "118652\.xyz" ascii wide nocase
        $domain30 = "119012\.xyz" ascii wide nocase
        $domain31 = "120459\.xyz" ascii wide nocase
        $domain32 = "120974\.xyz" ascii wide nocase
        $domain33 = "12498376\.xyz" ascii wide nocase
        $domain34 = "126805\.xyz" ascii wide nocase
        $domain35 = "126841\.xyz" ascii wide nocase
        $domain36 = "1274672\.xyz" ascii wide nocase
        $domain37 = "1279578\.xyz" ascii wide nocase
        $domain38 = "128901\.xyz" ascii wide nocase
        $domain39 = "129012\.xyz" ascii wide nocase
        $domain40 = "1307486\.xyz" ascii wide nocase
        $domain41 = "132345\.xyz" ascii wide nocase
        $domain42 = "132579\.xyz" ascii wide nocase
        $domain43 = "132690\.xyz" ascii wide nocase
        $domain44 = "1327589\.xyz" ascii wide nocase
        $domain45 = "1357806\.xyz" ascii wide nocase
        $domain46 = "1365084\.xyz" ascii wide nocase
        $domain47 = "1368497\.xyz" ascii wide nocase
        $domain48 = "138901\.xyz" ascii wide nocase
        $domain49 = "139012\.xyz" ascii wide nocase
        ...
        $ip73 = "144.172.111.159" ascii wide
        $ip74 = "146.19.143.14" ascii wide
        $ip75 = "146.70.106.89" ascii wide
        $ip76 = "146.70.124.102" ascii wide
        $ip77 = "146.70.149.61" ascii wide
        $ip78 = "149.202.242.80" ascii wide
        $ip79 = "149.202.242.80" ascii wide
...
rule APT_MUSTANGPANDA
{
    ...
    strings:
        $domain0 = "21-ninety\.com" ascii wide nocase
        $domain1 = "247up\.org" ascii wide nocase
        $domain2 = "3012965\.securefastserver\.com" ascii wide nocase
        $domain3 = "3784f20bb00\.com" ascii wide nocase
        $domain4 = "9521182\.com" ascii wide nocase
        $domain5 = "aadcdn\.msauth\.document-invoiceviewer\.online" ascii wide nocase
        $domain6 = "aadcdn\.msauth\.document-viewer\.xyz" ascii wide nocase
        $domain7 = "aadcdn\.msauth\.documentpdfviewer\.xyz" ascii wide nocase
        $domain8 = "account\.live\.document-invoiceviewer\.online" ascii wide nocase
        $domain9 = "account\.live\.document-viewer\.xyz" ascii wide nocase
        $domain10 = "account\.live\.office-docs\.online" ascii wide nocase
        $domain11 = "accounts\.documentpdfviewer\.xyz" ascii wide nocase
        $domain12 = "accounts\.hmailevma5\.documentpdfviewer\.xyz" ascii wide nocase
        $domain13 = "adobephotostage\.com" ascii wide nocase
        $domain14 = "ai\.nerdnooks\.com" ascii wide nocase
        $domain15 = "aihkstore\.com" ascii wide nocase
        $domain16 = "airdndvn\.com" ascii wide nocase
        $domain17 = "aliyunconsole\.com" ascii wide nocase
        $domain18 = "api\.document-invoiceviewer\.online" ascii wide nocase
        $domain19 = "api\.document-viewer\.xyz" ascii wide nocase
        $domain20 = "api\.office-docs\.online" ascii wide nocase
        $domain21 = "apple-net\.com" ascii wide nocase
        $domain22 = "attd\.z23\.web\.core\.windows\.net" ascii wide nocase
        $domain23 = "b\.document-viewer\.xyz" ascii wide nocase
        $domain24 = "b83928922\.questincc\.com" ascii wide nocase
        $domain25 = "b8pjmgd6\.com" ascii wide nocase
        $domain26 = "babyafrosapparel\.com" ascii wide nocase
        $domain27 = "back\.vlvlvlvl\.site" ascii wide nocase
        $domain28 = "backups\.muathye\.com" ascii wide nocase
        $domain29 = "bcller\.com" ascii wide nocase
        $domain30 = "blogdirve\.com" ascii wide nocase
        $domain31 = "bonuscave\.com" ascii wide nocase
        $domain32 = "buyonebuy\.top" ascii wide nocase
        $domain33 = "c7p949983\.silveradeearyray\.com" ascii wide nocase
        $domain34 = "cabsecnow\.com" ascii wide nocase
        $domain35 = "calendargbmechanical\.cam" ascii wide nocase
        $domain36 = "calendarthomastecs\.cam" ascii wide nocase
        $domain37 = "calendercongress\.cam" ascii wide nocase
        $domain38 = "calendercongress\.com" ascii wide nocase
        $domain39 = "careerhuawei\.net" ascii wide nocase
        $domain40 = "cdn\.update\.huaweiyuncdn\.com" ascii wide nocase
        $domain41 = "cdn1\.update\.huaweiyuncdn\.com" ascii wide nocase
        $domain42 = "cdn7s65\.z13\.web\.core\.windows\.net" ascii wide nocase
        $domain43 = "concreteinportland\.com" ascii wide nocase
        $domain44 = "conflictaslesson\.com" ascii wide nocase
        ...
        $ip50 = "102.211.234.105" ascii wide
        $ip51 = "103.107.104.37" ascii wide
        $ip52 = "103.107.104.61" ascii wide
        $ip53 = "103.107.104.61" ascii wide
        $ip54 = "103.13.31.75" ascii wide
        $ip55 = "103.15.28.145" ascii wide
        $ip56 = "103.15.29.17" ascii wide
        $ip57 = "103.159.132.80" ascii wide
        $ip58 = "103.175.50.32" ascii wide
        $ip59 = "103.192.226.46" ascii wide
        $ip60 = "103.200.97.189" ascii wide
        $ip61 = "103.200.97.189" ascii wide
        $ip62 = "103.245.164.154" ascii wide
        $ip63 = "103.247.19.204" ascii wide
        $ip64 = "103.249.84.137" ascii wide
        $ip65 = "103.27.109.157" ascii wide
        $ip66 = "103.56.18.101" ascii wide
        $ip67 = "103.56.18.101" ascii wide
        $ip68 = "103.56.53.120" ascii wide
        $ip69 = "103.79.120.70" ascii wide
        $ip70 = "103.79.120.70" ascii wide
        $ip71 = "103.79.120.71" ascii wide
        $ip72 = "103.79.120.71" ascii wide
        $ip73 = "103.79.120.73" ascii wide
        $ip74 = "103.79.120.73" ascii wide
        $ip75 = "103.79.120.74" ascii wide
        $ip76 = "103.79.120.74" ascii wide
        $ip77 = "103.79.120.81" ascii wide
        $ip78 = "103.79.120.81" ascii wide
        $ip79 = "103.79.120.85" ascii wide
...
rule APT_OCEANLOTUS
{
    ...
    strings:
        $domain0 = "0b3l1sk\.me" ascii wide nocase
        $domain1 = "163mailservice\.com" ascii wide nocase
        $domain2 = "24\.datatimes\.org" ascii wide nocase
        $domain3 = "360skylar\.host" ascii wide nocase
        $domain4 = "365\.urielcallum\.com" ascii wide nocase
        $domain5 = "accounts\.getmyip\.com" ascii wide nocase
        $domain6 = "ad\.ssageevrenue\.com" ascii wide nocase
        $domain7 = "adineohler\.com" ascii wide nocase
        $domain8 = "adobe\.riceaub\.com" ascii wide nocase
        $domain9 = "agoras\.hopto\.org" ascii wide nocase
        $domain10 = "agoras\.zapto\.org" ascii wide nocase
        $domain11 = "aisicoin\.com" ascii wide nocase
        $domain12 = "aki\.viperse\.com" ascii wide nocase
        $domain13 = "alicervois\.com" ascii wide nocase
        $domain14 = "aliexpresscn\.net" ascii wide nocase
        $domain15 = "alyerrac\.com" ascii wide nocase
        $domain16 = "anaehler\.com" ascii wide nocase
        $domain17 = "andreafaerber\.com" ascii wide nocase
        $domain18 = "andreagahuvrauvin\.com" ascii wide nocase
        $domain19 = "andreagbridge\.com" ascii wide nocase
        $domain20 = "anessallie\.com" ascii wide nocase
        $domain21 = "annamerrett\.com" ascii wide nocase
        $domain22 = "anofrio\.com" ascii wide nocase
        $domain23 = "antenham\.com" ascii wide nocase
        $domain24 = "aol\.straliaenollma\.xyz" ascii wide nocase
        $domain25 = "api\.anaehler\.com" ascii wide nocase
        $domain26 = "api\.blogdns\.com" ascii wide nocase
        $domain27 = "api\.ciscofreak\.com" ascii wide nocase
        $domain28 = "api\.myddns\.me" ascii wide nocase
        $domain29 = "apiservice\.webhop\.net" ascii wide nocase
        $domain30 = "arbenha\.com" ascii wide nocase
        $domain31 = "arinaurna\.com" ascii wide nocase
        $domain32 = "arkoimmerma\.com" ascii wide nocase
        $domain33 = "art\.guillermoespana\.com" ascii wide nocase
        $domain34 = "art\.yfieldrainasch\.com" ascii wide nocase
        $domain35 = "asia-kotoba\.net" ascii wide nocase
        $domain36 = "att\.illagedrivestralia\.xyz" ascii wide nocase
        $domain37 = "au\.charlineopkesston\.com" ascii wide nocase
        $domain38 = "audreybourgeois\.com" ascii wide nocase
        $domain39 = "aulolloy\.com" ascii wide nocase
        $domain40 = "auth\.lineage2ez\.com" ascii wide nocase
        $domain41 = "avidilleneu\.com" ascii wide nocase
        $domain42 = "avidsontre\.com" ascii wide nocase
        $domain43 = "aximilian\.com" ascii wide nocase
        $domain44 = "b\.cortanazone\.com" ascii wide nocase
        $domain45 = "background\.ristians\.com" ascii wide nocase
        $domain46 = "baidu-search\.net" ascii wide nocase
        $domain47 = "baodachieu\.com" ascii wide nocase
        $domain48 = "baomoivietnam\.com" ascii wide nocase
        $domain49 = "base\.msteamsapi\.com" ascii wide nocase
...
rule APT_PAPERWEREWOLF
{
    ...
    strings:
        $domain0 = "acrobatupdate\.online" ascii wide nocase
        $domain1 = "adobecheck\.online" ascii wide nocase
        $domain2 = "arrotech\.org" ascii wide nocase
        $domain3 = "awalitalk\.com" ascii wide nocase
        $domain4 = "certcalc\.online" ascii wide nocase
        $domain5 = "certcheck\.online" ascii wide nocase
        $domain6 = "certinform\.online" ascii wide nocase
        $domain7 = "easytrns\.com" ascii wide nocase
        $domain8 = "edgeupdates\.online" ascii wide nocase
        $domain9 = "fast-eda\.my" ascii wide nocase
        $domain10 = "fastchessplay\.com" ascii wide nocase
        $domain11 = "fungaros\.com" ascii wide nocase
        $domain12 = "hakyru\.com" ascii wide nocase
        $domain13 = "jantyroza\.com" ascii wide nocase
        $domain14 = "ntpadjust\.online" ascii wide nocase
        $domain15 = "ntpbayhai\.online" ascii wide nocase
        $domain16 = "ntpcalc\.online" ascii wide nocase
        $domain17 = "ntpchck\.online" ascii wide nocase
        $domain18 = "ntpcheck\.online" ascii wide nocase
        $domain19 = "ntpcorrect\.online" ascii wide nocase
        $domain20 = "ntpedge\.online" ascii wide nocase
        $domain21 = "ntpfetch\.online" ascii wide nocase
        $domain22 = "ntpfix\.online" ascii wide nocase
        $domain23 = "ntpget\.online" ascii wide nocase
        $domain24 = "ntphaiba\.online" ascii wide nocase
        $domain25 = "ntphaimot\.online" ascii wide nocase
        $domain26 = "ntphaisau\.online" ascii wide nocase
        $domain27 = "ntpinform\.online" ascii wide nocase
        $domain28 = "ntpluck\.online" ascii wide nocase
        $domain29 = "ntpmatch\.online" ascii wide nocase
        $domain30 = "ntpmuoitam\.online" ascii wide nocase
        $domain31 = "ntpnet\.online" ascii wide nocase
        $domain32 = "ntpquirks\.online" ascii wide nocase
        $domain33 = "ntpsetup\.online" ascii wide nocase
        $domain34 = "ntpsum\.online" ascii wide nocase
        $domain35 = "ntpsync\.online" ascii wide nocase
        $domain36 = "ntptake\.online" ascii wide nocase
        $domain37 = "ntptop\.online" ascii wide nocase
        $domain38 = "ntptrack\.online" ascii wide nocase
        $domain39 = "ntpverify\.online" ascii wide nocase
        $domain40 = "ntpzone\.online" ascii wide nocase
        $domain41 = "packetflow\.online" ascii wide nocase
        $domain42 = "packethost\.online" ascii wide nocase
        $domain43 = "packetlabs\.online" ascii wide nocase
        $domain44 = "packetread\.online" ascii wide nocase
        $domain45 = "packetsign\.online" ascii wide nocase
        $domain46 = "packetswift\.online" ascii wide nocase
        $domain47 = "packettake\.online" ascii wide nocase
        $domain48 = "packetuser\.online" ascii wide nocase
        $domain49 = "packetxhub\.online" ascii wide nocase
...
rule APT_PATCHWORK
{
    ...
    strings:
        ...
        $domain11 = "adobeonline\.org" ascii wide nocase
        $domain12 = "ados\.fyicompsol\.xyz" ascii wide nocase
        $domain13 = "adskochbus\.org" ascii wide nocase
        $domain14 = "alfred\.ignorelist\.com" ascii wide nocase
        $domain15 = "alieanmote\.live" ascii wide nocase
        $domain16 = "altered\.twilightparadox\.com" ascii wide nocase
        $domain17 = "amelaits\.info" ascii wide nocase
        $domain18 = "anabel\.rootranger\.info" ascii wide nocase
        $domain19 = "anchorsoft\.org" ascii wide nocase
        $domain20 = "android-helper\.info" ascii wide nocase
        $domain21 = "anglerrscovey\.com" ascii wide nocase
        $domain22 = "annchenn\.com" ascii wide nocase
        $domain23 = "aonepiece\.org" ascii wide nocase
        $domain24 = "apcas\.bhutanembassynepal\.com" ascii wide nocase
        $domain25 = "api\.inboundhealthcare\.us" ascii wide nocase
        $domain26 = "api\.opensecurity-legacy\.com" ascii wide nocase
        $domain27 = "applepicker\.info" ascii wide nocase
        $domain28 = "appplace\.life" ascii wide nocase
        $domain29 = "apps-house\.com" ascii wide nocase
        $domain30 = "aquilei\.live" ascii wide nocase
        $domain31 = "aquileia\.live" ascii wide nocase
        $domain32 = "arabcomputersupportgroup\.com" ascii wide nocase
        $domain33 = "arkiverat\.info" ascii wide nocase
        $domain34 = "arpawebdom\.org" ascii wide nocase
        $domain35 = "arrayhouse\.org" ascii wide nocase
        $domain36 = "asftbngh\.top" ascii wide nocase
        $domain37 = "asiandefnetwork\.com" ascii wide nocase
        $domain38 = "asustufupdates\.com" ascii wide nocase
        $domain39 = "atus\.toproid\.xyz" ascii wide nocase
        $domain40 = "aurorafoss\.xyz" ascii wide nocase
        $domain41 = "auth\.fyicompsol\.xyz" ascii wide nocase
        $domain42 = "avangrid\.info" ascii wide nocase
        $domain43 = "avtofrom\.us" ascii wide nocase
...
rule APT_Q27
{
    ...
    strings:
        ...
        $domain5 = "api\.keensie\.com" ascii wide nocase
        $domain6 = "d\.pic447\.com" ascii wide nocase
        $domain7 = "datareportnew\.s3\.ap-northeast-2\.amazonaws\.com" ascii wide nocase
        $domain8 = "goldeyeuu\.io" ascii wide nocase
        $domain9 = "l\.pic447\.com" ascii wide nocase
        $domain10 = "l2\.pic447\.com" ascii wide nocase
        $domain11 = "links3s\.s3\.ap-east-1\.amazonaws\.com" ascii wide nocase
        $domain12 = "nsjdhmdjs\.com" ascii wide nocase
        $domain13 = "potatouu\.com" ascii wide nocase
        $domain14 = "s3work08\.s3\.ap-east-1\.amazonaws\.com" ascii wide nocase
        $domain15 = "t\.pic447\.com" ascii wide nocase
        $domain16 = "uu\.goldeyeuu\.io" ascii wide nocase
        $domain17 = "v\.pic447\.com" ascii wide nocase
        $domain18 = "v2\.pic447\.com" ascii wide nocase
        $domain19 = "w\.pic447\.com" ascii wide nocase
        $domain20 = "wk\.goldeyeuu\.io" ascii wide nocase
        $domain21 = "yy-service\.s3\.ap-northeast-2\.amazonaws\.com" ascii wide nocase
        $domain22 = "yyupdats\.s3\.ap-southeast-1\.amazonaws\.com" ascii wide nocase
        $ip23 = "143.92.57.46" ascii wide
        $ip24 = "185.135.79.196" ascii wide
        $ip25 = "185.135.79.200" ascii wide
        $ip26 = "206.233.128.103" ascii wide
        $ip27 = "35.78.126.246" ascii wide
...
rule APT_RAINBOWHYENA
{
    ...
    strings:
        $domain0 = "146\.190\.234\.multiversitetet\.no" ascii wide nocase
        $domain1 = "193\.37\.71\.221\.sslip\.io" ascii wide nocase
        $domain2 = "1be\.pro" ascii wide nocase
        $domain3 = "1cbit-dev\.com" ascii wide nocase
        $domain4 = "1to30\.shop" ascii wide nocase
        $domain5 = "3hito\.tech" ascii wide nocase
        $domain6 = "50forwardspodcast\.co\.uk" ascii wide nocase
        $domain7 = "7evenfoundation\.org" ascii wide nocase
        $domain8 = "92108\.sbs" ascii wide nocase
        $domain9 = "aainfo\.online" ascii wide nocase
        $domain10 = "abhinayafoodrecipes\.com" ascii wide nocase
        $domain11 = "abstractcorner\.com" ascii wide nocase
        $domain12 = "account\.win-shares\.com" ascii wide nocase
        $domain13 = "acquisizione\.net" ascii wide nocase
        $domain14 = "activehealth01\.online" ascii wide nocase
        $domain15 = "admirationhq\.com" ascii wide nocase
        $domain16 = "aegissecurity\.online" ascii wide nocase
        $domain17 = "affilipost\.com" ascii wide nocase
        $domain18 = "affordablecarsonline\.com" ascii wide nocase
        $domain19 = "agelessbonds\.com" ascii wide nocase
        $domain20 = "aifix\.space" ascii wide nocase
        $domain21 = "ainghain\.com" ascii wide nocase
        $domain22 = "aiupworkpro\.com" ascii wide nocase
        $domain23 = "alliedambitions\.com" ascii wide nocase
        $domain24 = "allin1livetv\.xyz" ascii wide nocase
        $domain25 = "allretail\.shop" ascii wide nocase
        $domain26 = "allstaramerican\.com" ascii wide nocase
        $domain27 = "almaxhura\.com" ascii wide nocase
        $domain28 = "alquilerdecuatrimotosmedellin\.com" ascii wide nocase
        $domain29 = "alsawsanaalsawdaa\.com" ascii wide nocase
        $domain30 = "alugueseusite\.net" ascii wide nocase
        $domain31 = "alvarezgabriel\.com" ascii wide nocase
        $domain32 = "alyseikari\.com" ascii wide nocase
        $domain33 = "ama30anos\.online" ascii wide nocase
        $domain34 = "amaatucachorro\.com" ascii wide nocase
        $domain35 = "americancrepes\.co" ascii wide nocase
        $domain36 = "amritsariyadhaba\.com" ascii wide nocase
        $domain37 = "analytisec\.space" ascii wide nocase
        $domain38 = "andrescardenas\.uno" ascii wide nocase
        $domain39 = "anishpitale\.com" ascii wide nocase
        $domain40 = "antenasbet\.online" ascii wide nocase
        $domain41 = "anthonychukwu\.net" ascii wide nocase
        $domain42 = "aonemy\.com" ascii wide nocase
        $domain43 = "app\.shieldify\.online" ascii wide nocase
        $domain44 = "appeasy\.ai" ascii wide nocase
        $domain45 = "appulse\.info" ascii wide nocase
        $domain46 = "areamarket\.online" ascii wide nocase
        $domain47 = "arkadcorretora\.online" ascii wide nocase
        $domain48 = "artmateriali\.com" ascii wide nocase
        $domain49 = "arya-anggara\.xyz" ascii wide nocase
        $ip50 = "178.255.127.65" ascii wide
        $ip51 = "185.80.91.107" ascii wide
        $ip52 = "193.176.153.162" ascii wide
        $ip53 = "193.176.153.162" ascii wide
        $ip54 = "194.87.239.71" ascii wide
        $ip55 = "194.87.239.71" ascii wide
        $ip56 = "194.87.239.71" ascii wide
        $ip57 = "194.87.239.71" ascii wide
        $ip58 = "194.87.93.153" ascii wide
        $ip59 = "195.133.32.213" ascii wide
        $ip60 = "213.232.204.111" ascii wide
        $ip61 = "213.232.204.111" ascii wide
        $ip62 = "31.56.227.100" ascii wide
        $ip63 = "31.56.227.100" ascii wide
        $ip64 = "31.56.227.100" ascii wide
        $ip65 = "31.56.227.61" ascii wide
        $ip66 = "31.56.227.61" ascii wide
        $ip67 = "31.56.227.61" ascii wide
        $ip68 = "31.56.227.61" ascii wide
        $ip69 = "31.56.227.61" ascii wide
        $ip70 = "31.56.227.61" ascii wide
        $ip71 = "31.56.227.61" ascii wide
        $ip72 = "31.56.227.61" ascii wide
        $ip73 = "31.56.48.178" ascii wide
        $ip74 = "31.58.137.197" ascii wide
        $ip75 = "31.58.137.197" ascii wide
        $ip76 = "31.58.137.197" ascii wide
        $ip77 = "31.59.102.61" ascii wide
        $ip78 = "38.244.205.244" ascii wide
        $ip79 = "38.244.205.244" ascii wide
...
rule APT_SANDWORM
{
    ...
    strings:
        $domain0 = "1o\.cdn-googel\.com" ascii wide nocase
        $domain1 = "2zilmiystfbjib2k4hvhpnv2uhni4ax5ce4xlpb7swkjimfnszxbkaid\.onion" ascii wide nocase
        $domain2 = "365softupdate\.com" ascii wide nocase
        $domain3 = "389424\.xyz" ascii wide nocase
        $domain4 = "445600\.xyz" ascii wide nocase
        $domain5 = "4b\.cdn-banamex\.com" ascii wide nocase
        $domain6 = "abaronaweb\.net" ascii wide nocase
        $domain7 = "account-check\.hostapp\.link" ascii wide nocase
        $domain8 = "account-googlmail\.ml" ascii wide nocase
        $domain9 = "account-loginserv\.com" ascii wide nocase
        $domain10 = "account\.adfs\.kyivstar\.online" ascii wide nocase
        $domain11 = "accounts\.google-account-settings\.spdup\.art" ascii wide nocase
        $domain12 = "activationsmicrosoft\.com" ascii wide nocase
        $domain13 = "adfs\.kyivstar\.online" ascii wide nocase
        $domain14 = "admin\.hantangcapital\.com" ascii wide nocase
        $domain15 = "adobeprotectcheck\.com" ascii wide nocase
        $domain16 = "ads\.ew\.com\.cn" ascii wide nocase
        $domain17 = "ads\.tolinkhub\.com" ascii wide nocase
        $domain18 = "aiads\.best" ascii wide nocase
        $domain19 = "akamaizes\.com" ascii wide nocase
        $domain20 = "all-invite\.org" ascii wide nocase
        $domain21 = "allserve\.xyz" ascii wide nocase
        $domain22 = "annualgieconferenceinmunich2024\.com" ascii wide nocase
        $domain23 = "antimailspam\.com" ascii wide nocase
        $domain24 = "api-to-now\.allserve\.xyz" ascii wide nocase
        $domain25 = "api\.beesapp\.top" ascii wide nocase
        $domain26 = "api\.budandan\.com" ascii wide nocase
        $domain27 = "api\.chaboshi\.cc" ascii wide nocase
        $domain28 = "api\.click2mine\.top" ascii wide nocase
        $domain29 = "api\.degendogs\.top" ascii wide nocase
        $domain30 = "api\.fastrig\.top" ascii wide nocase
        $domain31 = "api\.globalsimc\.com" ascii wide nocase
        $domain32 = "api\.gmc-doge\.top" ascii wide nocase
        $domain33 = "api\.jackpotsure\.win" ascii wide nocase
        $domain34 = "api\.luckytonspin\.top" ascii wide nocase
        $domain35 = "api\.omgton\.xyz" ascii wide nocase
        $domain36 = "api\.plantton\.top" ascii wide nocase
        $domain37 = "api\.powerdigger\.top" ascii wide nocase
        $domain38 = "api\.powerton\.top" ascii wide nocase
        $domain39 = "api\.surewinsgjackpot\.com" ascii wide nocase
        $domain40 = "api\.tonblastrun\.top" ascii wide nocase
        $domain41 = "api\.tonchainer\.top" ascii wide nocase
        $domain42 = "api\.toncore\.top" ascii wide nocase
        $domain43 = "api\.tondaily\.top" ascii wide nocase
        $domain44 = "api\.tondrillx\.top" ascii wide nocase
        $domain45 = "api\.tonengine\.top" ascii wide nocase
        $domain46 = "api\.tonfarmers\.top" ascii wide nocase
        $domain47 = "api\.tonforgex\.top" ascii wide nocase
        $domain48 = "api\.tonhive\.top" ascii wide nocase
        $domain49 = "api\.tonmineplus\.top" ascii wide nocase
...
rule APT_SIDEWINDER
{
    ...
    strings:
        $domain0 = "0range\.site" ascii wide nocase
        $domain1 = "0ultook\.live" ascii wide nocase
        $domain2 = "1\.modp-pk\.org" ascii wide nocase
        $domain3 = "101c4a583c3acdd2a06ca2fb183cf995fgd55fghf67dhf7dhf7dhnfks7\.pages\.dev" ascii wide nocase
        $domain4 = "101c4a583c3acdd2afd06ca2fb183cf995sdfsdh54jkdfgh54893489h5\.pages\.dev" ascii wide nocase
        $domain5 = "101c4a583c3acdd2dfgn54990fgmkl5i90ghml569ig06ca2fb183cf995\.pages\.dev" ascii wide nocase
        $domain6 = "101c4a5fdjfjkf8fg90fksd9dfslsd0fk83c3acdd2a06ca2fb183cf995\.pages\.dev" ascii wide nocase
        $domain7 = "109\.176\.30\.212\.sslip\.io" ascii wide nocase
        $domain8 = "126-com\.live" ascii wide nocase
        $domain9 = "126mail-cn\.com" ascii wide nocase
        $domain10 = "163inc\.org" ascii wide nocase
        $domain11 = "168-gov\.info" ascii wide nocase
        $domain12 = "16bz5\.pmreco\.xyz" ascii wide nocase
        $domain13 = "17067699af72f31706fgjkf5kg9j4990gk950\.netlify\.app" ascii wide nocase
        $domain14 = "172\.86\.92\.150\.sslip\.io" ascii wide nocase
        $domain15 = "1846m\.pmreco\.xyz" ascii wide nocase
        $domain16 = "1c1157fa\.caa\.update\.customs-lk\.org" ascii wide nocase
        $domain17 = "1d06bfb2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain18 = "1d06bfb2\.local\.update\.fia-gov\.org" ascii wide nocase
        $domain19 = "1d06bfb2\.scan\.update\.fia-gov\.org" ascii wide nocase
        $domain20 = "203-124351878443\.hopto\.org" ascii wide nocase
        $domain21 = "234rewr44dfs34sdf43454353fd4ffg345rr4\.netlify\.app" ascii wide nocase
        $domain22 = "23873f12-1c4d-40b4-a5b4-60277cca546f\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain23 = "24170-40494\.bacloud\.info" ascii wide nocase
        $domain24 = "2672ewr5403894534fgdgfd5907e44fdfgdfg67088gdfgfd90e2cbd8b6\.pages\.dev" ascii wide nocase
        $domain25 = "2aeb306b-4c5f-4cc6-a7a2-6fcd96612b9d\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain26 = "2let\.org" ascii wide nocase
        $domain27 = "2r\.nrtcpk-net\.com" ascii wide nocase
        $domain28 = "38273409\.mail-defence-lk-loging-horde\.pages\.dev" ascii wide nocase
        $domain29 = "3g\.maildownloadfiles\.com" ascii wide nocase
        $domain30 = "3nxyc\.pmreco\.xyz" ascii wide nocase
        $domain31 = "423743f1-53d2-41bf-9dba-e1e0b7c8f460\.pmreco\.xyz" ascii wide nocase
        $domain32 = "435fdgfd-fgh675gh56jh-65jhg65ghjytu65\.netlify\.app" ascii wide nocase
        $domain33 = "4yj7f\.pmreco\.xyz" ascii wide nocase
        $domain34 = "5673696e-bcf9-4a34-848d-2e6875b0561e\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain35 = "5vs9r\.pmreco\.xyz" ascii wide nocase
        $domain36 = "63inc\.com" ascii wide nocase
        $domain37 = "64115cb6\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain38 = "6441056b613c32a9\.dwnlld\.info" ascii wide nocase
        $domain39 = "6dbb77fd-6d9d-415e-b414-3d1051cd33f4\.dytt888\.net" ascii wide nocase
        $domain40 = "753fa5b2\.check\.update\.fia-gov\.org" ascii wide nocase
        $domain41 = "7b1271c3-0158-4f94-b54e-d51a4be1cfc4\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain42 = "7ef1996f-c463-4540-936a-70d0fd477f98\.live-co\.org" ascii wide nocase
        $domain43 = "81-cn\.ddns\.net" ascii wide nocase
        $domain44 = "81-cn\.info" ascii wide nocase
        $domain45 = "85476ee3-a4b9-4815-bd1d-68653205e378\.us-east-1\.cloud\.genez\.io" ascii wide nocase
        $domain46 = "8ad94e36\.cdn-caa-sco\.pages\.dev" ascii wide nocase
        $domain47 = "96c54\.pmreco\.xyz" ascii wide nocase
        $domain48 = "982m31\.pmreco\.xyz" ascii wide nocase
        $domain49 = "9af72fg4jg75hg8jg94kg94k9fk390gk4170674tr69bf1f766cdec1d11\.pages\.dev" ascii wide nocase
        ...
        $ip70 = "38.60.235.109" ascii wide
        $ip71 = "46.8.226.5" ascii wide
        $ip72 = "47.236.177.123" ascii wide
        $ip73 = "47.76.135.130" ascii wide
        $ip74 = "47.84.196.148" ascii wide
        $ip75 = "5.230.40.141" ascii wide
        $ip76 = "5.230.42.202" ascii wide
        $ip77 = "5.230.43.203" ascii wide
        $ip78 = "5.230.52.133" ascii wide
        $ip79 = "5.230.54.162" ascii wide
...
rule APT_SILENTLYNX
{
    ...
    strings:
        ...
        $domain36 = "catalog-update-update-microsoft\.serveftp\.com" ascii wide nocase
        $domain37 = "catchthestorms\.net" ascii wide nocase
        $domain38 = "check-connection\.org" ascii wide nocase
        $domain39 = "checkingsite\.org" ascii wide nocase
        $domain40 = "citylinefood\.com" ascii wide nocase
        $domain41 = "cm-elevatori\.com" ascii wide nocase
        $domain42 = "cmcrushermachine\.com" ascii wide nocase
        $domain43 = "colombaogrobg\.com" ascii wide nocase
        $domain44 = "consultafacildoc\.com" ascii wide nocase
        $domain45 = "consultasfacildoc\.com" ascii wide nocase
        $domain46 = "converting-system\.com" ascii wide nocase
        $domain47 = "csiwoffshore\.com" ascii wide nocase
        ...
        $ip52 = "152.53.20.140" ascii wide
        $ip53 = "154.31.217.203" ascii wide
        $ip54 = "172.86.75.237" ascii wide
        $ip55 = "185.122.171.22" ascii wide
        $ip56 = "185.62.57.219" ascii wide
        $ip57 = "193.124.203.226" ascii wide
        $ip58 = "65.38.120.38" ascii wide
        $ip59 = "65.38.121.107" ascii wide
        $ip60 = "72.5.43.100" ascii wide
        $ip61 = "72.5.43.178" ascii wide
        $ip62 = "81.19.136.241" ascii wide
        $ip63 = "81.19.136.241" ascii wide
        $ip64 = "82.115.223.210" ascii wide
        $ip65 = "85.209.128.171" ascii wide
        $ip66 = "85.209.128.171" ascii wide
        $ip67 = "85.209.128.171" ascii wide
        $ip68 = "85.209.128.171" ascii wide
        $ip69 = "85.209.128.171" ascii wide
        $ip70 = "88.214.26.37" ascii wide
        $ip71 = "88.214.26.37" ascii wide
        $ip72 = "96.9.125.168" ascii wide
...
rule APT_SOFACY
{
    ...
    strings:
        ...
        $domain29 = "48d83469-d0c6-4ade-8f82-e383fff094b8\.webhook\.site" ascii wide nocase
        $domain30 = "512521525-5245451515-985978774-2341235146436\.xyz" ascii wide nocase
        $domain31 = "546874\.tk" ascii wide nocase
        $domain32 = "5thelementq8\.com" ascii wide nocase
        $domain33 = "645547657668787\.com" ascii wide nocase
        $domain34 = "6c7aa72bd5f1d30203b80596f926b2b7\.serveo\.net" ascii wide nocase
        $domain35 = "73ce1aae8a9ba738b91040232524f51a\.serveo\.net" ascii wide nocase
        $domain36 = "78cc700b31dcd7c7f25fd7b0372259e3\.serveo\.net" ascii wide nocase
        $domain37 = "7daysinabudhabi\.org" ascii wide nocase
        $domain38 = "90update\.com" ascii wide nocase
        $domain39 = "910cf351-a05d-4f67-ab8e-6f62cfa8e26d\.dnshook\.site" ascii wide nocase
        $domain40 = "92ace7e653e9c32d2af9700592cc96ea\.serveo\.net" ascii wide nocase
        $domain41 = "9348243249382479234343284324023432748892349702394023\.xyz" ascii wide nocase
        $domain42 = "9832473219412342343423243242364-34939246823743287468793247237\.site" ascii wide nocase
        $domain43 = "99996665550\.fun" ascii wide nocase
        $domain44 = "99kg\.site" ascii wide nocase
        $domain45 = "9b5uja\.am\.files\.1drv\.com" ascii wide nocase
        $domain46 = "a\.zhblz\.com" ascii wide nocase
        $domain47 = "aa\.69\.mu" ascii wide nocase
        $domain48 = "aadexpo2014\.co\.za" ascii wide nocase
        $domain49 = "abbott-export\.com" ascii wide nocase
        $ip50 = "101.255.119.42" ascii wide
        $ip51 = "103.140.186.148" ascii wide
        $ip52 = "103.140.186.149" ascii wide
        $ip53 = "103.140.186.155" ascii wide
        $ip54 = "109.169.15.73" ascii wide
        $ip55 = "113.160.234.229" ascii wide
        $ip56 = "128.199.199.187" ascii wide
        $ip57 = "144.126.202.227" ascii wide
        $ip58 = "145.249.106.198" ascii wide
        $ip59 = "148.252.42.42" ascii wide
        $ip60 = "163.172.67.233" ascii wide
        $ip61 = "167.114.153.55" ascii wide
        $ip62 = "168.205.200.55" ascii wide
        $ip63 = "172.114.170.18" ascii wide
        $ip64 = "172.114.170.18" ascii wide
        $ip65 = "174.53.242.108" ascii wide
        $ip66 = "178.32.251.98" ascii wide
        $ip67 = "18.157.68.73" ascii wide
        $ip68 = "18.192.93.86" ascii wide
        $ip69 = "18.197.239.109" ascii wide
        $ip70 = "181.209.99.204" ascii wide
        $ip71 = "184.95.51.172" ascii wide
        $ip72 = "185.117.88.22" ascii wide
        $ip73 = "185.117.88.28" ascii wide
        $ip74 = "185.117.88.29" ascii wide
        $ip75 = "185.117.88.30" ascii wide
        $ip76 = "185.117.88.31" ascii wide
        $ip77 = "185.117.88.50" ascii wide
        $ip78 = "185.117.88.60" ascii wide
        $ip79 = "185.117.88.61" ascii wide
...
rule APT_THEWIZARDS
{
    ...
    strings:
        ...
        $ip5 = "110.92.64.177" ascii wide
        $ip6 = "117.175.185.81" ascii wide
        $ip7 = "43.132.205.118" ascii wide
        $ip8 = "43.155.62.54" ascii wide
        $ip9 = "47.238.107.83" ascii wide
        $ip10 = "47.93.54.134" ascii wide
        $ip11 = "47.93.54.134" ascii wide
        $ip12 = "47.93.54.134" ascii wide
        $ip13 = "49.89.41.187" ascii wide
        $ip14 = "49.89.41.187" ascii wide
        $ip15 = "49.89.41.187" ascii wide
        $ip16 = "89.195.5.18" ascii wide
...
rule APT_TRANSPARENTTRIBE
{
    meta:
        ...
        aliases = "G0134, actionrat, apt-c-56"
    ...
    strings:
        ...
        $domain2 = "1ov\.shop" ascii wide nocase
        $domain3 = "1s1\.accesscam\.org" ascii wide nocase
        $domain4 = "2\.digipay\.us\.cc" ascii wide nocase
        $domain5 = "2co\.shop" ascii wide nocase
        $domain6 = "2ndline\.cfd" ascii wide nocase
        $domain7 = "34667\.fun" ascii wide nocase
        $domain8 = "37-221-64-202\.cprapid\.com" ascii wide nocase
        $domain9 = "37-221-64-252\.cprapid\.com" ascii wide nocase
        $domain10 = "376zbaqsnigt\.com" ascii wide nocase
        $domain11 = "3a4p8gq8bojwn\.xyz" ascii wide nocase
        $domain12 = "414\.camdvr\.org" ascii wide nocase
        $domain13 = "415\.mywire\.org" ascii wide nocase
        $domain14 = "419\.theworkpc\.com" ascii wide nocase
        $domain15 = "43-228-125-28\.cprapid\.com" ascii wide nocase
        $domain16 = "5-135-125-106\.cinfuserver\.com" ascii wide nocase
        $domain17 = "56184\.fun" ascii wide nocase
        $domain18 = "5gsewa\.cyou" ascii wide nocase
        $domain19 = "5zbm0\.cfd" ascii wide nocase
        $domain20 = "66xq2\.top" ascii wide nocase
        $domain21 = "6jxbmkpe\.torontobotdns\.com" ascii wide nocase
        $domain22 = "76767\.icu" ascii wide nocase
        $domain23 = "78990\.fun" ascii wide nocase
        $domain24 = "7thcpcupdates\.info" ascii wide nocase
        $domain25 = "873013\.xyz" ascii wide nocase
        $domain26 = "88c\.34667\.fun" ascii wide nocase
        $domain27 = "89204\.fun" ascii wide nocase
        $domain28 = "8a\.monitorondomainlintgt\.store" ascii wide nocase
        $domain29 = "8fold\.space" ascii wide nocase
        $domain30 = "8ln62\.cfd" ascii wide nocase
        $domain31 = "8thpaycomission\.cloud" ascii wide nocase
        $domain32 = "8tqxpf27\.torontobotdns\.com" ascii wide nocase
        $domain33 = "903\.78990\.fun" ascii wide nocase
        $domain34 = "9123\.89204\.fun" ascii wide nocase
        $domain35 = "9882aa1216\.autos" ascii wide nocase
        $domain36 = "999game\.website" ascii wide nocase
        $domain37 = "9gi02\.cfd" ascii wide nocase
        $domain38 = "9ydygorig3l7z\.xyz" ascii wide nocase
        $domain39 = "9z\.monitorondomainwintgt2\.store" ascii wide nocase
        $domain40 = "a\.erforias\.cam" ascii wide nocase
        $domain41 = "aa\.76767\.icu" ascii wide nocase
        $domain42 = "aadharpor\.xyz" ascii wide nocase
        $domain43 = "aadharsewa\.site" ascii wide nocase
        $domain44 = "aadperson\.xyz" ascii wide nocase
        $domain45 = "aaloochaat\.com" ascii wide nocase
        $domain46 = "aboutcase\.nl" ascii wide nocase
        $domain47 = "ac\.76767\.icu" ascii wide nocase
        $domain48 = "accinfo\.live" ascii wide nocase
        $domain49 = "account-recovery\.com" ascii wide nocase
...
rule APT_TURLA
{
    ...
    strings:
        ...
        $domain6 = "api\.softwareupdatenews\.com" ascii wide nocase
        $domain7 = "archive-articles\.linkpc\.net" ascii wide nocase
        $domain8 = "arctic-zone\.bbsindex\.com" ascii wide nocase
        $domain9 = "arinas\.tk" ascii wide nocase
        $domain10 = "auberdine\.etowns\.net" ascii wide nocase
        $domain11 = "av\.master\.dns-cloud\.net" ascii wide nocase
        $domain12 = "avmaster\.dns-cloud\.net" ascii wide nocase
        $domain13 = "badget\.ignorelist\.com" ascii wide nocase
        $domain14 = "baltdefcol\.webredirect\.org" ascii wide nocase
        $domain15 = "bedrost\.com" ascii wide nocase
        $domain16 = "bestfunc\.slyip\.net" ascii wide nocase
        $domain17 = "bigpen\.ga" ascii wide nocase
        $domain18 = "blackerror\.ignorelist\.com" ascii wide nocase
        $domain19 = "booking\.etowns\.org" ascii wide nocase
        $domain20 = "booking\.strangled\.net" ascii wide nocase
        $domain21 = "bookstore\.strangled\.net" ascii wide nocase
        $domain22 = "branter\.tk" ascii wide nocase
        $domain23 = "bronerg\.tk" ascii wide nocase
        $domain24 = "bug\.ignorelist\.com" ascii wide nocase
        $domain25 = "buy-new-car\.com" ascii wide nocase
        $domain26 = "caduff-sa\.chjeepcarlease\.com" ascii wide nocase
        $domain27 = "canal1zac1a\.onrender\.com" ascii wide nocase
        $domain28 = "carleasingguru\.com" ascii wide nocase
        $domain29 = "cars-online\.zapto\.org" ascii wide nocase
        $domain30 = "cdn\.datacenterate\.com" ascii wide nocase
        $domain31 = "celestyna\.tk" ascii wide nocase
        $domain32 = "ceremon\.2waky\.com" ascii wide nocase
        $domain33 = "cheapflights\.etowns\.net" ascii wide nocase
        $domain34 = "chinafood\.chickenkiller\.com" ascii wide nocase
        $domain35 = "chjeepcarlease\.com" ascii wide nocase
        $domain36 = "climbent\.mooo\.com" ascii wide nocase
        $domain37 = "codewizard\.ml" ascii wide nocase
        $domain38 = "coldriver\.strangled\.net" ascii wide nocase
        $domain39 = "communityeu\.xp3\.biz" ascii wide nocase
        $domain40 = "connectotels\.net" ascii wide nocase
        $domain41 = "crusider\.tk" ascii wide nocase
        $domain42 = "cyberazov\.com" ascii wide nocase
        $domain43 = "cyberazov\.tk" ascii wide nocase
        $domain44 = "d3hdbjtb1686tn\.cloudfront\.net" ascii wide nocase
        $domain45 = "da\.anythinktech\.com" ascii wide nocase
        $domain46 = "datacenterate\.com" ascii wide nocase
        $domain47 = "davilta\.tk" ascii wide nocase
        $domain48 = "dellservice\.publicvm\.com" ascii wide nocase
        $domain49 = "deme\.ml" ascii wide nocase
        $ip50 = "103.136.43.65" ascii wide
        $ip51 = "103.143.40.60" ascii wide
        $ip52 = "103.143.40.91" ascii wide
        $ip53 = "103.30.76.194" ascii wide
        $ip54 = "104.167.16.42" ascii wide
        $ip55 = "134.209.222.206" ascii wide
        $ip56 = "154.53.42.194" ascii wide
        $ip57 = "185.126.255.132" ascii wide
        $ip58 = "185.253.116.122" ascii wide
        $ip59 = "194.36.190.17" ascii wide
        $ip60 = "205.186.64.197" ascii wide
        $ip61 = "38.180.173.194" ascii wide
        $ip62 = "45.64.186.26" ascii wide
        $ip63 = "45.89.107.77" ascii wide
        $ip64 = "46.17.45.93" ascii wide
        $ip65 = "5.252.176.22" ascii wide
        $ip66 = "85.222.235.156" ascii wide
        $url67 = "/rss_0\.php" ascii wide nocase
        $url68 = "/config\.php" ascii wide nocase
        $url69 = "/rss_0\.php" ascii wide nocase
...
rule APT_UNC1151
{
    ...
    strings:
        $domain0 = "a1si\.icu" ascii wide nocase
        $domain1 = "a3ufz\.xsjdsb\.icu" ascii wide nocase
        $domain2 = "account-inbox\.online" ascii wide nocase
        $domain3 = "account-login\.top" ascii wide nocase
        $domain4 = "account-noreply\.space" ascii wide nocase
        $domain5 = "account-passports\.top" ascii wide nocase
        $domain6 = "account\.no-replay-notification\.ga" ascii wide nocase
        $domain7 = "accounts-facebook\.com-pastas\.top" ascii wide nocase
        $domain8 = "accounts-gmail\.com-check\.online" ascii wide nocase
        $domain9 = "accounts-gmail\.com-login\.space" ascii wide nocase
        $domain10 = "accounts-gmail\.com-pastas\.top" ascii wide nocase
        $domain11 = "accounts-group\.com-pastas\.top" ascii wide nocase
        $domain12 = "accounts-inbox\.ml" ascii wide nocase
        $domain13 = "accounts-login\.top" ascii wide nocase
        $domain14 = "accounts-mail\.site" ascii wide nocase
        $domain15 = "accounts-passport\.top" ascii wide nocase
        $domain16 = "accounts-secure\.com-firewall\.online" ascii wide nocase
        $domain17 = "accounts-support\.com-account\.website" ascii wide nocase
        $domain18 = "accounts-support\.net-account\.space" ascii wide nocase
        $domain19 = "accounts-telekom\.online" ascii wide nocase
        $domain20 = "accounts-ukr\.net-account\.space" ascii wide nocase
        $domain21 = "accounts-ukr\.net-verification\.online" ascii wide nocase
        $domain22 = "accounts-verification\.net-account\.space" ascii wide nocase
        $domain23 = "accounts-verify\.space" ascii wide nocase
        $domain24 = "accounts\.safe-mail\.space" ascii wide nocase
        $domain25 = "accounts\.secure-ua\.site" ascii wide nocase
        $domain26 = "accounts\.secure-ua\.website" ascii wide nocase
        $domain27 = "accounts\.verify-email\.space" ascii wide nocase
        $domain28 = "accountsverify\.top" ascii wide nocase
        $domain29 = "acount-pasport\.site" ascii wide nocase
        $domain30 = "acount-passport\.site" ascii wide nocase
        $domain31 = "acounts\.net-verification\.online" ascii wide nocase
        $domain32 = "advancedaisolutionsforeveryone\.a1si\.icu" ascii wide nocase
        $domain33 = "aff-gos\.top" ascii wide nocase
        $domain34 = "agelessinvesting\.xyz" ascii wide nocase
        $domain35 = "ais-gos\.top" ascii wide nocase
        $domain36 = "akademia-mil\.space" ascii wide nocase
        $domain37 = "alertapp\.icu" ascii wide nocase
        $domain38 = "alerteddatalistsclients\.alertapp\.icu" ascii wide nocase
        $domain39 = "alexavegas\.icu" ascii wide nocase
        $domain40 = "algsat\.icu" ascii wide nocase
        $domain41 = "all-ukraine\.top" ascii wide nocase
        $domain42 = "alls-gos\.top" ascii wide nocase
        $domain43 = "americandeliriumsociety\.shop" ascii wide nocase
        $domain44 = "ams-gos\.top" ascii wide nocase
        $domain45 = "ao-opros\.top" ascii wide nocase
        $domain46 = "api\.passport-yandex\.ru" ascii wide nocase
        $domain47 = "aplikacje\.ron-mil\.space" ascii wide nocase
        $domain48 = "attachment-storage-asset-static\.needbinding\.icu" ascii wide nocase
        $domain49 = "authorization-inbox\.site" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        $domain0 = "08f0\.proxy-edge-c5f\.workers\.dev" ascii wide nocase
        $domain1 = "10bet\.space" ascii wide nocase
        $domain2 = "12\.workbencn\.com" ascii wide nocase
        $domain3 = "178\.159\.43\.206\.sslip\.io" ascii wide nocase
        $domain4 = "1r\.rvtoolsed\.com" ascii wide nocase
        $domain5 = "1s\.rvtoolsai\.com" ascii wide nocase
        $domain6 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain7 = "1v\.rvtootsad\.com" ascii wide nocase
        $domain8 = "1yeralti\.com" ascii wide nocase
        $domain9 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain10 = "20\.rvtoolse\.info" ascii wide nocase
        $domain11 = "20\.rvtoolsme\.com" ascii wide nocase
        $domain12 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain13 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain14 = "24\.rvtoolis\.info" ascii wide nocase
        $domain15 = "24\.rvtoolsgo\.com" ascii wide nocase
        $domain16 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain17 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain18 = "2b\.rvtoolsit\.com" ascii wide nocase
        $domain19 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain20 = "2w\.s3abrowser\.com" ascii wide nocase
        $domain21 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain22 = "3p\.workbenche\.com" ascii wide nocase
        $domain23 = "40\.workbencse\.com" ascii wide nocase
        $domain24 = "45perhour\.org" ascii wide nocase
        $domain25 = "4l\.rvtoolslab\.com" ascii wide nocase
        $domain26 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain27 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain28 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain29 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain30 = "5n\.rvtoolsrun\.com" ascii wide nocase
        $domain31 = "7stories\.sbs" ascii wide nocase
        $domain32 = "91movs\.com" ascii wide nocase
...
rule APT_UNC2814
{
    ...
    strings:
        ...
        $domain4 = "apiotc\.duckdns\.org" ascii wide nocase
        $domain5 = "applebox\.camdvr\.org" ascii wide nocase
        $domain6 = "appler\.kozow\.com" ascii wide nocase
        $domain7 = "asdad21ww\.freeddns\.org" ascii wide nocase
        $domain8 = "aw2o25forsbc\.camdvr\.org" ascii wide nocase
        $domain9 = "awcc001jdaigfwdagdcew\.giize\.com" ascii wide nocase
        $domain10 = "bab2o25com\.accesscam\.org" ascii wide nocase
        $domain11 = "babaji\.accesscam\.org" ascii wide nocase
        $domain12 = "babi5599ss\.ddnsgeek\.com" ascii wide nocase
        $domain13 = "balabalabo\.mywire\.org" ascii wide nocase
        $domain14 = "bggs\.giize\.com" ascii wide nocase
        $domain15 = "bibabo\.freeddns\.org" ascii wide nocase
        $domain16 = "binmol\.webredirect\.org" ascii wide nocase
        $domain17 = "bioth\.giize\.com" ascii wide nocase
        $domain18 = "bitel\.mywire\.org" ascii wide nocase
        $domain19 = "boemobww\.ddnsfree\.com" ascii wide nocase
        $domain20 = "brcallletme\.theworkpc\.com" ascii wide nocase
        $domain21 = "btbtutil\.theworkpc\.com" ascii wide nocase
        $domain22 = "btltan\.ooguy\.com" ascii wide nocase
        $domain23 = "camcampkes\.ddnsfree\.com" ascii wide nocase
        $domain24 = "camsqewivo\.kozow\.com" ascii wide nocase
        $domain25 = "ccammutom\.ddnsgeek\.com" ascii wide nocase
        $domain26 = "ccel\.kozow\.com" ascii wide nocase
        $domain27 = "cdnvmtools\.theworkpc\.com" ascii wide nocase
        $domain28 = "cloacpae\.ddnsfree\.com" ascii wide nocase
        $domain29 = "cmwwoods1\.theworkpc\.com" ascii wide nocase
        $domain30 = "cnrpaslceas\.freeddns\.org" ascii wide nocase
        $domain31 = "codemicros12\.gleeze\.com" ascii wide nocase
        $domain32 = "cp02odjaic\.kozow\.com" ascii wide nocase
        $domain33 = "cressmiss\.ooguy\.com" ascii wide nocase
        $domain34 = "cvabiasbae\.ddnsfree\.com" ascii wide nocase
        $domain35 = "cvnoc01da1cjmnftsd\.accesscam\.org" ascii wide nocase
        $domain36 = "cvpc01aenusocirem\.accesscam\.org" ascii wide nocase
        $domain37 = "cvpc01cgsdfn53hgd\.giize\.com" ascii wide nocase
        $domain38 = "dclcwpdtsdcc\.ddnsfree\.com" ascii wide nocase
        $domain39 = "dlpossie\.ddnsfree\.com" ascii wide nocase
        $domain40 = "dnsfreedb\.ddnsfree\.com" ascii wide nocase
        $domain41 = "doboudix1024\.mywire\.org" ascii wide nocase
        $domain42 = "docla1rocodetellkadihewfnt3\.kozow\.com" ascii wide nocase
        $domain43 = "entel\.kozow\.com" ascii wide nocase
        $domain44 = "evilginx2\.loseyourip\.com" ascii wide nocase
        $domain45 = "examp1e\.webredirect\.org" ascii wide nocase
        $domain46 = "faeelt\.giize\.com" ascii wide nocase
        $domain47 = "fakjcsaeyhs\.ddnsfree\.com" ascii wide nocase
        $domain48 = "fasceadvcva3\.gleeze\.com" ascii wide nocase
        $domain49 = "ffosies2024\.camdvr\.org" ascii wide nocase
...
rule APT_UNC5174
{
    ...
    strings:
        $domain0 = "9oogle\.net" ascii wide nocase
        $domain1 = "apib\.googlespays\.com" ascii wide nocase
        $domain2 = "bootstrapcdn\.fun" ascii wide nocase
        $domain3 = "btt\.evil\.gooogleasia\.com" ascii wide nocase
        $domain4 = "c1oudf1are\.com" ascii wide nocase
        $domain5 = "chmobank\.com" ascii wide nocase
        $domain6 = "goo9le\.net" ascii wide nocase
        $domain7 = "googlespays\.com" ascii wide nocase
        $domain8 = "goole-app\.com" ascii wide nocase
        $domain9 = "https\.sex666vr\.com" ascii wide nocase
        $domain10 = "huionepay\.me" ascii wide nocase
        $domain11 = "jajal\.goo9le\.net" ascii wide nocase
        $domain12 = "javaw\.virustotal\.xyz" ascii wide nocase
        $domain13 = "ks\.evil\.gooogleasia\.com" ascii wide nocase
        $domain14 = "l1\.mo1vip\.org" ascii wide nocase
        $domain15 = "l1\.topayapp\.org" ascii wide nocase
        $domain16 = "lin\.c1oudf1are\.com" ascii wide nocase
        $domain17 = "lin\.huionepay\.me" ascii wide nocase
        $domain18 = "lin\.telegrams\.icu" ascii wide nocase
        $domain19 = "mcafeecdn\.xyz" ascii wide nocase
        $domain20 = "mo1vip\.org" ascii wide nocase
        $domain21 = "mtls\.sex666vr\.com" ascii wide nocase
        $domain22 = "samsungcdn\.com" ascii wide nocase
        $domain23 = "start\.bootstrapcdn\.fun" ascii wide nocase
        $domain24 = "telegrams\.icu" ascii wide nocase
        $domain25 = "topayapp\.org" ascii wide nocase
        $domain26 = "virustotal\.xyz" ascii wide nocase
        $domain27 = "vs\.gooogleasia\.com" ascii wide nocase
        $domain28 = "w1\.topayapp\.org" ascii wide nocase
        $domain29 = "wg\.gooogleasia\.com" ascii wide nocase
        $domain30 = "ws\.9oogle\.net" ascii wide nocase
        $domain31 = "ws\.goo9le\.net" ascii wide nocase
        $domain32 = "ws\.goole-app\.com" ascii wide nocase
        $domain33 = "ws\.mo1vip\.org" ascii wide nocase
        $domain34 = "ws\.z2s\.us" ascii wide nocase
        $domain35 = "z2s\.us" ascii wide nocase
        $ip36 = "124.221.120.25" ascii wide
        $ip37 = "5.199.166.4" ascii wide
        $ip38 = "5.199.166.4" ascii wide
        $ip39 = "5.199.166.4" ascii wide
        $ip40 = "84.32.22.130" ascii wide
        $ip41 = "84.32.22.130" ascii wide
...
rule APT_UNC5221
{
    ...
    strings:
        $domain0 = "172-235-56-113\.plesk\.page" ascii wide nocase
        $domain1 = "abbeglasses\.s3\.amazonaws\.com" ascii wide nocase
        $domain2 = "abode-dashboard-media\.s3\.ap-south-1\.amazonaws\.com" ascii wide nocase
        $domain3 = "api\.d-n-s\.name" ascii wide nocase
        $domain4 = "archivevalley-media\.s3\.amazonaws\.com" ascii wide nocase
        $domain5 = "azdatastore\.workers\.dev" ascii wide nocase
        $domain6 = "barannclinic\.com" ascii wide nocase
        $domain7 = "bititer\.org" ascii wide nocase
        $domain8 = "blooming\.s3\.amazonaws\.com" ascii wide nocase
        $domain9 = "calixcloudinfo\.com" ascii wide nocase
        $domain10 = "catcher\.requestcatcher\.com" ascii wide nocase
        $domain11 = "clickcom\.click" ascii wide nocase
        $domain12 = "clicko\.click" ascii wide nocase
        $domain13 = "devs\.calixcloudinfo\.com" ascii wide nocase
        $domain14 = "duorhytm\.fun" ascii wide nocase
        $domain15 = "faoith\.com" ascii wide nocase
        $domain16 = "fconnect\.s3\.amazonaws\.com" ascii wide nocase
        $domain17 = "fiveworkscorp\.com" ascii wide nocase
        $domain18 = "gpoaccess\.com" ascii wide nocase
        $domain19 = "kitfloor\.org" ascii wide nocase
        $domain20 = "line-api\.com" ascii wide nocase
        $domain21 = "msazure\.azdatastore\.workers\.dev" ascii wide nocase
        $domain22 = "natsupport\.net" ascii wide nocase
        $domain23 = "openrbf\.s3\.amazonaws\.com" ascii wide nocase
        $domain24 = "performanceviewtools\.com" ascii wide nocase
        $domain25 = "psecure\.pro" ascii wide nocase
        $domain26 = "safe\.rocks" ascii wide nocase
        $domain27 = "secure-cama\.com" ascii wide nocase
        $domain28 = "service\.systemsvcs\.com" ascii wide nocase
        $domain29 = "shapefiles\.fews\.net\.s3\.amazonaws\.com" ascii wide nocase
        $domain30 = "symantke\.com" ascii wide nocase
        $domain31 = "systemsvcs\.com" ascii wide nocase
        $domain32 = "telemetry\.psecure\.pro" ascii wide nocase
        $domain33 = "the-mentor\.s3\.amazonaws\.com" ascii wide nocase
        $domain34 = "tkshopqd\.s3\.amazonaws\.com" ascii wide nocase
        $domain35 = "tnegadge\.s3\.amazonaws\.com" ascii wide nocase
        $domain36 = "trkbucket\.s3\.amazonaws\.com" ascii wide nocase
        $domain37 = "webb-institute\.com" ascii wide nocase
        $domain38 = "winfoacacorp\.com" ascii wide nocase
        $ip39 = "146.0.228.66" ascii wide
        $ip40 = "146.0.228.66" ascii wide
        $ip41 = "45.227.255.213" ascii wide
        $ip42 = "66.42.68.120" ascii wide
        $ip43 = "8.137.112.245" ascii wide
        $ip44 = "81.2.216.78" ascii wide
...
rule APT_UNC5976
{
    ...
    strings:
        ...
        $domain1 = "anticorruption\.eurcpa\.org" ascii wide nocase
        $domain2 = "brightwave\.top" ascii wide nocase
        $domain3 = "cedarvalley\.top" ascii wide nocase
        $domain4 = "drive\.google\.anticorruption\.eurcpa\.org" ascii wide nocase
        $domain5 = "drive\.google\.sharedfolders\.app" ascii wide nocase
        $domain6 = "drive\.google\.sharedfolders\.org" ascii wide nocase
        $domain7 = "drive\.google\.sharefolders\.org" ascii wide nocase
        $domain8 = "drive\.google\.verify-drive\.com" ascii wide nocase
        $domain9 = "ftp\.brightwave\.top" ascii wide nocase
        $domain10 = "ftp\.cedarvalley\.top" ascii wide nocase
        $domain11 = "ftp\.moonharbor\.top" ascii wide nocase
        $domain12 = "ftp\.plumoapps\.top" ascii wide nocase
        $domain13 = "ftp\.silvercreek\.top" ascii wide nocase
        $domain14 = "ftp\.starlingbay\.top" ascii wide nocase
        $domain15 = "ftp\.willowgrove\.top" ascii wide nocase
        $domain16 = "google\.anticorruption\.eurcpa\.org" ascii wide nocase
        $domain17 = "google\.sharedfolders\.app" ascii wide nocase
        $domain18 = "google\.sharedfolders\.org" ascii wide nocase
        $domain19 = "google\.sharefolders\.org" ascii wide nocase
        $domain20 = "google\.verify-drive\.com" ascii wide nocase
        $domain21 = "kiis\.co\.uk" ascii wide nocase
        $domain22 = "mail\.brightwave\.top" ascii wide nocase
        $domain23 = "mail\.cedarvalley\.top" ascii wide nocase
        $domain24 = "mail\.kiis\.co\.uk" ascii wide nocase
        $domain25 = "mail\.moonharbor\.top" ascii wide nocase
        $domain26 = "mail\.plumoapps\.top" ascii wide nocase
        $domain27 = "mail\.silvercreek\.top" ascii wide nocase
        $domain28 = "mail\.starlingbay\.top" ascii wide nocase
        $domain29 = "mail\.willowgrove\.top" ascii wide nocase
        $domain30 = "moonharbor\.top" ascii wide nocase
        $domain31 = "ns1\.plumoapps\.top" ascii wide nocase
        $domain32 = "ns2\.plumoapps\.top" ascii wide nocase
        $domain33 = "plumoapps\.top" ascii wide nocase
        $domain34 = "sharedfolders\.app" ascii wide nocase
        $domain35 = "sharedfolders\.org" ascii wide nocase
        $domain36 = "sharefolders\.org" ascii wide nocase
        $domain37 = "silvercreek\.top" ascii wide nocase
        $domain38 = "starlingbay\.top" ascii wide nocase
        $domain39 = "verify-drive\.com" ascii wide nocase
        $domain40 = "willowgrove\.top" ascii wide nocase
...
rule APT_UNC6293
{
    ...
    strings:
        $domain0 = "dosportal\.app" ascii wide nocase
        $domain1 = "foreignrelations\.us" ascii wide nocase
        $ip2 = "91.190.191.117" ascii wide
...
{
    meta:
        description = "Detects IOCs associated with APT UNC6353"
        author = "APTtrail Automated Collection"
        apt_group = "UNC6353"
        aliases = "darksword"
    ...
    strings:
        ...
        $domain1 = "cartned\.sheexcell\.ink" ascii wide nocase
        $domain2 = "cdn\.cdncounter\.net" ascii wide nocase
        $domain3 = "cdn\.uacounter\.com" ascii wide nocase
        $domain4 = "cdncounter\.net" ascii wide nocase
        $domain5 = "count\.cdncounter\.net" ascii wide nocase
        $domain6 = "downdown\.online" ascii wide nocase
        $domain7 = "duflaro\.com" ascii wide nocase
        $domain8 = "escofiringbijou\.com" ascii wide nocase
        $domain9 = "inventorepkrje\.sheexcell\.ink" ascii wide nocase
        $domain10 = "iokert\.com" ascii wide nocase
        $domain11 = "lifechangerai\.site" ascii wide nocase
        $domain12 = "link\.sheexcell\.ink" ascii wide nocase
        $domain13 = "mxloft\.sheexcell\.ink" ascii wide nocase
        $domain14 = "nuceciwa138\.xyz" ascii wide nocase
        $domain15 = "rhdcnwjnwf\.site" ascii wide nocase
        $domain16 = "sheexcell\.ink" ascii wide nocase
        $domain17 = "shkaacloud\.ink" ascii wide nocase
        $domain18 = "siekeltd\.com" ascii wide nocase
        $domain19 = "sqwas\.shapelie\.com" ascii wide nocase
        $domain20 = "static\.cdncounter\.net" ascii wide nocase
        $domain21 = "t\.sheexcell\.ink" ascii wide nocase
        $domain22 = "touch-n-go\.online" ascii wide nocase
        $domain23 = "uacounter\.com" ascii wide nocase
        $domain24 = "world-news\.site" ascii wide nocase
        $domain25 = "wwteam\.space" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        $domain0 = "00c397xmk7\.shop" ascii wide nocase
        $domain1 = "00da\.6hv86gxz\.com" ascii wide nocase
        $domain2 = "0159\.axmatx\.com" ascii wide nocase
        $domain3 = "017\.xdjuvoau\.xyz" ascii wide nocase
        $domain4 = "01b26ddfd3\.top" ascii wide nocase
        $domain5 = "01k\.cc" ascii wide nocase
        $domain6 = "022\.furzocpc\.cc" ascii wide nocase
        $domain7 = "0221f016\.6hv86gxz\.com" ascii wide nocase
        $domain8 = "025f\.cjmekxr\.xyz" ascii wide nocase
        $domain9 = "027\.st" ascii wide nocase
        $domain10 = "0278\.fxexebji\.org" ascii wide nocase
        $domain11 = "028mfsb\.com" ascii wide nocase
        $domain12 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain13 = "03f6aef6fd\.top" ascii wide nocase
        $domain14 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain15 = "047\.auyciwmw\.com" ascii wide nocase
        $domain16 = "04f327f914\.top" ascii wide nocase
        $domain17 = "054\.esqifis\.com" ascii wide nocase
        $domain18 = "063\.heppmpuz\.org" ascii wide nocase
        $domain19 = "0661\.vdrywdi\.xyz" ascii wide nocase
        $domain20 = "069\.st" ascii wide nocase
        $domain21 = "06bf0\.crfbbarx\.com" ascii wide nocase
        $domain22 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain23 = "070052\.sod777\.com" ascii wide nocase
        $domain24 = "07c0\.ybbshhn\.com" ascii wide nocase
        $domain25 = "07f61\.ncjqeyid\.com" ascii wide nocase
        $domain26 = "0847\.zcfniju\.cc" ascii wide nocase
        $domain27 = "09688\.xkbaamgc\.cc" ascii wide nocase
        $domain28 = "0992\.app" ascii wide nocase
        $domain29 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain30 = "099ae\.qcechaw\.cc" ascii wide nocase
        $domain31 = "0am15\.com" ascii wide nocase
        $domain32 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain33 = "0b461\.xdjuvoau\.xyz" ascii wide nocase
        $domain34 = "0b6c80a39c\.top" ascii wide nocase
        $domain35 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain36 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain37 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain38 = "0bb7\.dmjdwvpy\.com" ascii wide nocase
        $domain39 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain40 = "0cncoxi\.com" ascii wide nocase
        $domain41 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain42 = "0dc48\.xjhvsgg\.xyz" ascii wide nocase
        $domain43 = "0de\.ofvtspr\.xyz" ascii wide nocase
        $domain44 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain45 = "0e8\.kqyxwyb\.xyz" ascii wide nocase
        $domain46 = "0fx7qmdggegytul\.xyz" ascii wide nocase
        $domain47 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain48 = "0jijrwbzxzzxz04\.xyz" ascii wide nocase
        $domain49 = "0opus\.com" ascii wide nocase
        $ip50 = "151.245.104.179" ascii wide
        $ip51 = "43.103.5.166" ascii wide
        $ip52 = "43.110.83.200" ascii wide
        $ip53 = "43.135.167.226" ascii wide
        $ip54 = "67.215.247.183" ascii wide
...
rule APT_UNC6691_1
{
    ...
    strings:
        $domain0 = "00149989\.com" ascii wide nocase
        $domain1 = "003\.6ad59f5345\.workers\.dev" ascii wide nocase
        $domain2 = "00ah6\.com" ascii wide nocase
        $domain3 = "0209\.oocg3wf2\.workers\.dev" ascii wide nocase
        $domain4 = "0243jcssa\.online" ascii wide nocase
        $domain5 = "027hao\.cn" ascii wide nocase
        $domain6 = "0291\.top" ascii wide nocase
        $domain7 = "0323\.pages\.dev" ascii wide nocase
        $domain8 = "0406\.kaemy-lan\.workers\.dev" ascii wide nocase
        $domain9 = "042266\.yqqjingyou\.com\.cn" ascii wide nocase
        $domain10 = "0505\.wwxblue\.workers\.dev" ascii wide nocase
        $domain11 = "0rdershop\.com" ascii wide nocase
        $domain12 = "1-00000\.cn" ascii wide nocase
        $domain13 = "1-67l\.pages\.dev" ascii wide nocase
        $domain14 = "1-nycyh\.workers\.dev" ascii wide nocase
        $domain15 = "1\.a13518075286\.workers\.dev" ascii wide nocase
        $domain16 = "100\.pzx19941211\.workers\.dev" ascii wide nocase
        $domain17 = "1031001366\.workers\.dev" ascii wide nocase
        $domain18 = "11\.jponliine\.com" ascii wide nocase
        $domain19 = "125540947\.workers\.dev" ascii wide nocase
        $domain20 = "1289238bgyu8bgy8o\.pages\.dev" ascii wide nocase
        $domain21 = "1328054280\.workers\.dev" ascii wide nocase
        $domain22 = "13802880308\.workers\.dev" ascii wide nocase
        $domain23 = "13p13\.tyhls\.cn" ascii wide nocase
        $domain24 = "14\.harajukup\.com" ascii wide nocase
        $domain25 = "1561909197\.workers\.dev" ascii wide nocase
        $domain26 = "15999756862\.workers\.dev" ascii wide nocase
        $domain27 = "16388\.pages\.dev" ascii wide nocase
        $domain28 = "18agj\.com" ascii wide nocase
        $domain29 = "1a\.zencartjp\.com" ascii wide nocase
        $domain30 = "1b21533f51\.workers\.dev" ascii wide nocase
        $domain31 = "1bxvv83nskca6a14\.cfd" ascii wide nocase
        $domain32 = "1d8x3\.com" ascii wide nocase
        $domain33 = "1f\.okinasumo\.com" ascii wide nocase
        $domain34 = "1f6z8\.com" ascii wide nocase
        $domain35 = "1f8z5\.com" ascii wide nocase
        $domain36 = "1j1j\.tyhls\.cn" ascii wide nocase
        $domain37 = "1k\.kyusmalli\.com" ascii wide nocase
        $domain38 = "1k\.zenjpmart\.com" ascii wide nocase
        $domain39 = "1k1k\.tyhls\.cn" ascii wide nocase
        $domain40 = "1k4m8\.com" ascii wide nocase
        $domain41 = "1m9z3\.com" ascii wide nocase
        $domain42 = "1mgtpu86\.niponshop\.com" ascii wide nocase
        $domain43 = "1n3p9\.com" ascii wide nocase
        $domain44 = "1n5f8\.com" ascii wide nocase
        $domain45 = "1natsuhina\.workers\.dev" ascii wide nocase
        $domain46 = "1p2k9\.com" ascii wide nocase
        $domain47 = "1p4k9\.com" ascii wide nocase
        $domain48 = "1q\.zenshopjp\.com" ascii wide nocase
        $domain49 = "1r5z8\.com" ascii wide nocase
...
rule APT_UNCLASSIFIED
{
    ...
    strings:
        ...
        $domain19 = "3s\.aliqwenapi\.com" ascii wide nocase
        $domain20 = "4sdfaash\.mypi\.co" ascii wide nocase
        $domain21 = "4sdfaashe\.mypi\.co" ascii wide nocase
        $domain22 = "60431\.club" ascii wide nocase
        $domain23 = "7077\.000webhostapp\.com" ascii wide nocase
        $domain24 = "75735\.club" ascii wide nocase
        $domain25 = "77444\.club" ascii wide nocase
        $domain26 = "78276\.ussdns01\.heketwe\.com" ascii wide nocase
        $domain27 = "78276\.ussdns02\.heketwe\.com" ascii wide nocase
        $domain28 = "80001\.me" ascii wide nocase
        $domain29 = "816e-182-227-90-53\.ngrok\.io" ascii wide nocase
        $domain30 = "82813\.club" ascii wide nocase
        $domain31 = "86wts86a8j\.com" ascii wide nocase
        $domain32 = "881\.000webhostapp\.com" ascii wide nocase
        $domain33 = "8d\.cloudops-api\.com" ascii wide nocase
        $domain34 = "EuDbSyncUp\.com" ascii wide nocase
        $domain35 = "Jdokdo\.ml" ascii wide nocase
        $domain36 = "Jospubs\.com" ascii wide nocase
        $domain37 = "MsCupDb\.com" ascii wide nocase
        $domain38 = "UsMobileSos\.com" ascii wide nocase
        $domain39 = "a\.00-online\.com" ascii wide nocase
        $domain40 = "a7788\.1apps\.com" ascii wide nocase
        $domain41 = "aaaaaaaahmad\.no-ip\.biz" ascii wide nocase
        $domain42 = "abbaass313\.hopto\.org" ascii wide nocase
        $domain43 = "abbarhs\.mypi\.co" ascii wide nocase
        $domain44 = "abbarhsa\.mypi\.co" ascii wide nocase
        $domain45 = "abc69696969\.vicp\.net" ascii wide nocase
        $domain46 = "abdillahzraibi\.no-ip\.biz" ascii wide nocase
        $domain47 = "abdou36\.noip\.me" ascii wide nocase
        $domain48 = "abevahack123\.no-ip\.biz" ascii wide nocase
        $domain49 = "acccountsgoog1e\.com" ascii wide nocase
        $ip50 = "103.117.120.129" ascii wide
        $ip51 = "103.117.120.181" ascii wide
        $ip52 = "103.117.120.182" ascii wide
        $ip53 = "103.170.154.120" ascii wide
        $ip54 = "103.233.11.162" ascii wide
        $ip55 = "103.97.128.53" ascii wide
        $ip56 = "104.248.153.204" ascii wide
        $ip57 = "104.248.153.204" ascii wide
        $ip58 = "104.255.66.139" ascii wide
        $ip59 = "108.181.165.94" ascii wide
        $ip60 = "109.237.97.43" ascii wide
        $ip61 = "109.237.97.4" ascii wide
        $ip62 = "111.20.145.84" ascii wide
        $ip63 = "111.90.150.37" ascii wide
        $ip64 = "122.10.82.65" ascii wide
        $ip65 = "122.10.93.136" ascii wide
        $ip66 = "13.211.167.218" ascii wide
        $ip67 = "135.125.107.221" ascii wide
        $ip68 = "137.184.67.33" ascii wide
        $ip69 = "137.220.180.39" ascii wide
        $ip70 = "138.124.228.103" ascii wide
        $ip71 = "138.68.56.176" ascii wide
        $ip72 = "138.68.56.176" ascii wide
        $ip73 = "143.110.189.141" ascii wide
        $ip74 = "146.70.161.78" ascii wide
        $ip75 = "146.70.233.83" ascii wide
        $ip76 = "147.78.46.40" ascii wide
        $ip77 = "147.78.46.40" ascii wide
        $ip78 = "150.241.97.10" ascii wide
        $ip79 = "154.82.92.160" ascii wide
...
rule APT_VOIDBLIZZARD
{
    meta:
        ...
        aliases = "laundry bear, pluggyape, ta-488"
    ...
    strings:
        ...
        $domain13 = "gertasd\.top" ascii wide nocase
        $domain14 = "hart-hulp-ua\.com" ascii wide nocase
        $domain15 = "harthulp-ua\.com" ascii wide nocase
        $domain16 = "it-sharepoint\.com" ascii wide nocase
        $domain17 = "m-365-app\.com" ascii wide nocase
        $domain18 = "maidservant\.shop" ascii wide nocase
        $domain19 = "mail-forgot\.com" ascii wide nocase
        $domain20 = "max-linear\.com" ascii wide nocase
        $domain21 = "microffice\.org" ascii wide nocase
        $domain22 = "micsrosoftonline\.com" ascii wide nocase
        $domain23 = "miscrsosoft\.com" ascii wide nocase
        $domain24 = "myspringbank\.com" ascii wide nocase
        $domain25 = "ourbelovedsainscore\.space" ascii wide nocase
        $domain26 = "outlook-office\.micsrosoftonline\.com" ascii wide nocase
        $domain27 = "portal-microsoftonline\.com" ascii wide nocase
        $domain28 = "propescom\.com" ascii wide nocase
        $domain29 = "redronesolutions\.cloud" ascii wide nocase
        $domain30 = "refundes\.net" ascii wide nocase
        $domain31 = "remerelli\.com" ascii wide nocase
        $domain32 = "saint-daniel\.com" ascii wide nocase
        $domain33 = "saint-daniel\.org" ascii wide nocase
        $domain34 = "saint-daniel\.world" ascii wide nocase
        $domain35 = "solidarity-help\.com" ascii wide nocase
        $domain36 = "solidarity-help\.org" ascii wide nocase
        $domain37 = "spidergov\.org" ascii wide nocase
        $domain38 = "teamsupportonline\.top" ascii wide nocase
        $domain39 = "weblogmail\.live" ascii wide nocase
        $domain40 = "x9a7lm02kqaccountprotectionaccountsecuritynoreply\.com" ascii wide nocase
        $ip41 = "108.165.164.155" ascii wide
        $ip42 = "176.9.23.216" ascii wide
        $ip43 = "193.23.216.39" ascii wide
        $ip44 = "193.23.216.39" ascii wide
...
rule APT_WIRTE
{
    ...
    strings:
        $domain0 = "account\.techupinfo\.com" ascii wide nocase
        $domain1 = "allaccounting\.ca" ascii wide nocase
        $domain2 = "api\.healthylifefeed\.com" ascii wide nocase
        $domain3 = "api\.medicinefinders\.com" ascii wide nocase
        $domain4 = "api\.softmatictech\.com" ascii wide nocase
        $domain5 = "api\.systemsync\.info" ascii wide nocase
        $domain6 = "api\.technology-system\.com" ascii wide nocase
        $domain7 = "api\.widetechno\.info" ascii wide nocase
        $domain8 = "apiv2\.onlinefieldtech\.com" ascii wide nocase
        $domain9 = "auth\.onlinefieldtech\.com" ascii wide nocase
        $domain10 = "bankjordan\.com" ascii wide nocase
        $domain11 = "cdn\.techpointinfo\.com" ascii wide nocase
        $domain12 = "check\.office365-update\.com" ascii wide nocase
        $domain13 = "dentalaccord\.com" ascii wide nocase
        $domain14 = "dentalmatrix\.net" ascii wide nocase
        $domain15 = "doctoressolis\.com" ascii wide nocase
        $domain16 = "download\.share2file\.pro" ascii wide nocase
        $domain17 = "easybackupcloud\.com" ascii wide nocase
        $domain18 = "economymentor\.com" ascii wide nocase
        $domain19 = "economystocking\.com" ascii wide nocase
        $domain20 = "eg\.foxlove\.life" ascii wide nocase
        $domain21 = "egyptican\.com" ascii wide nocase
        $domain22 = "egyptskytours\.com" ascii wide nocase
        $domain23 = "egypttourism-online\.com" ascii wide nocase
        $domain24 = "ellemedic\.com" ascii wide nocase
        $domain25 = "est-clinic\.com" ascii wide nocase
        $domain26 = "finance-analyst\.com" ascii wide nocase
        $domain27 = "financecovers\.com" ascii wide nocase
        $domain28 = "financeinfoguide\.com" ascii wide nocase
        $domain29 = "firstohiobank\.com" ascii wide nocase
        $domain30 = "forum\.technoforts\.com" ascii wide nocase
        $domain31 = "forum\.techtg\.com" ascii wide nocase
        $domain32 = "fox\.foxlove\.life" ascii wide nocase
        $domain33 = "foxlove\.life" ascii wide nocase
        $domain34 = "healthcarb\.com" ascii wide nocase
        $domain35 = "healthoptionstoday\.com" ascii wide nocase
        $domain36 = "healthscratches\.com" ascii wide nocase
        $domain37 = "healthylifefeed\.com" ascii wide nocase
        $domain38 = "imagine-world\.com" ascii wide nocase
        $domain39 = "jo\.foxlove\.life" ascii wide nocase
        $domain40 = "jordanrefugees\.com" ascii wide nocase
        $domain41 = "jordansons\.com" ascii wide nocase
        $domain42 = "king-pharmacy\.com" ascii wide nocase
        $domain43 = "kneeexercises\.net" ascii wide nocase
        $domain44 = "master-dental\.com" ascii wide nocase
        $domain45 = "medicinefinders\.com" ascii wide nocase
        $domain46 = "micorsoft\.store" ascii wide nocase
        $domain47 = "microsoftliveforums\.com" ascii wide nocase
        $domain48 = "microsoftteams365\.com" ascii wide nocase
        $domain49 = "microsoftwindowshelp\.com" ascii wide nocase
