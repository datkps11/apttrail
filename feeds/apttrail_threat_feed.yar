...
rule APT_BITTER
{
    ...
    strings:
        ...
        $domain48 = "briarapppro\.org" ascii wide nocase
        $domain49 = "broadsforthestate\.com" ascii wide nocase
...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain4 = "05meet\.us" ascii wide nocase
        $domain5 = "05uk\.us" ascii wide nocase
        $domain6 = "05ukweb\.uk" ascii wide nocase
        $domain7 = "05usweb\.us" ascii wide nocase
        $domain8 = "05usweb\.zoom\.meet-05\.sbs" ascii wide nocase
        $domain9 = "05web\.us" ascii wide nocase
        $domain10 = "05webus\.meet\.05uk\.us" ascii wide nocase
        $domain11 = "06ukweb\.uk" ascii wide nocase
        $domain12 = "06usweb\.us" ascii wide nocase
        $domain13 = "07-web\.us" ascii wide nocase
        $domain14 = "07usweb\.site" ascii wide nocase
        $domain15 = "07web\.zoom\.uk07\.pro" ascii wide nocase
        $domain16 = "07webus\.zoom\.us07\.sbs" ascii wide nocase
        $domain17 = "163qiye\.top" ascii wide nocase
        $domain18 = "1driv\.org" ascii wide nocase
        $domain19 = "1drv\.email" ascii wide nocase
        $domain20 = "1drvmail\.work" ascii wide nocase
        $domain21 = "256ventures\.us" ascii wide nocase
        $domain22 = "31ventures\.info" ascii wide nocase
        $domain23 = "32\.ww-live\.online" ascii wide nocase
        $domain24 = "3f\.teams-meet\.xyz" ascii wide nocase
        $domain25 = "5q\.ms-meets\.online" ascii wide nocase
        $domain26 = "a\.mylkc\.cloudns\.ch" ascii wide nocase
        $domain27 = "abf-cap\.co" ascii wide nocase
        $domain28 = "abf-cap\.com" ascii wide nocase
        $domain29 = "abiesvc\.com" ascii wide nocase
        $domain30 = "abiesvc\.info" ascii wide nocase
        $domain31 = "abiesvc\.jp\.net" ascii wide nocase
        $domain32 = "account-googlemeet\.com" ascii wide nocase
        $domain33 = "adiclas-nft\.quest" ascii wide nocase
        $domain34 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain35 = "aidpartners\.org" ascii wide nocase
        $domain36 = "ajayplamingo\.com" ascii wide nocase
        $domain37 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain38 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain39 = "altair-vc\.co\.uk" ascii wide nocase
        $domain40 = "altair-vc\.com" ascii wide nocase
        $domain41 = "altair\.linkpc\.net" ascii wide nocase
        $domain42 = "amazonaws1\.info" ascii wide nocase
        $domain43 = "amzonnews\.club" ascii wide nocase
        $domain44 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain45 = "angelbridge\.capital" ascii wide nocase
        $domain46 = "angelbridge\.jp" ascii wide nocase
        $domain47 = "ankanimatoka\.com" ascii wide nocase
        $domain48 = "annaelsa\.xyz" ascii wide nocase
        $domain49 = "anobaka\.info" ascii wide nocase
        ...
        $ip54 = "118.70.116.154" ascii wide
        $ip55 = "140.117.91.22" ascii wide
        $ip56 = "140.136.134.201" ascii wide
        $ip57 = "163.25.24.44" ascii wide
        $ip58 = "163.5.254.70" ascii wide
        $ip59 = "186.183.185.94" ascii wide
        $ip60 = "23.254.202.223" ascii wide
        $ip61 = "41.85.145.164" ascii wide
        $ip62 = "45.238.25.2" ascii wide
        $ip63 = "45.61.129.29" ascii wide
        $ip64 = "45.61.140.26" ascii wide
        $ip65 = "45.61.157.248" ascii wide
        $ip66 = "66.181.166.15" ascii wide
        $ip67 = "83.136.208.246" ascii wide
        $ip68 = "83.136.208.48" ascii wide
        $ip69 = "83.136.209.22" ascii wide
        $ip70 = "83.136.210.180" ascii wide
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain20 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain21 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain22 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain23 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain24 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain25 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain26 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain27 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain28 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain29 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain30 = "a\.videotalks\.site" ascii wide nocase
        ...
        $domain37 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain38 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain39 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain40 = "acoustickoala\.com" ascii wide nocase
        $domain41 = "acroadovw\.com" ascii wide nocase
        $domain42 = "activity-179384736\.site" ascii wide nocase
        $domain43 = "activity-permission\.online" ascii wide nocase
        $domain44 = "additional\.work\.gd" ascii wide nocase
        $domain45 = "additionalpublic\.work\.gd" ascii wide nocase
        $domain46 = "addrcheck\.corecheckmailsrv\.com" ascii wide nocase
        $domain47 = "ade\.dropfile\.online" ascii wide nocase
        $domain48 = "admin-8jy8o7jbg\.vercel\.sh" ascii wide nocase
        $domain49 = "admin\.alwayswelcome\.online" ascii wide nocase
...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain34 = "aa\.76767\.icu" ascii wide nocase
        $domain35 = "aadharpor\.xyz" ascii wide nocase
        $domain36 = "aaloochaat\.com" ascii wide nocase
        $domain37 = "aboutcase\.nl" ascii wide nocase
        $domain38 = "ac\.76767\.icu" ascii wide nocase
        $domain39 = "accinfo\.live" ascii wide nocase
        $domain40 = "account-recovery\.com" ascii wide nocase
        $domain41 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain42 = "accountmail\.in" ascii wide nocase
        $domain43 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
        $domain44 = "accounts\.mgovcloud\.de" ascii wide nocase
        $domain45 = "accounts\.mgovcloud\.in\.cloudshare\.digital" ascii wide nocase
        $domain46 = "accounts\.mgovcloud\.in\.departmentofdefence\.live" ascii wide nocase
        $domain47 = "accounts\.mgovcloud\.in\.indiagov\.support" ascii wide nocase
        $domain48 = "accounts\.mgovcloud\.in\.storagecloud\.download" ascii wide nocase
        $domain49 = "accounts\.mgovcloud\.in\.virtualeoffice\.cloud" ascii wide nocase
