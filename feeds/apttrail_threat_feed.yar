...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain24 = "cdn-app-server\.vewojo9572\.workers\.dev" ascii wide nocase
        $domain25 = "cdn-app-web\.piniyi9484\.workers\.dev" ascii wide nocase
        $domain26 = "cdn-server-1\.xiren77418\.workers\.dev" ascii wide nocase
        $domain27 = "cdn-server-2\.wesoc40288\.workers\.dev" ascii wide nocase
        $domain28 = "cdn-server-full\.taros12579\.workers\.dev" ascii wide nocase
        $domain29 = "cdn-web-server1\.techserver01\.workers\.dev" ascii wide nocase
        $domain30 = "cdn1\.cowivat156\.workers\.dev" ascii wide nocase
        $domain31 = "cdn1\.poyag17470\.workers\.dev" ascii wide nocase
        $domain32 = "computerservicesource\.com" ascii wide nocase
        $domain33 = "crimson-unit-2561\.kopis56799\.workers\.dev" ascii wide nocase
        $domain34 = "daniel-foster\.workers\.dev" ascii wide nocase
        $domain35 = "dark-bar-d282\.nina-alvarez\.workers\.dev" ascii wide nocase
        $domain36 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain37 = "data-pipeline-9e4\.workers\.dev" ascii wide nocase
        $domain38 = "database-lists\.com" ascii wide nocase
        $domain39 = "db-proxy-9b2\.daniel-foster\.workers\.dev" ascii wide nocase
        $domain40 = "dbeaver-database\.app" ascii wide nocase
        $domain41 = "dbeaver-database\.cc" ascii wide nocase
        $domain42 = "dbeaver-database\.cloud" ascii wide nocase
        $domain43 = "dbeaver-database\.co" ascii wide nocase
        $domain44 = "dbeaver-database\.com" ascii wide nocase
        $domain45 = "dbeaver-database\.org" ascii wide nocase
        $domain46 = "dbeaver-database\.pro" ascii wide nocase
        $domain47 = "dbeaver-database\.tech" ascii wide nocase
        $domain48 = "dbeaver-database\.us" ascii wide nocase
        $domain49 = "dbeaver\.softwarep2p\.com" ascii wide nocase
