...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain8 = "abf-cap\.co" ascii wide nocase
        $domain9 = "abf-cap\.com" ascii wide nocase
        $domain10 = "abiesvc\.com" ascii wide nocase
        $domain11 = "abiesvc\.info" ascii wide nocase
        $domain12 = "abiesvc\.jp\.net" ascii wide nocase
        $domain13 = "adiclas-nft\.quest" ascii wide nocase
        $domain14 = "aidpartners\.org" ascii wide nocase
        $domain15 = "ajayplamingo\.com" ascii wide nocase
        $domain16 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain17 = "altair-vc\.co\.uk" ascii wide nocase
        $domain18 = "altair-vc\.com" ascii wide nocase
        $domain19 = "altair\.linkpc\.net" ascii wide nocase
        $domain20 = "amazonaws1\.info" ascii wide nocase
        $domain21 = "amzonnews\.club" ascii wide nocase
        $domain22 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain23 = "angelbridge\.capital" ascii wide nocase
        $domain24 = "angelbridge\.jp" ascii wide nocase
        $domain25 = "ankanimatoka\.com" ascii wide nocase
        $domain26 = "anobaka\.info" ascii wide nocase
        $domain27 = "anobaka\.jp" ascii wide nocase
        $domain28 = "antcapital\.us" ascii wide nocase
        $domain29 = "api\.betterfun\.space" ascii wide nocase
        $domain30 = "api\.zerodev\.pro" ascii wide nocase
        $domain31 = "api\.zoom-sdk\.com" ascii wide nocase
        $domain32 = "app-wechat\.xyz" ascii wide nocase
        $domain33 = "app\.baiduweb\.pro" ascii wide nocase
        $domain34 = "app\.developcore\.org" ascii wide nocase
        $domain35 = "app\.republicrypto\.vc" ascii wide nocase
        $domain36 = "app\.thorwsap\.finance" ascii wide nocase
        $domain37 = "appleaccess\.pro" ascii wide nocase
        $domain38 = "appleupdate\.datauploader\.site" ascii wide nocase
        $domain39 = "arbordeck\.co\.in" ascii wide nocase
        $domain40 = "arborventures\.capital" ascii wide nocase
        $domain41 = "arkinvst\.com" ascii wide nocase
        $domain42 = "armzon\.onmypc\.org" ascii wide nocase
        $domain43 = "association\.linkpc\.net" ascii wide nocase
        $domain44 = "atajerefoods\.com" ascii wide nocase
        $domain45 = "atom\.publicvm\.com" ascii wide nocase
        $domain46 = "att\.gdrvupload\.xyz" ascii wide nocase
        $domain47 = "authenticate\.azure-drive\.com" ascii wide nocase
        $domain48 = "autodynamics\.work\.gd" ascii wide nocase
        $domain49 = "automatic-update\.online" ascii wide nocase
