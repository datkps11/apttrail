...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain5 = "37-221-64-202\.cprapid\.com" ascii wide nocase
        $domain6 = "37-221-64-252\.cprapid\.com" ascii wide nocase
        $domain7 = "376zbaqsnigt\.com" ascii wide nocase
        $domain8 = "3a4p8gq8bojwn\.xyz" ascii wide nocase
        $domain9 = "414\.camdvr\.org" ascii wide nocase
        $domain10 = "415\.mywire\.org" ascii wide nocase
        $domain11 = "419\.theworkpc\.com" ascii wide nocase
        $domain12 = "43-228-125-28\.cprapid\.com" ascii wide nocase
        $domain13 = "5-135-125-106\.cinfuserver\.com" ascii wide nocase
        $domain14 = "56184\.fun" ascii wide nocase
        $domain15 = "5zbm0\.cfd" ascii wide nocase
        $domain16 = "66xq2\.top" ascii wide nocase
        $domain17 = "6jxbmkpe\.torontobotdns\.com" ascii wide nocase
        $domain18 = "76767\.icu" ascii wide nocase
        $domain19 = "78990\.fun" ascii wide nocase
        $domain20 = "7thcpcupdates\.info" ascii wide nocase
        $domain21 = "873013\.xyz" ascii wide nocase
        $domain22 = "88c\.34667\.fun" ascii wide nocase
        $domain23 = "89204\.fun" ascii wide nocase
        $domain24 = "8fold\.space" ascii wide nocase
        $domain25 = "8ln62\.cfd" ascii wide nocase
        $domain26 = "8thpaycomission\.cloud" ascii wide nocase
        $domain27 = "8tqxpf27\.torontobotdns\.com" ascii wide nocase
        $domain28 = "903\.78990\.fun" ascii wide nocase
        $domain29 = "9123\.89204\.fun" ascii wide nocase
        $domain30 = "9882aa1216\.autos" ascii wide nocase
        $domain31 = "999game\.website" ascii wide nocase
        $domain32 = "9gi02\.cfd" ascii wide nocase
        $domain33 = "9ydygorig3l7z\.xyz" ascii wide nocase
        $domain34 = "a\.erforias\.cam" ascii wide nocase
        $domain35 = "aa\.76767\.icu" ascii wide nocase
        $domain36 = "aadharpor\.xyz" ascii wide nocase
        $domain37 = "aadharsewa\.site" ascii wide nocase
        $domain38 = "aadperson\.xyz" ascii wide nocase
        $domain39 = "aaloochaat\.com" ascii wide nocase
        $domain40 = "aboutcase\.nl" ascii wide nocase
        $domain41 = "ac\.76767\.icu" ascii wide nocase
        $domain42 = "accinfo\.live" ascii wide nocase
        $domain43 = "account-recovery\.com" ascii wide nocase
        $domain44 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain45 = "accountmail\.in" ascii wide nocase
        $domain46 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
        $domain47 = "accounts\.mgovcloud\.de" ascii wide nocase
        $domain48 = "accounts\.mgovcloud\.in\.cloudshare\.digital" ascii wide nocase
        $domain49 = "accounts\.mgovcloud\.in\.departmentofdefence\.live" ascii wide nocase
