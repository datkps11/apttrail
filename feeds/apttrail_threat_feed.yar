...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain41 = "13udm\.v6\.navy" ascii wide nocase
        $domain42 = "14nservercc\.cfd" ascii wide nocase
        $domain43 = "14onlinen\.cfd" ascii wide nocase
        $domain44 = "15dhyfituhivoivjjgijrtjtgg\.cfd" ascii wide nocase
        $domain45 = "15fuerouhrgiurtituigjtug\.cfd" ascii wide nocase
        $domain46 = "15hjdgvfdjbvunghghod\.cfd" ascii wide nocase
        $domain47 = "15jhguerhguyogjopgoff\.cfd" ascii wide nocase
        $domain48 = "15nservercc\.cfd" ascii wide nocase
        $domain49 = "15onlinen\.cfd" ascii wide nocase
