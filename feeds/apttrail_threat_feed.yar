...
rule APT_SOFACY
{
    ...
    strings:
        ...
        $domain39 = "92ace7e653e9c32d2af9700592cc96ea\.serveo\.net" ascii wide nocase
        $domain40 = "9348243249382479234343284324023432748892349702394023\.xyz" ascii wide nocase
        $domain41 = "9832473219412342343423243242364-34939246823743287468793247237\.site" ascii wide nocase
