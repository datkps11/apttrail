...
rule APT_UNC2814
{
    ...
    strings:
        ...
        $domain18 = "boemobww\.ddnsfree\.com" ascii wide nocase
        $domain19 = "brcallletme\.theworkpc\.com" ascii wide nocase
        $domain20 = "btbtutil\.theworkpc\.com" ascii wide nocase
        $domain21 = "btltan\.ooguy\.com" ascii wide nocase
        $domain22 = "camcampkes\.ddnsfree\.com" ascii wide nocase
        $domain23 = "camsqewivo\.kozow\.com" ascii wide nocase
        $domain24 = "ccammutom\.ddnsgeek\.com" ascii wide nocase
        $domain25 = "ccel\.kozow\.com" ascii wide nocase
        $domain26 = "cdnvmtools\.theworkpc\.com" ascii wide nocase
        $domain27 = "cloacpae\.ddnsfree\.com" ascii wide nocase
        $domain28 = "cmwwoods1\.theworkpc\.com" ascii wide nocase
        $domain29 = "cnrpaslceas\.freeddns\.org" ascii wide nocase
        $domain30 = "codemicros12\.gleeze\.com" ascii wide nocase
        $domain31 = "cp02odjaic\.kozow\.com" ascii wide nocase
        $domain32 = "cressmiss\.ooguy\.com" ascii wide nocase
        $domain33 = "cvabiasbae\.ddnsfree\.com" ascii wide nocase
        $domain34 = "cvnoc01da1cjmnftsd\.accesscam\.org" ascii wide nocase
        $domain35 = "cvpc01aenusocirem\.accesscam\.org" ascii wide nocase
        $domain36 = "cvpc01cgsdfn53hgd\.giize\.com" ascii wide nocase
        $domain37 = "dclcwpdtsdcc\.ddnsfree\.com" ascii wide nocase
        $domain38 = "dlpossie\.ddnsfree\.com" ascii wide nocase
        $domain39 = "dnsfreedb\.ddnsfree\.com" ascii wide nocase
        $domain40 = "doboudix1024\.mywire\.org" ascii wide nocase
        $domain41 = "docla1rocodetellkadihewfnt3\.kozow\.com" ascii wide nocase
        $domain42 = "entel\.kozow\.com" ascii wide nocase
        $domain43 = "evilginx2\.loseyourip\.com" ascii wide nocase
        $domain44 = "examp1e\.webredirect\.org" ascii wide nocase
        $domain45 = "faeelt\.giize\.com" ascii wide nocase
        $domain46 = "fakjcsaeyhs\.ddnsfree\.com" ascii wide nocase
        $domain47 = "fasceadvcva3\.gleeze\.com" ascii wide nocase
        $domain48 = "ffosies2024\.camdvr\.org" ascii wide nocase
        $domain49 = "fgdedd1dww\.gleeze\.com" ascii wide nocase
