...
rule APT_UNC1151
{
    ...
    strings:
        ...
        $domain31 = "agelessinvesting\.xyz" ascii wide nocase
        $domain32 = "ais-gos\.top" ascii wide nocase
        $domain33 = "akademia-mil\.space" ascii wide nocase
        $domain34 = "alexavegas\.icu" ascii wide nocase
        $domain35 = "algsat\.icu" ascii wide nocase
        $domain36 = "all-ukraine\.top" ascii wide nocase
        $domain37 = "alls-gos\.top" ascii wide nocase
        $domain38 = "americandeliriumsociety\.shop" ascii wide nocase
        $domain39 = "ams-gos\.top" ascii wide nocase
        $domain40 = "ao-opros\.top" ascii wide nocase
        $domain41 = "api\.passport-yandex\.ru" ascii wide nocase
        $domain42 = "aplikacje\.ron-mil\.space" ascii wide nocase
        $domain43 = "attachment-storage-asset-static\.needbinding\.icu" ascii wide nocase
        $domain44 = "authorization-inbox\.site" ascii wide nocase
        $domain45 = "awa-opros\.top" ascii wide nocase
        $domain46 = "aws-opros\.top" ascii wide nocase
        $domain47 = "backstagemerch\.shop" ascii wide nocase
        $domain48 = "beez-gos\.top" ascii wide nocase
        $domain49 = "bel-oprosov\.top" ascii wide nocase
