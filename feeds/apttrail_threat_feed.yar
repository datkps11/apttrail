...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $ip62 = "118.194.248.246" ascii wide
        $ip63 = "121.183.134.113" ascii wide
        $ip64 = "121.183.134.113" ascii wide
        $ip65 = "121.183.134.113" ascii wide
        $ip66 = "121.66.72.110" ascii wide
        $ip67 = "125.136.67.99" ascii wide
        $ip68 = "141.164.41.17" ascii wide
        $ip69 = "152.89.247.57" ascii wide
        $ip70 = "156.224.22.247" ascii wide
        $ip71 = "158.247.238.155" ascii wide
        $ip72 = "159.100.6.137" ascii wide
        $ip73 = "161.97.113.34" ascii wide
        $ip74 = "162.216.114.133" ascii wide
        $ip75 = "162.245.188.225" ascii wide
        $ip76 = "172.93.201.248" ascii wide
        $ip77 = "172.93.201.248" ascii wide
        $ip78 = "183.105.66.48" ascii wide
        $ip79 = "185.224.137.164" ascii wide
...
rule APT_MUDDYWATER
{
    ...
    strings:
        $domain0 = "0973642\.xyz" ascii wide nocase
        $domain1 = "1274672\.xyz" ascii wide nocase
        $domain2 = "1279578\.xyz" ascii wide nocase
        $domain3 = "1368497\.xyz" ascii wide nocase
        $domain4 = "1549038\.xyz" ascii wide nocase
        $domain5 = "159352\.xyz" ascii wide nocase
        $domain6 = "1748906\.xyz" ascii wide nocase
        $domain7 = "18372046\.xyz" ascii wide nocase
        $domain8 = "206904\.xyz" ascii wide nocase
        $domain9 = "2097583\.xyz" ascii wide nocase
        $domain10 = "261467\.xyz" ascii wide nocase
        $domain11 = "261615\.xyz" ascii wide nocase
        $domain12 = "261957\.xyz" ascii wide nocase
        $domain13 = "268439\.xyz" ascii wide nocase
        $domain14 = "274352\.xyz" ascii wide nocase
        $domain15 = "275481\.xyz" ascii wide nocase
        $domain16 = "3129685\.xyz" ascii wide nocase
        $domain17 = "3181275\.xyz" ascii wide nocase
        $domain18 = "3197506\.xyz" ascii wide nocase
        $domain19 = "319830\.xyz" ascii wide nocase
        $domain20 = "340593\.xyz" ascii wide nocase
        $domain21 = "340629\.xyz" ascii wide nocase
        $domain22 = "368890\.xyz" ascii wide nocase
        $domain23 = "4391275\.xyz" ascii wide nocase
        $domain24 = "4507268\.xyz" ascii wide nocase
        $domain25 = "4529086\.xyz" ascii wide nocase
        $domain26 = "476194\.xyz" ascii wide nocase
        $domain27 = "4818903\.xyz" ascii wide nocase
        $domain28 = "490127\.xyz" ascii wide nocase
        $domain29 = "49582631\.xyz" ascii wide nocase
        $domain30 = "51\.89\.175\.196\.sslip\.io" ascii wide nocase
        $domain31 = "512194\.xyz" ascii wide nocase
        $domain32 = "517706\.xyz" ascii wide nocase
        $domain33 = "5609184\.xyz" ascii wide nocase
        $domain34 = "592782\.xyz" ascii wide nocase
        $domain35 = "60271485\.xyz" ascii wide nocase
        $domain36 = "60284719\.xyz" ascii wide nocase
        $domain37 = "6129740\.xyz" ascii wide nocase
        $domain38 = "6219037\.xyz" ascii wide nocase
        $domain39 = "6292759\.xyz" ascii wide nocase
        $domain40 = "673706\.xyz" ascii wide nocase
        $domain41 = "682352\.xyz" ascii wide nocase
        $domain42 = "682439\.xyz" ascii wide nocase
        $domain43 = "682640\.xyz" ascii wide nocase
        $domain44 = "6831905\.xyz" ascii wide nocase
        $domain45 = "6841750\.xyz" ascii wide nocase
        $domain46 = "6842903\.xyz" ascii wide nocase
        $domain47 = "684568\.xyz" ascii wide nocase
        $domain48 = "6nc051221a\.co" ascii wide nocase
        $domain49 = "6nc051221c\.co" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain1 = "1s\.rvtoolsai\.com" ascii wide nocase
        $domain2 = "1v\.rvtoollsa\.com" ascii wide nocase
        $domain3 = "1v\.rvtootsad\.com" ascii wide nocase
        $domain4 = "1yeralti\.com" ascii wide nocase
        $domain5 = "20\.rvtoolsaq\.com" ascii wide nocase
        $domain6 = "20\.rvtoolse\.info" ascii wide nocase
        $domain7 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain8 = "24\.rvtoolis\.info" ascii wide nocase
        $domain9 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain10 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain11 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain12 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain13 = "3p\.workbenche\.com" ascii wide nocase
        $domain14 = "45perhour\.org" ascii wide nocase
        $domain15 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain16 = "7stories\.sbs" ascii wide nocase
        $domain17 = "91movs\.com" ascii wide nocase
        $domain18 = "9xstream\.live" ascii wide nocase
        $domain19 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain20 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain21 = "abstractest-hydroski\.site" ascii wide nocase
        $domain22 = "academytradeai\.com" ascii wide nocase
        $domain23 = "acquasicuras\.com" ascii wide nocase
        $domain24 = "actbluecs\.com" ascii wide nocase
        $domain25 = "actblues\.net" ascii wide nocase
        $domain26 = "adionetjrei\.shop" ascii wide nocase
        $domain27 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain28 = "adrilex\.digital" ascii wide nocase
        $domain29 = "aexnp\.com" ascii wide nocase
        $domain30 = "afeherbopenuk\.com" ascii wide nocase
        $domain31 = "agronomywork\.info" ascii wide nocase
        $domain32 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain33 = "aialgocamp\.com" ascii wide nocase
        $domain34 = "aialgocore\.com" ascii wide nocase
        $domain35 = "aialgodrive\.com" ascii wide nocase
        $domain36 = "aialgoflow\.com" ascii wide nocase
        $domain37 = "aialgofusion\.com" ascii wide nocase
        $domain38 = "aialgohash\.com" ascii wide nocase
        $domain39 = "aialgorithmforge\.com" ascii wide nocase
        $domain40 = "aialgorithmicforge\.com" ascii wide nocase
        $domain41 = "aialgorithmicpath\.com" ascii wide nocase
        $domain42 = "aialgosense\.com" ascii wide nocase
        $domain43 = "aialgosphere\.com" ascii wide nocase
        $domain44 = "aianalyticengine\.com" ascii wide nocase
        $domain45 = "aianalyticmesh\.com" ascii wide nocase
        $domain46 = "aiautomationframework\.com" ascii wide nocase
        $domain47 = "aiautonomycore\.com" ascii wide nocase
        $domain48 = "aibigdatamap\.com" ascii wide nocase
        $domain49 = "aibotscale\.com" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain23 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain24 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain25 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain26 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain27 = "12cc\.thqirrxu\.com" ascii wide nocase
        $domain28 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain29 = "158\.ozhignq\.com" ascii wide nocase
        $domain30 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain31 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain32 = "168\.yktajeyp\.com" ascii wide nocase
        $domain33 = "17cx1\.com" ascii wide nocase
        $domain34 = "17cx11\.com" ascii wide nocase
        $domain35 = "17cx2\.com" ascii wide nocase
        $domain36 = "17cx3\.com" ascii wide nocase
        $domain37 = "17cx4\.com" ascii wide nocase
        $domain38 = "17cx5\.com" ascii wide nocase
        $domain39 = "17cx7\.com" ascii wide nocase
        $domain40 = "17cx8\.com" ascii wide nocase
        $domain41 = "17cx9\.com" ascii wide nocase
        $domain42 = "17cxa\.com" ascii wide nocase
        $domain43 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain44 = "17lu\.life" ascii wide nocase
        $domain45 = "17lulu\.club" ascii wide nocase
        $domain46 = "17lulu\.live" ascii wide nocase
        $domain47 = "17lulu\.ltd" ascii wide nocase
        $domain48 = "17lulu\.online" ascii wide nocase
        $domain49 = "17lulu\.site" ascii wide nocase
