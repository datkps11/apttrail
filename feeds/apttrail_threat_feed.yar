...
rule APT_VOIDBLIZZARD
{
    ...
    strings:
        ...
        $domain13 = "hart-hulp-ua\.com" ascii wide nocase
        $domain14 = "harthulp-ua\.com" ascii wide nocase
        $domain15 = "it-sharepoint\.com" ascii wide nocase
        $domain16 = "m-365-app\.com" ascii wide nocase
        $domain17 = "maidservant\.shop" ascii wide nocase
        $domain18 = "mail-forgot\.com" ascii wide nocase
        $domain19 = "max-linear\.com" ascii wide nocase
        $domain20 = "microffice\.org" ascii wide nocase
        $domain21 = "micsrosoftonline\.com" ascii wide nocase
        $domain22 = "miscrsosoft\.com" ascii wide nocase
        $domain23 = "myspringbank\.com" ascii wide nocase
        $domain24 = "ourbelovedsainscore\.space" ascii wide nocase
        $domain25 = "outlook-office\.micsrosoftonline\.com" ascii wide nocase
        $domain26 = "portal-microsoftonline\.com" ascii wide nocase
        $domain27 = "propescom\.com" ascii wide nocase
        $domain28 = "redronesolutions\.cloud" ascii wide nocase
        $domain29 = "refundes\.net" ascii wide nocase
        $domain30 = "remerelli\.com" ascii wide nocase
        $domain31 = "saint-daniel\.com" ascii wide nocase
        $domain32 = "saint-daniel\.org" ascii wide nocase
        $domain33 = "saint-daniel\.world" ascii wide nocase
        $domain34 = "solidarity-help\.com" ascii wide nocase
        $domain35 = "solidarity-help\.org" ascii wide nocase
        $domain36 = "spidergov\.org" ascii wide nocase
        $domain37 = "teamsupportonline\.top" ascii wide nocase
        $domain38 = "weblogmail\.live" ascii wide nocase
        $domain39 = "x9a7lm02kqaccountprotectionaccountsecuritynoreply\.com" ascii wide nocase
        $ip40 = "108.165.164.155" ascii wide
        $ip41 = "176.9.23.216" ascii wide
        $ip42 = "193.23.216.39" ascii wide
