...
rule APT_FORUMTROLL
{
    ...
    strings:
        ...
        $domain3 = "bus-pod-tenant\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain4 = "clip-rdp-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain5 = "common-rdp-front\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain6 = "cybers46\.team" ascii wide nocase
        $domain7 = "cybers4646\.my\.id" ascii wide nocase
        $domain8 = "e-library\.wiki" ascii wide nocase
        $domain9 = "elibrary\.wiki" ascii wide nocase
        $domain10 = "fast-telemetry-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain11 = "front-static-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain12 = "futurebull\.live" ascii wide nocase
        $domain13 = "futurebull\.net" ascii wide nocase
        $domain14 = "globaloneai\.com" ascii wide nocase
        $domain15 = "infosecteam\.info" ascii wide nocase
        $domain16 = "main-front-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain17 = "mil-by\.info" ascii wide nocase
        $domain18 = "ms-appdata-fonts\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain19 = "ms-appdata-main\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain20 = "ms-appdata-query\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain21 = "perf-service-clients2\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain22 = "primakovreadings\.info" ascii wide nocase
        $domain23 = "primakovreadings2025\.info" ascii wide nocase
        $domain24 = "rabotnik\.today" ascii wide nocase
        $domain25 = "rdp-api-front\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain26 = "rdp-query-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain27 = "rdp-statistics-api\.global\.ssl\.fastly\.net" ascii wide nocase
        $domain28 = "srv480138\.hstgr\.cloud" ascii wide nocase
        $domain29 = "srv484118\.hstgr\.cloud" ascii wide nocase
        $domain30 = "status-portal-api\.global\.ssl\.fastly\.net" ascii wide nocase
