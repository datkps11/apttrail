...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain35 = "0twjc657tu\.v6\.navy" ascii wide nocase
        $domain36 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain37 = "0x0\.care" ascii wide nocase
        $domain38 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain39 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain40 = "100000recipe\.com" ascii wide nocase
        $domain41 = "100nservercc\.cfd" ascii wide nocase
        $domain42 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain43 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain44 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain45 = "10nservercc\.cfd" ascii wide nocase
        $domain46 = "10onlinen\.cfd" ascii wide nocase
        $domain47 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain48 = "11nservercc\.cfd" ascii wide nocase
        $domain49 = "11onlinen\.cfd" ascii wide nocase
