...
rule APT_BITTER
{
    ...
    strings:
        ...
        $ip68 = "185.117.72.87" ascii wide
        $ip69 = "185.117.73.195" ascii wide
        $ip70 = "185.117.73.209" ascii wide
        $ip71 = "185.141.25.244" ascii wide
        $ip72 = "185.193.48.135" ascii wide
        $ip73 = "185.193.50.233" ascii wide
        $ip74 = "185.237.166.24" ascii wide
        $ip75 = "185.76.79.30" ascii wide
        $ip76 = "192.71.213.128" ascii wide
        $ip77 = "192.71.249.194" ascii wide
        $ip78 = "193.142.58.38" ascii wide
        $ip79 = "193.29.58.210" ascii wide
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain20 = "floral-paper-8eb1\.pihara4672\.workers\.dev" ascii wide nocase
        $domain21 = "keystore-explorer\.com" ascii wide nocase
        $domain22 = "mstore\.framfarmers\.co\.uk" ascii wide nocase
        $domain23 = "pofelal314\.workers\.dev" ascii wide nocase
        $domain24 = "rv-tools\.eu" ascii wide nocase
        $domain25 = "rvtoo1s\.com" ascii wide nocase
        $domain26 = "rvtooles\.com" ascii wide nocase
        $domain27 = "rvtoolis\.com" ascii wide nocase
        $domain28 = "rvtoolit\.com" ascii wide nocase
        $domain29 = "rvtoolsac\.com" ascii wide nocase
        $domain30 = "rvtoolsacad\.com" ascii wide nocase
        $domain31 = "rvtoolspro\.com" ascii wide nocase
        $domain32 = "rvtoolspro\.info" ascii wide nocase
        $domain33 = "rvtoolspro\.online" ascii wide nocase
        $domain34 = "rvtoolsus\.com" ascii wide nocase
        $domain35 = "rvtoolsusa\.com" ascii wide nocase
        $domain36 = "server-cd2\.bipewi2747\.workers\.dev" ascii wide nocase
        $domain37 = "server-cdn\.jawigaw383\.workers\.dev" ascii wide nocase
        $domain38 = "server-cdn\.lafise2419\.workers\.dev" ascii wide nocase
        $domain39 = "server-cdn\.lecoc56350\.workers\.dev" ascii wide nocase
        $domain40 = "server-cdn\.sidoke9822\.workers\.dev" ascii wide nocase
        $domain41 = "server-cdn\.virej10913\.workers\.dev" ascii wide nocase
        $domain42 = "server-cdn\.xohahey822\.workers\.dev" ascii wide nocase
        $domain43 = "server-web-cdn\.detocim498\.workers\.dev" ascii wide nocase
        $domain44 = "server-web-cdn\.dones86497\.workers\.dev" ascii wide nocase
        $domain45 = "server-web-cdn\.kagoli5215\.workers\.dev" ascii wide nocase
        $domain46 = "server-web-cdn\.mevame4224\.workers\.dev" ascii wide nocase
        $domain47 = "server-web-cdn\.nefixeg373\.workers\.dev" ascii wide nocase
        $domain48 = "server-web-cdn\.pixece7948\.workers\.dev" ascii wide nocase
        $domain49 = "server-web-cdn\.ravebo3233\.workers\.dev" ascii wide nocase
