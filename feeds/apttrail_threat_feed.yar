...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain11 = "adionetjrei\.shop" ascii wide nocase
        $domain12 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain13 = "aexnp\.com" ascii wide nocase
        $domain14 = "afeherbopenuk\.com" ascii wide nocase
        $domain15 = "agronomywork\.info" ascii wide nocase
        $domain16 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain17 = "aialgocamp\.com" ascii wide nocase
        $domain18 = "aialgocore\.com" ascii wide nocase
        $domain19 = "aialgodrive\.com" ascii wide nocase
        $domain20 = "aialgoflow\.com" ascii wide nocase
        $domain21 = "aialgofusion\.com" ascii wide nocase
        $domain22 = "aialgohash\.com" ascii wide nocase
        $domain23 = "aialgorithmforge\.com" ascii wide nocase
        $domain24 = "aialgorithmicforge\.com" ascii wide nocase
        $domain25 = "aialgorithmicpath\.com" ascii wide nocase
        $domain26 = "aialgosense\.com" ascii wide nocase
        $domain27 = "aialgosphere\.com" ascii wide nocase
        $domain28 = "aianalyticengine\.com" ascii wide nocase
        $domain29 = "aianalyticmesh\.com" ascii wide nocase
        $domain30 = "aiautomationframework\.com" ascii wide nocase
        $domain31 = "aiautonomycore\.com" ascii wide nocase
        $domain32 = "aibigdatamap\.com" ascii wide nocase
        $domain33 = "aibotscale\.com" ascii wide nocase
        $domain34 = "aibrainatelier\.com" ascii wide nocase
        $domain35 = "aibrainframe\.com" ascii wide nocase
        $domain36 = "aibrainlogicc\.com" ascii wide nocase
        $domain37 = "aibrainmatrixed\.com" ascii wide nocase
        $domain38 = "aibrainyard\.com" ascii wide nocase
        $domain39 = "aibuildersguild\.com" ascii wide nocase
        $domain40 = "aibuildnet\.com" ascii wide nocase
        $domain41 = "aibuildspark\.com" ascii wide nocase
        $domain42 = "aibytepad\.com" ascii wide nocase
        $domain43 = "aicalcengine\.com" ascii wide nocase
        $domain44 = "aichatbeam\.com" ascii wide nocase
        $domain45 = "aichatfuse\.com" ascii wide nocase
        $domain46 = "aichattask\.com" ascii wide nocase
        $domain47 = "aichippad\.com" ascii wide nocase
        $domain48 = "aicloudcamp\.com" ascii wide nocase
        $domain49 = "aicloudlayer\.com" ascii wide nocase
