...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain38 = "11nservercc\.cfd" ascii wide nocase
        $domain39 = "11onlinen\.cfd" ascii wide nocase
        $domain40 = "12-ko-official\.com" ascii wide nocase
        $domain41 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain42 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain43 = "12nservercc\.cfd" ascii wide nocase
        $domain44 = "12onlinen\.cfd" ascii wide nocase
        $domain45 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain46 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain47 = "13nservercc\.cfd" ascii wide nocase
        $domain48 = "13onlinen\.cfd" ascii wide nocase
        $domain49 = "13udm\.v6\.navy" ascii wide nocase
