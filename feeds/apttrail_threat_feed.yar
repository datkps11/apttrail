...
rule APT_BARIUM
{
    ...
    strings:
        ...
        $domain36 = "arestc\.net" ascii wide nocase
        $domain37 = "asdasw21\.icu" ascii wide nocase
        $domain38 = "ashcrack\.freetcp\.com" ascii wide nocase
        $domain39 = "assistcustody\.xyz" ascii wide nocase
        $domain40 = "astudycarsceu\.net" ascii wide nocase
        $domain41 = "asushotfix\.com" ascii wide nocase
        $domain42 = "atomiclampco\.com" ascii wide nocase
        $domain43 = "auth\.microsoftsservice\.com" ascii wide nocase
        $domain44 = "az\.performed12\.com" ascii wide nocase
        $domain45 = "back\.rooter\.tk" ascii wide nocase
        $domain46 = "backdoor\.apt\.photo" ascii wide nocase
        $domain47 = "bingsearches\.com" ascii wide nocase
        $domain48 = "bobs8\.oss-cn-hongkong\.aliyuncs\.com" ascii wide nocase
        $domain49 = "bold-hamilton\.207-246-119-197\.plesk\.page" ascii wide nocase
...
rule APT_UNCLASSIFIED
{
    ...
    strings:
        ...
        $domain19 = "48d83469-d0c6-4ade-8f82-e383fff094b8\.webhook\.site" ascii wide nocase
        ...
        $domain33 = "EuDbSyncUp\.com" ascii wide nocase
        $domain34 = "Jdokdo\.ml" ascii wide nocase
        $domain35 = "Jospubs\.com" ascii wide nocase
        $domain36 = "MsCupDb\.com" ascii wide nocase
        $domain37 = "UsMobileSos\.com" ascii wide nocase
        $domain38 = "a\.00-online\.com" ascii wide nocase
        $domain39 = "a7788\.1apps\.com" ascii wide nocase
        $domain40 = "aaaaaaaahmad\.no-ip\.biz" ascii wide nocase
        $domain41 = "abbaass313\.hopto\.org" ascii wide nocase
        $domain42 = "abbarhs\.mypi\.co" ascii wide nocase
        $domain43 = "abbarhsa\.mypi\.co" ascii wide nocase
        $domain44 = "abc69696969\.vicp\.net" ascii wide nocase
        $domain45 = "abdillahzraibi\.no-ip\.biz" ascii wide nocase
        $domain46 = "abdou36\.noip\.me" ascii wide nocase
        $domain47 = "abevahack123\.no-ip\.biz" ascii wide nocase
        $domain48 = "acccountsgoog1e\.com" ascii wide nocase
        $domain49 = "account-mail\.info" ascii wide nocase
