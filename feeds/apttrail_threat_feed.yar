...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain23 = "rvtoo1s\.com" ascii wide nocase
        $domain24 = "rvtoolis\.com" ascii wide nocase
        $domain25 = "rvtoolit\.com" ascii wide nocase
        $domain26 = "rvtoolsac\.com" ascii wide nocase
        $domain27 = "rvtoolspro\.info" ascii wide nocase
        $domain28 = "rvtoolspro\.online" ascii wide nocase
        $domain29 = "rvtoolsus\.com" ascii wide nocase
        $domain30 = "rvtoolsusa\.com" ascii wide nocase
        $domain31 = "server-cd2\.bipewi2747\.workers\.dev" ascii wide nocase
        $domain32 = "server-cdn\.jawigaw383\.workers\.dev" ascii wide nocase
        $domain33 = "server-cdn\.lafise2419\.workers\.dev" ascii wide nocase
        $domain34 = "server-cdn\.lecoc56350\.workers\.dev" ascii wide nocase
        $domain35 = "server-cdn\.sidoke9822\.workers\.dev" ascii wide nocase
        $domain36 = "server-cdn\.virej10913\.workers\.dev" ascii wide nocase
        $domain37 = "server-cdn\.xohahey822\.workers\.dev" ascii wide nocase
        $domain38 = "server-web-cdn\.detocim498\.workers\.dev" ascii wide nocase
        $domain39 = "server-web-cdn\.dones86497\.workers\.dev" ascii wide nocase
        $domain40 = "server-web-cdn\.kagoli5215\.workers\.dev" ascii wide nocase
        $domain41 = "server-web-cdn\.mevame4224\.workers\.dev" ascii wide nocase
        $domain42 = "server-web-cdn\.nefixeg373\.workers\.dev" ascii wide nocase
        $domain43 = "server-web-cdn\.pixece7948\.workers\.dev" ascii wide nocase
        $domain44 = "server-web-cdn\.ravebo3233\.workers\.dev" ascii wide nocase
        $domain45 = "server-web-cdn\.rojotoc516\.workers\.dev" ascii wide nocase
        $domain46 = "server-web-cdn\.vosax32455\.workers\.dev" ascii wide nocase
        $domain47 = "server-web-cdn\.yevobod379\.workers\.dev" ascii wide nocase
        $domain48 = "server-web-cdn1\.gekod80409\.workers\.dev" ascii wide nocase
        $domain49 = "server-web\.sasex59966\.workers\.dev" ascii wide nocase
