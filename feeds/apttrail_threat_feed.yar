...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain12 = "05nservercc\.cfd" ascii wide nocase
        $domain13 = "05onlinen\.cfd" ascii wide nocase
        $domain14 = "06nservercc\.cfd" ascii wide nocase
        $domain15 = "06onlinen\.cfd" ascii wide nocase
        $domain16 = "07nservercc\.cfd" ascii wide nocase
        $domain17 = "07onlinen\.cfd" ascii wide nocase
        $domain18 = "08nservercc\.cfd" ascii wide nocase
        $domain19 = "08onlinen\.cfd" ascii wide nocase
        $domain20 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain21 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain22 = "09nservercc\.cfd" ascii wide nocase
        $domain23 = "09onlinen\.cfd" ascii wide nocase
        $domain24 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain25 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain26 = "0x0\.care" ascii wide nocase
        $domain27 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain28 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain29 = "100000recipe\.com" ascii wide nocase
        $domain30 = "100nservercc\.cfd" ascii wide nocase
        $domain31 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain32 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain33 = "10nservercc\.cfd" ascii wide nocase
        $domain34 = "10onlinen\.cfd" ascii wide nocase
        $domain35 = "11nservercc\.cfd" ascii wide nocase
        $domain36 = "11onlinen\.cfd" ascii wide nocase
        $domain37 = "12-ko-official\.com" ascii wide nocase
        $domain38 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain39 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain40 = "12nservercc\.cfd" ascii wide nocase
        $domain41 = "12onlinen\.cfd" ascii wide nocase
        $domain42 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain43 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain44 = "13nservercc\.cfd" ascii wide nocase
        $domain45 = "13onlinen\.cfd" ascii wide nocase
        $domain46 = "13udm\.v6\.navy" ascii wide nocase
        $domain47 = "149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain48 = "149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain49 = "14nservercc\.cfd" ascii wide nocase
