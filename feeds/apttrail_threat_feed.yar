...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain34 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain35 = "a\.videotalks\.site" ascii wide nocase
        $domain36 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain37 = "abc\.meeting-central\.online" ascii wide nocase
        $domain38 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain39 = "abc\.preconnection\.online" ascii wide nocase
        $domain40 = "abc\.roomconnect\.online" ascii wide nocase
        $domain41 = "abilityscan360\.com" ascii wide nocase
        $domain42 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain43 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain44 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain45 = "acoustickoala\.com" ascii wide nocase
        $domain46 = "acroadovw\.com" ascii wide nocase
        $domain47 = "activity-179384736\.site" ascii wide nocase
        $domain48 = "activity-permission\.online" ascii wide nocase
        $domain49 = "additional\.work\.gd" ascii wide nocase
