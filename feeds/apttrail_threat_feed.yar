...
rule APT_WIRTE
{
    ...
    strings:
        ...
        $domain2 = "check\.office365-update\.com" ascii wide nocase
        $domain3 = "dentalaccord\.com" ascii wide nocase
        $domain4 = "dentalmatrix\.net" ascii wide nocase
        $domain5 = "doctoressolis\.com" ascii wide nocase
        $domain6 = "download\.share2file\.pro" ascii wide nocase
        $domain7 = "easybackupcloud\.com" ascii wide nocase
        $domain8 = "economymentor\.com" ascii wide nocase
        $domain9 = "economystocking\.com" ascii wide nocase
        $domain10 = "eg\.foxlove\.life" ascii wide nocase
        $domain11 = "egyptican\.com" ascii wide nocase
        $domain12 = "egyptskytours\.com" ascii wide nocase
        $domain13 = "egypttourism-online\.com" ascii wide nocase
        $domain14 = "ellemedic\.com" ascii wide nocase
        $domain15 = "est-clinic\.com" ascii wide nocase
        $domain16 = "finance-analyst\.com" ascii wide nocase
        $domain17 = "financecovers\.com" ascii wide nocase
        $domain18 = "financeinfoguide\.com" ascii wide nocase
        $domain19 = "firstohiobank\.com" ascii wide nocase
        $domain20 = "fox\.foxlove\.life" ascii wide nocase
        $domain21 = "foxlove\.life" ascii wide nocase
        $domain22 = "healthcarb\.com" ascii wide nocase
        $domain23 = "healthoptionstoday\.com" ascii wide nocase
        $domain24 = "healthscratches\.com" ascii wide nocase
        $domain25 = "imagine-world\.com" ascii wide nocase
        $domain26 = "jo\.foxlove\.life" ascii wide nocase
        $domain27 = "jordanrefugees\.com" ascii wide nocase
        $domain28 = "jordansons\.com" ascii wide nocase
        $domain29 = "king-pharmacy\.com" ascii wide nocase
        $domain30 = "kneeexercises\.net" ascii wide nocase
        $domain31 = "master-dental\.com" ascii wide nocase
        $domain32 = "micorsoft\.store" ascii wide nocase
        $domain33 = "microsoftliveforums\.com" ascii wide nocase
        $domain34 = "microsoftteams365\.com" ascii wide nocase
        $domain35 = "microsoftwindowshelp\.com" ascii wide nocase
        $domain36 = "neweconomysolution\.com" ascii wide nocase
        $domain37 = "niftybuysellchart\.com" ascii wide nocase
        $domain38 = "nutrition-information\.org" ascii wide nocase
        $domain39 = "office-update\.services" ascii wide nocase
        $domain40 = "office365-update\.co" ascii wide nocase
        $domain41 = "office365-update\.com" ascii wide nocase
        $domain42 = "omegaeyehospital\.com" ascii wide nocase
        $domain43 = "pocket-property\.com" ascii wide nocase
        $domain44 = "printspoolerupdates\.com" ascii wide nocase
        $domain45 = "qrdorks\.com" ascii wide nocase
        $domain46 = "saudiarabianow\.org" ascii wide nocase
        $domain47 = "saudiday\.org" ascii wide nocase
        $domain48 = "share2file\.pro" ascii wide nocase
        $domain49 = "stgeorgebankers\.com" ascii wide nocase
