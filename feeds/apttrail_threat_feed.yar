...
rule APT_CHARMINGKITTEN
{
    ...
    strings:
        ...
        $domain18 = "acconut-mail\.com" ascii wide nocase
        $domain19 = "acconut-signin\.com" ascii wide nocase
        $domain20 = "acconut-verify\.com" ascii wide nocase
        $domain21 = "account-customerservice\.com" ascii wide nocase
        $domain22 = "account-drive\.com" ascii wide nocase
        $domain23 = "account-dropbox\.net" ascii wide nocase
        $domain24 = "account-google\.co" ascii wide nocase
        $domain25 = "account-log-user-verify-mail\.com" ascii wide nocase
        $domain26 = "account-login\.net" ascii wide nocase
        $domain27 = "account-logins\.com" ascii wide nocase
        $domain28 = "account-permission-mail-user\.com" ascii wide nocase
        $domain29 = "account-profile-users\.info" ascii wide nocase
        $domain30 = "account-servicemanagement\.info" ascii wide nocase
        $domain31 = "account-servicerecovery\.com" ascii wide nocase
        $domain32 = "account-servieemanagement\.info" ascii wide nocase
        $domain33 = "account-signin-myaccount-users\.ga" ascii wide nocase
        $domain34 = "account-signin\.com" ascii wide nocase
        $domain35 = "account-siqnin\.com" ascii wide nocase
        $domain36 = "account-support-user\.com" ascii wide nocase
        $domain37 = "account-user-permission-account\.com" ascii wide nocase
        $domain38 = "account-user-verify-mail\.com" ascii wide nocase
        $domain39 = "account-user\.com" ascii wide nocase
        $domain40 = "account-users-mail\.com" ascii wide nocase
        $domain41 = "account-verifiy\.net" ascii wide nocase
        $domain42 = "accountroyal\.com" ascii wide nocase
        $domain43 = "accounts-apple\.com" ascii wide nocase
        $domain44 = "accounts-drive\.com" ascii wide nocase
        $domain45 = "accounts-googelmail\.com" ascii wide nocase
        $domain46 = "accounts-googelmails\.com" ascii wide nocase
...
rule APT_PATCHWORK
{
    ...
    strings:
        ...
        $domain37 = "atus\.toproid\.xyz" ascii wide nocase
        $domain38 = "aurorafoss\.xyz" ascii wide nocase
        $domain39 = "auth\.fyicompsol\.xyz" ascii wide nocase
        $domain40 = "avangrid\.info" ascii wide nocase
        $domain41 = "avtofrom\.us" ascii wide nocase
        $domain42 = "azureinternalupdates\.com" ascii wide nocase
        $domain43 = "b3autybab3s\.com" ascii wide nocase
        $domain44 = "baidunetdisk\.info" ascii wide nocase
        $domain45 = "bayanat\.co\.nf" ascii wide nocase
        $domain46 = "beautifullimages\.co\.nf" ascii wide nocase
        $domain47 = "beijingtv\.org" ascii wide nocase
        $domain48 = "bhutanembassynepal\.com" ascii wide nocase
        $domain49 = "biaonton\.insightglobel\.info" ascii wide nocase
