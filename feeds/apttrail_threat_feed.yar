...
rule APT_BITTER
{
    ...
    strings:
        ...
        $domain6 = "99togel\.org" ascii wide nocase
        $domain7 = "99toto\.shop" ascii wide nocase
        $domain8 = "a\.churchill91\.com" ascii wide nocase
        $domain9 = "aadresourcing\.com" ascii wide nocase
        $domain10 = "abelewebconnect\.com" ascii wide nocase
        $domain11 = "activemobistore\.ddns\.net" ascii wide nocase
        $domain12 = "adamsresearchshare\.com" ascii wide nocase
        $domain13 = "aday\.primeservices\.mobi" ascii wide nocase
        $domain14 = "aduhoki88\.com" ascii wide nocase
        $domain15 = "affinitycapitalgp\.com" ascii wide nocase
        $domain16 = "affinitycapitalgr\.com" ascii wide nocase
        $domain17 = "alfiehealtcareservice\.com" ascii wide nocase
        $domain18 = "alfiehealthcareservice\.com" ascii wide nocase
        $domain19 = "alkhaleejpk\.info" ascii wide nocase
        $domain20 = "alvesbarcelona\.com" ascii wide nocase
        $domain21 = "andbouncersclub\.com" ascii wide nocase
        $domain22 = "andrewswebstorage\.com" ascii wide nocase
        $domain23 = "apifilestore\.net" ascii wide nocase
        $domain24 = "app\.chabaka\.com" ascii wide nocase
        $domain25 = "app2\.appvlc\.com" ascii wide nocase
        $domain26 = "appbriar\.com" ascii wide nocase
        $domain27 = "appprotonvpn\.com" ascii wide nocase
        $domain28 = "appsupdate\.net" ascii wide nocase
        $domain29 = "archiverst\.com" ascii wide nocase
        $domain30 = "aroundtheworld123\.net" ascii wide nocase
        $domain31 = "ashersoftlib\.com" ascii wide nocase
        $domain32 = "autodefragapp\.com" ascii wide nocase
        $domain33 = "bakuackermannfashions\.com" ascii wide nocase
        $domain34 = "balkanclan\.com" ascii wide nocase
        $domain35 = "bartelemarks\.com" ascii wide nocase
        $domain36 = "benclickstudio\.com" ascii wide nocase
        $domain37 = "bensnewfashionstyles\.com" ascii wide nocase
        $domain38 = "bheragreens\.com" ascii wide nocase
        $domain39 = "bickrickneoservice\.com" ascii wide nocase
        $domain40 = "biocons\.pk" ascii wide nocase
        $domain41 = "blth32serv\.net" ascii wide nocase
        $domain42 = "blucollinsoutien\.com" ascii wide nocase
        $domain43 = "bluelotus\.mail-gdrive\.com" ascii wide nocase
        $domain44 = "bootcampquest\.com" ascii wide nocase
        $domain45 = "botanoolifeapp\.net" ascii wide nocase
        $domain46 = "box\.livevideosonlinepk\.com" ascii wide nocase
        $domain47 = "briarapppro\.org" ascii wide nocase
        $domain48 = "broadsforthestate\.com" ascii wide nocase
        $domain49 = "bsdqcaptureman\.com" ascii wide nocase
...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain39 = "13nservercc\.cfd" ascii wide nocase
        $domain40 = "13onlinen\.cfd" ascii wide nocase
        $domain41 = "14nservercc\.cfd" ascii wide nocase
        $domain42 = "14onlinen\.cfd" ascii wide nocase
        $domain43 = "15dhyfituhivoivjjgijrtjtgg\.cfd" ascii wide nocase
        $domain44 = "15fuerouhrgiurtituigjtug\.cfd" ascii wide nocase
        $domain45 = "15hjdgvfdjbvunghghod\.cfd" ascii wide nocase
        $domain46 = "15jhguerhguyogjopgoff\.cfd" ascii wide nocase
        $domain47 = "15nservercc\.cfd" ascii wide nocase
        $domain48 = "15onlinen\.cfd" ascii wide nocase
        $domain49 = "15ygfyerfgyufhsdgfyegf\.cfd" ascii wide nocase
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $ip50 = "103.106.67.63" ascii wide
        $ip51 = "103.106.67.63" ascii wide
        $ip52 = "103.106.67.63" ascii wide
        $ip53 = "103.205.179.4" ascii wide
        $ip54 = "103.231.75.101" ascii wide
        $ip55 = "103.35.189.107" ascii wide
        $ip56 = "103.35.189.107" ascii wide
        $ip57 = "103.65.230.100" ascii wide
        $ip58 = "104.168.136.24" ascii wide
        $ip59 = "104.168.151.34" ascii wide
        $ip60 = "104.168.157.45" ascii wide
        $ip61 = "104.168.157.45" ascii wide
        $ip62 = "104.168.165.165" ascii wide
        $ip63 = "104.168.165.165" ascii wide
        $ip64 = "104.168.165.173" ascii wide
        $ip65 = "104.168.165.173" ascii wide
        $ip66 = "104.168.165.203" ascii wide
        $ip67 = "104.168.165.203" ascii wide
        $ip68 = "104.168.172.20" ascii wide
        $ip69 = "104.168.203.159" ascii wide
        $ip70 = "104.168.203.159" ascii wide
        $ip71 = "104.192.42.117" ascii wide
        $ip72 = "104.194.133.88" ascii wide
        $ip73 = "104.194.133.88" ascii wide
        $ip74 = "104.217.163.61" ascii wide
        $ip75 = "104.232.71.7" ascii wide
        $ip76 = "107.172.197.175" ascii wide
        $ip77 = "107.175.172.129" ascii wide
        $ip78 = "107.189.16.122" ascii wide
...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain24 = "8ln62\.cfd" ascii wide nocase
        $domain25 = "8thpaycomission\.cloud" ascii wide nocase
        $domain26 = "8tqxpf27\.torontobotdns\.com" ascii wide nocase
        $domain27 = "903\.78990\.fun" ascii wide nocase
        $domain28 = "9123\.89204\.fun" ascii wide nocase
        $domain29 = "9882aa1216\.autos" ascii wide nocase
        $domain30 = "999game\.website" ascii wide nocase
        $domain31 = "9gi02\.cfd" ascii wide nocase
        $domain32 = "9ydygorig3l7z\.xyz" ascii wide nocase
        $domain33 = "aa\.76767\.icu" ascii wide nocase
        $domain34 = "aadharpor\.xyz" ascii wide nocase
        $domain35 = "aaloochaat\.com" ascii wide nocase
        $domain36 = "aboutcase\.nl" ascii wide nocase
        $domain37 = "ac\.76767\.icu" ascii wide nocase
        $domain38 = "accinfo\.live" ascii wide nocase
        $domain39 = "account-recovery\.com" ascii wide nocase
        $domain40 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain41 = "accountmail\.in" ascii wide nocase
        $domain42 = "accounts-migration\.mgovcloud\.de" ascii wide nocase
        $domain43 = "accounts\.mgovcloud\.de" ascii wide nocase
        $domain44 = "accounts\.mgovcloud\.in\.cloudshare\.digital" ascii wide nocase
        $domain45 = "accounts\.mgovcloud\.in\.departmentofdefence\.live" ascii wide nocase
        $domain46 = "accounts\.mgovcloud\.in\.indiagov\.support" ascii wide nocase
        $domain47 = "accounts\.mgovcloud\.in\.storagecloud\.download" ascii wide nocase
        $domain48 = "accounts\.mgovcloud\.in\.virtualeoffice\.cloud" ascii wide nocase
        $domain49 = "accountsinfo\.site" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain2 = "022\.furzocpc\.cc" ascii wide nocase
        $domain3 = "0221f016\.6hv86gxz\.com" ascii wide nocase
        $domain4 = "0278\.fxexebji\.org" ascii wide nocase
        $domain5 = "035b1c\.xlgxyf\.net" ascii wide nocase
        $domain6 = "0462b0\.xdkfog\.net" ascii wide nocase
        $domain7 = "047\.auyciwmw\.com" ascii wide nocase
        $domain8 = "063\.heppmpuz\.org" ascii wide nocase
        $domain9 = "06ee\.vcfwvb\.com" ascii wide nocase
        $domain10 = "099339\.6hv86gxz\.com" ascii wide nocase
        $domain11 = "0b2b\.dljuhnea\.com" ascii wide nocase
        $domain12 = "0b87ed69\.xlgxyf\.net" ascii wide nocase
        $domain13 = "0b88\.mqztymvz\.cc" ascii wide nocase
        $domain14 = "0ba7\.vqlbhbmo\.xyz" ascii wide nocase
        $domain15 = "0ce1\.dljuhnea\.com" ascii wide nocase
        $domain16 = "0d0\.ozhignq\.com" ascii wide nocase
        $domain17 = "0e2a2\.xlgxyf\.net" ascii wide nocase
        $domain18 = "0gab6nun8ubl2pk\.xyz" ascii wide nocase
        $domain19 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain20 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain21 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain22 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain23 = "158\.ozhignq\.com" ascii wide nocase
        $domain24 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain25 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain26 = "168\.yktajeyp\.com" ascii wide nocase
        $domain27 = "17cx1\.com" ascii wide nocase
        $domain28 = "17cx11\.com" ascii wide nocase
        $domain29 = "17cx2\.com" ascii wide nocase
        $domain30 = "17cx3\.com" ascii wide nocase
        $domain31 = "17cx4\.com" ascii wide nocase
        $domain32 = "17cx5\.com" ascii wide nocase
        $domain33 = "17cx7\.com" ascii wide nocase
        $domain34 = "17cx8\.com" ascii wide nocase
        $domain35 = "17cx9\.com" ascii wide nocase
        $domain36 = "17cxa\.com" ascii wide nocase
        $domain37 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain38 = "180\.auyciwmw\.com" ascii wide nocase
        $domain39 = "186c0a0f\.auyciwmw\.com" ascii wide nocase
        $domain40 = "18c54\.dljuhnea\.com" ascii wide nocase
        $domain41 = "18cnask0a147yxj\.xyz" ascii wide nocase
        $domain42 = "1a4\.kjtwhgda\.tips" ascii wide nocase
        $domain43 = "1b4d\.jkhvfia\.com" ascii wide nocase
        $domain44 = "1c68f\.vxhbijn\.com" ascii wide nocase
        $domain45 = "1cc01\.ryvjugi\.com" ascii wide nocase
        $domain46 = "1d42ghd36as85azx54\.com" ascii wide nocase
        $domain47 = "1d82\.de83c8f74\.net" ascii wide nocase
        $domain48 = "1d9085\.xlgxyf\.net" ascii wide nocase
        $domain49 = "1dad1\.ryvjugi\.com" ascii wide nocase
