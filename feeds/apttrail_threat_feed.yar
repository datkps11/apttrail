...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain36 = "91\.90\.121\.87\.sslip\.io" ascii wide nocase
        $domain37 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain38 = "a\.videotalks\.site" ascii wide nocase
        $domain39 = "aaronsfazzy\.slack\.com" ascii wide nocase
        $domain40 = "aaronzeeshan\.slack\.com" ascii wide nocase
        $domain41 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain42 = "abc\.meeting-central\.online" ascii wide nocase
        $domain43 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain44 = "abc\.preconnection\.online" ascii wide nocase
        $domain45 = "abc\.roomconnect\.online" ascii wide nocase
        $domain46 = "abilityscan360\.com" ascii wide nocase
        $domain47 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain48 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain49 = "accounts\.ceinbase\.com" ascii wide nocase
...
rule APT_RAINBOWHYENA
{
    ...
    strings:
        ...
        $domain3 = "1to30\.shop" ascii wide nocase
        $domain4 = "3hito\.tech" ascii wide nocase
        $domain5 = "50forwardspodcast\.co\.uk" ascii wide nocase
        $domain6 = "7evenfoundation\.org" ascii wide nocase
        $domain7 = "92108\.sbs" ascii wide nocase
        $domain8 = "aainfo\.online" ascii wide nocase
        $domain9 = "abhinayafoodrecipes\.com" ascii wide nocase
        $domain10 = "abstractcorner\.com" ascii wide nocase
        $domain11 = "account\.win-shares\.com" ascii wide nocase
        $domain12 = "acquisizione\.net" ascii wide nocase
        $domain13 = "activehealth01\.online" ascii wide nocase
        $domain14 = "admirationhq\.com" ascii wide nocase
        $domain15 = "aegissecurity\.online" ascii wide nocase
        $domain16 = "affilipost\.com" ascii wide nocase
        $domain17 = "affordablecarsonline\.com" ascii wide nocase
        $domain18 = "agelessbonds\.com" ascii wide nocase
        $domain19 = "aifix\.space" ascii wide nocase
        $domain20 = "ainghain\.com" ascii wide nocase
        $domain21 = "aiupworkpro\.com" ascii wide nocase
        $domain22 = "alliedambitions\.com" ascii wide nocase
        $domain23 = "allin1livetv\.xyz" ascii wide nocase
        $domain24 = "allretail\.shop" ascii wide nocase
        $domain25 = "allstaramerican\.com" ascii wide nocase
        $domain26 = "almaxhura\.com" ascii wide nocase
        $domain27 = "alquilerdecuatrimotosmedellin\.com" ascii wide nocase
        $domain28 = "alsawsanaalsawdaa\.com" ascii wide nocase
        $domain29 = "alugueseusite\.net" ascii wide nocase
        $domain30 = "alvarezgabriel\.com" ascii wide nocase
        $domain31 = "alyseikari\.com" ascii wide nocase
        $domain32 = "ama30anos\.online" ascii wide nocase
        $domain33 = "amaatucachorro\.com" ascii wide nocase
        $domain34 = "americancrepes\.co" ascii wide nocase
        $domain35 = "amritsariyadhaba\.com" ascii wide nocase
        $domain36 = "analytisec\.space" ascii wide nocase
        $domain37 = "andrescardenas\.uno" ascii wide nocase
        $domain38 = "anishpitale\.com" ascii wide nocase
        $domain39 = "antenasbet\.online" ascii wide nocase
        $domain40 = "anthonychukwu\.net" ascii wide nocase
        $domain41 = "aonemy\.com" ascii wide nocase
        $domain42 = "app\.shieldify\.online" ascii wide nocase
        $domain43 = "appeasy\.ai" ascii wide nocase
        $domain44 = "appulse\.info" ascii wide nocase
        $domain45 = "areamarket\.online" ascii wide nocase
        $domain46 = "arkadcorretora\.online" ascii wide nocase
        $domain47 = "artmateriali\.com" ascii wide nocase
        $domain48 = "arya-anggara\.xyz" ascii wide nocase
        $domain49 = "ashariyya\.online" ascii wide nocase
        ...
        $ip54 = "195.133.32.213" ascii wide
        $ip55 = "213.232.204.111" ascii wide
        $ip56 = "213.232.204.111" ascii wide
        $ip57 = "31.56.227.100" ascii wide
        $ip58 = "31.56.227.100" ascii wide
        $ip59 = "31.56.227.100" ascii wide
        $ip60 = "31.56.227.61" ascii wide
        $ip61 = "31.56.227.61" ascii wide
        $ip62 = "31.56.227.61" ascii wide
        $ip63 = "31.56.227.61" ascii wide
        $ip64 = "31.56.227.61" ascii wide
        $ip65 = "31.56.227.61" ascii wide
        $ip66 = "31.56.227.61" ascii wide
        $ip67 = "31.56.227.61" ascii wide
        $ip68 = "31.56.48.178" ascii wide
        $ip69 = "31.58.137.197" ascii wide
        $ip70 = "31.58.137.197" ascii wide
        $ip71 = "31.58.137.197" ascii wide
        $ip72 = "45.11.27.232" ascii wide
        $ip73 = "45.87.245.30" ascii wide
        $ip74 = "45.87.246.169" ascii wide
        $ip75 = "5.252.176.77" ascii wide
        $ip76 = "5.252.176.77" ascii wide
        $ip77 = "80.66.81.13" ascii wide
        $ip78 = "80.66.81.13" ascii wide
        $ip79 = "94.183.188.166" ascii wide
