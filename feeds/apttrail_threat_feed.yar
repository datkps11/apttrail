...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain35 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain36 = "0x0\.care" ascii wide nocase
        $domain37 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain38 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain39 = "100000recipe\.com" ascii wide nocase
        $domain40 = "100nservercc\.cfd" ascii wide nocase
        $domain41 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain42 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain43 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain44 = "10nservercc\.cfd" ascii wide nocase
        $domain45 = "10onlinen\.cfd" ascii wide nocase
        $domain46 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain47 = "11nservercc\.cfd" ascii wide nocase
        $domain48 = "11onlinen\.cfd" ascii wide nocase
        $domain49 = "12-ko-official\.com" ascii wide nocase
...
rule APT_UNC6691
{
    ...
    strings:
        ...
        $domain25 = "101\.vqlbhbmo\.xyz" ascii wide nocase
        $domain26 = "1124e\.ryvjugi\.com" ascii wide nocase
        $domain27 = "112b\.kjtwhgda\.tips" ascii wide nocase
        $domain28 = "12cc\.thqirrxu\.com" ascii wide nocase
        $domain29 = "132f03\.vnriifeq\.com" ascii wide nocase
        $domain30 = "158\.ozhignq\.com" ascii wide nocase
        $domain31 = "158a9\.ryvjugi\.com" ascii wide nocase
        $domain32 = "1622\.heppmpuz\.org" ascii wide nocase
        $domain33 = "168\.yktajeyp\.com" ascii wide nocase
        $domain34 = "17cx1\.com" ascii wide nocase
        $domain35 = "17cx11\.com" ascii wide nocase
        $domain36 = "17cx2\.com" ascii wide nocase
        $domain37 = "17cx3\.com" ascii wide nocase
        $domain38 = "17cx4\.com" ascii wide nocase
        $domain39 = "17cx5\.com" ascii wide nocase
        $domain40 = "17cx7\.com" ascii wide nocase
        $domain41 = "17cx8\.com" ascii wide nocase
        $domain42 = "17cx9\.com" ascii wide nocase
        $domain43 = "17cxa\.com" ascii wide nocase
        $domain44 = "17f2c2i2npjklhl\.xyz" ascii wide nocase
        $domain45 = "17lu\.life" ascii wide nocase
        $domain46 = "17lulu\.club" ascii wide nocase
        $domain47 = "17lulu\.live" ascii wide nocase
        $domain48 = "17lulu\.ltd" ascii wide nocase
        $domain49 = "17lulu\.online" ascii wide nocase
