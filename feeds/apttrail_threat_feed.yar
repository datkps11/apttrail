...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain11 = "dash-server\.servertech03\.workers\.dev" ascii wide nocase
        $domain12 = "ec2-app\.lewoha7320\.workers\.dev" ascii wide nocase
        $domain13 = "ec2-server\.bayaj19162\.workers\.dev" ascii wide nocase
        $domain14 = "ec2-server\.gegodec527\.workers\.dev" ascii wide nocase
        $domain15 = "ec2-server\.milago3967\.workers\.dev" ascii wide nocase
        $domain16 = "floral-paper-8eb1\.pihara4672\.workers\.dev" ascii wide nocase
        $domain17 = "keystore-explorer\.com" ascii wide nocase
        $domain18 = "mstore\.framfarmers\.co\.uk" ascii wide nocase
        $domain19 = "pofelal314\.workers\.dev" ascii wide nocase
        $domain20 = "server-cdn\.jawigaw383\.workers\.dev" ascii wide nocase
        $domain21 = "server-cdn\.lafise2419\.workers\.dev" ascii wide nocase
        $domain22 = "server-cdn\.lecoc56350\.workers\.dev" ascii wide nocase
        $domain23 = "server-cdn\.sidoke9822\.workers\.dev" ascii wide nocase
        $domain24 = "server-cdn\.virej10913\.workers\.dev" ascii wide nocase
        $domain25 = "server-cdn\.xohahey822\.workers\.dev" ascii wide nocase
        $domain26 = "server-web-cdn\.detocim498\.workers\.dev" ascii wide nocase
        $domain27 = "server-web-cdn\.dones86497\.workers\.dev" ascii wide nocase
        $domain28 = "server-web-cdn\.kagoli5215\.workers\.dev" ascii wide nocase
        $domain29 = "server-web-cdn\.mevame4224\.workers\.dev" ascii wide nocase
        $domain30 = "server-web-cdn\.nefixeg373\.workers\.dev" ascii wide nocase
        $domain31 = "server-web-cdn\.pixece7948\.workers\.dev" ascii wide nocase
        $domain32 = "server-web-cdn\.ravebo3233\.workers\.dev" ascii wide nocase
        $domain33 = "server-web-cdn\.rojotoc516\.workers\.dev" ascii wide nocase
        $domain34 = "server-web-cdn\.vosax32455\.workers\.dev" ascii wide nocase
        $domain35 = "server-web-cdn\.yevobod379\.workers\.dev" ascii wide nocase
        $domain36 = "server-web-cdn1\.gekod80409\.workers\.dev" ascii wide nocase
        $domain37 = "soft-base-01\.ginigiy117\.workers\.dev" ascii wide nocase
        $domain38 = "soft-dns\.sejilod748\.workers\.dev" ascii wide nocase
        $domain39 = "ssl\.bapiyat727\.workers\.dev" ascii wide nocase
        $domain40 = "web-app\.dasik14289\.workers\.dev" ascii wide nocase
        $domain41 = "work-server-1\.picalob750\.workers\.dev" ascii wide nocase
