...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain14 = "0746382\.xyz" ascii wide nocase
        $domain15 = "0746925\.xyz" ascii wide nocase
        $domain16 = "0857314\.xyz" ascii wide nocase
        $domain17 = "0865174\.xyz" ascii wide nocase
        $domain18 = "0946158\.xyz" ascii wide nocase
        $domain19 = "0947682\.xyz" ascii wide nocase
        $domain20 = "0973642\.xyz" ascii wide nocase
        $domain21 = "0973648\.xyz" ascii wide nocase
        $domain22 = "1059748\.xyz" ascii wide nocase
        $domain23 = "108901\.xyz" ascii wide nocase
        $domain24 = "115437\.xyz" ascii wide nocase
        $domain25 = "116240\.xyz" ascii wide nocase
        $domain26 = "118462\.xyz" ascii wide nocase
        $domain27 = "118652\.xyz" ascii wide nocase
        $domain28 = "119012\.xyz" ascii wide nocase
        $domain29 = "120459\.xyz" ascii wide nocase
        $domain30 = "120974\.xyz" ascii wide nocase
        $domain31 = "12498376\.xyz" ascii wide nocase
        $domain32 = "126805\.xyz" ascii wide nocase
        $domain33 = "126841\.xyz" ascii wide nocase
        $domain34 = "1274672\.xyz" ascii wide nocase
        $domain35 = "1279578\.xyz" ascii wide nocase
        $domain36 = "128901\.xyz" ascii wide nocase
        $domain37 = "129012\.xyz" ascii wide nocase
        $domain38 = "1307486\.xyz" ascii wide nocase
        $domain39 = "132345\.xyz" ascii wide nocase
        $domain40 = "132579\.xyz" ascii wide nocase
        $domain41 = "132690\.xyz" ascii wide nocase
        $domain42 = "1327589\.xyz" ascii wide nocase
        $domain43 = "1357806\.xyz" ascii wide nocase
        $domain44 = "1365084\.xyz" ascii wide nocase
        $domain45 = "1368497\.xyz" ascii wide nocase
        $domain46 = "138901\.xyz" ascii wide nocase
        $domain47 = "139012\.xyz" ascii wide nocase
        $domain48 = "143456\.xyz" ascii wide nocase
        $domain49 = "143682\.xyz" ascii wide nocase
