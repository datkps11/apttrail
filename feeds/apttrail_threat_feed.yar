...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain11 = "a\.mylkc\.cloudns\.ch" ascii wide nocase
        $domain12 = "abf-cap\.co" ascii wide nocase
        $domain13 = "abf-cap\.com" ascii wide nocase
        $domain14 = "abiesvc\.com" ascii wide nocase
        $domain15 = "abiesvc\.info" ascii wide nocase
        $domain16 = "abiesvc\.jp\.net" ascii wide nocase
        $domain17 = "account-googlemeet\.com" ascii wide nocase
        $domain18 = "adiclas-nft\.quest" ascii wide nocase
        $domain19 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain20 = "aidpartners\.org" ascii wide nocase
        $domain21 = "ajayplamingo\.com" ascii wide nocase
        $domain22 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain23 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain24 = "altair-vc\.co\.uk" ascii wide nocase
        $domain25 = "altair-vc\.com" ascii wide nocase
        $domain26 = "altair\.linkpc\.net" ascii wide nocase
        $domain27 = "amazonaws1\.info" ascii wide nocase
        $domain28 = "amzonnews\.club" ascii wide nocase
        $domain29 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain30 = "angelbridge\.capital" ascii wide nocase
        $domain31 = "angelbridge\.jp" ascii wide nocase
        $domain32 = "ankanimatoka\.com" ascii wide nocase
        $domain33 = "anobaka\.info" ascii wide nocase
        $domain34 = "anobaka\.jp" ascii wide nocase
        $domain35 = "antcapital\.us" ascii wide nocase
        $domain36 = "api\.betterfun\.space" ascii wide nocase
        $domain37 = "api\.clearit\.sbs" ascii wide nocase
        $domain38 = "api\.flashstore\.sbs" ascii wide nocase
        $domain39 = "api\.zerodev\.pro" ascii wide nocase
        $domain40 = "api\.zoom-sdk\.com" ascii wide nocase
        $domain41 = "apizoom\.myfanshu\.com" ascii wide nocase
        $domain42 = "app-wechat\.xyz" ascii wide nocase
        $domain43 = "app\.baiduweb\.pro" ascii wide nocase
        $domain44 = "app\.developcore\.org" ascii wide nocase
        $domain45 = "app\.republicrypto\.vc" ascii wide nocase
        $domain46 = "app\.thorwsap\.finance" ascii wide nocase
        $domain47 = "appleaccess\.pro" ascii wide nocase
        $domain48 = "appleupdate\.datauploader\.site" ascii wide nocase
        $domain49 = "arbordeck\.co\.in" ascii wide nocase
