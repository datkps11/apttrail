...
rule APT_KIMSUKY
{
    ...
    strings:
        ...
        $domain17 = "07nservercc\.cfd" ascii wide nocase
        $domain18 = "07onlinen\.cfd" ascii wide nocase
        $domain19 = "08nservercc\.cfd" ascii wide nocase
        $domain20 = "08onlinen\.cfd" ascii wide nocase
        $domain21 = "090\.apollo-page\.kro\.kr" ascii wide nocase
        $domain22 = "090\.gov5nikisa\.kro\.kr" ascii wide nocase
        $domain23 = "09nservercc\.cfd" ascii wide nocase
        $domain24 = "09onlinen\.cfd" ascii wide nocase
        $domain25 = "0c50zrvnoi\.v6\.rocks" ascii wide nocase
        $domain26 = "0knw2300\.mypressonline\.com" ascii wide nocase
        $domain27 = "0vym\.mailcorp\.eu" ascii wide nocase
        $domain28 = "0x0\.care" ascii wide nocase
        $domain29 = "1-z\.never\.com\.ru" ascii wide nocase
        $domain30 = "1\.aenco\.kro\.kr" ascii wide nocase
        $domain31 = "100000recipe\.com" ascii wide nocase
        $domain32 = "100nservercc\.cfd" ascii wide nocase
        $domain33 = "102c928da265b\.duckdns\.org" ascii wide nocase
        $domain34 = "107-189-24-28\.cprapid\.com" ascii wide nocase
        $domain35 = "107\.189\.24\.28\.sslip\.io" ascii wide nocase
        $domain36 = "10nservercc\.cfd" ascii wide nocase
        $domain37 = "10onlinen\.cfd" ascii wide nocase
        $domain38 = "112-216-240-98\.softether\.net" ascii wide nocase
        $domain39 = "11nservercc\.cfd" ascii wide nocase
        $domain40 = "11onlinen\.cfd" ascii wide nocase
        $domain41 = "12-ko-official\.com" ascii wide nocase
        $domain42 = "1213rt\.atwebpages\.com" ascii wide nocase
        $domain43 = "123\.apollo-page\.n-e\.kr" ascii wide nocase
        $domain44 = "12nservercc\.cfd" ascii wide nocase
        $domain45 = "12onlinen\.cfd" ascii wide nocase
        $domain46 = "139\.149amdoc-hometax\.mydns\.bz" ascii wide nocase
        $domain47 = "139\.149aodoc-hometax\.mydns\.bz" ascii wide nocase
        $domain48 = "13nservercc\.cfd" ascii wide nocase
        $domain49 = "13onlinen\.cfd" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain2 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain3 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain4 = "45perhour\.org" ascii wide nocase
        $domain5 = "7stories\.sbs" ascii wide nocase
        $domain6 = "91movs\.com" ascii wide nocase
        $domain7 = "9xstream\.live" ascii wide nocase
        $domain8 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain9 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain10 = "abstractest-hydroski\.site" ascii wide nocase
        $domain11 = "academytradeai\.com" ascii wide nocase
        $domain12 = "acquasicuras\.com" ascii wide nocase
        $domain13 = "actbluecs\.com" ascii wide nocase
        $domain14 = "actblues\.net" ascii wide nocase
        $domain15 = "adionetjrei\.shop" ascii wide nocase
        $domain16 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain17 = "adrilex\.digital" ascii wide nocase
        $domain18 = "aexnp\.com" ascii wide nocase
        $domain19 = "afeherbopenuk\.com" ascii wide nocase
        $domain20 = "agronomywork\.info" ascii wide nocase
        $domain21 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain22 = "aialgocamp\.com" ascii wide nocase
        $domain23 = "aialgocore\.com" ascii wide nocase
        $domain24 = "aialgodrive\.com" ascii wide nocase
        $domain25 = "aialgoflow\.com" ascii wide nocase
        $domain26 = "aialgofusion\.com" ascii wide nocase
        $domain27 = "aialgohash\.com" ascii wide nocase
        $domain28 = "aialgorithmforge\.com" ascii wide nocase
        $domain29 = "aialgorithmicforge\.com" ascii wide nocase
        $domain30 = "aialgorithmicpath\.com" ascii wide nocase
        $domain31 = "aialgosense\.com" ascii wide nocase
        $domain32 = "aialgosphere\.com" ascii wide nocase
        $domain33 = "aianalyticengine\.com" ascii wide nocase
        $domain34 = "aianalyticmesh\.com" ascii wide nocase
        $domain35 = "aiautomationframework\.com" ascii wide nocase
        $domain36 = "aiautonomycore\.com" ascii wide nocase
        $domain37 = "aibigdatamap\.com" ascii wide nocase
        $domain38 = "aibotscale\.com" ascii wide nocase
        $domain39 = "aibrainatelier\.com" ascii wide nocase
        $domain40 = "aibrainframe\.com" ascii wide nocase
        $domain41 = "aibrainlogicc\.com" ascii wide nocase
        $domain42 = "aibrainmatrixed\.com" ascii wide nocase
        $domain43 = "aibrainyard\.com" ascii wide nocase
        $domain44 = "aibuildersguild\.com" ascii wide nocase
        $domain45 = "aibuildnet\.com" ascii wide nocase
        $domain46 = "aibuildspark\.com" ascii wide nocase
        $domain47 = "aibytepad\.com" ascii wide nocase
        $domain48 = "aicalcengine\.com" ascii wide nocase
        $domain49 = "aichatbeam\.com" ascii wide nocase
