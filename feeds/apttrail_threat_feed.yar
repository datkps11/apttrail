...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain33 = "api\.zerodev\.pro" ascii wide nocase
        $domain34 = "api\.zoom-sdk\.com" ascii wide nocase
        $domain35 = "apizoom\.myfanshu\.com" ascii wide nocase
        $domain36 = "app-wechat\.xyz" ascii wide nocase
        $domain37 = "app\.baiduweb\.pro" ascii wide nocase
        $domain38 = "app\.developcore\.org" ascii wide nocase
        $domain39 = "app\.republicrypto\.vc" ascii wide nocase
        $domain40 = "app\.thorwsap\.finance" ascii wide nocase
        $domain41 = "appleaccess\.pro" ascii wide nocase
        $domain42 = "appleupdate\.datauploader\.site" ascii wide nocase
        $domain43 = "arbordeck\.co\.in" ascii wide nocase
        $domain44 = "arborventures\.capital" ascii wide nocase
        $domain45 = "arkinvst\.com" ascii wide nocase
        $domain46 = "armzon\.onmypc\.org" ascii wide nocase
        $domain47 = "association\.linkpc\.net" ascii wide nocase
        $domain48 = "atajerefoods\.com" ascii wide nocase
        $domain49 = "atom\.publicvm\.com" ascii wide nocase
