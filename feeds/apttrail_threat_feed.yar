...
rule APT_MUDDYWATER
{
    ...
    strings:
        $domain0 = "0947682\.xyz" ascii wide nocase
        $domain1 = "0973642\.xyz" ascii wide nocase
        $domain2 = "1274672\.xyz" ascii wide nocase
        $domain3 = "1279578\.xyz" ascii wide nocase
        $domain4 = "132690\.xyz" ascii wide nocase
        $domain5 = "1368497\.xyz" ascii wide nocase
        $domain6 = "1459738\.xyz" ascii wide nocase
        $domain7 = "1549038\.xyz" ascii wide nocase
        $domain8 = "159352\.xyz" ascii wide nocase
        $domain9 = "1597382\.xyz" ascii wide nocase
        $domain10 = "1748906\.xyz" ascii wide nocase
        $domain11 = "1759248\.xyz" ascii wide nocase
        $domain12 = "18372046\.xyz" ascii wide nocase
        $domain13 = "19372048\.xyz" ascii wide nocase
        $domain14 = "204681\.xyz" ascii wide nocase
        $domain15 = "204904\.xyz" ascii wide nocase
        $domain16 = "206904\.xyz" ascii wide nocase
        $domain17 = "2097583\.xyz" ascii wide nocase
        $domain18 = "2358406\.xyz" ascii wide nocase
        $domain19 = "2384609\.xyz" ascii wide nocase
        $domain20 = "2508173\.xyz" ascii wide nocase
        $domain21 = "2609481\.xyz" ascii wide nocase
        $domain22 = "261467\.xyz" ascii wide nocase
        $domain23 = "261615\.xyz" ascii wide nocase
        $domain24 = "261957\.xyz" ascii wide nocase
        $domain25 = "268439\.xyz" ascii wide nocase
        $domain26 = "274352\.xyz" ascii wide nocase
        $domain27 = "2749051\.xyz" ascii wide nocase
        $domain28 = "275481\.xyz" ascii wide nocase
        $domain29 = "2759306\.xyz" ascii wide nocase
        $domain30 = "28461937\.xyz" ascii wide nocase
        $domain31 = "3028617\.xyz" ascii wide nocase
        $domain32 = "3129685\.xyz" ascii wide nocase
        $domain33 = "3181275\.xyz" ascii wide nocase
        $domain34 = "3197506\.xyz" ascii wide nocase
        $domain35 = "319830\.xyz" ascii wide nocase
        $domain36 = "340593\.xyz" ascii wide nocase
        $domain37 = "340629\.xyz" ascii wide nocase
        $domain38 = "3605817\.xyz" ascii wide nocase
        $domain39 = "3672159\.xyz" ascii wide nocase
        $domain40 = "368890\.xyz" ascii wide nocase
        $domain41 = "37194825\.xyz" ascii wide nocase
        $domain42 = "37491826\.xyz" ascii wide nocase
        $domain43 = "3847165\.xyz" ascii wide nocase
        $domain44 = "4237019\.xyz" ascii wide nocase
        $domain45 = "4391275\.xyz" ascii wide nocase
        $domain46 = "4395931\.xyz" ascii wide nocase
        $domain47 = "4507268\.xyz" ascii wide nocase
        $domain48 = "4529086\.xyz" ascii wide nocase
        $domain49 = "4702168\.xyz" ascii wide nocase
...
rule APT_UNC2465
{
    ...
    strings:
        ...
        $domain7 = "21\.rvtoolsen\.com" ascii wide nocase
        $domain8 = "22\.rvtoolsik\.com" ascii wide nocase
        $domain9 = "24\.rvtoolis\.info" ascii wide nocase
        $domain10 = "27\.rvtoolsax\.com" ascii wide nocase
        $domain11 = "2a\.rvtoolso\.info" ascii wide nocase
        $domain12 = "2j\.rvtoolsup\.com" ascii wide nocase
        $domain13 = "3g\.s3brovvser\.com" ascii wide nocase
        $domain14 = "3p\.workbenche\.com" ascii wide nocase
        $domain15 = "45perhour\.org" ascii wide nocase
        $domain16 = "4t\.rvtoolsacs\.com" ascii wide nocase
        $domain17 = "54\.rvtoolsone\.com" ascii wide nocase
        $domain18 = "58\.rvtoolsmax\.com" ascii wide nocase
        $domain19 = "5b\.rvtoolsbox\.com" ascii wide nocase
        $domain20 = "7stories\.sbs" ascii wide nocase
        $domain21 = "91movs\.com" ascii wide nocase
        $domain22 = "9xstream\.live" ascii wide nocase
        $domain23 = "aapanel116864\.hostkey\.in" ascii wide nocase
        $domain24 = "aapanel34768\.hostkey\.in" ascii wide nocase
        $domain25 = "abstractest-hydroski\.site" ascii wide nocase
        $domain26 = "academytradeai\.com" ascii wide nocase
        $domain27 = "acquasicuras\.com" ascii wide nocase
        $domain28 = "actbluecs\.com" ascii wide nocase
        $domain29 = "actblues\.net" ascii wide nocase
        $domain30 = "adionetjrei\.shop" ascii wide nocase
        $domain31 = "admin\.rvtoolacs\.online" ascii wide nocase
        $domain32 = "adrilex\.digital" ascii wide nocase
        $domain33 = "aexnp\.com" ascii wide nocase
        $domain34 = "afeherbopenuk\.com" ascii wide nocase
        $domain35 = "agronomywork\.info" ascii wide nocase
        $domain36 = "aiadvancedreasoning\.com" ascii wide nocase
        $domain37 = "aialgocamp\.com" ascii wide nocase
        $domain38 = "aialgocore\.com" ascii wide nocase
        $domain39 = "aialgodrive\.com" ascii wide nocase
        $domain40 = "aialgoflow\.com" ascii wide nocase
        $domain41 = "aialgofusion\.com" ascii wide nocase
        $domain42 = "aialgohash\.com" ascii wide nocase
        $domain43 = "aialgorithmforge\.com" ascii wide nocase
        $domain44 = "aialgorithmicforge\.com" ascii wide nocase
        $domain45 = "aialgorithmicpath\.com" ascii wide nocase
        $domain46 = "aialgosense\.com" ascii wide nocase
        $domain47 = "aialgosphere\.com" ascii wide nocase
        $domain48 = "aianalyticengine\.com" ascii wide nocase
        $domain49 = "aianalyticmesh\.com" ascii wide nocase
