...
rule APT_BLUENOROFF
{
    ...
    strings:
        ...
        $domain1 = "02room\.us" ascii wide nocase
        $domain2 = "02usweb\.us" ascii wide nocase
        $domain3 = "02web-zoom\.us" ascii wide nocase
        $domain4 = "02webzoom\.us" ascii wide nocase
        $domain5 = "05meet\.us" ascii wide nocase
        $domain6 = "05uk\.us" ascii wide nocase
        $domain7 = "05ukweb\.uk" ascii wide nocase
        $domain8 = "05usweb\.us" ascii wide nocase
        $domain9 = "05usweb\.zoom\.meet-05\.sbs" ascii wide nocase
        $domain10 = "05web\.us" ascii wide nocase
        $domain11 = "05webus\.meet\.05uk\.us" ascii wide nocase
        $domain12 = "06ukweb\.uk" ascii wide nocase
        $domain13 = "06usweb\.us" ascii wide nocase
        $domain14 = "07-web\.us" ascii wide nocase
        $domain15 = "07usweb\.site" ascii wide nocase
        $domain16 = "07web\.zoom\.uk07\.pro" ascii wide nocase
        $domain17 = "07webus\.zoom\.us07\.sbs" ascii wide nocase
        $domain18 = "163qiye\.top" ascii wide nocase
        $domain19 = "1driv\.org" ascii wide nocase
        $domain20 = "1drv\.email" ascii wide nocase
        $domain21 = "1drvmail\.work" ascii wide nocase
        $domain22 = "256ventures\.us" ascii wide nocase
        $domain23 = "31ventures\.info" ascii wide nocase
        $domain24 = "32\.ww-live\.online" ascii wide nocase
        $domain25 = "3f\.teams-meet\.xyz" ascii wide nocase
        $domain26 = "5q\.ms-meets\.online" ascii wide nocase
        $domain27 = "a\.mylkc\.cloudns\.ch" ascii wide nocase
        $domain28 = "abf-cap\.co" ascii wide nocase
        $domain29 = "abf-cap\.com" ascii wide nocase
        $domain30 = "abiesvc\.com" ascii wide nocase
        $domain31 = "abiesvc\.info" ascii wide nocase
        $domain32 = "abiesvc\.jp\.net" ascii wide nocase
        $domain33 = "account-googlemeet\.com" ascii wide nocase
        $domain34 = "addressstore\.space" ascii wide nocase
        $domain35 = "adiclas-nft\.quest" ascii wide nocase
        $domain36 = "admin\.unitpowergeneration\.top" ascii wide nocase
        $domain37 = "aidpartners\.org" ascii wide nocase
        $domain38 = "ajayplamingo\.com" ascii wide nocase
        $domain39 = "aleslosev\.workers\.dev" ascii wide nocase
        $domain40 = "algozzoom\.us006web\.us" ascii wide nocase
        $domain41 = "altair-vc\.co\.uk" ascii wide nocase
        $domain42 = "altair-vc\.com" ascii wide nocase
        $domain43 = "altair\.linkpc\.net" ascii wide nocase
        $domain44 = "amazonaws1\.info" ascii wide nocase
        $domain45 = "amzonnews\.club" ascii wide nocase
        $domain46 = "analysis\.arkinvst\.com" ascii wide nocase
        $domain47 = "angelbridge\.capital" ascii wide nocase
        $domain48 = "angelbridge\.jp" ascii wide nocase
        $domain49 = "ankanimatoka\.com" ascii wide nocase
...
rule APT_LAZARUS
{
    ...
    strings:
        ...
        $domain13 = "1drvmicrosoft\.com" ascii wide nocase
        $domain14 = "1winfans\.com" ascii wide nocase
        $domain15 = "247l\.net" ascii wide nocase
        $domain16 = "260120\.vercel\.app" ascii wide nocase
        $domain17 = "2ab9\.watashinonegai\.ru" ascii wide nocase
        $domain18 = "2daojnjnp666jla6\.dropfile\.online" ascii wide nocase
        $domain19 = "3\.143\.24\.91\.sslip\.io" ascii wide nocase
        $domain20 = "360scanner\.store" ascii wide nocase
        $domain21 = "360share\.pro" ascii wide nocase
        $domain22 = "3la6ol\.net" ascii wide nocase
        $domain23 = "49rjaf1fgrlzl1t82dpxmiqmyeedl4kku5y3hjvanjleyhpo3pjmbn23q0\.pages\.dev" ascii wide nocase
        $domain24 = "4bjt2rceijktwedi\.onion" ascii wide nocase
        $domain25 = "4w9h8ps9\.naveicoipa\.tech" ascii wide nocase
        $domain26 = "4w9h8ps9\.naveicoipc\.tech" ascii wide nocase
        $domain27 = "5l\.securemypc\.xyz" ascii wide nocase
        $domain28 = "6la0cwds\.naveicoiph\.online" ascii wide nocase
        $domain29 = "7xvc\.meeting-central\.online" ascii wide nocase
        $domain30 = "7xvc\.meeting-zone\.online" ascii wide nocase
        $domain31 = "7xvc\.roomconnect\.online" ascii wide nocase
        $domain32 = "7xvc\.virtual-collab\.online" ascii wide nocase
        $domain33 = "8190ocvswfyd57v5\.docsend\.online" ascii wide nocase
        $domain34 = "91\.90\.121\.87\.sslip\.io" ascii wide nocase
        $domain35 = "9yxqida1b\.naveicoiph\.online" ascii wide nocase
        $domain36 = "a\.videotalks\.site" ascii wide nocase
        $domain37 = "aat1pbil\.naveicoipg\.online" ascii wide nocase
        $domain38 = "abc\.meeting-central\.online" ascii wide nocase
        $domain39 = "abc\.meeting-zone\.online" ascii wide nocase
        $domain40 = "abc\.preconnection\.online" ascii wide nocase
        $domain41 = "abc\.roomconnect\.online" ascii wide nocase
        $domain42 = "abilityscan360\.com" ascii wide nocase
        $domain43 = "abs\.twitter\.expublic\.linkpc\.net" ascii wide nocase
        $domain44 = "access\.support\.general-meet\.site" ascii wide nocase
        $domain45 = "accounts\.ceinbase\.com" ascii wide nocase
        $domain46 = "acoustickoala\.com" ascii wide nocase
        $domain47 = "acroadovw\.com" ascii wide nocase
        $domain48 = "activity-179384736\.site" ascii wide nocase
        $domain49 = "activity-permission\.online" ascii wide nocase
...
rule APT_MUDDYWATER
{
    ...
    strings:
        ...
        $domain4 = "0419726\.xyz" ascii wide nocase
        $domain5 = "0427691\.xyz" ascii wide nocase
        $domain6 = "0518429\.xyz" ascii wide nocase
        $domain7 = "0584962\.xyz" ascii wide nocase
        $domain8 = "0618497\.xyz" ascii wide nocase
        $domain9 = "0682149\.xyz" ascii wide nocase
        $domain10 = "0746382\.xyz" ascii wide nocase
        $domain11 = "0746925\.xyz" ascii wide nocase
        $domain12 = "0857314\.xyz" ascii wide nocase
        $domain13 = "0865174\.xyz" ascii wide nocase
        $domain14 = "0946158\.xyz" ascii wide nocase
        $domain15 = "0947682\.xyz" ascii wide nocase
        $domain16 = "0973642\.xyz" ascii wide nocase
        $domain17 = "0973648\.xyz" ascii wide nocase
        $domain18 = "108901\.xyz" ascii wide nocase
        $domain19 = "115437\.xyz" ascii wide nocase
        $domain20 = "118652\.xyz" ascii wide nocase
        $domain21 = "119012\.xyz" ascii wide nocase
        $domain22 = "120974\.xyz" ascii wide nocase
        $domain23 = "126805\.xyz" ascii wide nocase
        $domain24 = "126841\.xyz" ascii wide nocase
        $domain25 = "1274672\.xyz" ascii wide nocase
        $domain26 = "1279578\.xyz" ascii wide nocase
        $domain27 = "129012\.xyz" ascii wide nocase
        $domain28 = "132579\.xyz" ascii wide nocase
        $domain29 = "132690\.xyz" ascii wide nocase
        $domain30 = "1327589\.xyz" ascii wide nocase
        $domain31 = "1365084\.xyz" ascii wide nocase
        $domain32 = "1368497\.xyz" ascii wide nocase
        $domain33 = "139012\.xyz" ascii wide nocase
        $domain34 = "143456\.xyz" ascii wide nocase
        $domain35 = "143682\.xyz" ascii wide nocase
        $domain36 = "1459738\.xyz" ascii wide nocase
        $domain37 = "14638275\.xyz" ascii wide nocase
        $domain38 = "1485390\.xyz" ascii wide nocase
        $domain39 = "15093472\.xyz" ascii wide nocase
        $domain40 = "1509782\.xyz" ascii wide nocase
        $domain41 = "1549038\.xyz" ascii wide nocase
        $domain42 = "156738\.xyz" ascii wide nocase
        $domain43 = "1573208\.xyz" ascii wide nocase
        $domain44 = "158739\.xyz" ascii wide nocase
        $domain45 = "158901\.xyz" ascii wide nocase
        $domain46 = "159352\.xyz" ascii wide nocase
        $domain47 = "1597382\.xyz" ascii wide nocase
        $domain48 = "159740\.xyz" ascii wide nocase
        $domain49 = "1628394\.xyz" ascii wide nocase
...
rule APT_OCEANLOTUS
{
    ...
    strings:
        ...
        $domain8 = "agoras\.hopto\.org" ascii wide nocase
        $domain9 = "agoras\.zapto\.org" ascii wide nocase
        $domain10 = "aisicoin\.com" ascii wide nocase
        $domain11 = "aki\.viperse\.com" ascii wide nocase
        $domain12 = "alicervois\.com" ascii wide nocase
        $domain13 = "aliexpresscn\.net" ascii wide nocase
        $domain14 = "alyerrac\.com" ascii wide nocase
        $domain15 = "anaehler\.com" ascii wide nocase
        $domain16 = "andreafaerber\.com" ascii wide nocase
        $domain17 = "andreagahuvrauvin\.com" ascii wide nocase
        $domain18 = "andreagbridge\.com" ascii wide nocase
        $domain19 = "anessallie\.com" ascii wide nocase
        $domain20 = "annamerrett\.com" ascii wide nocase
        $domain21 = "anofrio\.com" ascii wide nocase
        $domain22 = "antenham\.com" ascii wide nocase
        $domain23 = "aol\.straliaenollma\.xyz" ascii wide nocase
        $domain24 = "api\.anaehler\.com" ascii wide nocase
        $domain25 = "api\.blogdns\.com" ascii wide nocase
        $domain26 = "api\.ciscofreak\.com" ascii wide nocase
        $domain27 = "api\.myddns\.me" ascii wide nocase
        $domain28 = "apiservice\.webhop\.net" ascii wide nocase
        $domain29 = "arbenha\.com" ascii wide nocase
        $domain30 = "arinaurna\.com" ascii wide nocase
        $domain31 = "arkoimmerma\.com" ascii wide nocase
        $domain32 = "art\.guillermoespana\.com" ascii wide nocase
        $domain33 = "art\.yfieldrainasch\.com" ascii wide nocase
        $domain34 = "asia-kotoba\.net" ascii wide nocase
        $domain35 = "att\.illagedrivestralia\.xyz" ascii wide nocase
        $domain36 = "au\.charlineopkesston\.com" ascii wide nocase
        $domain37 = "audreybourgeois\.com" ascii wide nocase
        $domain38 = "aulolloy\.com" ascii wide nocase
        $domain39 = "auth\.lineage2ez\.com" ascii wide nocase
        $domain40 = "avidilleneu\.com" ascii wide nocase
        $domain41 = "avidsontre\.com" ascii wide nocase
        $domain42 = "aximilian\.com" ascii wide nocase
        $domain43 = "b\.cortanazone\.com" ascii wide nocase
        $domain44 = "background\.ristians\.com" ascii wide nocase
        $domain45 = "baidu-search\.net" ascii wide nocase
        $domain46 = "baodachieu\.com" ascii wide nocase
        $domain47 = "baomoivietnam\.com" ascii wide nocase
        $domain48 = "base\.msteamsapi\.com" ascii wide nocase
        $domain49 = "beaudrysang\.xyz" ascii wide nocase
...
rule APT_TRANSPARENTTRIBE
{
    ...
    strings:
        ...
        $domain28 = "8fold\.space" ascii wide nocase
        $domain29 = "8ln62\.cfd" ascii wide nocase
        $domain30 = "8thpaycomission\.cloud" ascii wide nocase
        $domain31 = "8tqxpf27\.torontobotdns\.com" ascii wide nocase
        $domain32 = "903\.78990\.fun" ascii wide nocase
        $domain33 = "9123\.89204\.fun" ascii wide nocase
        $domain34 = "9882aa1216\.autos" ascii wide nocase
        $domain35 = "999game\.website" ascii wide nocase
        $domain36 = "9gi02\.cfd" ascii wide nocase
        $domain37 = "9ydygorig3l7z\.xyz" ascii wide nocase
        $domain38 = "a\.erforias\.cam" ascii wide nocase
        $domain39 = "aa\.76767\.icu" ascii wide nocase
        $domain40 = "aadharpor\.xyz" ascii wide nocase
        $domain41 = "aadharsewa\.site" ascii wide nocase
        $domain42 = "aadperson\.xyz" ascii wide nocase
        $domain43 = "aaloochaat\.com" ascii wide nocase
        $domain44 = "aboutcase\.nl" ascii wide nocase
        $domain45 = "ac\.76767\.icu" ascii wide nocase
        $domain46 = "accinfo\.live" ascii wide nocase
        $domain47 = "account-recovery\.com" ascii wide nocase
        $domain48 = "account\.migration\.jkpolice\.gov\.in\.mgovcloud\.de" ascii wide nocase
        $domain49 = "accountmail\.in" ascii wide nocase
...
rule APT_VOIDBLIZZARD
{
    meta:
        ...
        aliases = "laundry bear, pluggyape, uac-0190"
