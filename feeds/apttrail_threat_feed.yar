...
rule APT_UNCLASSIFIED
{
    ...
    strings:
        ...
        $ip59 = "109.237.97.43" ascii wide
        $ip60 = "109.237.97.4" ascii wide
        $ip61 = "111.20.145.84" ascii wide
        $ip62 = "111.90.150.37" ascii wide
        $ip63 = "122.10.82.65" ascii wide
        $ip64 = "122.10.93.136" ascii wide
        $ip65 = "13.211.167.218" ascii wide
        $ip66 = "135.125.107.221" ascii wide
        $ip67 = "137.184.67.33" ascii wide
        $ip68 = "137.220.180.39" ascii wide
        $ip69 = "138.124.228.103" ascii wide
        $ip70 = "138.68.56.176" ascii wide
